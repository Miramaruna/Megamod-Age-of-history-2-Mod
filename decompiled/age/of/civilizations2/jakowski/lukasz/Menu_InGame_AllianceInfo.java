...
public class Menu_InGame_AllianceInfo extends SliderMenu {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      ImageManager.getImage(Images.diplo_alliance)
         .draw(
            ...
            this.getPosX2()
               + this.getWidth2() / 2
               - (int)(ImageManager.getImage(Images.diplo_alliance).getWidth() * this.getImageScale(Images.diplo_alliance)) / 2
               + iTranslateX,
            this.getPosY2()
               + this.getHeight2() / 2
               + CFG.PADDING
