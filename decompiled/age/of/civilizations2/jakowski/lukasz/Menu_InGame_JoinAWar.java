...
public class Menu_InGame_JoinAWar extends SliderMenu {
   ...
   public Menu_InGame_JoinAWar() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("JoinAWar"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_JoinAWar(int onCivID, int warAgainst) {
      ...
      int tY = 0;
      menuElements.add(
         new Button_Diplomacy_Message_JoinAWar(CFG.langManager.get("JoinAWarAgainst") + ": ", this.iOnCivID, this.warAgainstCivID, 2, tY, CFG.BUTTON_WIDTH * 2) {
            @Override
            public int getWidth() {
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var8 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_JoinAWar.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("DeclareWar") + "!", -1, 2, var8, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_JoinAWar.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_JoinAWar.this.warAgainstCivID, 0, CFG.PADDING));
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getCiv(Menu_InGame_JoinAWar.this.warAgainstCivID).getCivName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                  )
               );
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Relation") + ": "));
               nData.add(new MenuElement_Hover_v2_Element_Type_Text("+5", CFG.COLOR_TEXT_MODIFIER_POSITIVE));
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_JoinAWar.this.iOnCivID, CFG.PADDING, 0));
   ...
   public final void actionElement(int iID) {
      if (iID == 0) {
         ...
         if (iID == this.getMenuElementsSize() - 1) {
            DiplomacyManager.joinAWar(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.iOnCivID, this.warAgainstCivID);
