...
public class Menu_InGame_View_Economy extends SliderMenu {
   ...
   public Menu_InGame_View_Economy() {
      ...
      for (int i = 0; i < CFG.game.getCiv(this.iCivID).getNumOfProvinces(); i++) {
         if (CFG.FOG_OF_WAR != 2 || CFG.game.getPlayer(CFG.PLAYER_TURNID).getMetProvince(CFG.game.getCiv(this.iCivID).getProvinceID(i))) {
            ...
            totalPopulation += CFG.game.getProvince(CFG.game.getCiv(this.iCivID).getProvinceID(i)).getEconomy();
         }
      }
      ...
      while (tempProvs.size() > 0) {
         ...
         for (int i2 = 1; i2 < tempProvs.size(); i2++) {
            if (CFG.game.getProvince(tempProvs.get(tBest)).getEconomy() < CFG.game.getProvince(tempProvs.get(i2)).getEconomy()) {
               tBest = i2;
            }
         }
      ...
      if (tempProvincesSorted.size() > 0) {
         menuElements.add(
            new Button_NS_Population(
               ...
               CFG.getNumberWithSpaces("" + CFG.game.getCiv(this.iCivID).countEconomy()),
               Images.economy,
         ...
         new SliderMenuTitle(CFG.game.getCiv(this.iCivID).getCivName(), CFG.BUTTON_HEIGHT * 3 / 5, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_InGame_View_Economy.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Economy.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(),
                     Menu_InGame_View_Economy.this.getWidth() + 2,
                     this.getHeight(),
                     true,
                     false
                  );
               oSB.setColor(
                  new Color(
                     CFG.game.getCiv(Menu_InGame_View_Economy.this.iCivID).getR() / 255.0F,
                     CFG.game.getCiv(Menu_InGame_View_Economy.this.iCivID).getG() / 255.0F,
                     CFG.game.getCiv(Menu_InGame_View_Economy.this.iCivID).getB() / 255.0F,
                     0.165F
                  )
               );
               ...
               ImageManager.getImage(Images.pix255_255_255)
                  .draw(
                     oSB,
                     Menu_InGame_View_Economy.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Economy.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(),
                     Menu_InGame_View_Economy.this.getWidth()
                  );
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_InGame_View_Economy.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Economy.this.getPosY()
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     Menu_InGame_View_Economy.this.getWidth() / 4,
                     1
                  );
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Menu_InGame_View_Economy.this.getPosX()
                        + Menu_InGame_View_Economy.this.getWidth()
                        - Menu_InGame_View_Economy.this.getWidth() / 4
                        + iTranslateX,
                     Menu_InGame_View_Economy.this.getPosY()
               ...
               ImageManager.getImage(Images.economy)
                  .draw(
                     ...
                     Menu_InGame_View_Economy.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.economy).getHeight() / 2
                  );
