...
public class Event_Outcome_NonAggression extends Event_Outcome {
   public int iCivID = -1;
   public int iCivID2 = -1;
   public int iValue = 0;

   Event_Outcome_NonAggression() {
   }
   ...
   public void outcomeAction() {
      if (this.canMakeAction()) {
         CFG.game.setCivNonAggressionPact(this.getCivID(), this.getCivID2(), this.getValue());
   ...
   public List<MenuElement_Hover_v2_Element2> getHoverText() {
      try {
         ...
         if (this.canMakeAction()) {
            tData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("NonAggressionPact") + ":", CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
