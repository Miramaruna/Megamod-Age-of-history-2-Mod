...
public class Message_OpenBudget extends Message {
   public Message_OpenBudget(int fromCivID) {
      super(fromCivID, 0);
      this.messageType = Message_Type.BUDGET;
   ...
   public MenuElement_Hover_v2 getHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("OpenTheViewOfYourCivilizationsBudget"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
