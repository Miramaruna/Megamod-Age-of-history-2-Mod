...
public class Message_Union_Accepted extends Message {
   public Message_Union_Accepted(int fromCivID, int iValue) {
      super(fromCivID, iValue);
      this.messageType = Message_Type.UNION_ACCEPTED;
   ...
   public void onAccept(int iCivID) {
      if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID() == iCivID) {
         ...
         lMess.add(CFG.langManager.get("FormUnion") + " - " + CFG.langManager.get("OurProposalWasAccepted"));
