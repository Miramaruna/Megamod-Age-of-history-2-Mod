...
public class Graph_Vertical_Data_Value_Continent extends Graph_Vertical_Data_Value {
   ...
   public final Color getColor(float fAlpha) {
      try {
         return new Color(
            CFG.map.getMapContinents().getColor(this.iColorDataID).r,
            CFG.map.getMapContinents().getColor(this.iColorDataID).g,
            CFG.map.getMapContinents().getColor(this.iColorDataID).b,
            fAlpha
         );
