...
public class Menu_InGame_FestivalInAllProvince extends SliderMenu {
   public int iOnCivID = -1;

   public Menu_InGame_FestivalInAllProvince(int onCivID) {
      ...
      menuElements.add(
         new Button_NS_Opinion(
            ...
            @Override
            public int getWidth() {
               return Menu_InGame_FestivalInAllProvince.this.getElementW() * 2;
            }
         }
      );
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_FestivalInAllProvince.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Confirm"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_FestivalInAllProvince.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_FestivalInAllProvince.this.iOnCivID, CFG.PADDING, CFG.PADDING));
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getCiv(Menu_InGame_FestivalInAllProvince.this.iOnCivID).getCivName()));
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("HaveNationalCelebration"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            @Override
