...
public class Menu_InGame_View_Army extends SliderMenu {
   ...
   public static final int getButtonHeight() {
      return (int)(CFG.isAndroid() ? Math.max(CFG.BUTTON_HEIGHT * 0.6F, (float)(CFG.TEXT_HEIGHT + CFG.PADDING * 6)) : CFG.TEXT_HEIGHT + CFG.PADDING * 5);
   }
   ...
   public Menu_InGame_View_Army() {
      ...
      try {
         ...
         for (int i = 0; i < CFG.game.getCiv(this.iCivID).getNumOfProvinces(); i++) {
            if (CFG.game.getProvince(CFG.game.getCiv(this.iCivID).getProvinceID(i)).getArmyCivID(this.iCivID) > 0) {
               tempProvs.add(CFG.game.getCiv(this.iCivID).getProvinceID(i));
            }
         }

         for (int var10 = 0; var10 < CFG.game.getCiv(this.iCivID).getArmyInAnotherProvinceSize(); var10++) {
            if (CFG.game.getProvince(CFG.game.getCiv(this.iCivID).getArmyInAnotherProvince(var10)).getArmyCivID(this.iCivID) > 0) {
               tempProvs.add(CFG.game.getCiv(this.iCivID).getArmyInAnotherProvince(var10));
            }
         }
         ...
         while (tempProvs.size() > 0) {
            ...
            for (int i2 = 1; i2 < tempProvs.size(); i2++) {
               if (CFG.game.getProvince(tempProvs.get(tBest)).getArmyCivID(this.iCivID) < CFG.game.getProvince(tempProvs.get(i2)).getArmyCivID(this.iCivID)) {
                  tBest = i2;
               }
            }
         ...
         if (tempProvincesSorted.size() > 0) {
            menuElements.add(
               new Button_NS_Population(
                  ...
                  CFG.getNumberWithSpaces("" + CFG.game.getCiv(this.iCivID).getNumOfUnits()),
                  Images.diplo_army,
            ...
            for (int var11 = 0; var11 < tempProvincesSorted.size(); var11++) {
               menuElements.add(
                  new Button_View_Army(
                     var11,
                     (
                           CFG.game.getProvince((Integer)tempProvincesSorted.get(var11)).getName().length() > 0
                              ? CFG.game.getProvince((Integer)tempProvincesSorted.get(var11)).getName()
                              : CFG.game.getCiv(this.iCivID).getCivName()
                        )
                        + ": ",
                     (Integer)tempProvincesSorted.get(var11),
                     this.iCivID,
                     (int)CFG.game_NextTurnUpdate.getMilitaryUpkeep((Integer)tempProvincesSorted.get(var11), this.iCivID),
                     0,
                     tY,
         ...
         new SliderMenuTitle(null, CFG.BUTTON_HEIGHT * 3 / 5, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_InGame_View_Army.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Army.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(),
                     Menu_InGame_View_Army.this.getWidth() + 2,
                     this.getHeight(),
                     true,
                     false
                  );
               ...
               ImageManager.getImage(Images.pix255_255_255)
                  .draw(
                     oSB,
                     Menu_InGame_View_Army.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Army.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(),
                     Menu_InGame_View_Army.this.getWidth()
                  );
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_InGame_View_Army.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Army.this.getPosY()
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     Menu_InGame_View_Army.this.getWidth() / 4,
                     1
                  );
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Menu_InGame_View_Army.this.getPosX() + Menu_InGame_View_Army.this.getWidth() - Menu_InGame_View_Army.this.getWidth() / 4 + iTranslateX,
                     Menu_InGame_View_Army.this.getPosY()
                        - ImageManager.getImage(Images.pix255_255_255).getHeight()
                        - ImageManager.getImage(Images.slider_gradient).getHeight(),
                     Menu_InGame_View_Army.this.getWidth() / 4,
               ...
               ImageManager.getImage(Images.diplo_army)
                  .draw(
                     ...
                     Menu_InGame_View_Army.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_army).getHeight() / 2
                  );
