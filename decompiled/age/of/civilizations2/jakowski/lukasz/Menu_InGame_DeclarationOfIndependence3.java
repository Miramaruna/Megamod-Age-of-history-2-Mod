...
class Menu_InGame_DeclarationOfIndependence3 extends SliderMenu {
   private int iOnCivID = -1;

   protected Menu_InGame_DeclarationOfIndependence3(int var1) {
      ...
      var2.add(
         new Button_NS_Opinion(
            ...
            final Menu_InGame_DeclarationOfIndependence3 this$0;
            ...
            protected void drawText(SpriteBatch var1, int var2x, int var3x, boolean var4) {
               ImageManager.getImage(Images.diplo_festival)
                  .draw(
                     ...
                     this.getPosX()
                        + this.getWidth() / 2
                        - (int)((this.getTextWidth() * 0.8F + ImageManager.getImage(Images.diplo_festival).getWidth() + CFG.PADDING) / 2.0F)
                        + var2x,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.diplo_festival).getHeight() / 2 + var3x
                  );
               ...
               if (this.getTextPos() < 0) {
                  var7 = this.getWidth() / 2
                     - (int)((this.getTextWidth() * 0.8F + ImageManager.getImage(Images.diplo_festival).getWidth() + CFG.PADDING) / 2.0F)
                     + ImageManager.getImage(Images.diplo_festival).getWidth()
                     + CFG.PADDING;
               } else {
      ...
      SliderMenuTitle var5 = new SliderMenuTitle(this, CFG.langManager.get("HaveNationalCelebration"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
         final Menu_InGame_DeclarationOfIndependence3 this$0;
   ...
   protected final void actionElement(int var1) {
      if (var1 == this.getMenuElementsSize() - 1) {
         DiplomacyManager.addFestivalInAllProvince(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID());
   ...
   protected void draw(SpriteBatch var1, int var2, int var3, boolean var4) {
      if (Menu_InGame_OfferAlliance.lTime + 200L >= System.currentTimeMillis()) {
         ...
         var6 = this.getHeight();
         var14.draw2(var1, var8 + 2 + var7 - var12 + var2, var9 - var10 + var3, var11, CFG.PADDING + var6, true, true);
         ...
         var15.draw2(var1, var27 - 2 + var2, var21 - var18 + var3, var24 - var33 + 4, CFG.PADDING + var30, false, true);
         ...
         var15.draw2(var1, var27 + 2 + var24 - var21 + var2, var30 - var18 + var3, var33, CFG.PADDING + var35, true, true);
         var1.setColor(new Color(0.0F, 0.0F, 0.0F, 0.45F));
         ImageManager.getImage(Images.gradient)
            .draw(
               var1,
