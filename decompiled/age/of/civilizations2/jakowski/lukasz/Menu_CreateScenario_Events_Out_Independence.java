...
public class Menu_CreateScenario_Events_Out_Independence extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(3).setText(CFG.langManager.get("NumberOfTurns") + ": ");
      this.getTitle().setText(CFG.langManager.get("GuaranteeIndependence"));
   }
