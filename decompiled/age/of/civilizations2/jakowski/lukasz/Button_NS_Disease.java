...
public class Button_NS_Disease extends Button {
      ...
      ImageManager.getImage(Images.disease)
         .draw(
            ...
            this.getPosY()
               ...
               - (int)(ImageManager.getImage(Images.disease).getHeight() * this.getImageScale(Images.disease, 0.65F)) / 2
               - ImageManager.getImage(Images.disease).getHeight()
               + iTranslateY,
            (int)(ImageManager.getImage(Images.disease).getWidth() * this.getImageScale(Images.disease, 0.65F)),
            (int)(ImageManager.getImage(Images.disease).getHeight() * this.getImageScale(Images.disease, 0.65F))
         );
