...
public class RegroupArmy_Data_ToTheFront_Double extends RegroupArmy_Data_ToTheFront {
   public RegroupArmy_Data_ToTheFront_Double(int nCivID, int fromProvinceID, int toProvinceID) {
