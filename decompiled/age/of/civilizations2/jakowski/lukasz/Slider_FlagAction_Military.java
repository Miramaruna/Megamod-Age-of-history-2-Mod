...
public class Slider_FlagAction_Military extends Slider {
   ...
   public Slider_FlagAction_Military(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
