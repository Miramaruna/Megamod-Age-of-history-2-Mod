...
public class Menu_InGame_Invest_Development extends SliderMenu {
   ...
   public Menu_InGame_Invest_Development(int nProvinceID) {
      ...
      int tY = 0;
      menuElements.add(
         new Button_Build_Invest_Development(
      ...
      menuElements.add(
         new Slider_FlagAction_Gold(
            ...
            0,
            DiplomacyManager.invest_MaxDevelopment_Gold(nProvinceID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()),
            0,
            0.65F,
            Images.top_gold
         ) {
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getProvince(Menu_InGame_Invest_Development.iProvinceID).getName().length() > 0
                        ? CFG.game.getProvince(Menu_InGame_Invest_Development.iProvinceID).getName()
                        : CFG.langManager.get("Province")
                  )
               );
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(Menu_InGame_Invest_Development.iProvinceID).getCivID(), CFG.PADDING, 0)
               );
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "" + String.format("%.2f", CFG.game.getProvince(Menu_InGame_Invest_Development.iProvinceID).getDevelopmentLevel()).replace(',', '.'),
         ...
         new SliderMenuTitle(CFG.langManager.get("Invest"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_Invest_Development.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Invest_Development.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_Invest_Development.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Invest_Development.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
