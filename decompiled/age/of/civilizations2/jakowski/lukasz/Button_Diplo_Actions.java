...
public class Button_Diplo_Actions extends Button {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ImageManager.getImage(Images.top_diplomacy_points)
         .draw(
            ...
            this.getPosX()
               ...
               - CFG.PADDING
               - (int)(this.getTextWidth() * 0.6F / 2.0F)
               + iTranslateX,
      ...
      CFG.drawText(
         oSB,
         this.getText(),
         this.getPosX() + this.getWidth() / 2 - (int)(this.getTextWidth() * 0.6F / 2.0F) + iTranslateX,
