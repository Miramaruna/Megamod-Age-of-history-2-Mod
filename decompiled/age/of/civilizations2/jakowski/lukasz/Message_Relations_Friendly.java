...
public class Message_Relations_Friendly extends Message {
   public Message_Relations_Friendly(int byCivID) {
      super(byCivID, 0);
      this.messageType = Message_Type.RELATIONS_FRIEDNLY;
   ...
   public void onAccept(int iCivID) {
      if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID() == iCivID) {
         ...
         lMess.add(CFG.langManager.get("FriendlyCivilizations"));
