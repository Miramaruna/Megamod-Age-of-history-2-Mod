...
public class Button_View_Development extends Button {
   ...
   public Button_View_Development(int iRow, String sText, int nProvinceID, int iPosX, int iPosY, int iWidth, boolean isAssimiliate) {
      ...
      this.sPopulation = "" + (int)(CFG.game.getProvince(this.iProvinceID).getDevelopmentLevel() * 100.0F) / 100.0F;
   ...
   public void buildElementHover() {
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(
            "" + (int)(CFG.game.getCiv(CFG.game.getProvince(this.iProvinceID).getCivID()).getTechnologyLevel() * 100.0F) / 100.0F,
