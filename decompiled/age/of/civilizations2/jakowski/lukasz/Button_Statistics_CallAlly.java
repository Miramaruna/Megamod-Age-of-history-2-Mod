...
public class Button_Statistics_CallAlly extends Button_Statistics {
   public static final float FONT_SCALE = 0.6F;
   public int iCivID;
   public String sCallAll;
   public int iCallAllyWidth;

   public Button_Statistics_CallAlly(int nCivID, int iPosX, int iPosY, int iWidth, boolean isDeclareWar) {
      super(
         ...
         iPosY,
         iWidth,
         Math.max(CFG.TEXT_HEIGHT + CFG.PADDING * 2, (int)(CFG.BUTTON_HEIGHT * 0.5F))
      );
      this.iCivID = nCivID;
      this.callAlly(isDeclareWar);
   }

   public Button_Statistics_CallAlly(int nCivID, int iPosX, int iPosY, int iWidth, boolean checkbox, boolean isDeclareWar) {
      super(
         "" + (nCivID < 0 ? CFG.langManager.get("Undiscovered") : CFG.game.getCiv(nCivID).getCivName()),
         0,
         iPosX,
   ...
   public void callAlly(boolean isDeclareWar) {
      if (isDeclareWar) {
         this.sCallAll = "";
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      if (this.getClickable() && this.iCallAllyWidth > 0) {
         ...
         CFG.drawTextWithShadow(
            ...
            this.getPosY() + (int)((this.getHeight() - CFG.TEXT_HEIGHT * 0.6F) / 2.0F) + iTranslateY,
      ...
      ImageManager.getImage(Images.pix255_255_255)
         .draw(
            ...
            this.getPosY()
               + (this.getHeight() - (int)(ImageManager.getImage(Images.flag_rect).getHeight() * this.getImageScale(Images.flag_rect))) / 2
