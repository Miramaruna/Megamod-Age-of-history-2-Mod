...
public class Difficulty_Level extends MenuElement {
   public static final Color COLOR_BG = new Color(0.05490196F, 0.07450981F, 0.11764706F, 1.0F);
   public static final Color COLOR_BG_DIFF = new Color(0.039215688F, 0.047058824F, 0.06666667F, 1.0F);
   public float fPercentage = 1.0F;
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      if (System.currentTimeMillis() < this.lTime + 425L) {
         this.iCurrentPosX = (int)(this.getWidth() * this.fPercentage * ((float)(System.currentTimeMillis() - this.lTime) / 425.0F));
         this.iCurrentPosX = (int)Math.min((float)this.iCurrentPosX, this.getWidth() * this.fPercentage);
         CFG.setRender_3(true);
      } else {
         this.iCurrentPosX = (int)(this.getWidth() * this.fPercentage);
      }
   ...
   public void setCurrent(int nCurrent) {
      this.fPercentage = nCurrent / 100.0F;
      this.lTime = System.currentTimeMillis();
   }
