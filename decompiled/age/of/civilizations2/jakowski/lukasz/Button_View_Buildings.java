...
public class Button_View_Buildings extends Button {
         ...
         ImageManager.getImage(Images.b_fort)
            .draw(
               ...
               this.getPosX()
                  ...
                  + (
                     nX -= CFG.PADDING
                        + (int)(ImageManager.getImage(Images.b_fort).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_fort).getHeight()))
                  )
                  + iTranslateX,
               this.getPosY()
                  + this.getHeight() / 2
                  - (int)(ImageManager.getImage(Images.b_fort).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_fort).getHeight())) / 2
                  + iTranslateY
                  - ImageManager.getImage(Images.b_fort).getHeight(),
               (int)(ImageManager.getImage(Images.b_fort).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_fort).getHeight())),
               (int)(ImageManager.getImage(Images.b_fort).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_fort).getHeight()))
            );
      }
         ...
         ImageManager.getImage(Images.b_tower)
            .draw(
               ...
               this.getPosX()
                  ...
                  + (
                     nX -= CFG.PADDING
                        + (int)(ImageManager.getImage(Images.b_tower).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_tower).getHeight()))
                  )
                  + iTranslateX,
               this.getPosY()
                  + this.getHeight() / 2
                  - (int)(ImageManager.getImage(Images.b_tower).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_tower).getHeight())) / 2
                  + iTranslateY
                  - ImageManager.getImage(Images.b_tower).getHeight(),
               (int)(ImageManager.getImage(Images.b_tower).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_tower).getHeight())),
               (int)(ImageManager.getImage(Images.b_tower).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_tower).getHeight()))
            );
      }
         ...
         ImageManager.getImage(Images.b_port)
            .draw(
               ...
               this.getPosX()
                  ...
                  + (
                     nX -= CFG.PADDING
                        + (int)(ImageManager.getImage(Images.b_port).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_port).getHeight()))
                  )
                  + iTranslateX,
               this.getPosY()
                  + this.getHeight() / 2
                  - (int)(ImageManager.getImage(Images.b_port).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_port).getHeight())) / 2
                  + iTranslateY
                  - ImageManager.getImage(Images.b_port).getHeight(),
               (int)(ImageManager.getImage(Images.b_port).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_port).getHeight())),
               (int)(ImageManager.getImage(Images.b_port).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_port).getHeight()))
            );
      }
         ...
         ImageManager.getImage(Images.b_farm)
            .draw(
               ...
               this.getPosX()
                  ...
                  + (
                     nX -= CFG.PADDING
                        + (int)(ImageManager.getImage(Images.b_farm).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_farm).getHeight()))
                  )
                  + iTranslateX,
               this.getPosY()
                  + this.getHeight() / 2
                  - (int)(ImageManager.getImage(Images.b_farm).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_farm).getHeight())) / 2
                  + iTranslateY
                  - ImageManager.getImage(Images.b_farm).getHeight(),
               (int)(ImageManager.getImage(Images.b_farm).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_farm).getHeight())),
               (int)(ImageManager.getImage(Images.b_farm).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_farm).getHeight()))
            );
      }
         ...
         ImageManager.getImage(Images.b_armoury)
            .draw(
               ...
               this.getPosX()
                  ...
                  + (
                     nX -= CFG.PADDING
                        + (int)(ImageManager.getImage(Images.b_armoury).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_armoury).getHeight()))
                  )
                  + iTranslateX,
               this.getPosY()
                  + this.getHeight() / 2
                  - (int)(ImageManager.getImage(Images.b_armoury).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_armoury).getHeight())) / 2
                  + iTranslateY
                  - ImageManager.getImage(Images.b_armoury).getHeight(),
               (int)(ImageManager.getImage(Images.b_armoury).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_armoury).getHeight())),
               (int)(ImageManager.getImage(Images.b_armoury).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_armoury).getHeight()))
            );
      }
      ...
      if (CFG.game.getProvince(this.iProvinceID).getLevelOfSupply() > 0) {
         ImageManager.getImage(Images.b_supply)
            .draw(
                  ...
                  + (
                     nX
                        - (
                           CFG.PADDING
                              + (int)(
                                 ImageManager.getImage(Images.b_supply).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_supply).getHeight())
                              )
                        )
                  )
                  + iTranslateX,
               this.getPosY()
                  + this.getHeight() / 2
                  - (int)(ImageManager.getImage(Images.b_supply).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_supply).getHeight())) / 2
                  + iTranslateY
                  - ImageManager.getImage(Images.b_supply).getHeight(),
               (int)(ImageManager.getImage(Images.b_supply).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_supply).getHeight())),
               (int)(ImageManager.getImage(Images.b_supply).getHeight() * this.getImageScale2(ImageManager.getImage(Images.b_supply).getHeight()))
            );
      }
   ...
   public void buildElementHover() {
      try {
         ...
         if (CFG.game.getProvince(this.iProvinceID).getLevelOfFort() > 0) {
            ...
            nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + CFG.game.getProvince(this.iProvinceID).getLevelOfFort(), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
         ...
         if (CFG.game.getProvince(this.iProvinceID).getLevelOfPort() > 0) {
            ...
            nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Level") + ": ", CFG.COLOR_TEXT_MODIFIER_NEUTRAL));
            nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + CFG.game.getProvince(this.iProvinceID).getLevelOfPort(), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
            nElements.add(new MenuElement_Hover_v2_Element2(nData));
            nData.clear();
            nData.add(new MenuElement_Hover_v2_Element_Type_Text(" - "));
         ...
         if (CFG.game.getProvince(this.iProvinceID).getLevelOfFarm() > 0) {
            ...
            nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Level") + ": ", CFG.COLOR_TEXT_MODIFIER_NEUTRAL));
            nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + CFG.game.getProvince(this.iProvinceID).getLevelOfFarm(), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
            nElements.add(new MenuElement_Hover_v2_Element2(nData));
            nData.clear();
            nData.add(new MenuElement_Hover_v2_Element_Type_Text(" - "));
