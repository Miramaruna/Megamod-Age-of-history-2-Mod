...
public class Button_View_Disease extends Button {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
         ...
         ImageManager.getImage(Images.randomCivilizationFlag)
            .draw(
               ...
               this.getPosY()
                  ...
                  - ImageManager.getImage(Images.randomCivilizationFlag).getHeight(),
               (int)(
                  ImageManager.getImage(Images.randomCivilizationFlag).getWidth()
                     * this.getImageScale(ImageManager.getImage(Images.randomCivilizationFlag).getHeight())
               ),
               (int)(
                  ImageManager.getImage(Images.randomCivilizationFlag).getHeight()
      ...
      ImageManager.getImage(Images.disease)
         .draw(
            ...
            this.getPosX()
               + this.getWidth()
               - (int)(ImageManager.getImage(Images.disease).getWidth() * this.getImageScale(ImageManager.getImage(Images.disease).getHeight()))
               - CFG.PADDING * 2
               - this.iPopulationPercWidth
               + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               - (int)(ImageManager.getImage(Images.disease).getHeight() * this.getImageScale(ImageManager.getImage(Images.disease).getHeight())) / 2
               + iTranslateY
               - ImageManager.getImage(Images.disease).getHeight(),
            (int)(ImageManager.getImage(Images.disease).getWidth() * this.getImageScale(ImageManager.getImage(Images.disease).getHeight())),
            (int)(ImageManager.getImage(Images.disease).getHeight() * this.getImageScale(ImageManager.getImage(Images.disease).getHeight()))
         );
