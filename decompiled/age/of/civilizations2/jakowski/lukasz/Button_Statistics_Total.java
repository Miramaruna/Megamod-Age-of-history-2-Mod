...
public class Button_Statistics_Total extends Button_Statistics {
   public Button_Statistics_Total(String sText, int iTextPosX, int iPosX, int iPosY, int iWidth, int iHeight) {
