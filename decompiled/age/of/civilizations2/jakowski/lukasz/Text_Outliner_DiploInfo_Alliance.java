...
public class Text_Outliner_DiploInfo_Alliance extends Text {
   ...
   public Text_Outliner_DiploInfo_Alliance(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
      ...
      this.iCivRight = iCivRight > 0 ? (CFG.game.getPlayer(CFG.PLAYER_TURNID).getMetCivilization(iCivRight) ? iCivRight : -iCivRight) : -1;
