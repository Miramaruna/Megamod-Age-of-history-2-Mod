...
public class Menu_LoadGame extends SliderMenu {
   public Menu_LoadGame() {
      ...
      tY = var16 + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING;
      ...
      try {
         ...
         for (int i = tSplted.length - 1; i >= 0; i--) {
            ...
            if (iterator.hasNext()) {
               ...
               menuElements.add(
                  new Button_Menu_ScenarioLoad(
                     i,
                     tempData.PLAYER_TAG,
                     tempData.Civs,
                     tempData.GameDate + " - " + CFG.langManager.get("Turn") + ": " + tempData.Turn,
                     0,
                     tY,
