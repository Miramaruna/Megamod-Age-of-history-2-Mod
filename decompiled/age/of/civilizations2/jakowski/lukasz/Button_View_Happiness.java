...
public class Button_View_Happiness extends Button {
   ...
   public Button_View_Happiness(int iRow, String sText, int nProvinceID, int iPosX, int iPosY, int iWidth, boolean isFestivalOrganized) {
      ...
      this.sPopulationPerc = "" + (int)(CFG.game.getProvince(this.iProvinceID).getHappiness() * 10000.0F) / 100.0F + "%";
         ...
         ImageManager.getImage(Images.diplo_festival)
            .draw(
               ...
               this.getPosX()
                  ...
                  - (int)(
                     ImageManager.getImage(Images.diplo_festival).getWidth() * this.getImageScale2(ImageManager.getImage(Images.diplo_festival).getHeight())
                  )
                  + iTranslateX,
               this.getPosY()
                  + this.getHeight() / 2
                  ...
                  + iTranslateY
                  - ImageManager.getImage(Images.diplo_festival).getHeight(),
               (int)(ImageManager.getImage(Images.diplo_festival).getWidth() * this.getImageScale2(ImageManager.getImage(Images.diplo_festival).getHeight())),
               (int)(ImageManager.getImage(Images.diplo_festival).getHeight() * this.getImageScale2(ImageManager.getImage(Images.diplo_festival).getHeight()))
            );
      }
