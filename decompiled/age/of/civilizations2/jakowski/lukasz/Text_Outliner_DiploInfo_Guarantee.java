...
public class Text_Outliner_DiploInfo_Guarantee extends Text {
   ...
   public Text_Outliner_DiploInfo_Guarantee(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
   ...
   public final int getImage() {
      return Images.diplo_guarantee_gives;
   }
