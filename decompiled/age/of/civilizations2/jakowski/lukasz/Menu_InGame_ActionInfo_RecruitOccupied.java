...
public class Menu_InGame_ActionInfo_RecruitOccupied extends SliderMenu {
   ...
   public void updateLanguage() {
      this.getMenuElement(0).setText(CFG.langManager.get("YouCantRecruitArmyInOccupiedProvince") + ".");
   }
