...
public class Menu_CreateScenario_Events_Out_Development extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(3).setText(CFG.langManager.get("Development") + ": ");
      this.getTitle().setText(CFG.langManager.get("UpdateDevelopmentLevel"));
   }
