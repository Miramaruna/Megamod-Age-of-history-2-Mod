...
public class Buton_Diplomacy_CallAllies extends Button_Statistics {
   public static final float FONT_SCALE = 0.7F;
   public int iCivA;
   public int onCivID;
   public String sOpinion;
   public int iOpinionWidth;
   public String sOpinionNum;
   public int iOpinionNumWidth;
   public Color opinionColor;

   public Buton_Diplomacy_CallAllies(int i, int iCivA, int onCivID, int iPosX, int iPosY, int iWidth) {
      super(
         ...
         iPosY,
         iWidth,
         CFG.isAndroid() ? Math.max(CFG.TEXT_HEIGHT + CFG.PADDING * 4, (int)(CFG.BUTTON_HEIGHT * 0.6F)) : CFG.TEXT_HEIGHT + CFG.PADDING * 4,
         false
      );
      this.iCivA = iCivA;
