...
public class Button_Diplomacy_GenocideInfo extends Button_Statistics {
   ...
   public int iIncome = 0;
   public int iIncomeWidth = 0;
   public int iIncomeWidth2 = 0;
   public String sDiploCost;
   public int iDiploCostWidth = 0;
   public String sEfficiency;
   public int iEfficiencyWidth = 0;
   public String sEfficiencyPerc;
   public int iEfficiencyPercWidth = 0;

   public Button_Diplomacy_GenocideInfo(String nDiploCost, int nPopulation, int nIncome, int iPosX, int iPosY, int iWidth) {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.population)
         .draw(
            oSB,
            this.getPosX() + CFG.PADDING * 3 + (int)(this.getTextWidth() * 0.7F) + this.iPopulationWidth + iTranslateX,
            this.getPosY()
               + CFG.PADDING * 2
               + (CFG.TEXT_HEIGHT - (int)(ImageManager.getImage(Images.population).getHeight() * this.getImageScale(Images.population))) / 2
      ...
      CFG.game
         .getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getTrueOwnerOfProvince())
         .getFlag()
         .draw(
            oSB,
            this.getPosX() + CFG.PADDING * 2 + (int)(this.getTextWidth() * 0.7F) + iTranslateX,
            this.getPosY()
               + CFG.PADDING * 2
               + (CFG.TEXT_HEIGHT - (int)(ImageManager.getImage(Images.population).getHeight() * this.getImageScale(Images.population))),
            CFG.CIV_FLAG_WIDTH,
            CFG.CIV_FLAG_HEIGHT
         );
      CFG.drawTextWithShadow(
         ...
         this.sIncome,
         this.getPosX() + CFG.PADDING * 2 + iTranslateX,
         this.getPosY() + CFG.PADDING * 3 + CFG.TEXT_HEIGHT + (int)((CFG.TEXT_HEIGHT - CFG.TEXT_HEIGHT * 0.7F) / 2.0F) + iTranslateY,
         this.getColor(isActive)
      );
      CFG.drawTextWithShadow(
         oSB,
      ...
      ImageManager.getImage(Images.top_gold)
         .draw(
            ...
            this.getPosY()
               + CFG.PADDING * 3
               + CFG.TEXT_HEIGHT
               + (CFG.TEXT_HEIGHT - (int)(ImageManager.getImage(Images.top_gold).getHeight() * this.getImageScale(Images.top_gold))) / 2
      ...
      ImageManager.getImage(Images.top_movement_points)
         .draw(
            ...
            this.getPosY()
               ...
               + CFG.TEXT_HEIGHT
               + CFG.PADDING
               + (CFG.TEXT_HEIGHT - (int)(ImageManager.getImage(Images.top_movement_points).getHeight() * this.getImageScale(Images.top_movement_points))) / 2
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosX()
            ...
            - (int)(ImageManager.getImage(Images.top_movement_points).getWidth() * this.getImageScale(Images.top_movement_points))
            + iTranslateX,
         this.getPosY() + CFG.PADDING * 2 + CFG.TEXT_HEIGHT + CFG.PADDING + (int)((CFG.TEXT_HEIGHT - CFG.TEXT_HEIGHT * 0.7F) / 2.0F) + iTranslateY,
