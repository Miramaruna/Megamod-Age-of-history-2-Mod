...
public class Button_FlagFrame extends Button {
   ...
   public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      try {
         oSB.setColor(
            new Color(
               CFG.game.getCiv(CFG.getActiveCivInfo()).getR() / 255.0F,
               CFG.game.getCiv(CFG.getActiveCivInfo()).getG() / 255.0F,
               CFG.game.getCiv(CFG.getActiveCivInfo()).getB() / 255.0F,
               0.725F
            )
         );
