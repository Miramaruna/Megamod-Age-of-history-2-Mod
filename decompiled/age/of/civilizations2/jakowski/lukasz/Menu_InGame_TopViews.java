...
public class Menu_InGame_TopViews extends SliderMenu {
   public Menu_InGame_TopViews() {
      ...
      this.initMenu(
         null,
         ImageManager.getImage(Images.top_left).getWidth() - CFG.topBox.leftExtraViewPadding,
         0,
         CFG.GAME_WIDTH - ImageManager.getImage(Images.top_left).getWidth() + CFG.topBox.leftExtraViewPadding,
         ImageManager.getImage(Images.top_left).getHeight() + 1,
         menuElements
      );
      this.updateLanguage();
