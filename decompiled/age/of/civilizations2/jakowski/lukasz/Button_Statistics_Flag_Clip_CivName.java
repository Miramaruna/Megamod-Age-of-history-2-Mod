...
public class Button_Statistics_Flag_Clip_CivName extends Button_Statistics_Flag {
   public String sCivName;

   public Button_Statistics_Flag_Clip_CivName(int iCivID, String sText, String sName, int iTextPosX, int iPosX, int iPosY, int iWidth, int iHeight) {
