...
public class Button_Build_Destroy extends Button {
   public boolean row = false;

   public Button_Build_Destroy(int iPosX, int iPosY, int iWidth, boolean isClickable) {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.btn_x)
         .draw(
            oSB,
            this.getPosX() + this.getWidth() / 2 - (int)(ImageManager.getImage(Images.btn_x).getWidth() * getImageScale(Images.btn_x)) / 2 + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               - ImageManager.getImage(Images.btn_x).getHeight()
               - (int)(ImageManager.getImage(Images.btn_x).getHeight() * getImageScale(Images.btn_x)) / 2
               + iTranslateY,
            (int)(ImageManager.getImage(Images.btn_x).getWidth() * getImageScale(Images.btn_x)),
            (int)(ImageManager.getImage(Images.btn_x).getHeight() * getImageScale(Images.btn_x))
         );
      oSB.setColor(Color.WHITE);
   }
   ...
   public static final int getButtonWidth() {
      return Math.max((int)(ImageManager.getImage(Images.btn_x).getWidth() * getImageScale(Images.btn_x)) + CFG.PADDING * 6, CFG.BUTTON_WIDTH / 2);
   }
