...
public class UnionFlagsToGenerate_Manager {
   public List<Image> lFlags_Small = new ArrayList<>();
   public List<Image> lFlags_H = new ArrayList<>();
   public List<UnionFlagsToGenerate> lFlags = new ArrayList<>();
   public List<Integer> lCivs_FlagsToLoad = new ArrayList<>();
