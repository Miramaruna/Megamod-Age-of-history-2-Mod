...
public class HistoryLog_Guarantee extends HistoryLog {
   public String sMess;
   ...
   public void updateLanguage() {
      this.sMess = CFG.langManager.get("GuaranteeIndependence") + ": ";
   ...
   public void draw(SpriteBatch oSB, int nTurnID, int iPosX, int iPosY, int iWidth, int iHeight, boolean isActive) {
      this.drawLeftIcon(oSB, Images.diplo_guarantee_gives, iPosX, iPosY, iWidth, iHeight, isActive);
