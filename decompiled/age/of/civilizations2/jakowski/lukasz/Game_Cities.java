...
public class Game_Cities {
   ...
   public final List<City> loadCities() {
      ArrayList<City> nCities = new ArrayList<>();
      ...
      try {
         Game_Cities.Config var15 = this.readCities("cities_1.json");

         for (Object e : var15.cities) {
            Game_Cities.GameCity oCityData = (Game_Cities.GameCity)e;
      ...
      try {
         Game_Cities.Config var16 = this.readCities("cities_2.json");

         for (Object e : var16.cities) {
            Game_Cities.GameCity oCityData = (Game_Cities.GameCity)e;
      ...
      try {
         Game_Cities.Config var17 = this.readCities("cities_3.json");

         for (Object e : var17.cities) {
            Game_Cities.GameCity oCityData = (Game_Cities.GameCity)e;
      ...
      try {
         Game_Cities.Config var18 = this.readCities("cities_4.json");

         for (Object e : var18.cities) {
            Game_Cities.GameCity oCityData = (Game_Cities.GameCity)e;
   ...
   public final Game_Cities.Config readCities(String nFileName) {
      Json json = new Json();
