...
public class Menu_RandomGame_Civilizations_Select extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getTitle().setText(CFG.langManager.get("SelectCivilization") + " - " + CFG.langManager.get("RandomGames"));
   }
   ...
   public void onBackPressed() {
      ...
      CFG.menuManager.clearRandomGame_SelectCivilizations();
   }
