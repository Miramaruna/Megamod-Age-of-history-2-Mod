      ...
      ImageManager.getImage(Images.btn_localization)
         .draw(
            ...
            this.getPosX()
               + this.getWidth() / 2
               - (int)(
                     ImageManager.getImage(Images.btn_localization).getWidth() * this.getImageScale(ImageManager.getImage(Images.btn_localization).getHeight())
                  )
                  / 2
               + iTranslateX,
            this.getPosY()
               ...
               + iTranslateY
               - ImageManager.getImage(Images.btn_localization).getHeight(),
            (int)(ImageManager.getImage(Images.btn_localization).getWidth() * this.getImageScale(ImageManager.getImage(Images.btn_localization).getHeight())),
            (int)(ImageManager.getImage(Images.btn_localization).getHeight() * this.getImageScale(ImageManager.getImage(Images.btn_localization).getHeight()))
         );
      oSB.setColor(Color.WHITE);
   }
