...
public class Text_Outliner_DiploInfo_Annexation extends Text {
   ...
   public Text_Outliner_DiploInfo_Annexation(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
   ...
   public void buildElementHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Annexation"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(" -> ", CFG.COLOR_TEXT_MODIFIER_POSITIVE));
      nData.add(
   ...
   public void actionElement(int iID) {
      CFG.toast
         .setInView(
            CFG.langManager.get("Annexation")
               + ": "
