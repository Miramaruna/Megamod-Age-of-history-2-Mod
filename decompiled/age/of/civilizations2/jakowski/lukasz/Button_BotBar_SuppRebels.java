...
public class Button_BotBar_SuppRebels extends Button_BotBar {
   ...
   public List<Integer> lCivsTurnsLeft = new ArrayList<>();
   public List<List<Integer>> lSupportedByCivs = new ArrayList<>();
                  ...
                  this.getPosX()
                     ...
                     + (int)(
                        ImageManager.getImage(Images.diplo_revolution).getWidth()
                           * ((float)ImageManager.getImage(Images.victoryPoints).getHeight() / ImageManager.getImage(Images.diplo_revolution).getHeight())
                     )
                     + CFG.PADDING
                     + ((int)(CFG.CIV_FLAG_WIDTH * this.getImageScale()) + CFG.PADDING) * i
                     + iTranslateX,
                  this.getPosY()
   ...
   @Override
   public void setCurrent(int iProvinceID) {
   ...
   public int getWidth() {
      return (int)(
         ...
         + CFG.PADDING * 2
         + 2
         + ((int)(CFG.CIV_FLAG_WIDTH * this.getImageScale()) + CFG.PADDING) * this.iCivsSize
         + CFG.PADDING
