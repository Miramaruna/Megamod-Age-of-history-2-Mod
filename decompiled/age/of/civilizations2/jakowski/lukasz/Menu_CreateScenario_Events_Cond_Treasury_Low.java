...
public class Menu_CreateScenario_Events_Cond_Treasury_Low extends SliderMenu {
      ...
      menuElements.add(
         new Slider_BG(
            ...
            public String getDrawText() {
               return this.getText() + this.getCurrent() * 100;
            }
         }
      );
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("Treasury") + " < ");
      this.getTitle().setText(CFG.langManager.get("Treasury"));
   }
      ...
      switch (iID) {
         ...
         case 5:
            CFG.eventsManager
               ...
               .lConditions
               .get(CFG.eventsManager.iCreateEvent_EditConditionID)
               .setValue(this.getMenuElement(iID).getCurrent() * 100);
      }
   }
