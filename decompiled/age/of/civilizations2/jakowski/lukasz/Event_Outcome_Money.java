...
public class Event_Outcome_Money extends Event_Outcome {
   public int iCivID = -1;
   public int iValue = 0;
   ...
   public void outcomeAction() {
      if (this.canMakeAction()) {
         CFG.game.getCiv(this.getCivID()).setMoney(CFG.game.getCiv(this.getCivID()).getMoney() + this.getValue());
   ...
   public List<MenuElement_Hover_v2_Element2> getHoverText() {
      try {
         ...
         if (this.canMakeAction()) {
            ...
            tData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Treasury") + ": ", CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
            tData.add(
