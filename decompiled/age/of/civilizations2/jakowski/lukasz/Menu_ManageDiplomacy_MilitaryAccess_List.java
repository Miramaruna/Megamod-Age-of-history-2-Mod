...
public class Menu_ManageDiplomacy_MilitaryAccess_List extends SliderMenu {
   public Menu_ManageDiplomacy_MilitaryAccess_List() {
      ...
      if (CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID > 0) {
         ...
         for (int i = 1; i < CFG.game.getCivsSize(); i++) {
            if (i != CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID && CFG.game.getMilitaryAccess(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID, i) > 0) {
               menuElements.add(
                  new Slider_MilitartAccess(
                     i,
                     ...
                     1,
                     200,
                     CFG.game.getMilitaryAccess(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID, i)
                  )
               );
               menuElements.add(
         ...
         new SliderMenuTitle(null, CFG.BUTTON_HEIGHT * 3 / 4, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_ManageDiplomacy_MilitaryAccess_List.this.getPosX() + iTranslateX,
                     Menu_ManageDiplomacy_MilitaryAccess_List.this.getPosY()
                        - ImageManager.getImage(Images.new_game_top_edge_title).getHeight()
                        - this.getHeight(),
                     Menu_ManageDiplomacy_MilitaryAccess_List.this.getWidth() + 2,
                     this.getHeight(),
                     true,
                     false
                  );
               ...
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Menu_ManageDiplomacy_MilitaryAccess_List.this.getPosX() + iTranslateX,
                     Menu_ManageDiplomacy_MilitaryAccess_List.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() - this.getHeight() * 3 / 4,
                     Menu_ManageDiplomacy_MilitaryAccess_List.this.getWidth(),
                     this.getHeight() * 3 / 4,
                     false,
                     true
                  );
               ...
               ImageManager.getImage(Images.pix255_255_255)
                  .draw(
                     oSB,
                     Menu_ManageDiplomacy_MilitaryAccess_List.this.getPosX() + iTranslateX,
                     Menu_ManageDiplomacy_MilitaryAccess_List.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(),
                     Menu_ManageDiplomacy_MilitaryAccess_List.this.getWidth()
                  );
   ...
   public void updateLanguage() {
      this.getTitle().setText(CFG.langManager.get("MilitaryAccess"));
   }
   ...
   public void actionElement(int iID) {
      if (iID % 2 == 0) {
         this.updateMilitary(iID / 2, this.getMenuElement(iID).getCurrent());
      } else if (iID % 2 == 1) {
   ...
   public final void updateMilitary(int pactID, int iNumOfTurns) {
      if (CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID > 0) {
         int foundPacts = 0;
         ...
         for (int i = 1; i < CFG.game.getCivsSize(); i++) {
            if (i != CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID && CFG.game.getMilitaryAccess(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID, i) > 0) {
               if (foundPacts == pactID) {
                  CFG.game.setMilitaryAccess(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID, i, iNumOfTurns);
                  return;
               }
