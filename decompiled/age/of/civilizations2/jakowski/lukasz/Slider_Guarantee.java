...
public class Slider_Guarantee extends Slider_BG {
   public int iCivA = 0;
   ...
   public void drawSliderText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      CFG.game
         ...
         .draw(
            oSB,
            this.getPosX() + this.getWidth() / 2 - (int)(this.getTextWidth() * 0.85F) / 2 - CFG.PADDING - CFG.CIV_FLAG_WIDTH / 2 + iTranslateX,
            this.getPosY() + this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2 - CFG.game.getCiv(this.iCivA).getFlag().getHeight() + iTranslateY,
            CFG.CIV_FLAG_WIDTH,
            CFG.CIV_FLAG_HEIGHT
         );
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.getDrawText(),
         this.getPosX() + this.getWidth() / 2 + CFG.CIV_FLAG_WIDTH / 2 - (int)(this.getTextWidth() * 0.85F) / 2 + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(this.getTextHeight() * 0.85F) / 2 + iTranslateY,
