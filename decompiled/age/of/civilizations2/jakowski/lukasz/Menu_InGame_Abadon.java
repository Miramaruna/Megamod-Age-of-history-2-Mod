...
public class Menu_InGame_Abadon extends SliderMenu {
   public int iOnCivID = -1;
   public static int iProvinceID = -1;

   public Menu_InGame_Abadon() {
   ...
   public Menu_InGame_Abadon(int onCivID, int nProvinceID) {
      ArrayList<MenuElement> menuElements = new ArrayList<>();
      ...
      int tY = 0;
      menuElements.add(
         new Button_Diplomacy_Abadon(
            CFG.langManager.get("Abandon") + ": ", "0.0", CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), nProvinceID, 2, tY, CFG.BUTTON_WIDTH * 2
         ) {
            @Override
            public int getWidth() {
               return Menu_InGame_Abadon.this.getElementW() * 2;
            }
         }
      );
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var9 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Abadon.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Confirm"), -1, 2, var9, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_Abadon.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_Abadon.this.iOnCivID));
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("AbandonProvince"), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
            ...
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ...
               CFG.drawText(
                  oSB,
                  this.getText(),
                  this.getPosX() + this.getWidth() / 2 - (int)(this.getTextWidth() * 0.8 / 2.0) + iTranslateX,
      ...
      int tempMenuPosY = ImageManager.getImage(Images.top_left2).getHeight() + CFG.PADDING * 2 + CFG.BUTTON_HEIGHT * 3 / 5;
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("AbandonProvince"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            @Override
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               oSB.setColor(new Color(CFG.COLOR_TEXT_MODIFIER_NEGATIVE.r, CFG.COLOR_TEXT_MODIFIER_NEGATIVE.g, CFG.COLOR_TEXT_MODIFIER_NEGATIVE.b, 0.165F));
               ...
               oSB.setColor(new Color(CFG.COLOR_TEXT_MODIFIER_NEGATIVE.r, CFG.COLOR_TEXT_MODIFIER_NEGATIVE.g, CFG.COLOR_TEXT_MODIFIER_NEGATIVE.b, 0.375F));
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         CFG.setDialogType(Dialog.ABADON);
