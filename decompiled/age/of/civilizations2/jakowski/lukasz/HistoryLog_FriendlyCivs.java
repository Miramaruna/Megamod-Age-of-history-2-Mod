...
public class HistoryLog_FriendlyCivs extends HistoryLog {
   public String sMess;
   ...
   public void updateLanguage() {
      this.sMess = " - " + CFG.langManager.get("FriendlyCivilizations") + " - ";
   ...
   public void draw(SpriteBatch oSB, int nTurnID, int iPosX, int iPosY, int iWidth, int iHeight, boolean isActive) {
      this.drawLeftIcon(oSB, Images.diplo_heart, iPosX, iPosY, iWidth, iHeight, isActive);
