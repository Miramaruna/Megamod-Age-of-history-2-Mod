...
public class Button_Menu_LR_MainMenu_Rate extends Button_Menu {
   public Button_Menu_LR_MainMenu_Rate(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
      super(sText, iTextPositionX, iPosX, iPosY, iWidth, iHeight, isClickable);
   }

   public Button_Menu_LR_MainMenu_Rate(
   ...
   public Color getColor(boolean isActive) {
      return isActive
         ...
         : (
            this.getClickable()
               ? (this.getIsHovered() ? CFG.COLOR_BUTTON_MENU_TEXT_HOVERED : CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE)
