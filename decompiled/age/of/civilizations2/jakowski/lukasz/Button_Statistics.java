...
public class Button_Statistics extends Button {
   public static final float FONT_SCALE = 0.7F;
   public boolean row = false;

   public Button_Statistics(String sText, int iTextPosX, int iPosX, int iPosY, int iWidth, int iHeight) {
      super.init(sText, iTextPosX, iPosX, iPosY, iWidth, iHeight, true, true, false, false, null);
   }

   public Button_Statistics(String sText, int iTextPosX, int iPosX, int iPosY, int iWidth, int iHeight, boolean checkbox) {
      super.init(sText, iTextPosX, iPosX, iPosY, iWidth, iHeight, true, true, true, checkbox, null);
   }

   public Button_Statistics(String sText, int iTextPosX, int iPosX, int iPosY, int iWidth, int iHeight, boolean checkbox, boolean checkboxState) {
