...
public class Menu_ServiceRibbon_Editor_Edit extends SliderMenu {
   public Menu_ServiceRibbon_Editor_Edit() {
      ...
      menuElements.add(
         new Button_Menu_Classic("", 0, 0, CFG.PADDING * 4 + CFG.BUTTON_HEIGHT * 2, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true) {
            @Override
            public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ...
               ImageManager.getImage(Images.pickeIcon)
                  .draw(
                     ...
                     this.getPosY()
                        + this.getHeight() / 2
                        - ImageManager.getImage(Images.pickeIcon).getHeight() / 2
                        + Menu_ServiceRibbon_Editor_Edit.this.getMenuPosY()
                        + iTranslateY
                  );
      ...
      menuElements.add(
         new Button_Menu_Classic("", 0, CFG.BUTTON_WIDTH, CFG.PADDING * 4 + CFG.BUTTON_HEIGHT * 2, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true)
      );

      for (int i = 1; i < CFG.editorServiceRibbon_GameData.getSize(); i++) {
         menuElements.add(
            new Button_Menu_Classic("", 0, 0, CFG.PADDING * (i + 4) + CFG.BUTTON_HEIGHT * (i + 2), CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true) {
               @Override
               public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                  super.drawButtonBG(oSB, iTranslateX, iTranslateY, isActive);
                  ImageManager.getImage(Images.pickeIcon)
         ...
         menuElements.add(
            new Button_Menu_Classic(
               "", 0, CFG.BUTTON_WIDTH, CFG.PADDING * (i + 4) + CFG.BUTTON_HEIGHT * (i + 2), CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT, true
            )
         );
         menuElements.add(
            new Button_Menu_Remove(
               CFG.GAME_WIDTH - CFG.BUTTON_WIDTH, CFG.PADDING * (i + 4) + CFG.BUTTON_HEIGHT * (i + 2), CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true
            ) {
               @Override
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      CFG.serviceRibbon_Manager
         .drawSR(
            oSB,
            CFG.GAME_WIDTH / 2 - CFG.SERVICE_RIBBON_WIDTH / 2 + iTranslateX,
      ...
      CFG.serviceRibbon_Manager
         .drawSROver(
            oSB, CFG.GAME_WIDTH / 2 - CFG.SERVICE_RIBBON_WIDTH / 2 + iTranslateX, CFG.BUTTON_HEIGHT / 2 + CFG.PADDING - CFG.SERVICE_RIBBON_HEIGHT / 2, 1
         );
      super.drawMenu(oSB, iTranslateX, iTranslateY, sliderMenuIsActive);
      CFG.serviceRibbon_Manager
         .drawSROverlay(
            oSB,
            CFG.GAME_WIDTH / 2 - CFG.SERVICE_RIBBON_WIDTH + iTranslateX,
            this.getMenuElement(4).getPosY() + this.getMenuElement(4).getHeight() / 2 - CFG.SERVICE_RIBBON_HEIGHT,
            CFG.editorServiceRibbon_GameData.getServiceRibbon_Overlay(0),
            CFG.editorServiceRibbon_Colors.get(0),
            2
         );
      ...
      for (int i = 1; i < CFG.editorServiceRibbon_GameData.getSize(); i++) {
         CFG.serviceRibbon_Manager
            .drawSROverlay(
               oSB,
               CFG.GAME_WIDTH / 2 - CFG.SERVICE_RIBBON_WIDTH + iTranslateX,
               this.getMenuElement(4).getPosY() + this.getMenuElement(4).getHeight() / 2 + CFG.BUTTON_HEIGHT * i + CFG.PADDING * i - CFG.SERVICE_RIBBON_HEIGHT,
               CFG.editorServiceRibbon_GameData.getServiceRibbon_Overlay(0),
               CFG.editorServiceRibbon_Colors.get(0),
               2
            );
         CFG.serviceRibbon_Manager
            .drawSROverlay(
               ...
               CFG.GAME_WIDTH / 2 - CFG.SERVICE_RIBBON_WIDTH + iTranslateX,
               this.getMenuElement(4).getPosY() + this.getMenuElement(4).getHeight() / 2 + CFG.BUTTON_HEIGHT * i + CFG.PADDING * i - CFG.SERVICE_RIBBON_HEIGHT,
               CFG.editorServiceRibbon_GameData.getServiceRibbon_Overlay(i),
               CFG.editorServiceRibbon_Colors.get(i),
               2
            );
      }
