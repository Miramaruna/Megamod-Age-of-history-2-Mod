...
public class Button_Diplomacy_ChangeGovernment extends Button_Statistics {
   ...
   public Button_Diplomacy_ChangeGovernment(int i, int iCivA, int nIdeologyID, int iPosX, int iPosY, int iWidth) {
      super(
         CFG.ideologiesManager.getIdeology(nIdeologyID).getName(),
         0,
         iPosX,
         iPosY,
         iWidth,
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.ideologiesManager
         ...
         .draw(
            oSB,
            this.getPosX()
               + (Ideologies_Manager.MAX_CROWN_WIDTH + CFG.PADDING * 2) / 2
               - (int)(CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getWidth() * this.getImageScale_Ideology()) / 2
               + CFG.PADDING * 3
               + (int)(ImageManager.getImage(Images.flag_rect).getWidth() * this.getImageScale(Images.flag_rect))
               + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               - (int)(CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getHeight() * this.getImageScale_Ideology()) / 2
               - CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getHeight()
               + iTranslateY,
            (int)(CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getWidth() * this.getImageScale_Ideology()),
            (int)(CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getHeight() * this.getImageScale_Ideology())
         );
      oSB.setColor(Color.WHITE);
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosX()
            + CFG.PADDING * 4
            + (int)(ImageManager.getImage(Images.flag_rect).getWidth() * this.getImageScale(Images.flag_rect))
            + Ideologies_Manager.MAX_CROWN_WIDTH
            + CFG.PADDING * 2
            + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(CFG.TEXT_HEIGHT * 0.7F / 2.0F) + iTranslateY,
         this.getClickable()
            ? new Color(
               CFG.ideologiesManager.getIdeology(this.iIdeologyID).getColor().r,
               CFG.ideologiesManager.getIdeology(this.iIdeologyID).getColor().g,
               CFG.ideologiesManager.getIdeology(this.iIdeologyID).getColor().b,
               1.0F
            )
         ...
         ? new Button.Checkbox() {
            ...
            public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Button_Diplomacy_ChangeGovernment.this.getPosX() + iTranslateX,
                     Button_Diplomacy_ChangeGovernment.this.getPosY() - ImageManager.getImage(Images.line_32_off1).getHeight() + 1 + iTranslateY,
                     Button_Diplomacy_ChangeGovernment.this.getWidth(),
                     Button_Diplomacy_ChangeGovernment.this.getHeight() - 2,
                     true,
                     false
                  );
               oSB.setColor(new Color(0.0F, 0.0F, 0.0F, 0.3F));
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Button_Diplomacy_ChangeGovernment.this.getPosX() + iTranslateX,
                     Button_Diplomacy_ChangeGovernment.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() + 1 + iTranslateY,
                     Button_Diplomacy_ChangeGovernment.this.getWidth(),
                     Button_Diplomacy_ChangeGovernment.this.getHeight() / 4,
                     false,
                     false
                  );
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Button_Diplomacy_ChangeGovernment.this.getPosX() + iTranslateX,
                     Button_Diplomacy_ChangeGovernment.this.getPosY()
                        - ImageManager.getImage(Images.gradient).getHeight()
                        + Button_Diplomacy_ChangeGovernment.this.getHeight()
                        - 1
                        + iTranslateY
                        - Button_Diplomacy_ChangeGovernment.this.getHeight() / 4,
                     Button_Diplomacy_ChangeGovernment.this.getWidth(),
   ...
   public final float getImageScale_Ideology() {
      return (float)CFG.TEXT_HEIGHT / CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getHeight() < 1.0F
         ? (float)CFG.TEXT_HEIGHT / CFG.ideologiesManager.getIdeology(this.iIdeologyID).getCrownImageScaled().getHeight()
         : 1.0F;
   }
