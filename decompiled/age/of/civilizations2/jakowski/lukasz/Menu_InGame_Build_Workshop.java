...
public class Menu_InGame_Build_Workshop extends SliderMenu {
   ...
   public Menu_InGame_Build_Workshop() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Workshop"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Build_Workshop(int nProvinceID) {
      ...
      menuElements.add(
         new Button_Build_Building(
            CFG.langManager.get("BuildWorkshopIn") + ": ",
            ...
            Images.b_workshop,
            BuildingsManager.getWorkshop_BuildCost(CFG.game.getProvince(this.iProvinceID).getLevelOfWorkshop() + 1, this.iProvinceID),
            BuildingsManager.getWorkshop_BuildMovementCost(CFG.game.getProvince(this.iProvinceID).getLevelOfWorkshop() + 1),
            0,
            tY,
            CFG.BUTTON_WIDTH * 2
         ) {
            @Override
            public int getWidth() {
               return Menu_InGame_Build_Workshop.this.getElementW() * 2;
            }
                     ...
                     "+"
                        + (int)(
                           BuildingsManager.getWorkshop_IncomeProduction(
                                 CFG.game.getProvince(Menu_InGame_Build_Workshop.this.iProvinceID).getLevelOfWorkshop() + 1
                              )
                              * 100.0F
                        )
                        + "%",
      ...
      menuElements.get(menuElements.size() - 1)
         .setMin((int)(BuildingsManager.getWorkshop_TechLevel(CFG.game.getProvince(this.iProvinceID).getLevelOfWorkshop() + 1) * 100.0F));
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      int var7;
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Build_Workshop.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Construct"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_Build_Workshop.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getProvince(Menu_InGame_Build_Workshop.this.iProvinceID).getName().length() > 0
                        ? CFG.game.getProvince(Menu_InGame_Build_Workshop.this.iProvinceID).getName()
                        : CFG.langManager.get("Province")
                  )
               );
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(Menu_InGame_Build_Workshop.this.iProvinceID).getCivID(), CFG.PADDING, 0)
               );
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + BuildingsManager.getWorkshop_BuildCost(
                           CFG.game.getProvince(Menu_InGame_Build_Workshop.this.iProvinceID).getLevelOfWorkshop() + 1,
                           Menu_InGame_Build_Workshop.this.iProvinceID
                        ),
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager
                        .get(
                           ...
                           BuildingsManager.getWorkshop_Construction(CFG.game.getProvince(Menu_InGame_Build_Workshop.this.iProvinceID).getLevelOfWorkshop() + 1)
                        )
                  )
               );
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + (int)(
                              BuildingsManager.getWorkshop_TechLevel(CFG.game.getProvince(Menu_InGame_Build_Workshop.this.iProvinceID).getLevelOfWorkshop() + 1)
                                 * 100.0F
                           )
                           / 100.0F,
            ...
            public boolean getClickable() {
               return CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                  ...
                  && CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney()
                     >= BuildingsManager.getWorkshop_BuildCost(
                        CFG.game.getProvince(Menu_InGame_Build_Workshop.this.iProvinceID).getLevelOfWorkshop() + 1, Menu_InGame_Build_Workshop.this.iProvinceID
                     )
                  && CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getTechnologyLevel()
                     >= BuildingsManager.getWorkshop_TechLevel(CFG.game.getProvince(Menu_InGame_Build_Workshop.this.iProvinceID).getLevelOfWorkshop() + 1);
            }
      ...
      this.initMenu(
         new SliderMenuTitle(
            CFG.langManager.get(BuildingsManager.getWorkshop_Name(CFG.game.getProvince(this.iProvinceID).getLevelOfWorkshop() + 1)),
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               oSB.setColor(new Color(0.42745098F, 0.35686275F, 0.30588236F, 0.165F));
               ...
               oSB.setColor(new Color(0.42745098F, 0.35686275F, 0.30588236F, 0.375F));
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_Build_Workshop.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Workshop.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_Build_Workshop.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Workshop.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         if (BuildingsManager.constructWorkshop(this.iProvinceID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())) {
