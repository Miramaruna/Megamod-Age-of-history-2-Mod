...
public class Menu_ManageDiplomacy_MilitaryAccess extends SliderMenu {
   ...
   public final void actionElement(int iID) {
      switch (iID) {
         case 2:
            CFG.game.setMilitaryAccess(CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1, CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV2, 5);
