...
public class Menu_CreateNewGame extends SliderMenu {
   public Menu_CreateNewGame() {
      ...
      menuElements.add(
         new Button_Game_PLAY(null, -1, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2 - CFG.PADDING, CFG.PADDING, CFG.BUTTON_WIDTH * 2, true) {
            @Override
      ...
      menuElements.add(
         new Button_Game(null, -1, CFG.PADDING, CFG.PADDING, CFG.BUTTON_WIDTH + CFG.BUTTON_WIDTH / 2, true) {
            @Override
            public Color getColor(boolean isActive) {
               return isActive
                  ? CFG.COLOR_BUTTON_GAME_TEXT_IMPORTANT_ACTIVE
      ...
      menuElements.add(
         new Button_Game(null, -1, CFG.BUTTON_WIDTH + CFG.BUTTON_WIDTH / 2 + CFG.PADDING * 2, CFG.PADDING, true) {
            @Override
            public Color getColor(boolean isActive) {
               return isActive
                  ? CFG.COLOR_BUTTON_GAME_TEXT_IMPORTANT_ACTIVE
   ...
   public static final void newGameFreeMod() {
      CFG.menuManager.getColorPicker().setVisible(false, null);
      Gdx.app.log("AoC", "CREATE NG -> newGame: 000");
      RTS.reset();
      CFG.game.disableDrawCivlizationsRegions_Players();
