...
public class Button_PlayAsVassal extends Button {
         ...
         ? new Button.Checkbox() {
            ...
            public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Button_PlayAsVassal.this.getPosX() + Button_PlayAsVassal.this.getWidth() - Button_PlayAsVassal.this.getWidth() / 2 + iTranslateX,
                     Button_PlayAsVassal.this.getPosY() - ImageManager.getImage(Images.slider_gradient).getHeight() + 1 + iTranslateY,
                     Button_PlayAsVassal.this.getWidth() / 2,
                     Button_PlayAsVassal.this.getHeight() - 2,
                     true,
                     false
                  );
               ...
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Button_PlayAsVassal.this.getPosX() + iTranslateX,
                     Button_PlayAsVassal.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() + 1 + iTranslateY,
                     Button_PlayAsVassal.this.getWidth(),
                     Button_PlayAsVassal.this.getHeight() / 4,
                     false,
                     false
                  );
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Button_PlayAsVassal.this.getPosX() + iTranslateX,
                     Button_PlayAsVassal.this.getPosY()
                        - ImageManager.getImage(Images.gradient).getHeight()
                        + Button_PlayAsVassal.this.getHeight()
                        - 1
                        + iTranslateY
                        - Button_PlayAsVassal.this.getHeight() / 4,
                     Button_PlayAsVassal.this.getWidth(),
               ...
               CFG.drawRect_InfoBox_Left(
                  oSB,
                  Button_PlayAsVassal.this.getPosX() + iTranslateX,
                  Button_PlayAsVassal.this.getPosY() + iTranslateY,
                  Button_PlayAsVassal.this.getWidth(),
                  Button_PlayAsVassal.this.getHeight()
               );
               if (Button_PlayAsVassal.this.getCheckboxState()) {
                  ImageManager.getImage(Images.icon_check_true)
                     .draw(
                        oSB,
                        Button_PlayAsVassal.this.getPosX()
                           + Button_PlayAsVassal.this.getWidth()
                           - CFG.PADDING
                           - ImageManager.getImage(Images.icon_check_true).getWidth()
                           + iTranslateX,
                        Button_PlayAsVassal.this.getPosY()
                           + Button_PlayAsVassal.this.getHeight() / 2
                           - ImageManager.getImage(Images.icon_check_true).getHeight() / 2
                           + iTranslateY
                     );
               } else {
                  ImageManager.getImage(Images.icon_check_false)
                     .draw(
                        ...
                        Button_PlayAsVassal.this.getPosY()
                           + Button_PlayAsVassal.this.getHeight() / 2
                           - ImageManager.getImage(Images.icon_check_false).getHeight() / 2
                           + iTranslateY
                     );
               }
            }
