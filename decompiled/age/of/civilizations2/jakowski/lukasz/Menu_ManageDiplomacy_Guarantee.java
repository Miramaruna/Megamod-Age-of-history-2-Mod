...
public class Menu_ManageDiplomacy_Guarantee extends SliderMenu {
   ...
   public final void actionElement(int iID) {
      switch (iID) {
         case 2:
            CFG.game.setGuarantee(CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1, CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV2, 5);
