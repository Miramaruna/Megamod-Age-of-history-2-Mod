...
public class Button_Diplo_Opinions extends Button_Diplo_Actions {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ImageManager.getImage(Images.diplo_relations)
         .draw(
            ...
            this.getPosX()
               + this.getWidth() / 2
               - (ImageManager.getImage(Images.diplo_relations).getWidth() + CFG.PADDING + (int)(this.getTextWidth() * 0.6F)) / 2
               + iTranslateX,
            this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.diplo_relations).getHeight() / 2 + iTranslateY
         );
      ...
      CFG.drawText(
         ...
         this.getPosX()
            ...
            - (ImageManager.getImage(Images.diplo_relations).getWidth() + CFG.PADDING + (int)(this.getTextWidth() * 0.6F)) / 2
            + CFG.PADDING
            + ImageManager.getImage(Images.diplo_relations).getWidth()
            + iTranslateX,
