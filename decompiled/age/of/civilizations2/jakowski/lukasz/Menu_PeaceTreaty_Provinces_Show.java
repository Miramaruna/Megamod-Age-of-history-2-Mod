...
class Menu_PeaceTreaty_Provinces_Show extends SliderMenu {
   protected Menu_PeaceTreaty_Provinces_Show() {
   ...
   public void actionElement(int iID) {
      switch (iID) {
         case 0:
            CFG.menuManager.setVisible_InGamePeaceTreatyProvinces(true);
      }
   }
