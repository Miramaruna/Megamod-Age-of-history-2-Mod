...
public class Message_Independence_Ask_Accepted extends Message {
   public Message_Independence_Ask_Accepted(int fromCivID) {
      super(fromCivID, 0);
      this.messageType = Message_Type.GUARANTEE_ASK_ACCEPTED;
   ...
   public MenuElement_Hover_v2 getHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("OurProposalWasAccepted"), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
