...
public class Menu_Civilizations_Info_Diplomacy extends SliderMenu {
         ...
         new SliderMenuTitle(null, CFG.TEXT_HEIGHT + CFG.PADDING * 2, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Menu_Civilizations_Info_Diplomacy.this.getPosX() - CFG.PADDING + 2 + iTranslateX,
                     Menu_Civilizations_Info_Diplomacy.this.getPosY()
                        + 2
                        - ImageManager.getImage(Images.gradient).getHeight()
                        - (this.getHeight() + CFG.PADDING * 2),
                     Menu_Civilizations_Info_Diplomacy.this.getWidth() + CFG.PADDING * 2 - 2,
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_Civilizations_Info_Diplomacy.this.getPosX() - CFG.PADDING + 2 + iTranslateX,
                     Menu_Civilizations_Info_Diplomacy.this.getPosY() - ImageManager.getImage(Images.line_32_off1).getHeight() - 2 - CFG.PADDING * 2,
                     Menu_Civilizations_Info_Diplomacy.this.getWidth() + CFG.PADDING * 2 - 2,
                     ImageManager.getImage(Images.line_32_off1).getHeight(),
                     false,
                     true
