...
class Message_PeaceTreaty_Accepted extends Message {
   protected Message_PeaceTreaty_Accepted(int fromCivID) {
      super(fromCivID, 0);
      this.messageType = Message_Type.PEACE_TREATY_ACCEPTED;
   ...
   public void onAccept(int iCivID) {
      if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID() == iCivID) {
         ...
         lMess.add(CFG.langManager.get("OurProposalWasAccepted"));
