...
public class Text_Outliner_DiploInfo_AllianceLeaves extends Text {
   ...
   public Text_Outliner_DiploInfo_AllianceLeaves(int iCivLeft, String sAllianceName, int iTurnID, int iPosX, int iPosY, int nWidth) {
   ...
   public void buildElementHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(" " + CFG.langManager.get("CivAIsNoLongerAMemberOf") + " ", CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(this.sAllianceName));
