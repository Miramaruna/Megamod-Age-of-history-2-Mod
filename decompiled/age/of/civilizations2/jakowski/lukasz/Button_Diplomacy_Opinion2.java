...
public class Button_Diplomacy_Opinion2 extends Button_Diplomacy_Opinion {
   public String sText2;
   public int iText2Width = 0;
   public Color textColor2;

   public Button_Diplomacy_Opinion2(
      ...
      try {
         ...
         nData.add(
            new MenuElement_Hover_v2_Element_Type_Text(
               "" + (int)(CFG.game.getCivRelation_OfCivB(CFG.getActiveCivInfo(), this.iCivID) * 10.0F) / 10.0F,
         ...
         nData.add(
            new MenuElement_Hover_v2_Element_Type_Text(
               "" + (int)(CFG.game.getCivRelation_OfCivB(this.iCivID, CFG.getActiveCivInfo()) * 10.0F) / 10.0F,
