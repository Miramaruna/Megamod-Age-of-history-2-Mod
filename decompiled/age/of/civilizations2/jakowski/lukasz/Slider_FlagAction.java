...
public class Slider_FlagAction extends Slider {
   ...
   public Slider_FlagAction(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
      this.initSlider(sText, iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
      this.setCurrent(this.getCurrent());
   }

   public Slider_FlagAction(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent, boolean clickable) {
      this.initSlider(sText, iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
      this.setCurrent(this.getCurrent());
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      if (this.getClickable()) {
         ...
         oSB.setColor(new Color(CFG.COLOR_TEXT_MODIFIER_NEGATIVE2.r, CFG.COLOR_TEXT_MODIFIER_NEGATIVE2.g, CFG.COLOR_TEXT_MODIFIER_NEGATIVE2.b, 0.775F));
      }
      ...
      ImageManager.getImage(Images.line_32_off1)
         .draw(
            oSB,
            this.getPosX() + iTranslateX,
            this.getPosY() + this.getHeight() - CFG.PADDING - this.getSliderHeight() + 1 - ImageManager.getImage(Images.line_32_off1).getHeight() + iTranslateY,
            this.getWidth(),
            1
         );
      ImageManager.getImage(Images.line_32_off1)
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosY() + this.getHeight() - CFG.PADDING * 2 - this.getSliderHeight() - (int)(CFG.TEXT_HEIGHT * 0.8F) + iTranslateY,
         this.getColor(isActive)
      );
      CFG.drawTextWithShadow(
         oSB,
         this.getDrawText(),
         this.getPosX() + this.getWidth() - CFG.PADDING * 2 - (int)(this.getTextWidth() * 0.8F) + iTranslateX,
         this.getPosY() + this.getHeight() - CFG.PADDING * 2 - this.getSliderHeight() - (int)(CFG.TEXT_HEIGHT * 0.8F) + iTranslateY,
      ...
      if (this.drawSpendings) {
         ...
         ImageManager.getImage(Images.line_32_vertical)
            .draw(
               oSB,
               this.getPosX() + this.getWidth() - CFG.PADDING * 3 - (int)(this.getTextWidth() * 0.8F) + iTranslateX,
               this.getPosY()
                  + this.getHeight()
                  - CFG.PADDING * 2
                  - this.getSliderHeight()
         ...
         CFG.drawTextWithShadow(
            oSB,
            this.sSpendings,
            this.getPosX() + this.getWidth() - CFG.PADDING * 4 - this.iSpendingsWidth - (int)(this.getTextWidth() * 0.8F) + iTranslateX,
            this.getPosY() + this.getHeight() - CFG.PADDING * 2 - this.getSliderHeight() - (int)(CFG.TEXT_HEIGHT * 0.7F) + iTranslateY,
         ...
         ImageManager.getImage(Images.top_gold)
            .draw(
               ...
               this.getPosX()
                  ...
                  - (int)(ImageManager.getImage(Images.top_gold).getWidth() * this.getImageScale(0.7F, Images.top_gold))
                  + iTranslateX,
               this.getPosY()
                  + this.getHeight()
                  - CFG.PADDING * 2
                  - this.getSliderHeight()
                  - (int)(ImageManager.getImage(Images.top_gold).getHeight() * this.getImageScale(0.7F, Images.top_gold))
   ...
   public final float getImageScale(float fScale, int nImageID) {
      return this.getTextHeight() * fScale / ImageManager.getImage(nImageID).getHeight();
   }
}
