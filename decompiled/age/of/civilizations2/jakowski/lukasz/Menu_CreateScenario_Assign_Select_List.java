         ...
         if (CFG.chosen_AlphabetCharachter == null) {
            ...
            menuElements.add(
               new Button_Menu_Classic(
                  ...
                  CFG.CIV_FLAG_WIDTH + CFG.PADDING * 4,
                  CFG.BUTTON_HEIGHT * i + CFG.PADDING * (i + 1),
                  CFG.GAME_WIDTH - CFG.CIV_FLAG_WIDTH - CFG.PADDING * 4,
                  CFG.BUTTON_HEIGHT,
                  true
               )
            );
         } else if (CFG.game.getCiv(i).getCivName().charAt(0) == CFG.chosen_AlphabetCharachter.charAt(0)) {
            this.lCivs.add(i);
            menuElements.add(
               new Button_Flag(
                  i,
                  0,
                  CFG.BUTTON_HEIGHT * j + CFG.PADDING * (j + 1),
                  CFG.CIV_FLAG_WIDTH + CFG.PADDING * 4,
                  CFG.BUTTON_HEIGHT,
                  Button_Flag.ButtonFlagType.FLAG_COLOR
               )
