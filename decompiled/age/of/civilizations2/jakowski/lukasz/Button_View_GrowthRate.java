...
public class Button_View_GrowthRate extends Button {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
         ...
         ImageManager.getImage(Images.b_farm)
            .draw(
               ...
               this.getPosX()
                  + this.getWidth()
                  - CFG.PADDING * 3
                  - (int)(ImageManager.getImage(Images.population).getWidth() * this.getImageScale2(ImageManager.getImage(Images.population).getHeight()))
      ...
      ImageManager.getImage(Images.population)
         .draw(
            ...
            this.getPosY()
               + this.getHeight() / 2
               - (int)(ImageManager.getImage(Images.population).getHeight() * this.getImageScale2(ImageManager.getImage(Images.population).getHeight())) / 2
               + iTranslateY
               - ImageManager.getImage(Images.population).getHeight(),
            (int)(ImageManager.getImage(Images.population).getWidth() * this.getImageScale2(ImageManager.getImage(Images.population).getHeight())),
            (int)(ImageManager.getImage(Images.population).getHeight() * this.getImageScale2(ImageManager.getImage(Images.population).getHeight()))
         );
      CFG.fontMain.getData().setScale(0.6F);
      CFG.drawText(
         oSB,
