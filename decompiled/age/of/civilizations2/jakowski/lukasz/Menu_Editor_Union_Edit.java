   ...
   public Menu_Editor_Union_Edit() {
      ...
      menuElements.add(
         new Button_Menu_LR_Line(
            CFG.langManager.get("SelectCivilization") + ": " + CFG.langManager.getCiv(CFG.unionsManager.createUnion_Data.lCreateCivTag),
      ...
      menuElements.add(
         new Button_Menu_LR_Line(CFG.langManager.get("AddCivilization"), -1, 0, CFG.PADDING * 2 + CFG.BUTTON_HEIGHT, CFG.GAME_WIDTH, CFG.BUTTON_HEIGHT, true)
      );

      for (int i = 0; i < CFG.unionsManager.createUnion_Data.lCivsTags.size(); i++) {
         menuElements.add(
            new Button_Menu(
               CFG.langManager.get("Civilization") + ": " + CFG.langManager.getCiv(CFG.unionsManager.createUnion_Data.lCivsTags.get(i)),
               (int)(50.0F * CFG.GUI_SCALE),
               0,
               CFG.PADDING * (i + 3) + CFG.BUTTON_HEIGHT * (i + 2),
