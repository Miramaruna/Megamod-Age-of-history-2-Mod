...
public class Button_New_Game_Players_Players_LEFT extends Button_New_Game_Players {
   public int iPlayerID = 0;

   public Button_New_Game_Players_Players_LEFT(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable, int iPlayerID) {
