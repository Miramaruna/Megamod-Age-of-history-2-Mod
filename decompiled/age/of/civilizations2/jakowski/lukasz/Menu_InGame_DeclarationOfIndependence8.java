...
class Menu_InGame_DeclarationOfIndependence8 extends SliderMenu {
   private int iOnCivID = -1;
   private int toProvinceID;

   protected Menu_InGame_DeclarationOfIndependence8(int var1) {
      ArrayList var2 = new ArrayList();
      this.iOnCivID = CFG.game.getCiv(var1).getPuppetOfCivID();
      this.toProvinceID = CFG.game.getActiveProvinceID();
      ...
      var2.add(
         new Button_NS_Opinion(
            ...
            final Menu_InGame_DeclarationOfIndependence8 this$0;
               ...
               ImageManager.getImage(Images.diplo_trade)
                  .draw(
                     ...
                     this.getPosX()
                        ...
                        + var2x,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.diplo_trade).getHeight() / 2 + var3x
                  );
      ...
      String var6;
      if (!CFG.game.getCiv(var1).getClosingTheCommerce()) {
         var5 = CFG.langManager;
         var6 = "Setupatradebarrier";
      } else {
         var5 = CFG.langManager;
         var6 = "removetradebarrier";
      }
   ...
   protected final void actionElement(int var1) {
      if (var1 == this.getMenuElementsSize() - 1) {
         var1 = CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID();
         Civilization var2 = CFG.game.getCiv(var1);
         if (var2.getClosingTheCommerce()) {
            var2.setClosingTheCommerce(false);
         } else {
            var2.setClosingTheCommerce(true);
         }
   ...
   protected void draw(SpriteBatch var1, int var2, int var3, boolean var4) {
      if (Menu_InGame_OfferAlliance.lTime + 200L >= System.currentTimeMillis()) {
         ...
         var9 = this.getHeight();
         var14.draw2(var1, var12 + 2 + var6 - var8 + var2, var11 - var10 + var3, var7, CFG.PADDING + var9, true, true);
         ...
         var15.draw2(var1, var30 + 2 + var18 - var27 + var2, var21 - var35 + var3, var33, CFG.PADDING + var24, true, true);
         var1.setColor(new Color(0.0F, 0.0F, 0.0F, 0.45F));
         ImageManager.getImage(Images.gradient)
            .draw(
               var1,
