...
public class Menu_CreateScenario_Events_Out_Happiness extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(3).setText(CFG.langManager.get("Happiness") + ": ");
      this.getTitle().setText(CFG.langManager.get("UpdateHappiness"));
   }
