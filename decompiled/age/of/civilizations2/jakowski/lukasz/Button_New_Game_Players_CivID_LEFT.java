...
public class Button_New_Game_Players_CivID_LEFT extends Button_New_Game_Players {
   public int iCivID = 0;

   public Button_New_Game_Players_CivID_LEFT(int iCivID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
