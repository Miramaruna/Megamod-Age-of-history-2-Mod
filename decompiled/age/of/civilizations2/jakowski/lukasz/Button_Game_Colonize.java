...
public class Button_Game_Colonize extends Button_Game {
   public long lTime = 0L;
   public float fAlphaMod = 0.0F;
   public boolean backAnimation = false;
   public long lTimeAnimation = System.currentTimeMillis();
   ...
   public int iLeftWidth = 0;
   public int iRightWidth = 0;
   public int iRightIconWidth = 0;
   public String sGold;
   ...
   public Button_Game_Colonize(String sText, int nProvinceID, int iPosX, int iPosY, boolean isClickable) {
      ...
      try {
         ...
         this.colorGold = CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney() >= tempCostGold
         ...
         this.sMovement = "" + tempCostMovement / 10.0F;
         CFG.glyphLayout.setText(CFG.fontMain, this.sMovement);
         this.iMovementWidth = (int)(CFG.glyphLayout.width * TEXT_COST_SCALE);
         this.sDiplomacy = "" + CFG.gameAges.getAge(Game_Calendar.CURRENT_AGEID).COLONIZE_COST_DIPLOMACY_POINTS / 10.0F;
         ...
         this.iRightIconWidth = (int)Math.max(
            Math.max(
               ...
               ImageManager.getImage(Images.top_diplomacy_points).getWidth() * this.getImageScale(Images.top_diplomacy_points, TEXT_COST_SCALE)
            ),
         ...
         this.setClickable(
            CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney() >= tempCostGold
   ...
   public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.flag_rect)
         .draw(oSB, this.getPosX() + CFG.PADDING * 2 + iTranslateX, this.getPosY() + this.getHeight() / 2 - CFG.PADDING / 2 - CFG.CIV_FLAG_HEIGHT + iTranslateY);
      ...
      if (isActive) {
         CFG.drawText(
            ...
            this.getPosY() + this.getHeight() / 2 - CFG.PADDING / 2 - CFG.CIV_FLAG_HEIGHT / 2 - (int)(this.getTextHeight() * 0.9F / 2.0F) + iTranslateY,
      ...
      CFG.drawTextWithShadow(
         ...
         this.sTerrain,
         this.getPosX() + CFG.PADDING * 3 + CFG.CIV_FLAG_WIDTH + iTranslateX,
         this.getPosY() + this.getHeight() / 2 + CFG.PADDING / 2 + CFG.CIV_FLAG_HEIGHT / 2 - (int)(this.getTextHeight() * 0.8F / 2.0F) + iTranslateY,
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosY() + this.getHeight() / 2 - (int)(this.getTextHeight() * TEXT_COST_SCALE / 2.0F) + iTranslateY,
         this.colorMovement
      );
      CFG.drawTextWithShadow(
         oSB,
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosY() + this.getHeight() / 2 + (int)(this.getTextHeight() * TEXT_COST_SCALE / 2.0F) + CFG.PADDING + iTranslateY,
         this.colorDiplomacy
      );
      ...
      ImageManager.getImage(Images.top_diplomacy_points)
         .draw(
            ...
            this.getPosX()
               + this.getWidth()
               - CFG.PADDING * 2
               - (int)(ImageManager.getImage(Images.top_diplomacy_points).getWidth() * this.getImageScale(Images.top_diplomacy_points, TEXT_COST_SCALE))
               + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               + CFG.PADDING
               + (int)(this.getTextHeight() * TEXT_COST_SCALE) / 2
               + (int)(this.getTextHeight() * TEXT_COST_SCALE)
               - (int)(ImageManager.getImage(Images.top_diplomacy_points).getHeight() * this.getImageScale(Images.top_diplomacy_points, TEXT_COST_SCALE))
