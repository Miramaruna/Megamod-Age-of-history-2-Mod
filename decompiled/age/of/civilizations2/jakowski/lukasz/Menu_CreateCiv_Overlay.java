...
public class Menu_CreateCiv_Overlay extends SliderMenu {
   public Menu_CreateCiv_Overlay() {
      ...
      menuElements.add(
         new Slider(
            "X: ",
            CFG.PADDING + CFG.BUTTON_HEIGHT + CFG.BUTTON_HEIGHT / 2,
            tPosY = var5 + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING,
            tempW - CFG.PADDING * 2 - CFG.BUTTON_HEIGHT * 3,
            (int)(CFG.BUTTON_HEIGHT * 0.7F),
      ...
      menuElements.add(
         new Button_NewGameStyle_Left("-", -1, CFG.PADDING, tPosY, CFG.BUTTON_HEIGHT + CFG.BUTTON_HEIGHT / 2, (int)(CFG.BUTTON_HEIGHT * 0.7F), true)
      );
      menuElements.add(
         new Button_NewGameStyle_Right(
            "+",
            -1,
            tempW - CFG.PADDING - CFG.BUTTON_HEIGHT - CFG.BUTTON_HEIGHT / 2,
            tPosY,
      ...
      menuElements.add(
         new Button_NewGameStyle_Left("-", -1, CFG.PADDING, var7, CFG.BUTTON_HEIGHT + CFG.BUTTON_HEIGHT / 2, (int)(CFG.BUTTON_HEIGHT * 0.7F), true)
      );
      menuElements.add(
         new Button_NewGameStyle_Right(
            "+",
      ...
      menuElements.add(
         new Button_NewGameStyle_Left("-", -1, CFG.PADDING, var9, CFG.BUTTON_HEIGHT + CFG.BUTTON_HEIGHT / 2, (int)(CFG.BUTTON_HEIGHT * 0.7F), true)
      );
      menuElements.add(
         new Button_NewGameStyle_Right(
            "+",
            ...
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     this.getPosY() + Menu_CreateCiv_Overlay.this.getMenuPosY() + this.getHeight() / 2 + this.getTextHeight() / 2 + CFG.CIV_COLOR_WIDTH,
                     CFG.PADDING,
                     CFG.CIV_COLOR_WIDTH,
                     true,
                     false
      ...
      menuElements.add(
         new Button_NewGameStyle_Right(
            CFG.langManager.get("CenterX", "Y"),
            -1,
            tempW - CFG.PADDING * 2 - (tempW - CFG.PADDING * 2) / 2,
            tPosY,
            (tempW - CFG.PADDING * 2) / 2,
            (int)(CFG.BUTTON_HEIGHT * 0.6F),
            true
      ...
      this.initMenu(
         ...
         tempW,
         Math.min(
            (var13 = tPosY + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING) + CFG.PADDING,
   ...
   public void updateLanguage() {
      ...
      try {
         ...
         this.getMenuElement(4).setCurrent(CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iPosX);
         this.getMenuElement(7).setText("Y: ");
         this.getMenuElement(7).setCurrent(CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iPosY);
         this.getMenuElement(10).setText(CFG.langManager.get("Width") + ": ");
         this.getMenuElement(10).setCurrent(CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iWidth);
         this.getMenuElement(13).setText(CFG.langManager.get("Height") + ": ");
         this.getMenuElement(13).setCurrent(CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iHeight);
   ...
   public final void updateScale() {
      this.getMenuElement(16)
         .setCurrent(
            (int)(
               (float)CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iHeight
                  / CFG.flagManager.getOverlay(CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iOverlayID).getHeight()
                  * 100.0F
            )
         );
   }
   ...
   public final void actionElement(int iID) {
      switch (iID) {
         ...
         case 3:
            ...
            return;
         case 4:
            CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iPosX = this.getMenuElement(iID).getCurrent();
            return;
         case 5:
         ...
         case 6:
            ...
            return;
         case 7:
            CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iPosY = this.getMenuElement(iID).getCurrent();
            return;
         case 8:
         ...
         case 9:
            ...
            return;
         case 10:
            CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iWidth = this.getMenuElement(iID).getCurrent();
            this.updateScale();
            return;
         case 11:
         ...
         case 12:
            ...
            return;
         case 13:
            CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iHeight = this.getMenuElement(iID).getCurrent();
            return;
         case 14:
         ...
         case 15:
            ...
            return;
         case 16:
            CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iWidth = (int)Math.ceil(
               CFG.flagManager.getOverlay(CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iOverlayID).getWidth()
                     * this.getMenuElement(iID).getCurrent()
                  / 100.0F
            );
            CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iHeight = (int)Math.ceil(
               CFG.flagManager.getOverlay(CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iOverlayID).getHeight()
                     * this.getMenuElement(iID).getCurrent()
                  / 100.0F
            );
         ...
         case 18:
            CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iPosX = (
                  68 - CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iWidth
               )
               / 2;
            return;
         case 19:
            CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iPosY = (
                  44 - CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).iHeight
               )
               / 2;
      }
   }
