...
public class Text_Economy_Total extends Text {
   public String sText2;
   public Color textColor;

   public Text_Economy_Total(String sText, String sText2, int iPosX, int iPosY, int iWidth, int iHeight) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      ImageManager.getImage(Images.slider_gradient)
         .draw(
            oSB, this.getPosX() + iTranslateX, this.getPosY() - ImageManager.getImage(Images.slider_gradient).getHeight() + iTranslateY, this.getWidth() / 4, 1
         );
      ImageManager.getImage(Images.slider_gradient)
         .draw(
            oSB,
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.getText(),
         this.getPosX() + this.getWidth() - CFG.PADDING - CFG.PADDING / 2 - (int)(this.getTextWidth() * 0.8F) + iTranslateX,
   ...
   public final float getImageScale() {
      return this.iTextHeight * 0.8F / ImageManager.getImage(Images.top_gold).getHeight();
   }
