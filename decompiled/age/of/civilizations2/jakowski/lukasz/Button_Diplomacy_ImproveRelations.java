...
public class Button_Diplomacy_ImproveRelations extends Button_Statistics {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.game
         ...
         .draw(
            oSB,
            this.getPosX() + this.iRelationWidth + this.iCurrentRelationWidth + CFG.PADDING * 2 + (int)(this.getTextWidth() * 0.7F) + 2 + iTranslateX,
            this.getPosY()
               + CFG.PADDING * 2
      ...
      CFG.drawTextWithShadow(
         ...
         CFG.game.getCivRelation_OfCivB(this.iCivB, this.iCivA) > 0.0F
            ...
            : (CFG.game.getCivRelation_OfCivB(this.iCivB, this.iCivA) == 0.0F ? CFG.COLOR_TEXT_MODIFIER_NEUTRAL : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2)
      );
      CFG.drawTextWithShadow(
         oSB,
         this.sCivBName,
   ...
   public void buildElementHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("ImproveRelation"), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
      nData.add(new MenuElement_Hover_v2_Element_Type_Flag(this.iCivA, CFG.PADDING, CFG.PADDING));
