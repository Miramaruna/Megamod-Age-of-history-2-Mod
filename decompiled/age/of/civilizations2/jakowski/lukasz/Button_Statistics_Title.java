...
public class Button_Statistics_Title extends Button_Statistics {
   public Button_Statistics_Title(String sText, int iTextPosX, int iPosX, int iPosY, int iWidth, int iHeight) {
      super(sText, iTextPosX, iPosX, iPosY, iWidth, iHeight);
      if (iTextPosX < 0) {
         this.textPosition = new Button.TextPosition() {
            @Override
            public int getTextPosition() {
               return (int)(Button_Statistics_Title.this.getWidth() / 2 - Button_Statistics_Title.this.getTextWidth() * 0.6F / 2.0F);
            }
         };
      }
   }
