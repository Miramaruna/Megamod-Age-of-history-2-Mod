...
public class Menu_CreateScenario_Events_Out_UpdatePopulation_Perc extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(3).setText(CFG.langManager.get("Percentage") + ": ");
      this.getTitle().setText(CFG.langManager.get("UpdatePopulationPercentage"));
   }
