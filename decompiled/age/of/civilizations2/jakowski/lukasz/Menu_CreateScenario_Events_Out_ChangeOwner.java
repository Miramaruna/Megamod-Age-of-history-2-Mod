...
public class Menu_CreateScenario_Events_Out_ChangeOwner extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      try {
         this.getMenuElement(1)
            .setText(
               CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
                        ...
                        .getCivID2()
                     >= 0
                  ? CFG.langManager.get("ControlledBy")
                     + ": "
                     + CFG.game
                        .getCiv(
                           CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         this.getMenuElement(1).setText(CFG.langManager.get("ControlledBy"));
      }
      ...
      try {
         ...
         this.getMenuElement(2).setText(CFG.langManager.get("NewOwner"));
      }
      ...
      this.getTitle().setText(CFG.langManager.get("ChangeOwnerOfProvinces"));
   }
