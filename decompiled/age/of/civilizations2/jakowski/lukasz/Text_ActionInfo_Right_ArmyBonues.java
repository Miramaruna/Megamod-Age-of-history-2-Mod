...
public class Text_ActionInfo_Right_ArmyBonues extends Text_ActionInfo_Right {
   public String sValue;
   public int iValueWidth = 0;

   public Text_ActionInfo_Right_ArmyBonues(String sText, String sValue, int iPosX, int iPosY) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sText,
         this.getPosX() + this.getWidth() - (int)(this.getTextWidth() * 0.8F) - this.iValueWidth - CFG.PADDING + var6,
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sValue,
         this.getPosX() + this.getWidth() - this.iValueWidth - CFG.PADDING + var6,
         this.getPosY() + (int)((this.getHeight() - this.iTextHeight * 0.8F) / 2.0F) + iTranslateY,
         this.getColorValue()
      );
