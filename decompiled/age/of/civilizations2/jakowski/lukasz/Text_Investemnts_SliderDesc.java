...
public class Text_Investemnts_SliderDesc extends Text {
   public static final float TEXT2_SCALE = 0.65F;
   public String sText2;

   public Text_Investemnts_SliderDesc(String sText, String sText2, int iPosX, int iPosY, int iWidth, int iHeight) {
      ...
      ImageManager.getImage(Images.economy)
         .draw(
            ...
            this.getPosY()
               ...
               + (this.getHeight() - (int)(ImageManager.getImage(Images.economy).getHeight() * this.getImageScale(0.65F, Images.economy))) / 2
               + iTranslateY,
            (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale(0.65F, Images.economy)),
            (int)(ImageManager.getImage(Images.economy).getHeight() * this.getImageScale(0.65F, Images.economy))
         );
      ImageManager.getImage(
         ...
         .draw(
            ...
            this.getPosX()
               + this.getWidth()
               - CFG.PADDING * 2
               - (int)(ImageManager.getImage(Images.development).getWidth() * this.getImageScale(0.65F, Images.development))
               + iTranslateX,
            this.getPosY()
               - ImageManager.getImage(Images.development).getHeight()
               + (this.getHeight() - (int)(ImageManager.getImage(Images.development).getHeight() * this.getImageScale(0.65F, Images.development))) / 2
               + iTranslateY,
            (int)(ImageManager.getImage(Images.development).getWidth() * this.getImageScale(0.65F, Images.development)),
            (int)(ImageManager.getImage(Images.development).getHeight() * this.getImageScale(0.65F, Images.development))
         );
      CFG.fontMain.getData().setScale(0.65F);
      CFG.drawTextWithShadow(
         oSB,
         this.sText2,
         this.getPosX() + CFG.PADDING * 3 + (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale(0.65F, Images.economy)) + iTranslateX,
