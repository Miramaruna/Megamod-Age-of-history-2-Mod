...
public class Button_Diplomacy_Civilize2 extends Button {
   ...
   public Button_Diplomacy_Civilize2(int iCivID, int iPosX, int iPosY, int iWidth, boolean isClickable, boolean nCheckbox) {
      super.init(
         ...
         iPosY,
         iWidth,
         Math.max(Math.max(CFG.TEXT_HEIGHT, CFG.CIV_FLAG_HEIGHT) + CFG.PADDING * 4, (int)(CFG.BUTTON_HEIGHT * 0.6F)),
         isClickable,
         true,
         true,
         nCheckbox
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      try {
         CFG.drawText(
            ...
            this.getPosX() + Button_Diplomacy.iDiploWidth + (int)(this.getTextWidth() * 0.7F) + iTranslateX,
            this.getPosY() + this.getHeight() / 2 - (int)(this.getTextHeight() * 0.7F / 2.0F) + iTranslateY,
            new Color(
