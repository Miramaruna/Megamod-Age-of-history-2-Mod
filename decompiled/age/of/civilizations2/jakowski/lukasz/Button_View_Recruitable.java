...
public class Button_View_Recruitable extends Button {
         ...
         ImageManager.getImage(Images.b_armoury)
            .draw(
               ...
               this.getPosX()
                  ...
                  - this.iPopulationPercWidth
                  + iTranslateX
                  - (int)(ImageManager.getImage(Images.b_armoury).getWidth() * this.getImageScale(ImageManager.getImage(Images.b_armoury).getHeight()))
                  - CFG.PADDING,
               this.getPosY()
                  + this.getHeight() / 2
                  - (int)(ImageManager.getImage(Images.b_armoury).getHeight() * this.getImageScale(ImageManager.getImage(Images.b_armoury).getHeight())) / 2
                  + iTranslateY
                  - ImageManager.getImage(Images.b_armoury).getHeight(),
               (int)(ImageManager.getImage(Images.b_armoury).getWidth() * this.getImageScale(ImageManager.getImage(Images.b_armoury).getHeight())),
               (int)(ImageManager.getImage(Images.b_armoury).getHeight() * this.getImageScale(ImageManager.getImage(Images.b_armoury).getHeight()))
            );
      }
