...
public class Menu_CreateScenario_Events_Cond_Neutral extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("NeutralProvince"));
      this.getTitle().setText(CFG.langManager.get("NeutralProvince"));
   }
