...
public class Menu_CreateScenario_SetUp_StartingMoney extends Menu_CreateScenario {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      CFG.drawEditorButtons_Top_Edge_R_Reflected(
         ...
         CFG.GAME_WIDTH - (this.getMenuElement(7).getPosX() - CFG.PADDING),
         ...
         case 3:
            ...
            if (CFG.iCreateScenario_AssignProvinces_Civ > 0) {
               ...
               CFG.game
                  ...
                  .updateArmyWidth(
                     (int)(
                        CFG.game.getCiv(CFG.iCreateScenario_AssignProvinces_Civ).getMoney() == -999999L
                           ? CFG.game.getGameScenarios().getScenario_StartingMoney()
                           : CFG.game.getCiv(CFG.iCreateScenario_AssignProvinces_Civ).getMoney()
                     )
                  );
            }
               ...
               for (int i = 0; i < CFG.game.getProvincesSize(); i++) {
                  if (CFG.game.getProvince(i).getIsCapital()) {
                     CFG.game
                        ...
                        .updateArmyWidth(
                           (int)(
                              CFG.game.getCiv(CFG.game.getProvince(i).getCivID()).getMoney() == -999999L
                                 ? CFG.game.getGameScenarios().getScenario_StartingMoney()
                                 : CFG.game.getCiv(CFG.game.getProvince(i).getCivID()).getMoney()
                           )
                        );
                  }
               }
