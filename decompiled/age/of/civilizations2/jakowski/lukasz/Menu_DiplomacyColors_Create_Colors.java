...
public class Menu_DiplomacyColors_Create_Colors extends SliderMenu {
   public Menu_DiplomacyColors_Create_Colors() {
      ...
      menuElements.add(
         new Button_Game("OWN PROVINCES", -1, CFG.PADDING, tempPosY, CFG.BUTTON_WIDTH * 2, true) {
            @Override
      ...
      int var3;
      menuElements.add(
         new Button_Game("ALLIANCE", -1, CFG.PADDING, var3 = tempPosY + CFG.BUTTON_HEIGHT + CFG.PADDING, CFG.BUTTON_WIDTH * 2, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               super.drawText(oSB, iTranslateX, iTranslateY, isActive);
               oSB.setColor(
      ...
      menuElements.add(
         new Button_Game("AT WAR", -1, CFG.PADDING, tempPosY = var3 + CFG.BUTTON_HEIGHT + CFG.PADDING, CFG.BUTTON_WIDTH * 2, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               super.drawText(oSB, iTranslateX, iTranslateY, isActive);
               oSB.setColor(
      ...
      int var5;
      menuElements.add(
         new Button_Game("VASSAL", -1, CFG.PADDING, var5 = tempPosY + CFG.BUTTON_HEIGHT + CFG.PADDING, CFG.BUTTON_WIDTH * 2, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               super.drawText(oSB, iTranslateX, iTranslateY, isActive);
               oSB.setColor(
      ...
      menuElements.add(
         new Button_Game("PACT", -1, CFG.PADDING, tempPosY = var5 + CFG.BUTTON_HEIGHT + CFG.PADDING, CFG.BUTTON_WIDTH * 2, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               super.drawText(oSB, iTranslateX, iTranslateY, isActive);
               oSB.setColor(
                  new Color(
                     CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_PACT.getR(),
                     CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_PACT.getG(),
                     CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_PACT.getB(),
                     1.0F
                  )
               );
               ImageManager.getImage(Images.pix255_255_255)
      ...
      int var7;
      menuElements.add(
         new Button_Game("PACT MAX", -1, CFG.PADDING, var7 = tempPosY + CFG.BUTTON_HEIGHT + CFG.PADDING, CFG.BUTTON_WIDTH * 2, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               super.drawText(oSB, iTranslateX, iTranslateY, isActive);
               oSB.setColor(
                  new Color(
                     CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_PACT_MAX.getR(),
                     CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_PACT_MAX.getG(),
                     CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_PACT_MAX.getB(),
                     1.0F
                  )
               );
               ImageManager.getImage(Images.pix255_255_255)
      ...
      menuElements.add(
         new Button_Game("INDEPENDENCE", -1, CFG.PADDING, tempPosY = var7 + CFG.BUTTON_HEIGHT + CFG.PADDING, CFG.BUTTON_WIDTH * 2, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               super.drawText(oSB, iTranslateX, iTranslateY, isActive);
               oSB.setColor(
      ...
      int var9;
      menuElements.add(
         new Button_Game("MILITARY ACCESS", -1, CFG.PADDING, var9 = tempPosY + CFG.BUTTON_HEIGHT + CFG.PADDING, CFG.BUTTON_WIDTH * 2, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               super.drawText(oSB, iTranslateX, iTranslateY, isActive);
               oSB.setColor(
      ...
      menuElements.add(
         new Button_Game("DEFENSIVE PACT", -1, CFG.PADDING, tempPosY = var9 + CFG.BUTTON_HEIGHT + CFG.PADDING, CFG.BUTTON_WIDTH * 2, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               super.drawText(oSB, iTranslateX, iTranslateY, isActive);
               oSB.setColor(
      ...
      this.initMenu(
         null,
         0,
         CFG.BUTTON_HEIGHT * 2 + CFG.PADDING * 4,
         CFG.BUTTON_WIDTH * 2 + CFG.PADDING * 2,
         CFG.GAME_HEIGHT - (CFG.BUTTON_HEIGHT * 2 + CFG.PADDING * 4),
         menuElements
      );
      this.updateLanguage();
   }
