...
public class Menu_Leader_Edit_SelectCiv_Alphabet extends SliderMenu {
   ...
   public Menu_Leader_Edit_SelectCiv_Alphabet() {
      ...
      menuElements.add(new Button_Menu_Classic_Search("", CFG.PADDING * 2, 0, CFG.PADDING, CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT, true) {
         ...
         public String getTextToDraw() {
            return Menu_Leader_Edit_SelectCiv_Alphabet.this.nSearch + ": " + super.getTextToDraw();
         }
      });
      ...
      for (int i = 0; i < iSize; i++) {
         if (!CFG.isInLeaderCivs(tagsSPLITED[i])) {
      ...
      for (int var16 = 0; var16 < iSize; var16++) {
         if (!CFG.isInLeaderCivs(tagsSPLITED_ED[var16])) {
            boolean addChar = true;
