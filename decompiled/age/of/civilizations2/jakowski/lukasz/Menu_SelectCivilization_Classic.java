...
public class Menu_SelectCivilization_Classic extends SliderMenu {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      for (int i = 1; i < CFG.game.getCivsSize(); i++) {
         CFG.game
            ...
            .draw(
               oSB,
               this.getMenuElement(i + 1).getTextPos() / 2 - CFG.CIV_FLAG_WIDTH / 2 + iTranslateX,
               this.getMenuElement(i + 1).getPosY() + this.getMenuElement(i + 1).getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2 + this.getMenuPosY() + iTranslateY
            );
      }
   }
