...
public class Button_CNG_Options_Text2 extends Button_CNG_Options {
   ...
   public Button_CNG_Options_Text2(
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.drawText(
         ...
         this.getPosY() + CFG.PADDING * 2 + CFG.TEXT_HEIGHT / 2 - (int)(CFG.TEXT_HEIGHT * 0.85F) / 2 + iTranslateY,
      ...
      CFG.drawText(
         ...
         this.sText2,
         this.getPosX() + this.getTextPos() + iTranslateX,
         this.getPosY() + CFG.PADDING * 3 + CFG.TEXT_HEIGHT + CFG.TEXT_HEIGHT / 2 - (int)(CFG.TEXT_HEIGHT * 0.65F) / 2 + iTranslateY,
