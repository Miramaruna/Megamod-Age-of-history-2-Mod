...
public class Menu_InGame_Build_Shelter extends SliderMenu {
   public int iProvinceID = -1;

   public Menu_InGame_Build_Shelter() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Shelter"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Build_Shelter(int nProvinceID) {
      ArrayList<MenuElement> menuElements = new ArrayList<>();
      ...
      menuElements.add(
         new Button_Build_Building(
            CFG.langManager.get("BuildShelterIn") + ": ",
            ...
            Images.b_shelter,
            BuildingsManager.getShelter_BuildCost(CFG.game.getProvince(this.iProvinceID).getLevelOfShelter() + 1, this.iProvinceID),
            BuildingsManager.getShelter_BuildMovementCost(CFG.game.getProvince(this.iProvinceID).getLevelOfShelter() + 1),
            0,
            tY,
            CFG.BUTTON_WIDTH * 2
         ) {
            @Override
            public int getWidth() {
               return Menu_InGame_Build_Shelter.this.getElementW() * 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "-"
                        + (int)(
                           BuildingsManager.getShelter_Bonus(CFG.game.getProvince(Menu_InGame_Build_Shelter.this.iProvinceID).getLevelOfShelter() + 1) * 100.0F
                        )
                        + "%",
      ...
      menuElements.get(menuElements.size() - 1)
         .setMin((int)(BuildingsManager.getShelter_TechLevel(CFG.game.getProvince(this.iProvinceID).getLevelOfShelter() + 1) * 100.0F));
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      int var7;
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Build_Shelter.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Construct"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_Build_Shelter.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getProvince(Menu_InGame_Build_Shelter.this.iProvinceID).getName().length() > 0
                        ? CFG.game.getProvince(Menu_InGame_Build_Shelter.this.iProvinceID).getName()
                        : CFG.langManager.get("Province")
                  )
               );
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(Menu_InGame_Build_Shelter.this.iProvinceID).getCivID(), CFG.PADDING, 0)
               );
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + BuildingsManager.getShelter_BuildCost(
                           CFG.game.getProvince(Menu_InGame_Build_Shelter.this.iProvinceID).getLevelOfShelter() + 1, Menu_InGame_Build_Shelter.this.iProvinceID
                        ),
                     CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney()
                           >= BuildingsManager.getShelter_BuildCost(
                              CFG.game.getProvince(Menu_InGame_Build_Shelter.this.iProvinceID).getLevelOfShelter() + 1,
                              Menu_InGame_Build_Shelter.this.iProvinceID
                           )
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager
                        .get(
                           ...
                           BuildingsManager.getShelter_Construction(CFG.game.getProvince(Menu_InGame_Build_Shelter.this.iProvinceID).getLevelOfShelter() + 1)
                        )
                  )
               );
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + (int)(
                              BuildingsManager.getShelter_TechLevel(CFG.game.getProvince(Menu_InGame_Build_Shelter.this.iProvinceID).getLevelOfShelter() + 1)
                                 * 100.0F
                           )
                           / 100.0F,
            ...
            public boolean getClickable() {
               return CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                     >= BuildingsManager.getShelter_BuildMovementCost(CFG.game.getProvince(Menu_InGame_Build_Shelter.this.iProvinceID).getLevelOfShelter() + 1)
                  && CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney()
                     >= BuildingsManager.getShelter_BuildCost(
                        CFG.game.getProvince(Menu_InGame_Build_Shelter.this.iProvinceID).getLevelOfShelter() + 1, Menu_InGame_Build_Shelter.this.iProvinceID
                     )
         ...
         new SliderMenuTitle(CFG.langManager.get("Shelter"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_Build_Shelter.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Shelter.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_Build_Shelter.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Shelter.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         if (BuildingsManager.constructShelter(this.iProvinceID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())) {
            ...
            CFG.soundsManager.playSound(SoundsManager.SOUND_GEIGER);
         }
