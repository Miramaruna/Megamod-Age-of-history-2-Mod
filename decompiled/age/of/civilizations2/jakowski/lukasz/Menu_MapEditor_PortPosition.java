...
public class Menu_MapEditor_PortPosition extends SliderMenu {
      ...
      switch (iID) {
         ...
         case 1:
            if (CFG.game.getActiveProvinceID() >= 0
               ...
               Editor_ShiftPort.savePortPosition(
                  CFG.game.getProvince(CFG.game.getActiveProvinceID()).getPortShiftX() - 1,
                  CFG.game.getProvince(CFG.game.getActiveProvinceID()).getPortShiftY()
               );
            }
         ...
         case 2:
            if (CFG.game.getActiveProvinceID() >= 0
               ...
               && CFG.game.getProvince(CFG.game.getActiveProvinceID()).getLevelOfPort() > 0) {
               Editor_ShiftPort.savePortPosition(
                  CFG.game.getProvince(CFG.game.getActiveProvinceID()).getPortShiftX(),
                  CFG.game.getProvince(CFG.game.getActiveProvinceID()).getPortShiftY() + 1
               );
            }
