...
public class Button_Statistics_WarDetails extends Button_Statistics {
   ...
   public static final float FONT_SCALE2 = 0.65F;
   public static final float FONT_SCALE3 = 0.6F;
   public int iCivID;
                     ...
                     try {
                        try {
                           ...
                           try {
                              ...
                              this.civFlag = new Image(
                                 new Texture(Gdx.files.internal("game/flags/" + CFG.ideologiesManager.getRealTag(nTag) + ".png")), Texture.TextureFilter.Linear
                              );
                           }
                        }
   ...
   public void drawFlag(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      if (this.canPeaceOut && this.getIsHovered()) {
         ...
         Rectangle clipBounds2 = new Rectangle(
            this.getPosX() + iTranslateX, CFG.GAME_HEIGHT - this.getPosY() - iTranslateY, this.ANIMATION_POSX, -this.getHeight()
         );
         oSB.flush();
   ...
   public void buildElementHover() {
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(
            "" + (int)(CFG.game.getCiv(this.iCivID).getWarWeariness() * 10000.0F) / 100.0F + "%", CFG.COLOR_TEXT_MODIFIER_NEUTRAL2
         )
      );
