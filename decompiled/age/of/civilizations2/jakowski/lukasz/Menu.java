...
public enum Menu {
   ...
   eDOWNLOAD_PALLETS,
    eGENERATE_PREVIEW,
    eGENERATE_FLAG,
    eCREATE_SCENARIO_EVENTS_OUT_AddNuke,
    eCREATE_SCENARIO_EVENTS_OUT_BUILDBUILDING,
    eCREATE_SCENARIO_EVENTS_OUT_LEADER,
    eCREATE_SCENARIO_EVENTS_OUT_MUSIC,
    eCREATE_SCENARIO_EVENTS_OUT_RENAME_CITY,
    eCREATE_SCENARIO_EVENTS_OUT_Test,
    eCREATE_SCENARIO_EVENTS_OUT_UPDATEGROWTHRATES,
    eMODS;
}
