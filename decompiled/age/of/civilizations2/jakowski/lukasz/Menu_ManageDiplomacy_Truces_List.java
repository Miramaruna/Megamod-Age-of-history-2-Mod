...
public class Menu_ManageDiplomacy_Truces_List extends SliderMenu {
   public Menu_ManageDiplomacy_Truces_List() {
      ...
      if (CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID > 0) {
         ...
         for (int i = 1; i < CFG.game.getCivsSize(); i++) {
            if (i != CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID && CFG.game.getCivTruce(i, CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID) > 0) {
               menuElements.add(
                  new Slider_Truce(
                     i,
                     ...
                     1,
                     40,
                     CFG.game.getCivTruce(i, CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID)
                  )
               );
               menuElements.add(
         ...
         new SliderMenuTitle(null, CFG.BUTTON_HEIGHT * 3 / 4, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_ManageDiplomacy_Truces_List.this.getPosX() + iTranslateX,
                     Menu_ManageDiplomacy_Truces_List.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(),
                     Menu_ManageDiplomacy_Truces_List.this.getWidth() + 2,
                     this.getHeight(),
                     true,
                     false
                  );
               ...
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Menu_ManageDiplomacy_Truces_List.this.getPosX() + iTranslateX,
                     Menu_ManageDiplomacy_Truces_List.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() - this.getHeight() * 3 / 4,
                     Menu_ManageDiplomacy_Truces_List.this.getWidth(),
                     this.getHeight() * 3 / 4,
                     false,
                     true
                  );
               ...
               ImageManager.getImage(Images.pix255_255_255)
                  .draw(
                     oSB,
                     Menu_ManageDiplomacy_Truces_List.this.getPosX() + iTranslateX,
                     Menu_ManageDiplomacy_Truces_List.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(),
                     Menu_ManageDiplomacy_Truces_List.this.getWidth()
                  );
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_ManageDiplomacy_Truces_List.this.getPosX() + iTranslateX,
                     Menu_ManageDiplomacy_Truces_List.this.getPosY()
   ...
   public void updateLanguage() {
      this.getTitle().setText(CFG.langManager.get("Truces"));
   }
   ...
   public void actionElement(int iID) {
      if (iID % 2 == 0) {
         this.updateNonAggressionPact(iID / 2, this.getMenuElement(iID).getCurrent());
      } else if (iID % 2 == 1) {
         ...
         for (int i = 1; i < CFG.game.getCivsSize(); i++) {
            if (i != CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID && CFG.game.getCivTruce(i, CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID) > 0) {
               if (foundPacts == pactID) {
                  CFG.game.setCivTruce(i, CFG.MANAGE_DIPLOMACY_CUSTOMIZE_ALLIANCE_ID, iNumOfTurns);
                  return;
               }
