...
public class Menu_CreateScenario_Events_Cond_NumOfNeighbors_Low extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("NumberOfNeighbors") + " < ");
      this.getTitle().setText(CFG.langManager.get("NumberOfNeighbors"));
   }
