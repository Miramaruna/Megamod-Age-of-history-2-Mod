...
public class Button_Diplomacy_LiberityDesire extends Button {
   public int iCivID = 0;
   ...
   public Button_Diplomacy_LiberityDesire(
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
         ...
         CFG.ideologiesManager
            ...
            .draw(
               ...
               this.getPosX()
                  + this.getWidth()
                  - CFG.PADDING * 2
                  - (int)(this.getTextWidth() * 0.6)
                  - (int)(
                     CFG.ideologiesManager.getIdeology(CFG.game.getCiv(CFG.getActiveCivInfo()).getIdeologyID()).getCrownImageScaled().getWidth()
                        * this.getImageScale(
         ...
         ImageManager.getImage(this.iImageID)
            .draw(
               ...
               this.getPosY()
                  + 1
                  + this.getHeight() / 2
                  - (int)(ImageManager.getImage(this.iImageID).getHeight() * this.getImageScale(ImageManager.getImage(this.iImageID).getHeight())) / 2
                  + iTranslateY
      ...
      CFG.drawText(
         oSB,
         this.getText(),
         this.getPosX() + this.getWidth() - (int)(this.getTextWidth() * 0.6F) - CFG.PADDING + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(this.getTextHeight() * 0.6F / 2.0F) + iTranslateY,
         this.textColor
      );
