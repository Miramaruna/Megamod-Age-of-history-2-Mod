...
public class Button_Diplomacy_Action_Goverment extends Button {
   public int iGovID = 0;
   public boolean row = false;

   public Button_Diplomacy_Action_Goverment(int nGovID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      CFG.ideologiesManager
         .getIdeology(this.iGovID)
         .getCrownImageScaled()
         .draw(
            oSB,
            this.getPosX() + (Button_Diplomacy.iDiploWidth - CFG.ideologiesManager.getIdeology(this.iGovID).getCrownImageScaled().getWidth()) / 2 + iTranslateX,
            this.getPosY() + this.getHeight() / 2 - CFG.ideologiesManager.getIdeology(this.iGovID).getCrownImageScaled().getHeight() / 2 + iTranslateY
         );
