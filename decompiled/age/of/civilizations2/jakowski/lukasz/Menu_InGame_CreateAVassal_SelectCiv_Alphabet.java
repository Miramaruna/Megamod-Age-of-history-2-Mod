...
public class Menu_InGame_CreateAVassal_SelectCiv_Alphabet extends SliderMenu {
   ...
   public Menu_InGame_CreateAVassal_SelectCiv_Alphabet() {
      ...
      for (int i = 0; i < iSize; i++) {
         if (!CFG.isInTheGame_Or_IsFormableCiv(tagsSPLITED[i])) {
      ...
      for (int var16 = 0; var16 < iSize; var16++) {
         if (!CFG.isInTheGame_Or_IsFormableCiv(tagsSPLITED_ED[var16])) {
            boolean addChar = true;
