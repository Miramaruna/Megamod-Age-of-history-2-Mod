...
class Message_PeaceTreaty extends Message {
   ...
   public MenuElement_Hover_v2 getHover() {
      try {
         ...
         for (int var11 = 0; var11 < CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsData_Aggressors.size(); var11++) {
            nData.add(
               new MenuElement_Hover_v2_Element_Type_Flag(
                  CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsData_Aggressors.get(var11).iCivID, 0, 0
               )
            );
         }
         ...
         for (int var12 = 0; var12 < CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Defenders.size(); var12++) {
            if (CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Defenders.get(var12).lDemands.size() > 0) {
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Defenders.get(var12).iCivID)
               );
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getCiv(CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Defenders.get(var12).iCivID).getCivName(),
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     " - "
                        ...
                        + ": "
                        + CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Defenders.get(var12).lDemands.size()
                  )
               );
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();

               for (int j = 0; j < CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Defenders.get(var12).lDemands.size() && j < 5; j++) {
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Flag(
                        CFG.game
                           .getProvince(CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Defenders.get(var12).lDemands.get(j))
                  ...
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Flag(
                        CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Defenders.get(var12).iCivID, 0, CFG.PADDING
                     )
                  );
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Text(
                  ...
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Text(
                        " "
                           + CFG.game
                              .getProvinceValue(CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Defenders.get(var12).lDemands.get(j)),
         ...
         for (int var13 = 0; var13 < CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Aggressors.size(); var13++) {
            if (CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Aggressors.get(var13).lDemands.size() > 0) {
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Flag(
                     CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Aggressors.get(var13).iCivID
                  )
               );
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getCiv(CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Aggressors.get(var13).iCivID).getCivName(),
                     CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                  )
               );
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     " - "
                        + CFG.langManager.get("Provinces")
                        + ": "
                        + CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Aggressors.get(var13).lDemands.size()
                  )
               );
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();

               for (int j = 0; j < CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Aggressors.get(var13).lDemands.size() && j < 5; j++) {
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Flag(
                        CFG.game
                           .getProvince(CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Aggressors.get(var13).lDemands.get(j))
                           .getTrueOwnerOfProvince(),
                        0,
                        0
                     )
                  ...
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Flag(
                        CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Aggressors.get(var13).iCivID, 0, CFG.PADDING
                     )
                  );
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Text(
                  ...
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Text(
                        " "
                           + CFG.game
                              .getProvinceValue(CFG.game.lPeaceTreaties.get(peaceID).peaceTreaty_GameData.lCivsDemands_Aggressors.get(var13).lDemands.get(j)),
                        CFG.COLOR_TEXT_NUM_OF_PROVINCES
                     )
                  );
                  nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.victoryPoints, CFG.PADDING, 0));
