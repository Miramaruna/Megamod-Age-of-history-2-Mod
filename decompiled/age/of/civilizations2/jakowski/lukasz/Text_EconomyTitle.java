...
public class Text_EconomyTitle extends Text {
   public Text_EconomyTitle(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight) {
   ...
   public Color getColor(boolean isActive) {
      return isActive
         ...
         : (this.getClickable() ? (this.getIsHovered() ? new Color(0.95F, 0.95F, 0.95F, 1.0F) : Color.WHITE) : new Color(0.78F, 0.78F, 0.78F, 0.7F));
   }
}
