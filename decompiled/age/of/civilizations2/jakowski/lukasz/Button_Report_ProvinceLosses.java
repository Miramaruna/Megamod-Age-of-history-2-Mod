...
public class Button_Report_ProvinceLosses extends Button {
   public int iPopulationLosses;
   public int iEconomyLosses;
   public int iEconomyLossesWidth;
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.drawText(
         ...
         this.getPosY() + this.getHeight() / 2 - (int)(CFG.TEXT_HEIGHT * 0.85F / 2.0F) + iTranslateY,
      ...
      CFG.drawText(
         ...
         this.getPosX()
            ...
            - (int)(this.iEconomyLossesWidth * 0.85F)
            + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(CFG.TEXT_HEIGHT * 0.85F / 2.0F) + iTranslateY,
         Button_Report_Armies.COLOR_ARMY_LOST
      );
