...
public class Menu_Leader_Edit_Civs extends SliderMenu {
      ...
      for (int i = 0; i < CFG.leader_GameData.getCivsSize(); i++) {
         menuElements.add(
            new Button_NewGameStyle_Left(
               CFG.langManager.getCiv(CFG.leader_GameData.getCiv(i)),
               CFG.PADDING * 3 + CFG.CIV_FLAG_WIDTH,
               CFG.PADDING + 2,
               tY,
               tempW - 2 - CFG.PADDING * 2 - (int)(CFG.BUTTON_HEIGHT * 0.6F),
         ...
         menuElements.add(
            new Button_New_Game_Players_Players_RIGHT(
               "", -1, tempW - 2 - CFG.PADDING - (int)(CFG.BUTTON_HEIGHT * 0.6F), tY, (int)(CFG.BUTTON_HEIGHT * 0.6F), true
            ) {
               @Override
         ...
         new SliderMenuTitle(null, CFG.BUTTON_HEIGHT * 3 / 4, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_Leader_Edit_Civs.this.getPosX() - 2 + iTranslateX,
                     Menu_Leader_Edit_Civs.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(),
                     Menu_Leader_Edit_Civs.this.getWidth() + 2,
                     this.getHeight(),
                     false,
                     false
                  );
               ...
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Menu_Leader_Edit_Civs.this.getPosX() + iTranslateX,
                     Menu_Leader_Edit_Civs.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() - this.getHeight() * 3 / 4,
                     Menu_Leader_Edit_Civs.this.getWidth(),
                     this.getHeight() * 3 / 4,
                     false,
                     true
                  );
               ...
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Menu_Leader_Edit_Civs.this.getPosX() + iTranslateX,
                     Menu_Leader_Edit_Civs.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() - CFG.PADDING,
                     Menu_Leader_Edit_Civs.this.getWidth(),
                     CFG.PADDING,
                     false,
                     true
               ...
               ImageManager.getImage(Images.pix255_255_255)
                  .draw(
                     oSB,
                     Menu_Leader_Edit_Civs.this.getPosX() + iTranslateX,
                     Menu_Leader_Edit_Civs.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(),
                     Menu_Leader_Edit_Civs.this.getWidth()
                  );
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_Leader_Edit_Civs.this.getPosX() + iTranslateX,
                     Menu_Leader_Edit_Civs.this.getPosY()
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      for (int i = 0; i < this.lFlags.size(); i++) {
         this.lFlags
            ...
            .draw(
               oSB,
               this.getPosX() + this.getMenuElement(i * 2 + 1).getPosX() + CFG.PADDING * 2 + iTranslateX,
               this.getMenuPosY()
                  + this.getMenuElement(i * 2 + 1).getPosY()
                  + this.getMenuElement(i * 2 + 1).getHeight() / 2
                  - ImageManager.getImage(Images.flag_rect).getHeight() / 2
                  - this.lFlags.get(i).getHeight()
                  + iTranslateY,
   ...
   public void actionElement(int iID) {
      ...
      if (iID == 0) {
         CFG.menuManager.setViewID(Menu.eGAME_LEADERS_EDIT_SELECT_CIVS);
      }

      if ((iID - 1) % 2 == 1) {
         CFG.leader_GameData.removeCiv((iID - 1) / 2);
         CFG.menuManager.rebuildLeaders_Edit_Civs();
      } else {
   ...
   public final void loadFlags() {
      ...
      for (int i = 0; i < CFG.leader_GameData.getCivsSize(); i++) {
         try {
            try {
               this.lFlags
                  .add(new Image(new Texture(Gdx.files.internal("game/flags/" + CFG.leader_GameData.getCiv(i) + ".png")), Texture.TextureFilter.Nearest));
            } catch (GdxRuntimeException var7) {
               try {
                  this.lFlags
                     .add(
                        new Image(
                           new Texture(Gdx.files.internal("game/flags/" + CFG.ideologiesManager.getRealTag(CFG.leader_GameData.getCiv(i)) + ".png")),
                        ...
                        this.lFlags
                           .add(
                              new Image(
                                 new Texture(
                                    Gdx.files
                                       .local("game/civilizations_editor/" + CFG.leader_GameData.getCiv(i) + "/" + CFG.leader_GameData.getCiv(i) + "_FL.png")
                                 ),
                                 Texture.TextureFilter.Nearest
                              )
                           );
                        ...
                        this.lFlags
                           .add(
                              new Image(
                                 new Texture(
                                    Gdx.files
                                       .internal("game/civilizations_editor/" + CFG.leader_GameData.getCiv(i) + "/" + CFG.leader_GameData.getCiv(i) + "_FL.png")
                                 ),
                                 Texture.TextureFilter.Nearest
                              )
                           );
