...
public class Slider_BG_CNG_Pact extends Slider_BG_CNG {
   public int iCivA;
   public int iCivB;

   public Slider_BG_CNG_Pact(int nCivA, int nCivB, String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
