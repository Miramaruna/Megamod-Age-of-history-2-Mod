...
public class Text_Outliner_DiploInfo_FriendlyCivs extends Text {
   ...
   public Text_Outliner_DiploInfo_FriendlyCivs(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
      ...
      CFG.toast
         .setInView(
            (this.iCivLeft >= 0 ? CFG.game.getCiv(this.iCivLeft).getCivName() : CFG.langManager.get("Undiscovered"))
               + " - "
               + CFG.langManager.get("FriendlyCivilizations")
               + " - "
