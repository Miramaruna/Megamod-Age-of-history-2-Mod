...
public class Menu_ManageDiplomacy_Alliances extends SliderMenu {
   public Menu_ManageDiplomacy_Alliances() {
      ...
      for (int i = 1; i < CFG.game.getAlliancesSize(); i++) {
         ...
         menuElements.add(
            new Button_Alliance(
               ...
               -1,
               CFG.PADDING + CFG.BUTTON_WIDTH * 2 + CFG.PADDING + tPosX,
               CFG.PADDING,
               tWidth,
               ...
               public void buildElementHover() {
                  try {
                     ...
                     ArrayList<MenuElement_Hover_v2_Element_Type> nData = new ArrayList<>();
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getAlliance(this.getCurrent()).getAllianceName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE)
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     nData.clear();
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "" + CFG.getNumberWithSpaces("" + CFG.game.countAlliance_Provinces(this.getCurrent())), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     nData.clear();
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "" + CFG.getNumberWithSpaces("" + CFG.game.countAlliance_Population(this.getCurrent())), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     nData.clear();
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "" + CFG.getNumberWithSpaces("" + CFG.game.countAlliance_Economy(this.getCurrent())), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     nData.clear();
                     ...
                     for (int i = 0; i < CFG.game.getAlliance(this.getCurrent()).getCivilizationsSize(); i++) {
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getCiv(CFG.game.getAlliance(this.getCurrent()).getCivilization(i)).getCivName())
                        );
                        nElements.add(new MenuElement_Hover_v2_Element2(nData));
                        nData.clear();
                     }
         ...
         tPosX += (
               menuElements.get(menuElements.size() - 1).getTextWidth() + CFG.PADDING * 2 > tWidth
                  ? menuElements.get(menuElements.size() - 1).getTextWidth() + CFG.PADDING * 2
                  : tWidth
            )
            + CFG.PADDING;
      }
      ...
      menuElements.add(
         new Button_Game_ColorPicker(CFG.PADDING, CFG.BUTTON_HEIGHT + CFG.BUTTON_HEIGHT / 2 + CFG.PADDING * 3, true) {
            @Override
            public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               CFG.drawEditorButtons_Top_Edge_R(
                  oSB,
                  this.getPosX() - CFG.PADDING + iTranslateX + iTranslateY,
                  this.getPosY() - CFG.PADDING,
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      ImageManager.getImage(Images.slider_gradient)
         .draw(
            oSB,
            this.getPosX() + iTranslateX,
            this.getPosY() + this.getMenuElement(0).getHeight() + CFG.PADDING * 2 - 1 - ImageManager.getImage(Images.slider_gradient).getHeight() + iTranslateY,
            this.getWidth() / 2,
            1,
            false,
            false
