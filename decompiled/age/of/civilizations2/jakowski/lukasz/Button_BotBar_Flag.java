...
public class Button_BotBar_Flag extends Button_BotBar {
   public int iCivID = 0;

   public Button_BotBar_Flag(String sText, float FONT_SCALE, int iPosX, int iPosY, int iMinWidth, boolean isClickable, boolean isVisible) {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.flag_rect)
         .draw(
            oSB,
            this.getPosX() + this.getTextPos() + iTranslateX,
            this.getPosY() - CFG.CIV_FLAG_HEIGHT + this.getHeight() / 2 - (int)(CFG.CIV_FLAG_HEIGHT * this.getImageScale() / 2.0F) + iTranslateY,
            (int)(CFG.CIV_FLAG_WIDTH * this.getImageScale()),
            (int)(CFG.CIV_FLAG_HEIGHT * this.getImageScale())
         );
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.getTextToDraw(),
         this.getPosX() + this.getTextPos() + CFG.PADDING + (int)(CFG.CIV_FLAG_WIDTH * this.getImageScale()) + iTranslateX,
   ...
   public void setText(String sText) {
      ...
      try {
         ...
         if (super.getWidth() < this.iTextWidth + CFG.PADDING * 2 + 2 + (int)(CFG.CIV_FLAG_WIDTH * this.getImageScale()) + CFG.PADDING) {
            this.setWidth(this.iTextWidth + CFG.PADDING * 2 + 2 + (int)(CFG.CIV_FLAG_WIDTH * this.getImageScale()) + CFG.PADDING);
         }
