...
public class Button_Flag extends MenuElement {
   public int iCivID;
   public Button_Flag.DrawButton drawButton;

   public Button_Flag(int nCivID, int nPosX, int nPosY, int nWidth, int nHeight, Button_Flag.ButtonFlagType buttonFlagType) {
      ...
      switch (buttonFlagType) {
         case FLAG_COLOR:
            if (this.iCivID >= 0) {
               this.drawButton = new Button_Flag.DrawButton() {
                  ...
                  public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
                     oSB.setColor(
                        new Color(
                           CFG.game.getCiv(Button_Flag.this.iCivID).getR() / 255.0F,
                           CFG.game.getCiv(Button_Flag.this.iCivID).getG() / 255.0F,
                           CFG.game.getCiv(Button_Flag.this.iCivID).getB() / 255.0F,
                           1.0F
                        )
                     );
                     ...
                     CFG.game
                        ...
                        .draw(
                           oSB,
                           Button_Flag.this.getPosX() + (int)(CFG.CIV_COLOR_WIDTH * CFG.GUI_SCALE) + CFG.PADDING * 2 + iTranslateX,
            ...
            break;
         case FLAG:
            this.drawButton = this.iCivID > 0
               ? new Button_Flag.DrawButton() {
                  @Override
                  public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
                     CFG.game
                        .getCiv(Button_Flag.this.iCivID)
