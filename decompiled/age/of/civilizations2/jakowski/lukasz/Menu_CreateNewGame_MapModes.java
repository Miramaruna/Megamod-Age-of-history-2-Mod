...
public class Menu_CreateNewGame_MapModes extends SliderMenu {
   ...
   public Menu_CreateNewGame_MapModes() {
      ...
      this.initMenu(
         ...
         Math.min(Math.min(tempElemH * 5 + tempElemH / 2, CFG.GAME_HEIGHT - CFG.BUTTON_HEIGHT), menuElements.size() * tempElemH),
         menuElements,
         false,
         true
      );
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(1).setCurrent(ViewsManager.VIEW_POPULATION_MODE);
      this.getMenuElement(2).setText(CFG.langManager.get("Economy"));
      this.getMenuElement(2).setCurrent(ViewsManager.VIEW_ECONOMY_MODE);
      ...
      this.getMenuElement(4).setText(CFG.langManager.get("GrowthRate"));
      this.getMenuElement(4).setCurrent(ViewsManager.VIEW_GROWTH_RATE_MODE);
      this.getMenuElement(5).setText(CFG.langManager.get("Development"));
      this.getMenuElement(5).setCurrent(ViewsManager.VIEW_DEVELOPMENT_MODE);
      this.getMenuElement(6).setText(CFG.langManager.get("TerrainType"));
      this.getMenuElement(6).setCurrent(ViewsManager.VIEW_TERRAIN_TYPE_MODE);
   }
