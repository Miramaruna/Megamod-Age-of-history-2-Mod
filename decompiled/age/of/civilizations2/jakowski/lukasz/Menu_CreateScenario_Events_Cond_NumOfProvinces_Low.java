...
public class Menu_CreateScenario_Events_Cond_NumOfProvinces_Low extends SliderMenu {
   public Menu_CreateScenario_Events_Cond_NumOfProvinces_Low() {
      ...
      tY = var5 + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING * 2;
      int tNum = 0;
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("NumberOfProvinces") + " < ");
      this.getTitle().setText(CFG.langManager.get("NumberOfProvinces"));
   }
