...
public class Menu_InGame_FormUnion extends SliderMenu {
   ...
   public Menu_InGame_FormUnion() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("FormUnion"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_FormUnion(int onCivID) {
      ...
      int tY = 0;
      menuElements.add(
         new Button_NS_Opinion(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), CFG.getActiveCivInfo(), Images.diplo_union, 0, 22, 2, tY, CFG.BUTTON_WIDTH * 2) {
            @Override
            public int getWidth() {
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_FormUnion.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("SendProposal"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_FormUnion.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_FormUnion.this.iOnCivID, CFG.PADDING, CFG.PADDING));
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getCiv(Menu_InGame_FormUnion.this.iOnCivID).getCivName()));
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Text("-2.2", CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
            ...
            public boolean getClickable() {
               return CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getDiplomacyPoints() >= 22;
            }
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("FormUnion"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               oSB.setColor(
                  new Color(
                     CFG.game.getCiv(Menu_InGame_FormUnion.this.iOnCivID).getR() / 255.0F,
                     CFG.game.getCiv(Menu_InGame_FormUnion.this.iOnCivID).getG() / 255.0F,
                     CFG.game.getCiv(Menu_InGame_FormUnion.this.iOnCivID).getB() / 255.0F,
                     0.165F
                  )
               );
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         DiplomacyManager.sendUnionProposal(this.iOnCivID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID());
