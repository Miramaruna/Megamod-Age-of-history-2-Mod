...
public class Button_RandomGame_Players_Localization extends Button_New_Game_Players {
   public Button_RandomGame_Players_Localization(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
