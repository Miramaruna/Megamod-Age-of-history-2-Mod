...
public class Menu_InGame_RecruitedArmy extends SliderMenu {
   ...
   public final int getRecruitedArmy(int nCivID) {
      return !CFG.SPECTATOR_MODE
         ...
         ? -1
         : CFG.game.getCiv(CFG.game.getSortedCivsAZ(nCivID - 1)).civGameData.iRecruitedArmy;
   }
   ...
   public final int getRecruitedArmy_2(int nCivID) {
      return !CFG.SPECTATOR_MODE
         ...
         ? -1
         : CFG.game.getCiv(nCivID).civGameData.iRecruitedArmy;
   }
   ...
   public Menu_InGame_RecruitedArmy(int tInit) {
      ...
      this.initMenu(
         null, CFG.GAME_WIDTH * 3 / 4 - tempWidth / 2 + CFG.PADDING * 2, tempMenuPosY, tempWidth, CFG.GAME_HEIGHT * 3 / 5, menuElements, false, false
      );
   }
   ...
   public Menu_InGame_RecruitedArmy() {
      ...
      menuElements.add(new Button_Statistics_Title(CFG.langManager.get("Civilizations"), CFG.PADDING * 2, 2, 0, CFG.BUTTON_WIDTH * 2, tElemHeight) {
         ...
         public Color getColor(boolean isActive) {
            return Menu_InGame_RecruitedArmy.iSort == 0 ? CFG.COLOR_TEXT_NUM_OF_PROVINCES : super.getColor(isActive);
         }
      ...
      menuElements.add(
         new Button_Statistics_Title(
            CFG.langManager.get("RecruitedArmy"), CFG.PADDING, CFG.PADDING * 2 + CFG.BUTTON_WIDTH * 5, 0, CFG.BUTTON_WIDTH, tElemHeight
         ) {
            @Override
            public int getPosX() {
            ...
            @Override
            public Color getColor(boolean isActive) {
               return Menu_InGame_RecruitedArmy.iSort == 1 ? CFG.COLOR_TEXT_NUM_OF_PROVINCES : super.getColor(isActive);
            }
