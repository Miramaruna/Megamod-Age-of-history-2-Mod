...
public class ColorPicker_AoC {
   public int iPosX = 150;
   public int iPosY = 150;
   public boolean visible = false;
   public int iSVHeight;
   public int iHUEWidth;
   public int iResizeHeight;
   public boolean activeHUE = false;
   public boolean activeSV = false;
   public boolean activeResize = false;
   public boolean activeMove = false;
   public boolean activeClose = false;
   public static int activeRGB = -1;
   public int iActiveColorID = -1;
   public float fAlpha = 1.0F;
   public int iStartPosX;
   public int iStartPosY;
   public int iStartResizeHeight;
   public Color colorSVPos = Color.WHITE;
   public int iLastSVPosX;
   public int iLastSVPosY;
   public int iLastHUEPosY;
   public final float RGB_TEXT_SCALE = 0.9F;
   public int iRGBTextWidth;
   public int iRTextWidth;
   public int iGTextWidth;
   public int iBTextWidth;
   public List<ColorPicker_AoC.Box> lRGBBoxes = new ArrayList<>();
   public List<ColorPicker_AoC.Box> lColorsBoxes = new ArrayList<>();
   public List<Color> lColors = new ArrayList<>();
   public ColorPicker_AoC_Action ColorPicker_AoC_Action;
   public Color hueColor = new Color(1.0F, 0.0F, 0.0F, 1.0F);
   public Color activeColor = new Color(1.0F, 0.0F, 0.0F, 1.0F);
   public float[] hsv = new float[]{0.0F, 1.0F, 1.0F};
   public float hueVal = 1.0F;

   public final void updateColorPicker_Action(ColorPicker_AoC.PickerAction nAction) {
      switch (nAction) {
            ...
            this.ColorPicker_AoC_Action = new ColorPicker_AoC_Action() {
               ...
               public void setActiveProvince_Action() {
                  CFG.menuManager
                     .getColorPicker()
                     .setActiveRGBColor(
                        CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getR(),
                        CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getG(),
                        CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getB()
                     );
         ...
         case CREATE_VASSAL_COLOR:
            this.ColorPicker_AoC_Action = new ColorPicker_AoC_Action() {
               @Override
               public void update() {
                  CFG.createVassal_Data.oColor = new Color(
                     ColorPicker_AoC.this.activeColor.r, ColorPicker_AoC.this.activeColor.g, ColorPicker_AoC.this.activeColor.b, 1.0F
                  );
               }
            ...
            this.ColorPicker_AoC_Action = new ColorPicker_AoC_Action() {
               ...
               public void update() {
                  CFG.game
                     ...
                     .setColorOfAlliance(
                        new Color_GameData(ColorPicker_AoC.this.activeColor.r, ColorPicker_AoC.this.activeColor.g, ColorPicker_AoC.this.activeColor.b)
                     );
               }

               @Override
               public void setActiveProvince_Action() {
                  if (ColorPicker_AoC.this.getVisible()
                     && CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getAllianceID() > 0
                     && CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getAllianceID()
            ...
            this.ColorPicker_AoC_Action = new ColorPicker_AoC_Action() {
               ...
               public void update() {
                  ...
                  if (CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID() > 0) {
                     CFG.editorPalletOfCivsColors_Data
                        .setCivColor(
         ...
         case COLOR_DIPLOMACY_NEGATIVE:
            this.ColorPicker_AoC_Action = new ColorPicker_AoC_Action() {
               @Override
               public void update() {
                  CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEGATIVE[CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID]
                     .setR(ColorPicker_AoC.this.activeColor.r);
                  CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEGATIVE[CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID]
                     .setG(ColorPicker_AoC.this.activeColor.g);
                  CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEGATIVE[CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID]
                     .setB(ColorPicker_AoC.this.activeColor.b);
               }
         ...
         case COLOR_DIPLOMACY_POSITIVE:
            this.ColorPicker_AoC_Action = new ColorPicker_AoC_Action() {
               @Override
               public void update() {
                  CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_POSITIVE[CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID]
                     .setR(ColorPicker_AoC.this.activeColor.r);
                  CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_POSITIVE[CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID]
                     .setG(ColorPicker_AoC.this.activeColor.g);
                  CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_POSITIVE[CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID]
         ...
         case EDITOR_TERRAIN_COLOR:
            this.ColorPicker_AoC_Action = new ColorPicker_AoC_Action() {
               @Override
               public void update() {
                  CFG.editorTerrain_Data2
                     .setColor(new Color_GameData(ColorPicker_AoC.this.activeColor.r, ColorPicker_AoC.this.activeColor.g, ColorPicker_AoC.this.activeColor.b));
               }
               ...
               public void update() {
                  CFG.editorServiceRibbon_Colors
                     .set(
                        ...
                        new Color(ColorPicker_AoC.this.activeColor.r, ColorPicker_AoC.this.activeColor.g, ColorPicker_AoC.this.activeColor.b, 1.0F)
                     );
               }
         ...
         case EDITOR_CIV_GAME_COLOR_SR:
            this.ColorPicker_AoC_Action = new ColorPicker_AoC_Action() {
               @Override
               public void update() {
                  CFG.editorCivilization_GameData
                     .sr_GameData
                     .getColor(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID)
                     .setR(ColorPicker_AoC.this.activeColor.r);
                  CFG.editorCivilization_GameData
                     .sr_GameData
                     .getColor(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID)
   ...
   public ColorPicker_AoC() {
      ...
      this.lRGBBoxes
         .add(
            new ColorPicker_AoC.Box(
               CFG.PADDING,
               ImageManager.getImage(Images.btn_close).getHeight() + ImageManager.getImage(Images.btn_close).getHeight() / 2,
               this.iRGBTextWidth + CFG.PADDING * 2,
         ...
         .add(
            new ColorPicker_AoC.Box(
               ...
               ImageManager.getImage(Images.btn_close).getHeight()
                  + ImageManager.getImage(Images.btn_close).getHeight() / 2
                  + CFG.PADDING
                  + CFG.TEXT_HEIGHT
                  + CFG.PADDING * 2,
               this.iRGBTextWidth + CFG.PADDING * 2,
      ...
      this.updateColorPicker_Action(ColorPicker_AoC.PickerAction.ACTIVE_CIVILIZATION_COLOR);
   }

   public final void buildColors() {
      this.lColorsBoxes.add(new ColorPicker_AoC.Box(0, CFG.PADDING, this.getColorBoxWidth(), CFG.TEXT_HEIGHT + CFG.PADDING * 2));
      ...
      for (int i = this.lColorsBoxes.get(0).getPosX() + this.lColorsBoxes.get(0).getWidth(); i < CFG.GAME_WIDTH; i += this.getColorBoxWidth()) {
         this.lColorsBoxes.add(new ColorPicker_AoC.Box(i, CFG.PADDING, this.getColorBoxWidth(), CFG.TEXT_HEIGHT + CFG.PADDING * 2));
   ...
   public final void draw(SpriteBatch oSB, int iTranslateX) {
      ...
      ImageManager.getImage(Images.new_game_top_edge)
         .draw2(
            oSB,
            this.iPosX - CFG.PADDING * 2 + iTranslateX,
            this.iPosY - CFG.PADDING * 2 - ImageManager.getImage(Images.new_game_top_edge).getHeight(),
            this.getWidth() + CFG.PADDING * 4 - ImageManager.getImage(Images.new_game_top_edge).getWidth(),
            this.getHeight() + CFG.PADDING * 4 - ImageManager.getImage(Images.new_game_top_edge).getHeight()
         );
      ImageManager.getImage(Images.new_game_top_edge)
         .draw2(
            oSB,
            this.iPosX + this.getWidth() + CFG.PADDING * 2 - ImageManager.getImage(Images.new_game_top_edge).getWidth() + iTranslateX,
            this.iPosY - CFG.PADDING * 2 - ImageManager.getImage(Images.new_game_top_edge).getHeight(),
      ...
      ImageManager.getImage(Images.new_game_top_edge)
         .draw2(
            oSB,
            this.iPosX - CFG.PADDING * 2 + iTranslateX,
            this.iPosY + this.getHeight() + CFG.PADDING * 2 - ImageManager.getImage(Images.new_game_top_edge).getHeight() * 2,
            this.getWidth() + CFG.PADDING * 4 - ImageManager.getImage(Images.new_game_top_edge).getWidth(),
      ...
      ImageManager.getImage(Images.new_game_top_edge)
         .draw(
            oSB,
            this.iPosX + this.getWidth() + CFG.PADDING * 2 - ImageManager.getImage(Images.new_game_top_edge).getWidth() + iTranslateX,
            this.iPosY + this.getHeight() + CFG.PADDING * 2 - ImageManager.getImage(Images.new_game_top_edge).getHeight(),
            true,
            true
         );
      ImageManager.getImage(Images.pickerHUE)
         .draw(
            oSB,
            this.iPosX + this.iSVHeight + CFG.PADDING + iTranslateX,
            this.iPosY - ImageManager.getImage(Images.pickerHUE).getHeight(),
            this.iHUEWidth,
            this.iSVHeight
         );
      oSB.setColor(Color.WHITE);
      ImageManager.getImage(Images.pix255_255_255)
         .draw(oSB, this.iPosX + iTranslateX, this.iPosY - ImageManager.getImage(Images.pix255_255_255).getHeight(), this.iSVHeight, this.iSVHeight);
      oSB.setColor(this.hueColor);
      ImageManager.getImage(Images.pickerSV)
         .draw(oSB, this.iPosX + iTranslateX, this.iPosY - ImageManager.getImage(Images.pickerSV).getHeight(), this.iSVHeight, this.iSVHeight);
      if (!this.activeResize) {
         Rectangle clipBounds = new Rectangle(this.iPosX + iTranslateX, CFG.GAME_HEIGHT - this.iPosY, this.iSVHeight, -this.iSVHeight);
         oSB.flush();
         ScissorStack.pushScissors(clipBounds);
         oSB.setColor(this.colorSVPos);
         ImageManager.getImage(Images.pickerSVPos)
            .draw(
               oSB,
               this.iPosX + this.iLastSVPosX - ImageManager.getImage(Images.pickerSVPos).getWidth() / 2 + iTranslateX,
               this.iPosY + this.iLastSVPosY - ImageManager.getImage(Images.pickerSVPos).getHeight() / 2
            );
         ...
         ImageManager.getImage(Images.pix255_255_255)
            .draw2(
               oSB,
               this.iPosX + this.iSVHeight + CFG.PADDING + CFG.PADDING + iTranslateX,
               this.iPosY + this.iLastHUEPosY - 1,
               this.iHUEWidth - CFG.PADDING * 2 + 1,
               1
            );
      } else {
         oSB.setColor(Color.WHITE);
         ImageManager.getImage(Images.pickerEdge)
            .draw(
               oSB,
               this.iPosX + this.iSVHeight - ImageManager.getImage(Images.pickerEdge).getWidth() + iTranslateX,
               this.iPosY + this.iSVHeight - ImageManager.getImage(Images.pickerEdge).getHeight() - 1
            );
      }
      ...
      this.drawRGBText(
         oSB,
         0,
         this.iPosX + this.iSVHeight + CFG.PADDING + this.iHUEWidth + this.lRGBBoxes.get(0).getPosX() + iTranslateX,
         this.iPosY + this.lRGBBoxes.get(0).getPosY(),
         this.lRGBBoxes.get(0).getWidth(),
         this.lRGBBoxes.get(0).getHeight(),
         "R",
         "" + (int)(this.activeColor.r * 255.0F),
         this.iRTextWidth
      );
      this.drawRGBText(
         oSB,
         1,
         this.iPosX + this.iSVHeight + CFG.PADDING + this.iHUEWidth + this.lRGBBoxes.get(1).getPosX() + iTranslateX,
         this.iPosY + this.lRGBBoxes.get(1).getPosY(),
         this.lRGBBoxes.get(1).getWidth(),
         this.lRGBBoxes.get(1).getHeight(),
         "G",
         "" + (int)(this.activeColor.g * 255.0F),
         this.iGTextWidth
      );
      this.drawRGBText(
         oSB,
         2,
         this.iPosX + this.iSVHeight + CFG.PADDING + this.iHUEWidth + this.lRGBBoxes.get(2).getPosX() + iTranslateX,
         this.iPosY + this.lRGBBoxes.get(2).getPosY(),
         this.lRGBBoxes.get(2).getWidth(),
         this.lRGBBoxes.get(2).getHeight(),
         "B",
         "" + (int)(this.activeColor.b * 255.0F),
         this.iBTextWidth
      );
      ...
      ImageManager.getImage(Images.gradient)
         .draw(
            oSB,
            this.iPosX + this.lColorsBoxes.get(0).getPosX() + iTranslateX,
            this.iPosY + this.iSVHeight + this.lColorsBoxes.get(0).getPosY() - ImageManager.getImage(Images.gradient).getHeight(),
            this.getWidth(),
            this.lColorsBoxes.get(this.lColorsBoxes.size() - 1).getHeight(),
            false,
            true
         );
      if (this.iActiveColorID >= 0) {
         ...
         ImageManager.getImage(Images.gradient)
            .draw(
               oSB,
               this.iPosX + this.lColorsBoxes.get(this.iActiveColorID).getPosX() + iTranslateX,
               this.iPosY + this.iSVHeight + this.lColorsBoxes.get(0).getPosY() - ImageManager.getImage(Images.gradient).getHeight(),
               this.lColorsBoxes.get(this.iActiveColorID).getWidth(),
               this.lColorsBoxes.get(this.lColorsBoxes.size() - 1).getHeight()
            );
      }
      ...
      CFG.drawRect(
         oSB,
         this.iPosX + this.lColorsBoxes.get(0).getPosX() + iTranslateX,
         this.iPosY + this.iSVHeight + this.lColorsBoxes.get(0).getPosY(),
         this.getWidth(),
         this.lColorsBoxes.get(this.lColorsBoxes.size() - 1).getHeight()
      );
      oSB.setColor(Color.WHITE);
      ImageManager.getImage(this.activeClose ? Images.btnh_close : Images.btn_close)
         .draw(oSB, this.getPosX() + this.getWidth() - ImageManager.getImage(Images.btn_close).getWidth() + iTranslateX, this.getPosY());
   }
   ...
   public final void drawRGBText(SpriteBatch oSB, int boxID, int nPosX, int nPosY, int nWidth, int nHeight, String sLeft, String sRight, int nRightWidth) {
      ...
      CFG.drawText(oSB, sRight, nPosX + nWidth - CFG.PADDING - (int)(nRightWidth * 0.9F), nPosY + nHeight / 2 - CFG.TEXT_HEIGHT / 2, CFG.COLOR_TEXT_RANK);
      ...
      for (int i = this.lColorsBoxes.size() - 1; i >= 0; i--) {
         if (this.lColorsBoxes.get(i).getVisible()) {
            ...
            ImageManager.getImage(Images.pix255_255_255)
               .draw(
                  oSB,
                  nPosX + this.lColorsBoxes.get(i).getPosX(),
                  nPosY + this.lColorsBoxes.get(i).getPosY(),
                  this.lColorsBoxes.get(i).getWidth(),
                  this.lColorsBoxes.get(i).getHeight()
               );
            oSB.setColor(new Color(0.0F, 0.0F, 0.0F, 0.75F));
            ImageManager.getImage(Images.gradient)
               .draw(
                  oSB,
                  nPosX + this.lColorsBoxes.get(i).getPosX() + this.lColorsBoxes.get(i).getWidth(),
                  nPosY + this.lColorsBoxes.get(i).getPosY() - ImageManager.getImage(Images.gradient).getHeight(),
                  1,
                  this.lColorsBoxes.get(i).getHeight()
               );
         }
   ...
   public final void touchUp() {
      if (this.activeResize) {
         this.iLastSVPosX = (int)((float)(this.iLastSVPosX * this.iSVHeight) / this.iStartResizeHeight);
         this.iLastSVPosY = (int)((float)(this.iLastSVPosY * this.iSVHeight) / this.iStartResizeHeight);
         this.iLastHUEPosY = (int)((float)(this.iLastHUEPosY * this.iSVHeight) / this.iStartResizeHeight);
      } else if (this.activeClose
         && this.iLastSVPosX >= this.getPosX() + this.getWidth() - ImageManager.getImage(Images.btn_close).getWidth()
         && this.iLastSVPosX <= this.getPosX() + this.getWidth()
         && this.iLastSVPosY >= this.iPosY
         && this.iLastSVPosY <= this.iPosY + ImageManager.getImage(Images.btn_close).getHeight()) {
      ...
      if (activeRGB >= 0) {
         ...
         CFG.showKeyboard_ColorPickerRGB(
            activeRGB == 0
               ? "R: " + (int)(this.activeColor.r * 255.0F)
               : (activeRGB == 1 ? "G: " + (int)(this.activeColor.g * 255.0F) : "B: " + (int)(this.activeColor.b * 255.0F))
         );
         activeRGB = -1;
      }
      ...
      if (this.activeHUE) {
         ...
         if (this.iActiveColorID >= 0) {
            for (int i = 0; i < this.lColorsBoxes.size(); i++) {
               if (this.lColorsBoxes.get(i).getVisible()
                  && screenX >= this.iPosX + this.lColorsBoxes.get(i).getPosX()
                  && screenX <= this.iPosX + this.lColorsBoxes.get(i).getPosX() + this.lColorsBoxes.get(i).getWidth()) {
                  this.iActiveColorID = i;
                  if ((int)(this.activeColor.r * 255.0F) != (int)(this.lColors.get(i).r * 255.0F)
                     && (int)(this.activeColor.r * 255.0F) != (int)(this.lColors.get(i).g * 255.0F)
                     && (int)(this.activeColor.r * 255.0F) != (int)(this.lColors.get(i).b * 255.0F)) {
            ...
            if (screenX >= this.iPosX + this.iSVHeight - this.iResizeHeight
               && screenX <= this.iPosX + this.iSVHeight
               && screenY >= this.iPosY + this.iSVHeight - this.iResizeHeight
               && screenY <= this.iPosY + this.iSVHeight) {
            ...
            if (screenX >= this.iPosX + this.iSVHeight + CFG.PADDING
               ...
               Keyboard.activeColor_RGB_ID = -1;
               CFG.menuManager.getKeyboard().setVisible(false);
            } else if (screenX >= this.iPosX + this.lColorsBoxes.get(0).getPosX()
               && screenX <= this.iPosX + this.getWidth()
               && screenY >= this.iPosY + this.iSVHeight + this.lColorsBoxes.get(0).getPosY()
               && screenY <= this.iPosY + this.iSVHeight + this.lColorsBoxes.get(0).getPosY() + this.lColorsBoxes.get(0).getHeight()) {
               for (int ix = 0; ix < this.lColorsBoxes.size(); ix++) {
                  if (this.lColorsBoxes.get(ix).getVisible()
                     && screenX >= this.iPosX + this.lColorsBoxes.get(ix).getPosX()
                     && screenX <= this.iPosX + this.lColorsBoxes.get(ix).getPosX() + this.lColorsBoxes.get(ix).getWidth()
                     && screenY >= this.iPosY + this.iSVHeight + this.lColorsBoxes.get(ix).getPosY()
                     && screenY <= this.iPosY + this.iSVHeight + this.lColorsBoxes.get(ix).getPosY() + this.lColorsBoxes.get(ix).getHeight()) {
                     this.iActiveColorID = ix;
                     if ((int)(this.activeColor.r * 255.0F) != (int)(this.lColors.get(ix).r * 255.0F)
                        && (int)(this.activeColor.r * 255.0F) != (int)(this.lColors.get(ix).g * 255.0F)
                        && (int)(this.activeColor.r * 255.0F) != (int)(this.lColors.get(ix).b * 255.0F)) {
                        this.RGBtoHSV((int)(this.lColors.get(ix).r * 255.0F), (int)(this.lColors.get(ix).g * 255.0F), (int)(this.lColors.get(ix).b * 255.0F));
                     }
                     break;
                  }
               }
               ...
               Keyboard.activeColor_RGB_ID = -1;
               CFG.menuManager.getKeyboard().setVisible(false);
            } else if (screenX >= this.iPosX + this.iSVHeight + CFG.PADDING + this.iHUEWidth + CFG.PADDING + this.lRGBBoxes.get(0).getPosX()
               && screenX
                  <= this.iPosX
                     + this.iSVHeight
                     + CFG.PADDING
                     + this.iHUEWidth
                     + CFG.PADDING
                     + this.lRGBBoxes.get(0).getPosX()
                     + this.lRGBBoxes.get(0).getWidth()
               && screenY >= this.iPosY + this.lRGBBoxes.get(0).getPosY()
               && screenY <= this.iPosY + this.lRGBBoxes.get(2).getPosY() + this.lRGBBoxes.get(2).getHeight()) {
               activeRGB = 0;
               this.setActiveRGB_Box(screenX, screenY);
               Keyboard.activeColor_RGB_ID = -1;
               CFG.menuManager.getKeyboard().setVisible(false);
            } else if (screenX >= this.getPosX() + this.getWidth() - ImageManager.getImage(Images.btn_close).getWidth()
               && screenX <= this.getPosX() + this.getWidth()
               && screenY >= this.iPosY
               && screenY <= this.iPosY + ImageManager.getImage(Images.btn_close).getHeight()) {
   ...
   public final void setActiveRGB_Box(int screenX, int screenY) {
      for (int i = 0; i < this.lRGBBoxes.size(); i++) {
         if (screenX >= this.iPosX + this.iSVHeight + CFG.PADDING + this.iHUEWidth + CFG.PADDING + this.lRGBBoxes.get(i).getPosX()
            && screenX
               <= this.iPosX + this.iSVHeight + CFG.PADDING + this.iHUEWidth + CFG.PADDING + this.lRGBBoxes.get(i).getPosX() + this.lRGBBoxes.get(i).getWidth()
            && screenY >= this.iPosY + this.lRGBBoxes.get(i).getPosY()
            && screenY <= this.iPosY + this.lRGBBoxes.get(i).getPosY() + this.lRGBBoxes.get(i).getHeight()) {
            activeRGB = i;
            break;
         }
      }
   ...
   public final void updateHUE(int screenY) {
      float perc = 1.0F - (float)(screenY - this.iPosY) / this.iSVHeight;
   ...
   public final void updateSV(int screenX, int screenY) {
      float sat = (float)(screenX - this.iPosX) / this.iSVHeight;
      float val = 1.0F - (float)(screenY - this.iPosY) / this.iSVHeight;
   ...
   public final void updateColorSVPos(int nPosY) {
      this.colorSVPos = this.iSVHeight * 0.1F > nPosY ? Color.BLACK : Color.WHITE;
   }
   ...
   public final void RGBtoHSV(int R, int G, int B) {
      ...
      if (x == val) {
         ...
         float f = R == (int)x ? G - B : (G == (int)x ? B - R : R - G);
         float i = R == (int)x ? 3.0F : (G == (int)x ? 5 : 1);
      ...
      this.activeColor.r = R / 255.0F;
      this.activeColor.g = G / 255.0F;
      this.activeColor.b = B / 255.0F;
      this.updateRGBWidth();
   }

   public final void HSVtoRGB(float[] hsv, Color rgbOut) {
      float h = hsv[0];
      float s = hsv[1];
      float v = hsv[2];
      float r;
   ...
   public final void setVisible(boolean visible, ColorPicker_AoC.PickerAction nAction) {
      if (nAction != null) {
   ...
   public final void setSVHeight(int iSVHeight) {
      ...
      for (int var3 = this.lColorsBoxes.size() - 1; var3 > 0; var3--) {
         if (this.lColorsBoxes.get(var3).getPosX() > this.getWidth()) {
            this.lColorsBoxes.get(var3).setVisible(false);
         } else {
            this.lColorsBoxes.get(var3).setVisible(true);
            if (this.lColorsBoxes.get(var3).getPosX() + this.lColorsBoxes.get(var3).getWidth() > this.getWidth()) {
               this.lColorsBoxes.get(var3).setWidth(this.getWidth() - this.lColorsBoxes.get(var3).getPosX());
            }
         }
      }
   }
