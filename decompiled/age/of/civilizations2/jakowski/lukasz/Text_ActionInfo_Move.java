...
public class Text_ActionInfo_Move extends Text_ActionInfo {
   public Text_ActionInfo_Move(String sText, int iPosX, int iPosY) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      CFG.game
         ...
         .draw(
            ...
            this.getPosY()
               + (int)((this.getHeight() - CFG.CIV_FLAG_HEIGHT * this.getImageScale()) / 2.0F)
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sText,
         this.getPosX() + (int)(CFG.CIV_FLAG_WIDTH * this.getImageScale()) + CFG.PADDING * 2 + var6,
   ...
   @Override
   public int getWidth() {
      return super.getWidth() + (int)(CFG.CIV_FLAG_WIDTH * this.getImageScale()) + CFG.PADDING * 2;
   }
