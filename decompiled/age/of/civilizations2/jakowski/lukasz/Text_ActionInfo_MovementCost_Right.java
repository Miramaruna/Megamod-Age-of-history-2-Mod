...
public class Text_ActionInfo_MovementCost_Right extends Text {
   public Text_ActionInfo_MovementCost_Right(String sText, int iPosX, int iPosY) {
      super(sText, CFG.PADDING, iPosX, iPosY, CFG.TEXT_HEIGHT + CFG.PADDING * 2);
      this.setWidth((int)(this.getWidth() * 0.8F) + CFG.PADDING * 3 + CFG.PADDING + ImageManager.getImage(Images.top_movement_points).getWidth());
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      ImageManager.getImage(Images.top_movement_points)
         .draw(
            oSB,
            this.getPosX() + this.getWidth() - CFG.PADDING - ImageManager.getImage(Images.top_movement_points).getWidth() + var6,
