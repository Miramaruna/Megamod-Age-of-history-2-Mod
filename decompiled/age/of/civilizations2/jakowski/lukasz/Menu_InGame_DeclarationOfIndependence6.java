...
class Menu_InGame_DeclarationOfIndependence6 extends SliderMenu {
   private int iOnCivID = -1;

   protected Menu_InGame_DeclarationOfIndependence6(int var1) {
      ...
      var2.add(
         new Button_NS_Opinion(
            ...
            final Menu_InGame_DeclarationOfIndependence6 this$0;
      ...
      var1 = 0 + ((MenuElement)var2.get(var2.size() - 1)).getHeight() + CFG.PADDING;
      var2.add(new Button_FlagActionSliderStyle(this, CFG.langManager.get("Cancel"), -1, CFG.PADDING + 2, var1, CFG.BUTTON_WIDTH, true) {
         final Menu_InGame_DeclarationOfIndependence6 this$0;
      ...
      var2.add(
         new Button_FlagActionSliderStyle(this, CFG.langManager.get("Confirm"), -1, 2, var1, CFG.BUTTON_WIDTH, true) {
            ...
            @Override
            protected void drawText(SpriteBatch var1, int var2x, int var3x, boolean var4) {
               ImageManager.getImage(Images.diplo_army)
                  .draw(
                     var1,
                     this.getPosX()
                        + this.getWidth() / 2
                        - (int)((this.getTextWidth() * 0.8F + ImageManager.getImage(Images.diplo_army).getWidth() + CFG.PADDING) / 2.0F)
                        + var2x,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.diplo_army).getHeight() / 2 + var3x
                  );
      ...
      int var4 = ImageManager.getImage(Images.top_left2).getHeight() + CFG.PADDING * 0 + CFG.BUTTON_HEIGHT * 0 / 5;
      SliderMenuTitle var5 = new SliderMenuTitle(this, CFG.langManager.get("mobilisation"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
         final Menu_InGame_DeclarationOfIndependence6 this$0;
         ...
         @Override
         protected void draw(SpriteBatch var1, int var2x, int var3x, int var4x, int var5x, boolean var6) {
      ...
      this.initMenu(var5, var6 - var7, var4, var3, var1, var2, true, true);
      this.updateLanguage();
   ...
   protected final void actionElement(int var1) {
      if (var1 == this.getMenuElementsSize() - 1) {
         int var2 = CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID();
         CFG.game_NextTurnUpdate.updateCivRecruitableArmy(var2);
         int var3 = CFG.game.getCiv(var2).lProvincesWithMoreRecruitableArmy.size();
         if (var3 > 0) {
            for (int var5 = 0; var5 < var3; var5++) {
               int var4 = CFG.game.getCiv(var2).lProvincesWithMoreRecruitableArmy.get(var5);
               if (!CFG.game.getCiv(var2).recruitArmy(var4, CFG.gameAction.getRecruitableArmy(var4, var2))) {
                  break;
               }
            }
         }
   ...
   protected void draw(SpriteBatch var1, int var2, int var3, boolean var4) {
      if (Menu_InGame_OfferAlliance.lTime + 200L >= System.currentTimeMillis()) {
         ...
         var7 = this.getPosY();
         var9 = ImageManager.getImage(Images.new_game_top_edge).getHeight();
         var8 = ImageManager.getImage(Images.new_game_top_edge).getWidth();
         var11 = this.getHeight();
         var14.draw2(var1, var10 + 2 + var12 - var6 + var2, var7 - var9 + var3, var8, CFG.PADDING + var11, true, true);
