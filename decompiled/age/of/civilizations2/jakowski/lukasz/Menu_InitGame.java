...
public class Menu_InitGame extends SliderMenu {
   ...
   public int iNumOfSteps = 33;
   public int numToLoad = 60;
   public int numToLoad2 = 120;
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      CFG.drawJakowskiGames_RIGHT_BOT(oSB, iTranslateX, (float)this.iStepID / (this.iNumOfSteps + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2));
   ...
   public final void loadAssets() {
      try {
         if (this.iStepID == 0) {
            CFG.game.initGameCustomBuildings();
            ...
            Images.slider_rect_edge = ImageManager.addImage(
               "UI/" + CFG.getRescouresPath() + "loading/slider_edge.png",
            ...
            CFG.sLoading = CFG.langManager.get("LoadingMap");
            this.iStepID++;
         } else if (this.iStepID >= 8 && this.iStepID < 8 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID())) {
            CFG.sLoading = CFG.langManager.get("LoadingMap")
               + " [#"
               + (this.iStepID - 8)
               + "/"
         ...
         } else if (this.iStepID == 8 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID())) {
            CFG.sLoading = CFG.langManager.get("LoadingProvinces");
            CFG.saveSettings_LoadingStatus();
            this.iStepID++;
         } else if (this.iStepID >= 9 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID())
            && this.iStepID < 9 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            CFG.sLoading = CFG.langManager.get("LoadingProvinces")
               + " [#"
               + (this.iStepID - (9 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID())))
               + "/"
               + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID())
               + "] - ";
            ...
            CFG.sLoading = CFG.langManager.get("LoadingGraphics");
            this.iStepID++;
         } else if (this.iStepID == 10 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            ...
            this.iStepID++;
         } else if (this.iStepID == 11 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            ...
            Images.line_32_vertical = ImageManager.addImage(
               "UI/lines/line_32_vertical.png", Pixmap.Format.RGBA8888, Texture.TextureFilter.Linear, Texture.TextureWrap.Repeat
            );
            this.iStepID++;
         } else if (this.iStepID == 12 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            Images.army_capital = ImageManager.addImage(
               "UI/icons/army/army_capital.png", Pixmap.Format.RGBA8888, Texture.TextureFilter.Nearest, Texture.TextureWrap.ClampToEdge
            );
            Images.army_capital_frame = ImageManager.addImage(
               "UI/icons/army/army_capital_frame.png", Pixmap.Format.RGBA8888, Texture.TextureFilter.Nearest, Texture.TextureWrap.ClampToEdge
            );
            ...
            this.iStepID++;
         } else if (this.iStepID == 13 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            ...
            Images.slider_gradient = ImageManager.addImage(
               "UI/" + CFG.getRescouresPath() + "slider_gradient.png", Pixmap.Format.RGBA8888, Texture.TextureFilter.Linear, Texture.TextureWrap.ClampToEdge
            );
            ...
            CFG.sLoading = CFG.langManager.get("LoadingMap");
            this.iStepID++;
         } else if (this.iStepID == 14 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            CFG.game.updateProvincesSize();
            Game_Render_Province.updateDrawProvinces();
            CFG.game.checkLandBySeaProvincesBorders();
            this.iStepID++;
         } else if (this.iStepID == 15 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            CFG.game.checkSeaBySeaProvincesBorders();
            CFG.game.buildProvinceBorder();
            CFG.sLoading = CFG.langManager.get("LoadingGameData");
            this.iStepID++;
         } else if (this.iStepID == 16 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            CFG.loadFontBorder();
            this.iStepID++;
         } else if (this.iStepID == 17 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            CFG.gameAction = new Game_Action();
            CFG.game.initGameCities();
            CFG.game.loadCities();
            this.iStepID++;
         } else if (this.iStepID == 18 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            CFG.game.loadScenario(false);
            this.iStepID++;
         } else if (this.iStepID == 19 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            CFG.game.initPlayers();
            this.iStepID++;
         } else if (this.iStepID == 20 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            CFG.game.buildDrawArmy();
            CFG.game.buildBasinsOfSeaProvinces();
            this.iStepID++;
         } else if (this.iStepID == 21 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            CFG.game.loadProvinceNames_ALL();
            CFG.game.loadRegions();
            this.iStepID++;
         } else if (this.iStepID == 22 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            ...
            CFG.sLoading = CFG.langManager.get("LoadingGraphics");
            this.iStepID++;
         } else if (this.iStepID == 23 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            ...
            this.iStepID++;
         } else if (this.iStepID == 24 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            ...
            this.iStepID++;
         } else if (this.iStepID == 25 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            ...
            Images.militaryxp = ImageManager.addImage("UI/" + CFG.getRescouresPath() + "icons/MilitaryXP.png");
            Images.b_radiation = ImageManager.addImage("UI/" + CFG.getRescouresPath() + "icons/nuclear_weapons.png");
            Images.b_shelter = ImageManager.addImage("UI/" + CFG.getRescouresPath() + "icons/bBunker.png");
            Images.nuclear_boom = ImageManager.addImage("UI/" + CFG.getRescouresPath() + "nuclearBoom.png");
            Images.nuclear_icon = ImageManager.addImage("UI/" + CFG.getRescouresPath() + "icons/nuclear_weapons.png");
            Images.resources = ImageManager.addImage("UI/" + CFG.getRescouresPath() + "icons/Resource.png");
            Images.food = ImageManager.addImage("UI/" + CFG.getRescouresPath() + "icons/b_farm.png");
            ...
            this.iStepID++;
         } else if (this.iStepID == 26 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            ...
            this.iStepID++;
         } else if (this.iStepID == 27 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            ...
            this.iStepID++;
         } else if (this.iStepID == 28 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
            Images.map_border = ImageManager.addImage(
               "UI/lines/map_border.png", Pixmap.Format.RGBA8888, Texture.TextureFilter.Nearest, Texture.TextureWrap.Repeat
            );
            ...
            this.iStepID++;
         } else if (this.iStepID == 29 + CFG.map.getMapNumOfProvinces(CFG.map.getActiveMapID()) * 2) {
   ...
   public static final void loadArmyBGImages() {
      if (Images.army_bg > 0) {
         try {
            ...
            ImageManager.getImage(Images.army_bg)
               .init(
                  new Texture(Gdx.files.internal("UI/icons/army/" + CFG.settingsManager.FONT_ARMY_SIZE + "/army.png"), Pixmap.Format.RGBA8888, true),
                  Texture.TextureFilter.Nearest,
                  Texture.TextureFilter.Nearest,
                  Texture.TextureWrap.ClampToEdge,
                  Texture.TextureWrap.ClampToEdge
            ...
            ImageManager.getImage(Images.army_bg)
               .init(
                  new Texture(Gdx.files.internal("UI/icons/army/16/army.png"), Pixmap.Format.RGBA8888, true),
                  Texture.TextureFilter.Nearest,
                  Texture.TextureFilter.Nearest,
                  Texture.TextureWrap.ClampToEdge,
                  Texture.TextureWrap.ClampToEdge
         ...
         try {
            ...
            ImageManager.getImage(Images.army_sea)
               .init(
                  new Texture(Gdx.files.internal("UI/icons/army/" + CFG.settingsManager.FONT_ARMY_SIZE + "/army_sea.png"), Pixmap.Format.RGBA8888, true),
                  Texture.TextureFilter.Nearest,
                  Texture.TextureFilter.Nearest,
                  Texture.TextureWrap.ClampToEdge,
                  Texture.TextureWrap.ClampToEdge
            ...
            ImageManager.getImage(Images.army_sea)
               .init(
                  new Texture(Gdx.files.internal("UI/icons/army/16/army_sea.png"), Pixmap.Format.RGBA8888, true),
                  Texture.TextureFilter.Nearest,
                  Texture.TextureFilter.Nearest,
                  Texture.TextureWrap.ClampToEdge,
                  Texture.TextureWrap.ClampToEdge
         ...
         try {
            ...
            ImageManager.getImage(Images.army_16_seabg)
               .init(
                  new Texture(Gdx.files.internal("UI/icons/army/" + CFG.settingsManager.FONT_ARMY_SIZE + "/army_seabg.png"), Pixmap.Format.RGBA8888, true),
                  Texture.TextureFilter.Nearest,
                  Texture.TextureFilter.Nearest,
                  Texture.TextureWrap.ClampToEdge,
                  Texture.TextureWrap.ClampToEdge
            ...
            ImageManager.getImage(Images.army_16_seabg)
               .init(
                  new Texture(Gdx.files.internal("UI/icons/army/16/army_seabg.png"), Pixmap.Format.RGBA8888, true),
                  Texture.TextureFilter.Nearest,
                  Texture.TextureFilter.Nearest,
                  Texture.TextureWrap.ClampToEdge,
                  Texture.TextureWrap.ClampToEdge
         ...
         try {
            Images.army_bg = ImageManager.addImage(
               "UI/icons/army/" + CFG.settingsManager.FONT_ARMY_SIZE + "/army.png",
               Pixmap.Format.RGBA8888,
               Texture.TextureFilter.Nearest,
               Texture.TextureWrap.ClampToEdge
            );
            ...
            Images.army_bg = ImageManager.addImage(
               "UI/icons/army/16/army.png", Pixmap.Format.RGBA8888, Texture.TextureFilter.Nearest, Texture.TextureWrap.ClampToEdge
            );
         }

         try {
            Images.army_sea = ImageManager.addImage(
               "UI/icons/army/" + CFG.settingsManager.FONT_ARMY_SIZE + "/army_sea.png",
               Pixmap.Format.RGBA8888,
               Texture.TextureFilter.Nearest,
               Texture.TextureWrap.ClampToEdge
            );
            ...
            Images.army_sea = ImageManager.addImage(
               "UI/icons/army/16/army_sea.png", Pixmap.Format.RGBA8888, Texture.TextureFilter.Nearest, Texture.TextureWrap.ClampToEdge
            );
         }

         try {
            Images.army_16_seabg = ImageManager.addImage(
               "UI/icons/army/" + CFG.settingsManager.FONT_ARMY_SIZE + "/army_seabg.png",
               Pixmap.Format.RGBA8888,
               Texture.TextureFilter.Nearest,
               Texture.TextureWrap.ClampToEdge
            );
            ...
            Images.army_16_seabg = ImageManager.addImage(
               "UI/icons/army/16/army_seabg.png", Pixmap.Format.RGBA8888, Texture.TextureFilter.Nearest, Texture.TextureWrap.ClampToEdge
            );
         }
      }
   }
