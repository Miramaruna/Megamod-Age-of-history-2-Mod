...
public class Menu_CreateScenario_Events_Out_UpdatePopulation extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(3).setText(CFG.langManager.get("Population") + ": ");
      this.getTitle().setText(CFG.langManager.get("UpdatePopulation"));
   }
