...
class Menu_InGame_Politics$38 extends SliderMenuTitle {
   Menu_InGame_Politics$38(Menu_InGame_Politics this$0, String sText, int iHeight, boolean moveable, boolean resizable) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
      ...
      CFG.fontMain.getData().setScale(1.05F);
   }
}
