...
public class Text_Outliner_DiploInfo_Union extends Text {
   public static final float FONT_SCALE = 0.7F;
   public boolean row = false;
   public int iCivLeft;
   public int iTurnID;

   public Text_Outliner_DiploInfo_Union(int iCivLeft, int iTurnID, int iPosX, int iPosY, int nWidth) {
      super(CFG.langManager.get("Union"), CFG.PADDING * 2, iPosX, iPosY, nWidth, CFG.CIV_FLAG_HEIGHT + CFG.PADDING * 2);
   ...
   public void buildElementHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Union"), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
   ...
   public void actionElement(int iID) {
      CFG.toast
         .setInView(this.iCivLeft >= 0 ? CFG.game.getCiv(this.iCivLeft).getCivName() : CFG.langManager.get("Undiscovered"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
   }
