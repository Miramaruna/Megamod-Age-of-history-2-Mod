...
public class Menu_InGame_Message_PrepareForWar extends SliderMenu {
   ...
   public Menu_InGame_Message_PrepareForWar() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("PrepareForWar"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Message_PrepareForWar(int onCivID, int iMessageID, int warAgainstCivID, int numOfTurns) {
      ...
      int tY = 0;
      menuElements.add(
         new Button_PrepareForWar(CFG.langManager.get("PrepareForTheWarAgainst") + ": ", onCivID, warAgainstCivID, numOfTurns, 0, tY, CFG.BUTTON_WIDTH * 2) {
            @Override
            public int getWidth() {
      ...
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      int var10;
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Deny"), -1, 2 + CFG.PADDING, var10 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Confirm"), -1, 2, var10, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getPosX() {
         ...
         new SliderMenuTitle(CFG.langManager.get("PrepareForWar"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.diplo_message)
                  .draw(
                     oSB,
                     Menu_InGame_Message_PrepareForWar.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Message_PrepareForWar.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2
                  );
