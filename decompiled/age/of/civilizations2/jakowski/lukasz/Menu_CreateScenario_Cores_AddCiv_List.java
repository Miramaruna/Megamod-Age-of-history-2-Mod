...
public class Menu_CreateScenario_Cores_AddCiv_List extends SliderMenu {
         ...
         for (int tID = 0; lTempNames.size() > 0; nPosY++) {
            ...
            menuElements.add(
               new Button_Menu(
                  ...
                  0,
                  CFG.BUTTON_HEIGHT * (nPosY + 1) + CFG.PADDING * (nPosY + 3),
                     ...
                     try {
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              CFG.getWikiInormationsLink_Clear(Menu_CreateScenario_Cores_AddCiv_List.this.lCivsTags.get(this.getTextPos())),
