...
public class Menu_CreateScenario_Events_List extends SliderMenu {
   public Menu_CreateScenario_Events_List() {
      ...
      menuElements.add(
         new Button_NewGameStyle(CFG.langManager.get("AddNewEvent"), -1, CFG.PADDING, tPosY, tempW - CFG.PADDING * 2, (int)(CFG.BUTTON_HEIGHT * 0.6F), true)
      );
         ...
         menuElements.add(
            new Button_New_Game_Players_CivID_LEFT(
               ...
               public void buildElementHover() {
                  ...
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Text(CFG.eventsManager.getEvent(this.getCurrent()).getEventName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE)
                  );
                  ...
                  try {
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.game.getCiv(CFG.eventsManager.getEvent(this.getCurrent()).getCivID()).getCivName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
         ...
         new SliderMenuTitle(null, CFG.BUTTON_HEIGHT * 3 / 5, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.time)
                  .draw(
                     oSB,
                     nPosX + (int)(nWidth - this.getTextWidth() * 0.8F) / 2 - CFG.PADDING - ImageManager.getImage(Images.time).getWidth() + iTranslateX,
                     2 + nPosY - this.getHeight() + this.getHeight() / 2 - ImageManager.getImage(Images.time).getHeight() / 2
                  );
