...
public class Menu_CreateScenario_Events_Cond_NumOfUnits_Low extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("NumberOfUnits") + " < ");
      this.getTitle().setText(CFG.langManager.get("NumberOfUnits"));
   }
