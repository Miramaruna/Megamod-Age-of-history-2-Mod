...
public class Button_New_Game_Players_CivID extends Button_New_Game_Players {
   public int iCivID;

   public Button_New_Game_Players_CivID(int nCivID, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
