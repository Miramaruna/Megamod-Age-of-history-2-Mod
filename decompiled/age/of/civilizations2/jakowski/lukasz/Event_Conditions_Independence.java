...
public class Event_Conditions_Independence extends Event_Conditions {
   public int iCivID = -1;
   public int iCivID2 = -1;

   Event_Conditions_Independence() {
   }
   ...
   public boolean outCondition() {
      try {
         return CFG.game.getGuarantee(this.getCivID(), this.getCivID2()) > 0;
