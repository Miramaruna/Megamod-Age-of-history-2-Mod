...
public class Menu_InGame_SendInsult extends SliderMenu {
   ...
   public Menu_InGame_SendInsult() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("SendAnInsult"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_SendInsult(int onCivID) {
      ...
      menuElements.add(
         new Button_NS_Opinion(
            CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), CFG.getActiveCivInfo(), Images.diplo_relations_dec, 0, 2, 2, tY, CFG.BUTTON_WIDTH * 2
         ) {
            @Override
            public int getWidth() {
      ...
      menuElements.add(
         new Slider_FlagAction_Date(
            CFG.langManager.get("SuspendDiplomaticRelations"),
            CFG.PADDING * 2,
            menuElements.get(menuElements.size() - 1).getPosY() + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING,
            ...
            @Override
            public int getWidth() {
               return Menu_InGame_SendInsult.this.getElementW() * 2 - CFG.PADDING * 4;
            }
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var8 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_SendInsult.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("SendAnInsult"), -1, 2, var8, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_SendInsult.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("SendAnInsult") + ":", CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_SendInsult.this.iOnCivID, CFG.PADDING, CFG.PADDING));
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getCiv(Menu_InGame_SendInsult.this.iOnCivID).getCivName()));
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("SendAnInsult"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               oSB.setColor(
                  new Color(
                     CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEGATIVE[CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEGATIVE.length - 1].getR(),
                     CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEGATIVE[CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEGATIVE.length - 1].getG(),
                     CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEGATIVE[CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEGATIVE.length - 1].getB(),
                     0.165F
                  )
               );
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         DiplomacyManager.decreaseRelation(
            CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.iOnCivID, this.getMenuElement(this.getMenuElementsSize() - 3).getCurrent()
         );
