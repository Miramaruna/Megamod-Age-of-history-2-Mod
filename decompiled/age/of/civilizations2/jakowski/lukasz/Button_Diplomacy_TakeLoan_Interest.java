...
public class Button_Diplomacy_TakeLoan_Interest extends Button_Statistics {
   public static final float FONT_SCALE = 0.7F;
   public static final float FONT_SCALE2 = 0.6F;
   public String sInterest;
   public int iInterestWidth = 0;
   public String sInterestGold;
   public int iInterestGoldWidth = 0;
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sInterest,
         this.getPosX() + Button_Diplomacy.iDiploWidth + CFG.PADDING + (int)(this.getTextWidth() * 0.7F) + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(CFG.TEXT_HEIGHT * 0.7F / 2.0F) + iTranslateY,
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sInterestGold,
         this.getPosX() + Button_Diplomacy.iDiploWidth + CFG.PADDING + (int)(this.getTextWidth() * 0.7F) + this.iInterestWidth + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(CFG.TEXT_HEIGHT * 0.7F / 2.0F) + iTranslateY,
      ...
      CFG.drawTextWithShadow(
         ...
         CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints() >= 6 ? CFG.COLOR_INGAME_MOVEMENT : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2
      );
   ...
   public void setCurrent(int nCurrent) {
      this.sInterest = "" + nCurrent / 100.0F + "% ";
