...
public class Button_Diplomacy_ChangeReligion extends Button_Statistics {
   ...
   public Button_Diplomacy_ChangeReligion(int i, int iCivA, int nIdeologyID, int iPosX, int iPosY, int iWidth) {
      super(
      ...
      return this.checkbox
         ? new Button.Checkbox() {
            ...
            public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
               if (Button_Diplomacy_ChangeReligion.this.getCheckboxState()) {
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Button_Diplomacy_ChangeReligion.this.getPosX() + iTranslateX,
                     Button_Diplomacy_ChangeReligion.this.getPosY() - ImageManager.getImage(Images.line_32_off1).getHeight() + 1 + iTranslateY,
                     Button_Diplomacy_ChangeReligion.this.getWidth(),
                     Button_Diplomacy_ChangeReligion.this.getHeight() - 2,
                     true,
                     false
                  );
               oSB.setColor(new Color(0.0F, 0.0F, 0.0F, 0.3F));
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Button_Diplomacy_ChangeReligion.this.getPosX() + iTranslateX,
                     Button_Diplomacy_ChangeReligion.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() + 1 + iTranslateY,
                     Button_Diplomacy_ChangeReligion.this.getWidth(),
                     Button_Diplomacy_ChangeReligion.this.getHeight() / 4,
                     false,
                     false
                  );
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Button_Diplomacy_ChangeReligion.this.getPosX() + iTranslateX,
                     Button_Diplomacy_ChangeReligion.this.getPosY()
                        - ImageManager.getImage(Images.gradient).getHeight()
                        + Button_Diplomacy_ChangeReligion.this.getHeight()
                        - 1
                        + iTranslateY
                        - Button_Diplomacy_ChangeReligion.this.getHeight() / 4,
                     Button_Diplomacy_ChangeReligion.this.getWidth(),
