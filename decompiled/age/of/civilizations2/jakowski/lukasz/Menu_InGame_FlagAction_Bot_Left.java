...
public class Menu_InGame_FlagAction_Bot_Left extends SliderMenu {
   public Menu_InGame_FlagAction_Bot_Left() {
      ...
      if (CFG.isAndroid() && !CFG.LANDSCAPE) {
         ...
         tempHeight = ImageManager.getImage(Images.top_left).getHeight()
            + CFG.PADDING * 2
      ...
      menuElements.add(
         new Text_Economy_Value(
            ...
            CFG.PADDING * 2,
            var10 = tY + menuElements.get(menuElements.size() - 1).getPosY() + menuElements.get(menuElements.size() - 1).getHeight(),
      ...
      menuElements.add(
         new Text_Economy_Value(
            ...
            CFG.PADDING * 2,
            tY = var10 + menuElements.get(menuElements.size() - 1).getHeight(),
            (tempWidth - CFG.PADDING * 4) / 2,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2
         ) {
            @Override
      ...
      menuElements.add(
         new Text_Economy_Value(
            ...
            CFG.PADDING * 2 + (tempWidth - CFG.PADDING * 4) / 2,
            tY = var16 + menuElements.get(menuElements.size() - 1).getHeight(),
            (tempWidth - CFG.PADDING * 4) / 2,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2
         ) {
            @Override
      ...
      menuElements.add(
         new Text_Economy_Total(
            ...
            CFG.PADDING * 2 + (tempWidth - CFG.PADDING * 4) / 2,
            var18 = tY + menuElements.get(menuElements.size() - 1).getHeight(),
            (tempWidth - CFG.PADDING * 4) / 2,
            CFG.TEXT_HEIGHT + CFG.PADDING * 3
         )
      );
      ...
      menuElements.add(
         new Text_Economy_Balance(
            ...
            CFG.PADDING * 2,
            tY = var18 + menuElements.get(menuElements.size() - 1).getHeight(),
      ...
      menuElements.add(
         new Text_BudgetTitle(
            ...
            -1,
            2,
            tY = var21 + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING * 2,
            tempWidth - 2,
            CFG.TEXT_HEIGHT + CFG.PADDING * 4
         ) {
            @Override
      ...
      menuElements.add(
         new Slider_FlagAction_Goods(
            ...
            CFG.PADDING * 3,
            var23 = tY + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING,
            tempWidth - CFG.PADDING * 6,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5,
            0,
            100,
      ...
      menuElements.add(
         new Slider_FlagAction(
            ...
            CFG.PADDING * 3,
            var25 = tY + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING * 2,
            tempWidth - CFG.PADDING * 6,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5,
            0,
            100,
      ...
      menuElements.add(
         new Text_Economy_SliderDesc_Research(
            ...
            CFG.langManager.get("TechnologyLevel")
               ...
               + (int)(CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getTechnologyLevel() * 100.0F) / 100.0F,
            CFG.PADDING * 3,
            tY = var25 + menuElements.get(menuElements.size() - 1).getHeight(),
            tempWidth - CFG.PADDING * 6,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2
         ) {
            @Override
      ...
      menuElements.add(
         new Slider_FlagAction_Investments(
            ...
            CFG.PADDING * 3,
            var27 = tY + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING * 2,
            tempWidth - CFG.PADDING * 6,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5,
            0,
            100,
      ...
      menuElements.add(
         new Text_Investemnts_SliderDesc(
            ...
            CFG.langManager.get("Economy")
               ...
               + CFG.getNumberWithSpaces("" + CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).countEconomy()),
            CFG.PADDING * 3,
            tY = var27 + menuElements.get(menuElements.size() - 1).getHeight(),
            tempWidth - CFG.PADDING * 6,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2
         ) {
            @Override
      ...
      menuElements.add(
         new Slider_FlagAction_Military(
            CFG.langManager.get("Military"),
            CFG.PADDING * 3,
            var29 = tY + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING * 2,
            tempWidth - CFG.PADDING * 6,
      ...
      tY = var29 + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING * 2;
      menuElements.add(
         new Button_Transparent(
            0,
            0,
            tempWidth,
            tempHeight - CFG.PADDING < menuElements.get(menuElements.size() - 1).getPosY() + menuElements.get(menuElements.size() - 1).getHeight()
               ? menuElements.get(menuElements.size() - 1).getPosY() + menuElements.get(menuElements.size() - 1).getHeight()
               : tempHeight - CFG.PADDING,
            true
         )
      );
      this.initMenu(
   ...
   public final void updateIncomeAndExpenses() {
      int tempBalance = 0;
      int tempValue = CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).iIncomeTaxation;
   ...
   public final void updateResearchAndIvestments() {
