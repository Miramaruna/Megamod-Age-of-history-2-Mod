...
public class EventsManager {
   public Events_GameData eventsGD = new Events_GameData();
   public Event_GameData lCreateScenario_Event = new Event_GameData();
   ...
   public int iCreateEvent_EditEventID = 0;
   public int iCreateEvent_EditTriggerID = 0;
   public int iCreateEvent_EditConditionID = 0;
   ...
   public final void checkEvents() {
      try {
         ...
         for (int i = 0; i < this.eventsGD.iEventsSize; i++) {
            Gdx.app
               .log("AoC", "checkEvents: name: " + this.eventsGD.lEvents.get(i).getEventName() + ", wasFired:" + this.eventsGD.lEvents.get(i).getWasFired());
            if (!this.eventsGD.lEvents.get(i).getWasFired()) {
               Gdx.app.log("AoC", "checkEvents: name: " + this.eventsGD.lEvents.get(i).getEventName() + " 000");
               Gdx.app
                  .log(
                     "AoC",
                     "checkEvents: name: "
                        + this.eventsGD.lEvents.get(i).getEventName()
                        + " EventcurrYear: "
                        + this.eventsGD.lEvents.get(i).getEventDate_Since().iEventYear
                  );
               Gdx.app
                  .log(
                     "AoC",
                     "checkEvents: name: "
                        + this.eventsGD.lEvents.get(i).getEventName()
                        + " iEventMonth: "
                        + this.eventsGD.lEvents.get(i).getEventDate_Since().iEventMonth
                  );
               Gdx.app
                  .log(
                     "AoC",
                     "checkEvents: name: "
                        + this.eventsGD.lEvents.get(i).getEventName()
                        + " iEventDay: "
                        + this.eventsGD.lEvents.get(i).getEventDate_Since().iEventDay
                  );
               if (this.eventsGD.lEvents.get(i).getEventDate_Since().iEventYear < Game_Calendar.currentYear
                  || this.eventsGD.lEvents.get(i).getEventDate_Since().iEventYear == Game_Calendar.currentYear
                     && this.eventsGD.lEvents.get(i).getEventDate_Since().iEventMonth < Game_Calendar.currentMonth
                  || this.eventsGD.lEvents.get(i).getEventDate_Since().iEventYear == Game_Calendar.currentYear
                     && this.eventsGD.lEvents.get(i).getEventDate_Since().iEventMonth == Game_Calendar.currentMonth
                     && this.eventsGD.lEvents.get(i).getEventDate_Since().iEventDay <= Game_Calendar.currentDay) {
                  Gdx.app.log("AoC", "checkEvents: name: " + this.eventsGD.lEvents.get(i).getEventName() + " 111");
                  if (!this.eventsGD.lEvents.get(i).getWasTriedToRunOnce()) {
                     Gdx.app.log("AoC", "checkEvents: name: " + this.eventsGD.lEvents.get(i).getEventName() + " 222");
                     this.eventsGD.lEvents.get(i).setWasTriedToRunOnce(true);
                     this.checkCondtsitionsAndTryRun(i);
                  } else {
                     Gdx.app.log("AoC", "checkEvents: name: " + this.eventsGD.lEvents.get(i).getEventName() + " 333");
                     if (this.eventsGD.lEvents.get(i).getEventDate_Until().iEventYear == 9999999
                        || this.eventsGD.lEvents.get(i).getEventDate_Until().iEventYear > Game_Calendar.currentYear
                        || this.eventsGD.lEvents.get(i).getEventDate_Until().iEventYear == Game_Calendar.currentYear
                           && this.eventsGD.lEvents.get(i).getEventDate_Until().iEventMonth > Game_Calendar.currentMonth
                        || this.eventsGD.lEvents.get(i).getEventDate_Until().iEventYear == Game_Calendar.currentYear
                           && this.eventsGD.lEvents.get(i).getEventDate_Until().iEventMonth == Game_Calendar.currentMonth
                           && this.eventsGD.lEvents.get(i).getEventDate_Until().iEventDay >= Game_Calendar.currentDay) {
                        Gdx.app.log("AoC", "checkEvents: name: " + this.eventsGD.lEvents.get(i).getEventName() + " 444");
                        this.checkCondtsitionsAndTryRun(i);
                     }
                  }
               } else {
                  Gdx.app.log("AoC", "checkEvents: name: " + this.eventsGD.lEvents.get(i).getEventName() + " END");
               }
            }
         }
   ...
   public final void checkCondtsitionsAndTryRun(int i) {
      boolean canRunEvent = false;
      Gdx.app.log("AoC", "checkCondtsitionsAndTryRun: name: " + this.eventsGD.lEvents.get(i).getEventName() + " 000");

      for (int j = 0; j < this.eventsGD.lEvents.get(i).lTriggers.size(); j++) {
         if (this.eventsGD.lEvents.get(i).lTriggers.get(j).triggerType == Event_Type.OR && this.eventsGD.lEvents.get(i).lTriggers.get(j).getTriggerOut()) {
            canRunEvent = true;
            break;
         }
      }

      Gdx.app.log("AoC", "checkCondtsitionsAndTryRun: name: " + this.eventsGD.lEvents.get(i).getEventName() + " canRunEvent1: " + canRunEvent);
      if (!canRunEvent) {
         canRunEvent = true;
         boolean checked = false;

         for (int jx = 0; jx < this.eventsGD.lEvents.get(i).lTriggers.size(); jx++) {
            if (this.eventsGD.lEvents.get(i).lTriggers.get(jx).triggerType != Event_Type.OR) {
               if (this.eventsGD.lEvents.get(i).lTriggers.get(jx).triggerType == Event_Type.AND) {
                  if (!this.eventsGD.lEvents.get(i).lTriggers.get(jx).getTriggerOut()) {
                     canRunEvent = false;
                     break;
                  }

                  checked = true;
               } else if (this.eventsGD.lEvents.get(i).lTriggers.get(jx).triggerType == Event_Type.NOT) {
                  if (this.eventsGD.lEvents.get(i).lTriggers.get(jx).getTriggerOut()) {
                     canRunEvent = false;
                     break;
                  }
         ...
         Gdx.app.log("AoC", "checkCondtsitionsAndTryRun: name: " + this.eventsGD.lEvents.get(i).getEventName() + " canRunEvent1.5: " + canRunEvent);
         Gdx.app.log("AoC", "checkCondtsitionsAndTryRun: name: " + this.eventsGD.lEvents.get(i).getEventName() + " checked: " + checked);
         if (!checked) {
            canRunEvent = false;
         }
      }

      Gdx.app.log("AoC", "checkCondtsitionsAndTryRun: name: " + this.eventsGD.lEvents.get(i).getEventName() + " canRunEvent2: " + canRunEvent);
      if (canRunEvent) {
         this.tryRunEvent(i);
      }
   }

   public final void tryRunEvent(int i) {
      if (this.eventsGD.lEvents.get(i).getCivID() > 0) {
         ...
         try {
            for (int j = 0; j < CFG.game.getCivsSizeREAL(); j++) {
   ...
   public final void runEvent_Tag(String nTag) {
      int tID = -1;
      ...
      if (tID >= 0) {
         CFG.game.getCiv(this.eventsGD.lEvents.get(tID).getCivID()).addEventToRunID(tID);
         this.eventsGD.lEvents.get(tID).setWasFired(!this.eventsGD.lEvents.get(tID).getRepeatable());
      }
   }
   ...
   public final void updateEventsAferRemoveCiv(int nRemovedCivID) {
      for (int i = 0; i < this.eventsGD.iEventsSize; i++) {
         if (this.eventsGD.lEvents.get(i).getCivID() == nRemovedCivID) {
            this.removeEvent(i--);
         } else {
            if (this.eventsGD.lEvents.get(i).getCivID() > nRemovedCivID) {
               this.eventsGD.lEvents.get(i).setCivID(this.eventsGD.lEvents.get(i).getCivID() - 1);
            }

            for (int j = 0; j < this.eventsGD.lEvents.get(i).lTriggers.size(); j++) {
               for (int k = 0; k < this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.size(); k++) {
                  this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.get(k).updateCivIDAfterRemove(nRemovedCivID);
               }
            }

            for (int var6 = 0; var6 < this.eventsGD.lEvents.get(i).lDecisions.size(); var6++) {
               for (int k = 0; k < this.eventsGD.lEvents.get(i).lDecisions.get(var6).lOutcomes.size(); k++) {
                  this.eventsGD.lEvents.get(i).lDecisions.get(var6).lOutcomes.get(k).updateCivIDAfterRemove(nRemovedCivID);
               }
            }
         }
      }
   ...
   public final void swapIDsOfCivs(int nID_A, int nID_B) {
      for (int i = 0; i < this.eventsGD.iEventsSize; i++) {
         if (this.eventsGD.lEvents.get(i).getCivID() == nID_A) {
            this.eventsGD.lEvents.get(i).setCivID(nID_B);
         } else if (this.eventsGD.lEvents.get(i).getCivID() == nID_B) {
            this.eventsGD.lEvents.get(i).setCivID(nID_A);
         }

         for (int j = 0; j < this.eventsGD.lEvents.get(i).lTriggers.size(); j++) {
            for (int k = 0; k < this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.size(); k++) {
               if (this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.get(k).getCivID() == nID_A) {
                  this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.get(k).setCivID(nID_B);
               } else if (this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.get(k).getCivID() == nID_B) {
                  this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.get(k).setCivID(nID_A);
               }

               if (this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.get(k).getCivID2() == nID_A) {
                  this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.get(k).setCivID2(nID_B);
               } else if (this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.get(k).getCivID2() == nID_B) {
                  this.eventsGD.lEvents.get(i).lTriggers.get(j).lConditions.get(k).setCivID2(nID_A);
               }
            }
         }

         for (int var7 = 0; var7 < this.eventsGD.lEvents.get(i).lDecisions.size(); var7++) {
            for (int k = 0; k < this.eventsGD.lEvents.get(i).lDecisions.get(var7).lOutcomes.size(); k++) {
               if (this.eventsGD.lEvents.get(i).lDecisions.get(var7).lOutcomes.get(k).getCivID() == nID_A) {
                  this.eventsGD.lEvents.get(i).lDecisions.get(var7).lOutcomes.get(k).setCivID(nID_B);
               } else if (this.eventsGD.lEvents.get(i).lDecisions.get(var7).lOutcomes.get(k).getCivID() == nID_B) {
                  this.eventsGD.lEvents.get(i).lDecisions.get(var7).lOutcomes.get(k).setCivID(nID_A);
               }

               if (this.eventsGD.lEvents.get(i).lDecisions.get(var7).lOutcomes.get(k).getCivID2() == nID_A) {
                  this.eventsGD.lEvents.get(i).lDecisions.get(var7).lOutcomes.get(k).setCivID2(nID_B);
               } else if (this.eventsGD.lEvents.get(i).lDecisions.get(var7).lOutcomes.get(k).getCivID2() == nID_B) {
                  this.eventsGD.lEvents.get(i).lDecisions.get(var7).lOutcomes.get(k).setCivID2(nID_A);
               }
            }
         }
      }
         ...
         for (int j = i + 1; j < this.getEventsSize(); j++) {
            if (this.getEvent(i).getEventDate_Since().iEventYear > this.getEvent(j).getEventDate_Since().iEventYear) {
               ...
               if (this.getEvent(i).getEventDate_Since().iEventMonth > this.getEvent(j).getEventDate_Since().iEventMonth) {
                  ...
                  this.setEvent(i, this.getEvent(j));
                  this.setEvent(j, tempD);
               } else if (this.getEvent(i).getEventDate_Since().iEventMonth == this.getEvent(j).getEventDate_Since().iEventMonth
                  && this.getEvent(i).getEventDate_Since().iEventDay > this.getEvent(j).getEventDate_Since().iEventDay) {
                  Event_GameData tempD = this.getEvent(i);
                  this.setEvent(i, this.getEvent(j));
                  this.setEvent(j, tempD);
               }
   ...
   public final void selectCivAction(int nCivID) {
      switch (this.eSelectCivAction) {
         ...
         case SELECT_CIV_CONTROLLEDBYPLAYER:
            this.lCreateScenario_Event.getTrigger(this.iCreateEvent_EditTriggerID).lConditions.get(this.iCreateEvent_EditConditionID).setCivID(nCivID);
            break;
         ...
         case SELECT_CIV_ISVASSALOFCIV2:
            this.lCreateScenario_Event.getTrigger(this.iCreateEvent_EditTriggerID).lConditions.get(this.iCreateEvent_EditConditionID).setCivID2(nCivID);
            break;
         ...
         case SELECT_PROVINCES_PORT:
            this.lCreateScenario_Event
               .getTrigger(this.iCreateEvent_EditTriggerID)
               .lConditions
               .get(this.iCreateEvent_EditConditionID)
               .setProvinces(CFG.game.getSelectedProvinces().getProvinces());
            break;
         case OUT_SELECTIDEOLOGY_COND_IDEOLOGY:
            this.lCreateScenario_Event.getTrigger(this.iCreateEvent_EditTriggerID).lConditions.get(this.iCreateEvent_EditConditionID).setValue(nCivID);
            break;
         case OUT_SELECTCIV:
         ...
         case OUT_SELECTPROVICNES_MOVECAPITAL:
            if (CFG.game.getSelectedProvinces().getProvinces().size() > 0) {
               CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
                  .lOutcomes
                  .get(CFG.eventsManager.iCreateEvent_EditConditionID)
                  .setValue(CFG.game.getSelectedProvinces().getProvinces().get(0));
            } else {
               CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
                  .lOutcomes
                  .get(CFG.eventsManager.iCreateEvent_EditConditionID)
   ...
   public final Event_GameData getEvent(int i) {
      return this.eventsGD.lEvents.get(i);
   }
