...
public class Message_Gift_Refused extends Message {
   public Message_Gift_Refused(int fromCivID, int iValue) {
      super(fromCivID, iValue);
      this.messageType = Message_Type.GIFT_ACCEPTED;
   ...
   public void onAccept(int iCivID) {
      if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID() == iCivID) {
         ...
         lMess.add(CFG.langManager.get("XRefusedToAcceptOurGift", CFG.game.getCiv(this.iFromCivID).getCivName()));
   ...
   public MenuElement_Hover_v2 getHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("GiftSentBack"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(
            CFG.langManager.get("XRefusedToAcceptOurGift", CFG.game.getCiv(this.iFromCivID).getCivName()), CFG.COLOR_TEXT_MODIFIER_NEGATIVE2
         )
      );
      nElements.add(new MenuElement_Hover_v2_Element2(nData));
      nData.clear();
