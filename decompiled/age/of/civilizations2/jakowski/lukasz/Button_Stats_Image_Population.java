...
public class Button_Stats_Image_Population extends Button_Stats {
   public static final int NUM_OF_FLAGS = 2;
   public int iProvinceID = 0;
   public List<Integer> lSorted = new ArrayList<>();

   public Button_Stats_Image_Population(
                  ...
                  CFG.game
                     ...
                     .draw(
                        ...
                        this.getPosX()
                           ...
                           + this.getTextWidth()
                           + CFG.PADDING * (i + 1)
                           + (int)(CFG.CIV_FLAG_WIDTH * this.getImageScale()) * i,
                        this.getPosY()
      ...
      try {
         ...
         if (super.getWidth()
            < this.iTextWidth
               + CFG.PADDING * 2
               + ImageManager.getImage(Images.economy).getWidth()
               + (int)(CFG.CIV_FLAG_WIDTH * this.getImageScale() + CFG.PADDING) * Math.min(this.lSorted.size(), 2)) {
            this.setWidth(
               this.iTextWidth
                  + CFG.PADDING * 2
                  + ImageManager.getImage(Images.economy).getWidth()
