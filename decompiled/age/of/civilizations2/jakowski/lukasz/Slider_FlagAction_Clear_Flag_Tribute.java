...
public class Slider_FlagAction_Clear_Flag_Tribute extends Slider {
   public int iCivID;
   public static final Color bgColor = new Color(0.0F, 0.0F, 0.0F, 0.3F);
   public String sTributePaid = "";
   public int iTributeWidth = 0;
   public Color oColorTribute = CFG.COLOR_INGAME_GOLD;
   public int iCivNameWidth = 0;

   public Slider_FlagAction_Clear_Flag_Tribute(int iCivID, String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
   ...
   public Color getColorLEFT() {
      try {
         return new Color(
            CFG.game.getCiv(this.iCivID).getR() / 255.0F, CFG.game.getCiv(this.iCivID).getG() / 255.0F, CFG.game.getCiv(this.iCivID).getB() / 255.0F, 0.525F
         );
   ...
   public void setCurrent(int nCurrent) {
      ...
      this.sTributePaid = tempTribute > -1000000000 ? "+" + CFG.getNumberWithSpaces("" + tempTribute) : "0";
      this.oColorTribute = tempTribute > -100 ? CFG.COLOR_INGAME_GOLD : CFG.COLOR_TEXT_MODIFIER_NEUTRAL2;
