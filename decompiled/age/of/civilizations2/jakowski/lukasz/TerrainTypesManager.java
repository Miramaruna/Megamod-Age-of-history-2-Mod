...
public class TerrainTypesManager {
   ...
   public List<String> lTerrainTags;
   public List<Color> lColors;
   public List<Image> lTerrainIcons;
   public List<Float> lDefense;
   public List<Float> lMilitaryUpkeep;
   public List<Float> lPopulationGrowth;
   public List<Float> lEconomyGrowth;
   public List<Float> lBuildCost;
   public List<Float> lMovementCost;
   public List<Float> lBaseDevelopment;
   public List<Integer> lBaseProvinceValue;
   public int iTerrainTypesSize;
