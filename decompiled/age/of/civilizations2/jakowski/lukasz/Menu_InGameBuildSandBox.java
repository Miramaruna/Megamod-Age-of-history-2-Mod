...
public class Menu_InGameBuildSandBox extends SliderMenu {
   public int iOnCivID = -1;

   public Menu_InGameBuildSandBox(int onCivID) {
      ...
      menuElements.add(
         new Button_Build_Building_Destroy(
            ...
            CFG.langManager.get("BuildAll") + ": " + CFG.game.getCiv(this.iOnCivID).getCivName(),
            Images.b_workshop,
            0,
            tY,
            CFG.BUTTON_WIDTH * 2,
            ...
            @Override
            public int getWidth() {
               return Menu_InGameBuildSandBox.this.getElementW() * 2;
            }
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGameBuildSandBox.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Build"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGameBuildSandBox.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Построй всё") + "!", CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("BuildAll"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            @Override
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGameBuildSandBox.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGameBuildSandBox.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGameBuildSandBox.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGameBuildSandBox.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
   ...
   public final void actionElement(int iID) {
      if (iID != this.getMenuElementsSize() - 1) {
         ...
         CFG.game.getProvince(this.iOnCivID).updateDrawArmy();
         ...
         for (int i = 0; i < CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getNumOfProvinces(); i++) {
            CFG.game
               .getProvince(CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getProvinceID(i))
            ...
            CFG.game
               .getProvince(CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getProvinceID(i))
               .setLevelOfWatchTower(BuildingsManager.getTower_MaxLevel());
            CFG.game
               .getProvince(CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getProvinceID(i))
               .setLevelOfArmoury(BuildingsManager.getArmoury_MaxLevel());
            CFG.game
               .getProvince(CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getProvinceID(i))
               .setLevelOfLibrary(BuildingsManager.getLibrary_MaxLevel());
            CFG.game
               .getProvince(CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getProvinceID(i))
               .setLevelOfWorkshop(BuildingsManager.getWorkshop_MaxLevel());
            CFG.game
               .getProvince(CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getProvinceID(i))
               .setLevelOfSupply(BuildingsManager.getSupply_MaxLevel());
         }
