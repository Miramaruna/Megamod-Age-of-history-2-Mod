...
public class Text_BudgetTitle extends Text_EconomyTitle {
   public Text_BudgetTitle(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight) {
