...
public class Menu_InGame_View_Happiness extends SliderMenu {
   ...
   public Menu_InGame_View_Happiness() {
      ...
      while (tempProvs.size() > 0) {
         ...
         for (int i2 = 1; i2 < tempProvs.size(); i2++) {
            if (CFG.game.getProvince(tempProvs.get(tBest)).getHappiness() < CFG.game.getProvince(tempProvs.get(i2)).getHappiness()) {
               tBest = i2;
            }
         }
      ...
      if (tempProvincesSorted.size() > 0) {
         menuElements.add(
            new Button_NS_Population(
               ...
               CFG.game.getCiv(this.iCivID).getHappiness() + "%",
               Images.happiness,
               CFG.getColorStep(CFG.COLOR_TEXT_HAPPINESS_MIN, CFG.COLOR_TEXT_HAPPINESS_MAX, CFG.game.getCiv(this.iCivID).getHappiness(), 100, 1.0F),
               0,
               tY,
               tempW
            ) {}
               ...
               new Button_View_Happiness(
                  ...
                  !CFG.SPECTATOR_MODE && !CFG.game.isAlly(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.iCivID)
                     ...
                     : CFG.game
                        ...
                        .isFestivalOrganized((Integer)tempProvincesSorted.get(var9))
               ) {
                  @Override
                  public void actionElement(int iID) {
                     if (CFG.gameAction.getActiveTurnState() != Game_Action.TurnStates.INPUT_ORDERS
                        ...
                        || CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isFestivalOrganized(this.getCurrent())) {
                        ...
                        CFG.menuManager.rebuildInGame_Festival(this.getCurrent());
                     }
                  }
               }
            );
         ...
         new SliderMenuTitle(CFG.game.getCiv(this.iCivID).getCivName(), CFG.BUTTON_HEIGHT * 3 / 5, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_InGame_View_Happiness.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Happiness.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(),
                     Menu_InGame_View_Happiness.this.getWidth() + 2,
                     this.getHeight(),
                     true,
                     false
                  );
               oSB.setColor(new Color(CFG.COLOR_TEXT_HAPPINESS_MAX.r, CFG.COLOR_TEXT_HAPPINESS_MAX.g, CFG.COLOR_TEXT_HAPPINESS_MAX.b, 0.165F));
               ...
               oSB.setColor(new Color(CFG.COLOR_TEXT_HAPPINESS_MAX.r, CFG.COLOR_TEXT_HAPPINESS_MAX.g, CFG.COLOR_TEXT_HAPPINESS_MAX.b, 0.375F));
               ...
               ImageManager.getImage(Images.pix255_255_255)
                  .draw(
                     oSB,
                     Menu_InGame_View_Happiness.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Happiness.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(),
                     Menu_InGame_View_Happiness.this.getWidth()
                  );
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_InGame_View_Happiness.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Happiness.this.getPosY()
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     Menu_InGame_View_Happiness.this.getWidth() / 4,
                     1
                  );
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Menu_InGame_View_Happiness.this.getPosX()
                        + Menu_InGame_View_Happiness.this.getWidth()
                        - Menu_InGame_View_Happiness.this.getWidth() / 4
                        + iTranslateX,
                     Menu_InGame_View_Happiness.this.getPosY()
               ...
               ImageManager.getImage(Images.happiness)
                  .draw(
                     ...
                     Menu_InGame_View_Happiness.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.happiness).getHeight() / 2
                  );
