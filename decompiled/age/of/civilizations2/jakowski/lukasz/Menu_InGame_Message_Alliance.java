...
public class Menu_InGame_Message_Alliance extends SliderMenu {
   ...
   public Menu_InGame_Message_Alliance() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Alliance"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Message_Alliance(int onCivID, int iMessageID, int iValue) {
      ...
      menuElements.add(
         new Button_Diplomacy_MessageAlliance(
            CFG.langManager.get("CivAWantsToJoinAlliance", CFG.game.getCiv(this.iOnCivID).getCivName()), this.iOnCivID, 2, tY, CFG.BUTTON_WIDTH * 2
         ) {
            @Override
            public int getWidth() {
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Refuse"), -1, 2 + CFG.PADDING, var9 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Message_Alliance.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Accept"), -1, 2, var9, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getPosX() {
            return Menu_InGame_Message_Alliance.this.getElementW() + CFG.PADDING / 2;
         }
         ...
         public void buildElementHover() {
            ...
            nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_Message_Alliance.this.iOnCivID, CFG.PADDING, 0));
            nElements.add(new MenuElement_Hover_v2_Element2(nData));
            nData.clear();
            this.menuElementHover = new MenuElement_Hover_v2(nElements);
         }
         ...
         new SliderMenuTitle(CFG.langManager.get("Alliance"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.diplo_message)
                  .draw(
                     oSB,
                     Menu_InGame_Message_Alliance.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Message_Alliance.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2
                  );
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         CFG.menuManager
            .rebuildMenu_InGame_AllianceInfo(
               CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(),
               CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.getMessage(this.iMessageID).iFromCivID
            );
         CFG.game
