...
public class Menu_InGame_Build_Port extends SliderMenu {
   public int iProvinceID = -1;

   public Menu_InGame_Build_Port() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Port"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Build_Port(int nProvinceID) {
      ArrayList<MenuElement> menuElements = new ArrayList<>();
      ...
      menuElements.add(
         new Button_Build_Building(
            CFG.langManager.get("BuildPortIn") + ": ",
            ...
            Images.b_port,
            BuildingsManager.getPort_BuildCost(CFG.game.getProvince(this.iProvinceID).getLevelOfPort() + 1, this.iProvinceID),
            BuildingsManager.getPort_BuildMovementCost(CFG.game.getProvince(this.iProvinceID).getLevelOfPort() + 1),
            0,
            tY,
            CFG.BUTTON_WIDTH * 2
         ) {
            @Override
            public int getWidth() {
               return Menu_InGame_Build_Port.this.getElementW() * 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("AllowsYourArmyGoToTheSea"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "+"
                        + (int)(
                           BuildingsManager.getPort_IncomeProduction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() + 1) * 100.0F
                        )
                        + "%",
      ...
      menuElements.get(menuElements.size() - 1)
         .setMin((int)(BuildingsManager.getPort_TechLevel(CFG.game.getProvince(this.iProvinceID).getLevelOfPort() + 1) * 100.0F));
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      int var7;
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Build_Port.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Construct"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_Build_Port.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getName().length() > 0
                        ? CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getName()
                        : CFG.langManager.get("Province")
                  )
               );
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getCivID(), CFG.PADDING, 0));
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "+"
                        + (int)(
                           BuildingsManager.getPort_IncomeProduction(CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getLevelOfPort() + 1)
                              * 100.0F
                        )
                        + "%",
                     CFG.COLOR_TEXT_MODIFIER_POSITIVE
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + BuildingsManager.getPort_BuildCost(
                           CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getLevelOfPort() + 1, Menu_InGame_Build_Port.this.iProvinceID
                        ),
                     BuildingsManager.getPort_BuildCost(
                              CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getLevelOfPort() + 1, Menu_InGame_Build_Port.this.iProvinceID
                           )
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + BuildingsManager.getPort_BuildMovementCost(CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getLevelOfPort() + 1)
                           / 10.0F,
                     BuildingsManager.getPort_BuildMovementCost(CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getLevelOfPort() + 1)
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager
                        .get(
                           ...
                           BuildingsManager.getPort_Construction(CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getLevelOfPort() + 1)
                        )
                  )
               );
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + (int)(BuildingsManager.getPort_TechLevel(CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getLevelOfPort() + 1) * 100.0F)
                           / 100.0F,
                     CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getTechnologyLevel()
                           >= BuildingsManager.getPort_TechLevel(CFG.game.getProvince(Menu_InGame_Build_Port.this.iProvinceID).getLevelOfPort() + 1)
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Port"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               oSB.setColor(new Color(0.2F, 0.4F, 0.8F, 0.165F));
               ...
               oSB.setColor(new Color(0.2F, 0.4F, 0.8F, 0.375F));
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_Build_Port.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Port.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_Build_Port.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Port.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         if (BuildingsManager.constructPort(this.iProvinceID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())) {
         ...
         CFG.soundsManager.playSound(SoundsManager.SOUND_PORT);
