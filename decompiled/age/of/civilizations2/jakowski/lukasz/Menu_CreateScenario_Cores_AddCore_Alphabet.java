...
public class Menu_CreateScenario_Cores_AddCore_Alphabet extends SliderMenu {
   ...
   public Menu_CreateScenario_Cores_AddCore_Alphabet() {
      ...
      menuElements.add(new Button_Menu_Classic_Search("", CFG.PADDING * 2, 0, CFG.PADDING, CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT, true) {
         ...
         public String getTextToDraw() {
            return Menu_CreateScenario_Cores_AddCore_Alphabet.this.nSearch + ": " + super.getTextToDraw();
         }
      });
