...
public class Menu_InGame_Message_TransferControl extends SliderMenu {
   ...
   public Menu_InGame_Message_TransferControl(int onCivID, int iMessageID, int iValue) {
      ...
      menuElements.add(
         new Button_Build_TransferControl(
            CFG.langManager.get("TakeControlOverOccupiedProvince"),
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Refuse"), -1, 2 + CFG.PADDING, var9 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Message_TransferControl.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Accept"), -1, 2, var9, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_Message_TransferControl.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ImageManager.getImage(Images.transfer_control)
                  .draw(
                     oSB,
                     this.getPosX()
                        + this.getWidth() / 2
                        - (int)((this.getTextWidth() * 0.8F + ImageManager.getImage(Images.transfer_control).getWidth() + CFG.PADDING) / 2.0F)
                        + iTranslateX,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.transfer_control).getHeight() / 2 + iTranslateY
                  );
                  ...
                  this.getPosX()
                     + (
                        this.getTextPos() < 0
                           ? this.getWidth() / 2
                              - (int)((this.getTextWidth() * 0.8F + ImageManager.getImage(Images.transfer_control).getWidth() + CFG.PADDING) / 2.0F)
                              + ImageManager.getImage(Images.transfer_control).getWidth()
                              + CFG.PADDING
                           : this.getTextPos()
                     )
                     + iTranslateX,
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Flag(
                     CFG.game.getProvince(Menu_InGame_Message_TransferControl.this.iProvinceID).getCivID(), CFG.PADDING, 0
                  )
               );
         ...
         new SliderMenuTitle(CFG.langManager.get("TransferControl"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.diplo_message)
                  .draw(
                     oSB,
                     Menu_InGame_Message_TransferControl.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Message_TransferControl.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
      ...
      if (iID == 0) {
         ...
         if (iID == this.getMenuElementsSize() - 1) {
            ...
            if (CFG.viewsManager.getActiveViewID() == ViewsManager.VIEW_DIPLOMACY_MODE
               && Menu_InGame_Messages.VIEW_BEFORE != CFG.viewsManager.getActiveViewID()) {
