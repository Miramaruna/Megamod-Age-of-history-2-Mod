...
class Menu_InGame_Build_Bunker extends SliderMenu {
   private int iProvinceID = -1;

   protected Menu_InGame_Build_Bunker() {
   ...
   protected Menu_InGame_Build_Bunker(int var1) {
      ArrayList var2 = new ArrayList();
      this.iProvinceID = var1;
      int var3 = CFG.CIV_INFO_MENU_WIDTH * 2;
      StringBuilder var4 = new StringBuilder();
      LanguageManager var5 = CFG.langManager;
      if (CFG.game.getProvince(this.iProvinceID).getLevelOfBunker() == 0) {
      }

      String var13 = var4.append(var5.get("BuildBunkerIn")).append(": ").toString();
      String var14;
      if (CFG.game.getProvince(this.iProvinceID).getName().length() > 0) {
         var14 = CFG.game.getProvince(this.iProvinceID).getName();
      } else {
         var14 = CFG.langManager.get("Province");
      }
      ...
      var2.add(
         new Button_Build_Building(
            ...
            var14,
            Images.bBunker,
            BuildingsManager.getBunker_BuildCost(CFG.game.getProvince(this.iProvinceID).getLevelOfBunker() + 1, this.iProvinceID),
            BuildingsManager.getBunker_BuildMovementCost(CFG.game.getProvince(this.iProvinceID).getLevelOfBunker() + 1),
            0,
            0,
            CFG.BUTTON_WIDTH * 2
         ) {
            final Menu_InGame_Build_Bunker this$0;
            ...
            protected void buildElementHover() {
               ...
               var2x.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "+" + BuildingsManager.getBunker_DefenseBonus(CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfBunker() + 1) + "%",
      ...
      ((MenuElement)var2.get(var2.size() - 1))
         .setMin((int)(BuildingsManager.getBunker_TechLevel(CFG.game.getProvince(this.iProvinceID).getLevelOfBunker() + 1) * 100.0F));
      int var6 = ((MenuElement)var2.get(var2.size() - 1)).getHeight();
      String var15 = CFG.langManager.get("Cancel");
      var1 = CFG.PADDING;
      var6 = 0 + var6 + CFG.PADDING;
      var2.add(new Button_FlagActionSliderStyle(this, var15, -1, var1 + 2, var6, CFG.BUTTON_WIDTH, true) {
         final Menu_InGame_Build_Bunker this$0;
      ...
      var2.add(
         new Button_FlagActionSliderStyle(this, CFG.langManager.get("Construct"), -1, 2, var6, CFG.BUTTON_WIDTH, true) {
            ...
            protected void buildElementHover() {
               ...
               LanguageManager var4 = CFG.langManager;
               if (CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfBunker() == 0) {
               }

               var2.add(
                  new MenuElement_Hover_v2_Element_Type_Text(var3.append(var4.get("BuildBunkerIn")).append(": ").toString(), CFG.COLOR_TEXT_NUM_OF_PROVINCES)
               );
               String var6;
               if (CFG.game.getProvince(this.this$0.iProvinceID).getName().length() > 0) {
                  var6 = CFG.game.getProvince(this.this$0.iProvinceID).getName();
               } else {
               ...
               var2.clear();
               var2.add(new MenuElement_Hover_v2_Element_Type_Text(" - "));
               var2.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("DefenseBonus") + ": "));
               var2.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "+" + BuildingsManager.getBunker_DefenseBonus(CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfBunker() + 1) + "%",
                     CFG.COLOR_TEXT_MODIFIER_POSITIVE
               ...
               String var10 = ""
                  + BuildingsManager.getBunker_BuildCost(CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfBunker() + 1, this.this$0.iProvinceID);
               Color var7;
               if (CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney()
                  >= BuildingsManager.getBunker_BuildCost(CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfBunker() + 1, this.this$0.iProvinceID)) {
                  var7 = CFG.COLOR_INGAME_GOLD;
               } else {
                  var7 = CFG.COLOR_TEXT_MODIFIER_NEGATIVE2;
               }

               var2.add(new MenuElement_Hover_v2_Element_Type_Text(var10, var7));
               ...
               String var11 = "" + BuildingsManager.getBunker_BuildMovementCost(CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfBunker() + 1) / 10.0F;
               Color var8;
               if (CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                  >= BuildingsManager.getBunker_BuildMovementCost(CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfBunker() + 1)) {
                  var8 = CFG.COLOR_INGAME_MOVEMENT;
               } else {
                  var8 = CFG.COLOR_TEXT_MODIFIER_NEGATIVE2;
               }

               var2.add(new MenuElement_Hover_v2_Element_Type_Text(var11, var8));
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager
                        .get(
                           ...
                           BuildingsManager.getBunker_Construction(CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfBunker() + 1)
                        )
                  )
               );
               ...
               String var12 = ""
                  + (int)(BuildingsManager.getBunker_TechLevel(CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfBunker() + 1) * 100.0F) / 100.0F;
               Color var9;
               if (CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getTechnologyLevel()
                  >= BuildingsManager.getBunker_TechLevel(CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfBunker() + 1)) {
                  var9 = CFG.COLOR_TEXT_TECHNOLOGY;
               } else {
                  var9 = CFG.COLOR_TEXT_MODIFIER_NEGATIVE2;
               }

               var2.add(new MenuElement_Hover_v2_Element_Type_Text(var12, var9));
      ...
      var6 = ImageManager.getImage(Images.top_left2).getHeight() + CFG.PADDING * 2 + CFG.BUTTON_HEIGHT * 3 / 5;
      SliderMenuTitle var16 = new SliderMenuTitle(
         this, BuildingsManager.getBunker_Name(CFG.game.getProvince(this.iProvinceID).getLevelOfBunker() + 1), CFG.BUTTON_HEIGHT * 3 / 5, true, true
      ) {
         final Menu_InGame_Build_Bunker this$0;
         ...
         protected void draw(SpriteBatch var1, int var2x, int var3x, int var4x, int var5x, boolean var6x) {
            ...
            var1.setColor(new Color(0.78431374F, 0.78431374F, 0.78431374F, 0.165F));
            ...
            var1.setColor(new Color(0.78431374F, 0.78431374F, 0.78431374F, 0.375F));
      ...
      this.initMenu(var16, var7 - var8, var6, var3, var1, var2, true, true);
      this.updateLanguage();
   ...
   protected final void actionElement(int var1) {
      if (var1 == this.getMenuElementsSize() - 1) {
         if (BuildingsManager.constructBunker(this.iProvinceID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())) {
   ...
   protected void draw(SpriteBatch var1, int var2, int var3, boolean var4) {
      if (Menu_InGame_OfferAlliance.lTime + 200L >= System.currentTimeMillis()) {
         ...
         var14.draw2(var1, var6 + 2 + var8 - var7 + var2, var9 - var10 + var3, var12, CFG.PADDING + var11, true, true);
         ...
         int var21 = this.getPosY();
         int var24 = ImageManager.getImage(Images.new_game_top_edge).getHeight();
         int var30 = this.getWidth();
         int var18 = ImageManager.getImage(Images.new_game_top_edge).getWidth();
         int var27 = this.getHeight();
         var15.draw2(var1, var33 - 2 + var2, var21 - var24 + var3, var30 - var18 + 4, CFG.PADDING + var27, false, true);
         ...
         var30 = this.getPosY();
         var33 = ImageManager.getImage(Images.new_game_top_edge).getHeight();
         var27 = ImageManager.getImage(Images.new_game_top_edge).getWidth();
         var18 = this.getHeight();
         var15.draw2(var1, var24 + 2 + var35 - var21 + var2, var30 - var33 + var3, var27, CFG.PADDING + var18, true, true);
         var1.setColor(new Color(0.0F, 0.0F, 0.0F, 0.45F));
         ImageManager.getImage(Images.gradient)
            .draw(
               var1,
