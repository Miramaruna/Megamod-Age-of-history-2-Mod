...
public class Menu_InGame_Build_Farm extends SliderMenu {
   public int iProvinceID = -1;

   public Menu_InGame_Build_Farm() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Farm"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Build_Farm(int nProvinceID) {
      ArrayList<MenuElement> menuElements = new ArrayList<>();
      ...
      menuElements.add(
         new Button_Build_Building(
            CFG.langManager.get("BuildFarmIn") + ": ",
            ...
            Images.b_farm,
            BuildingsManager.getFarm_BuildCost(CFG.game.getProvince(this.iProvinceID).getLevelOfFarm() + 1, this.iProvinceID),
            BuildingsManager.getFarm_BuildMovementCost(CFG.game.getProvince(this.iProvinceID).getLevelOfFarm() + 1),
            0,
            tY,
            CFG.BUTTON_WIDTH * 2
         ) {
            @Override
            public int getWidth() {
               return Menu_InGame_Build_Farm.this.getElementW() * 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "+"
                        + (int)(
                           BuildingsManager.getFarm_GrowthRateBonus(CFG.game.getProvince(Menu_InGame_Build_Farm.this.iProvinceID).getLevelOfFarm() + 1)
                              * 100.0F
                        )
                        + "%",
      ...
      menuElements.get(menuElements.size() - 1)
         .setMin((int)(BuildingsManager.getFarm_TechLevel(CFG.game.getProvince(this.iProvinceID).getLevelOfFarm() + 1) * 100.0F));
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      int var7;
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Build_Farm.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Construct"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_Build_Farm.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getProvince(Menu_InGame_Build_Farm.this.iProvinceID).getName().length() > 0
                        ? CFG.game.getProvince(Menu_InGame_Build_Farm.this.iProvinceID).getName()
                        : CFG.langManager.get("Province")
                  )
               );
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(Menu_InGame_Build_Farm.this.iProvinceID).getCivID(), CFG.PADDING, 0));
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + BuildingsManager.getFarm_BuildCost(
                           CFG.game.getProvince(Menu_InGame_Build_Farm.this.iProvinceID).getLevelOfFarm() + 1, Menu_InGame_Build_Farm.this.iProvinceID
                        ),
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + BuildingsManager.getFarm_BuildMovementCost(CFG.game.getProvince(Menu_InGame_Build_Farm.this.iProvinceID).getLevelOfFarm() + 1)
                           / 10.0F,
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager
                        .get(
                           ...
                           BuildingsManager.getFarm_Construction(CFG.game.getProvince(Menu_InGame_Build_Farm.this.iProvinceID).getLevelOfFarm() + 1)
                        )
                  )
               );
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + (int)(BuildingsManager.getFarm_TechLevel(CFG.game.getProvince(Menu_InGame_Build_Farm.this.iProvinceID).getLevelOfFarm() + 1) * 100.0F)
                           / 100.0F,
                     CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getTechnologyLevel()
                           >= BuildingsManager.getFarm_TechLevel(CFG.game.getProvince(Menu_InGame_Build_Farm.this.iProvinceID).getLevelOfFarm() + 1)
      ...
      this.initMenu(
         new SliderMenuTitle(
            CFG.langManager.get(BuildingsManager.getFarm_Name(CFG.game.getProvince(this.iProvinceID).getLevelOfFarm() + 1)),
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               oSB.setColor(new Color(0.8784314F, 0.54901963F, 0.14901961F, 0.165F));
               ...
               oSB.setColor(new Color(0.8784314F, 0.54901963F, 0.14901961F, 0.375F));
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_Build_Farm.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Farm.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_Build_Farm.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Farm.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         if (BuildingsManager.constructFarm(this.iProvinceID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())) {
            ...
            CFG.soundsManager.playSound(SoundsManager.SOUND_FARM);
         }
