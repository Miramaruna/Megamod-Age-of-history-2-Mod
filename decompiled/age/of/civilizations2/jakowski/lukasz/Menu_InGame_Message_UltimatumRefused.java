...
public class Menu_InGame_Message_UltimatumRefused extends SliderMenu {
   ...
   public Menu_InGame_Message_UltimatumRefused() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("RefusedUltimatum"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Message_UltimatumRefused(int onCivID, int iMessageID, int iValue) {
      ...
      menuElements.add(
         new Button_Diplomacy_Demands(
            CFG.langManager.get("RefusedToAcceptOurUltimatum"),
            onCivID,
            2,
      ...
      int var10;
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Fine") + "!", -1, 2 + CFG.PADDING, var10 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getWidth() {
               return Menu_InGame_Message_UltimatumRefused.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
            }
         }
      );
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("DeclareWar"), -1, 2, var10, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_Message_UltimatumRefused.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_Message_UltimatumRefused.this.iOnCivID, 0, CFG.PADDING));
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getCiv(Menu_InGame_Message_UltimatumRefused.this.iOnCivID).getCivName()));
         ...
         new SliderMenuTitle(CFG.langManager.get("RefusedUltimatum"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.diplo_message)
                  .draw(
                     oSB,
                     Menu_InGame_Message_UltimatumRefused.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Message_UltimatumRefused.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
