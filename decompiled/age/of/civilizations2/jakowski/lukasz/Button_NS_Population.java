...
public class Button_NS_Population extends Button {
   ...
   public Button_NS_Population(
      Color nColor, String sText, int nCivID, String sTextLeft, String nPop, int iImageID, Color textColor, int iPosX, int iPosY, int iWidth
   ) {
            ...
            public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
               if (Button_NS_Population.this.getCheckboxState()) {
                  ...
                  ImageManager.getImage(Images.patt_square)
                     .draw2(
                        oSB,
                        Button_NS_Population.this.getPosX() + iTranslateX,
                        Button_NS_Population.this.getPosY() - ImageManager.getImage(Images.patt_square).getHeight() + 1 + iTranslateY,
                        Button_Diplomacy.iDiploWidth,
                        Button_NS_Population.this.getHeight() - 2,
                        true,
                        false
                     );
                  ...
                  ImageManager.getImage(Images.gradient)
                     .draw(
                        oSB,
                        Button_NS_Population.this.getPosX() + iTranslateX,
                        Button_NS_Population.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() + 1 + iTranslateY,
                        Button_Diplomacy.iDiploWidth,
                        Button_NS_Population.this.getHeight() / 4,
                        false,
                        false
                     );
                  ImageManager.getImage(Images.gradient)
                     .draw(
                        oSB,
                        Button_NS_Population.this.getPosX() + iTranslateX,
                        Button_NS_Population.this.getPosY()
                           - ImageManager.getImage(Images.gradient).getHeight()
                           + Button_NS_Population.this.getHeight()
                           - 1
                           + iTranslateY
                           - Button_NS_Population.this.getHeight() / 4,
                        Button_Diplomacy.iDiploWidth,
      ...
      if (this.iCivID >= 0) {
         ...
         ImageManager.getImage(Images.randomCivilizationFlag)
            .draw(
               oSB,
               this.getPosX() + Button_Diplomacy.iDiploWidth / 2 - CFG.CIV_FLAG_WIDTH / 2 + iTranslateX,
               this.getPosY() + this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2 + iTranslateY - ImageManager.getImage(Images.randomCivilizationFlag).getHeight(),
               CFG.CIV_FLAG_WIDTH,
               CFG.CIV_FLAG_HEIGHT
            );
      }
      ...
      ImageManager.getImage(this.iImageID)
         .draw(
            ...
            this.getPosY()
               ...
               - (int)(ImageManager.getImage(this.iImageID).getHeight() * this.getImageScale(this.iImageID, 0.65F)) / 2
               - ImageManager.getImage(this.iImageID).getHeight()
               + iTranslateY,
            (int)(ImageManager.getImage(this.iImageID).getWidth() * this.getImageScale(this.iImageID, 0.65F)),
            (int)(ImageManager.getImage(this.iImageID).getHeight() * this.getImageScale(this.iImageID, 0.65F))
         );
