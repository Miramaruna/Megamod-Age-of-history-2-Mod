...
public class Menu_ScreenshotMode extends SliderMenu {
   public Menu_ScreenshotMode() {
      ...
      menuElements.add(new Text("", 0, 0, CFG.PADDING, ImageManager.getImage(Images.top_left2).getHeight()) {
         @Override
         public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
         }
      });
      ...
      menuElements.add(
         new Text("", 0, 0, CFG.PADDING * 2 + (int)(CFG.TEXT_HEIGHT * 0.8F), ImageManager.getImage(Images.top_left2).getHeight()) {
            @Override
            public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
            ...
            @Override
            public int getPosX() {
               return Menu_ScreenshotMode.this.getMenuElement(1).getPosX();
            }

            @Override
            public int getWidth() {
               return Menu_ScreenshotMode.this.getMenuElement(1).getWidth();
            }
