...
public class Button_Statistics_WarDetails_Right extends Button_Statistics_WarDetails {
   ...
   @Override
   public final void drawFlag(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      oSB.setColor(new Color(0.0F, 0.0F, 0.0F, 0.5F));
      ImageManager.getImage(Images.slider_gradient)
         .draw(
            oSB,
            this.getPosX() + this.getWidth() - (int)(this.getHeight() / 44.0F * 68.0F) + iTranslateX,
            this.getPosY() - ImageManager.getImage(Images.slider_gradient).getHeight() + iTranslateY,
            (int)(this.getHeight() / 44.0F * 68.0F),
            this.getHeight(),
            true,
            false
         );
      if (this.civFlag != null) {
         try {
            oSB.setColor(new Color(0.3F, 0.3F, 0.3F, 0.9F));
            ...
            ImageManager.getImage(Images.slider_gradient)
               .draw(
                  oSB,
                  this.getPosX() + this.getWidth() - this.ANIMATION_POSX - (int)(this.getHeight() / 44.0F * 68.0F) + iTranslateX,
                  this.getPosY() - ImageManager.getImage(Images.slider_gradient).getHeight() + iTranslateY,
                  (int)(this.getHeight() / 44.0F * 68.0F),
                  this.getHeight(),
                  true,
      ...
      ImageManager.getImage(Images.slider_gradient)
         .draw(
            oSB,
            this.getPosX() + this.getWidth() - (int)(this.getHeight() / 44.0F * CFG.PADDING) + iTranslateX,
            this.getPosY() - ImageManager.getImage(Images.slider_gradient).getHeight() + iTranslateY,
            (int)(this.getHeight() / 44.0F * CFG.PADDING),
            this.getHeight(),
            true,
            false
         );
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      try {
         oSB.setColor(
            new Color(
               CFG.game.getCiv(this.iCivID).getR() / 255.0F, CFG.game.getCiv(this.iCivID).getG() / 255.0F, CFG.game.getCiv(this.iCivID).getB() / 255.0F, 1.0F
            )
         );
      ...
      ImageManager.getImage(Images.line_32_off1)
         .draw(
            ...
            this.getPosY()
               ...
               + iTranslateY,
            CFG.PADDING * 2 + (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale(Images.economy)),
      ...
      ImageManager.getImage(Images.line_32_off1)
         .draw(
            ...
            this.getPosY()
               ...
               - CFG.PADDING
               - CFG.TEXT_HEIGHT
               + (CFG.TEXT_HEIGHT - (int)(ImageManager.getImage(Images.economy).getHeight() * this.getImageScale(Images.economy))) / 2
               - ImageManager.getImage(Images.line_32_off1).getHeight()
               + iTranslateY,
            CFG.PADDING * 2 + (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale(Images.economy)),
            (int)(ImageManager.getImage(Images.economy).getHeight() * this.getImageScale(Images.economy))
         );
      ...
      ImageManager.getImage(Images.line_32_vertical)
         .draw(
            oSB,
            this.getPosX() + CFG.PADDING * 2 + (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale(Images.economy)) + iTranslateX,
            this.getPosY()
               + CFG.PADDING
               + (CFG.TEXT_HEIGHT - (int)(ImageManager.getImage(Images.flag_rect).getHeight() * this.getImageScale(Images.flag_rect))) / 2
      ...
      ImageManager.getImage(Images.population)
         .draw(
            ...
            this.getPosX()
               + CFG.PADDING
               + (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale(Images.economy)) / 2
               - (int)(ImageManager.getImage(Images.population).getWidth() * this.getImageScale(Images.population)) / 2
               + iTranslateX,
            this.getPosY()
               + CFG.PADDING
               + (CFG.TEXT_HEIGHT - (int)(ImageManager.getImage(Images.flag_rect).getHeight() * this.getImageScale(Images.flag_rect))) / 2
      ...
      ImageManager.getImage(Images.economy)
         .draw(
            ...
            this.getPosY()
               ...
               + iTranslateY,
            (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale(Images.economy)),
            (int)(ImageManager.getImage(Images.economy).getHeight() * this.getImageScale(Images.economy))
         );
      Rectangle clipBounds = new Rectangle(
         this.getPosX()
            ...
            + iTranslateX,
         CFG.GAME_HEIGHT - (this.getPosY() + CFG.PADDING + CFG.PADDING / 2 + (int)((CFG.TEXT_HEIGHT - CFG.TEXT_HEIGHT * 0.75F) / 2.0F) + iTranslateY),
         this.getMaxNameWidth(),
         -CFG.TEXT_HEIGHT
      );
      oSB.flush();
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosX()
            + this.getWidth()
            - this.ANIMATION_POSX
            - (int)Math.min((float)this.getMaxNameWidth(), this.getTextWidth() * 0.75F)
            - CFG.PADDING * 2
            - (int)(ImageManager.getImage(Images.flag_rect).getWidth() * this.getImageScale(Images.flag_rect))
            + iTranslateX,
         this.getPosY() + CFG.PADDING + CFG.PADDING / 2 + (int)((CFG.TEXT_HEIGHT - CFG.TEXT_HEIGHT * 0.75F) / 2.0F) + iTranslateY,
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosX() + CFG.PADDING * 3 + (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale(Images.economy)) + iTranslateX,
         this.getPosY() + CFG.PADDING + (int)((CFG.TEXT_HEIGHT - CFG.TEXT_HEIGHT * 0.65F) / 2.0F) + iTranslateY,
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosX() + CFG.PADDING * 3 + (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale(Images.economy)) + iTranslateX,
         this.getPosY() + this.getHeight() - CFG.PADDING - CFG.TEXT_HEIGHT + (int)((CFG.TEXT_HEIGHT - CFG.TEXT_HEIGHT * 0.65F) / 2.0F) + iTranslateY,
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosX()
            ...
            - this.ANIMATION_POSX
            - CFG.PADDING * 3
            - (int)Math.min((float)(this.getMaxNameWidth() - CFG.PADDING * 2), this.getTextWidth() * 0.75F)
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosY() + this.getHeight() - CFG.PADDING - CFG.TEXT_HEIGHT + (int)((CFG.TEXT_HEIGHT - CFG.TEXT_HEIGHT * 0.6F) / 2.0F) + iTranslateY,
      ...
      if (this.canPeaceOut && this.getIsHovered()) {
         if (this.ANIMATION_POSX < this.getTruceIconWidth()) {
            this.ANIMATION_POSX = (int)(Math.min((float)(System.currentTimeMillis() - this.ANIMATION_TIME) / 175.0F, 1.0F) * this.getTruceIconWidth());
            CFG.setRender_3(true);
         }

         Rectangle clipBounds2 = new Rectangle(
            this.getPosX() + this.getWidth() - this.ANIMATION_POSX + iTranslateX,
