...
public class Menu_InGame_Build_NuclearReactor extends SliderMenu {
   public int iProvinceID = -1;

   public Menu_InGame_Build_NuclearReactor() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("NuclearReactor"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Build_NuclearReactor(int nProvinceID) {
      ArrayList<MenuElement> menuElements = new ArrayList<>();
      ...
      menuElements.add(
         new Button_Build_Building(
            CFG.langManager.get("BuildNuclearReactorIn") + ": ",
            ...
            Images.b_radiation,
            BuildingsManager.getNuclearReactor_BuildCost(CFG.game.getProvince(this.iProvinceID).getLevelOfNuclearReactor() + 1, this.iProvinceID),
            BuildingsManager.getNuclearReactor_BuildMovementCost(CFG.game.getProvince(this.iProvinceID).getLevelOfNuclearReactor() + 1),
            0,
            tY,
            CFG.BUTTON_WIDTH * 2
         ) {
            @Override
            public int getWidth() {
               return Menu_InGame_Build_NuclearReactor.this.getElementW() * 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "-"
                        + (int)(
                           BuildingsManager.getNuclearReactor_Bonus(
                                 CFG.game.getProvince(Menu_InGame_Build_NuclearReactor.this.iProvinceID).getLevelOfNuclearReactor() + 1
                              )
                              * 100.0F
                        )
                        + "%",
      ...
      menuElements.get(menuElements.size() - 1)
         .setMin((int)(BuildingsManager.getNuclearReactor_TechLevel(CFG.game.getProvince(this.iProvinceID).getLevelOfNuclearReactor() + 1) * 100.0F));
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      int var7;
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Build_NuclearReactor.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Construct"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_Build_NuclearReactor.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getProvince(Menu_InGame_Build_NuclearReactor.this.iProvinceID).getName().length() > 0
                        ? CFG.game.getProvince(Menu_InGame_Build_NuclearReactor.this.iProvinceID).getName()
                        : CFG.langManager.get("Province")
                  )
               );
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(Menu_InGame_Build_NuclearReactor.this.iProvinceID).getCivID(), CFG.PADDING, 0)
               );
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + BuildingsManager.getNuclearReactor_BuildCost(
                           CFG.game.getProvince(Menu_InGame_Build_NuclearReactor.this.iProvinceID).getLevelOfNuclearReactor() + 1,
                           Menu_InGame_Build_NuclearReactor.this.iProvinceID
                        ),
         ...
         new SliderMenuTitle(CFG.langManager.get("NuclearReactor"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_Build_NuclearReactor.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_NuclearReactor.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_Build_NuclearReactor.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_NuclearReactor.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         if (BuildingsManager.constructNuclearReactor(this.iProvinceID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())) {
