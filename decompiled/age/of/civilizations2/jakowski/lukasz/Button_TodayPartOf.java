...
public class Button_TodayPartOf extends Button {
   public int iCivID;
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sText,
         this.getPosX() + this.getWidth() - CFG.PADDING * 2 - CFG.CIV_FLAG_WIDTH - CFG.PADDING - (int)(this.getTextWidth() * 0.7F) + iTranslateX,
