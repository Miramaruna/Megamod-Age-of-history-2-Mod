...
public class Text_Outliner_SaveGame extends Text {
   ...
   public Text_Outliner_SaveGame(int nCivID, int iPosX, int iPosY, int iWidth) {
      super(
         CFG.langManager.get("Save"), CFG.PADDING * 2, iPosX, iPosY, iWidth, Math.max(CFG.TEXT_HEIGHT + CFG.PADDING * 4, CFG.CIV_FLAG_HEIGHT + CFG.PADDING * 4)
      );
      this.iCivID = nCivID;
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      ImageManager.getImage(Images.icon_save)
         .draw(
            ...
            this.getPosX()
               + this.getWidth()
               - (int)(ImageManager.getImage(Images.icon_save).getWidth() * this.getImageScale(Images.icon_save)) / 2
               + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               - (int)(ImageManager.getImage(Images.icon_save).getHeight() * this.getImageScale(Images.icon_save)) / 2
               - ImageManager.getImage(Images.icon_save).getHeight()
               + iTranslateY,
            (int)(ImageManager.getImage(Images.icon_save).getWidth() * this.getImageScale(Images.icon_save)),
            (int)(ImageManager.getImage(Images.icon_save).getHeight() * this.getImageScale(Images.icon_save))
         );
      CFG.game
         .getCiv(this.iCivID)
         .getFlag()
