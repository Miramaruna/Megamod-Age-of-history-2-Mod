...
public class Button_Diplomacy_Message_JoinAWar_Denied extends Button_Statistics {
   public static final float FONT_SCALE = 0.7F;
   public int iCivA;
   public int warAgainstCivID;
   public int warAgainstCivIDWidth;
   public int iCivB;
   ...
   public Button_Diplomacy_Message_JoinAWar_Denied(String sText, int nFromCivID, int warAgainstCivID, int iCivB, int iPosX, int iPosY, int iWidth) {
      ...
      this.iCivB = iCivB;
      CFG.glyphLayout.setText(CFG.fontMain, CFG.game.getCiv(warAgainstCivID).getCivName());
      this.warAgainstCivIDWidth = (int)(CFG.glyphLayout.width * 0.7F);
   }
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.diplo_rivals)
         .draw(
            oSB,
            this.getPosX() + Button_Diplomacy.iDiploWidth / 2 - ImageManager.getImage(Images.diplo_rivals).getWidth() / 2 + iTranslateX,
      ...
      CFG.drawTextWithShadow(
         oSB,
         CFG.game.getCiv(this.warAgainstCivID).getCivName(),
         this.getPosX()
            + CFG.PADDING * 4
            + Button_Diplomacy.iDiploWidth
            + 4
