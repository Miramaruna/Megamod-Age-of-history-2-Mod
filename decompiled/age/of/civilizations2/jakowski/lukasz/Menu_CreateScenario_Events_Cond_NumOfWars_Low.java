...
public class Menu_CreateScenario_Events_Cond_NumOfWars_Low extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("NumberOfWars") + " < ");
      this.getTitle().setText(CFG.langManager.get("NumberOfWars"));
   }
