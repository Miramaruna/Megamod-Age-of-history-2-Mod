...
public class Button_EconomicPolitic extends Button {
   public static final float BUTTON_PERC_HEIGHT = 0.6F;
   private int economyType;

   public Button_EconomicPolitic(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable, int economyType) {
      super.init(sText, iTextPositionX, iPosX, iPosY, iWidth, (int)(CFG.BUTTON_HEIGHT * 0.6F), isClickable, true, false, false);
      this.economyType = economyType;
   }

   public Button_EconomicPolitic(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
   ...
   public Color getColor(boolean isActive) {
      return this.getClickable()
         ? (
            this.economyType == CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).civGameData.EconomyType
