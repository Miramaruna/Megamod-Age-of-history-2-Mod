...
public class HistoryLog_SignedDefensivePact extends HistoryLog {
   public String sMess;
   ...
   public void updateLanguage() {
      this.sMess = " - " + CFG.langManager.get("DefensivePact") + " - ";
   ...
   public void draw(SpriteBatch oSB, int nTurnID, int iPosX, int iPosY, int iWidth, int iHeight, boolean isActive) {
      this.drawLeftIcon(oSB, Images.diplo_defensive_pact, iPosX, iPosY, iWidth, iHeight, isActive);
