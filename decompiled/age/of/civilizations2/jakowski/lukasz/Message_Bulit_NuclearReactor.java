...
public class Message_Bulit_NuclearReactor extends Message {
   public Message_Bulit_NuclearReactor(int fromCivID, int iValue) {
   ...
   public MenuElement_Hover_v2 getHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.b_radiation, CFG.PADDING, 0));
      nElements.add(new MenuElement_Hover_v2_Element2(nData));
      nData.clear();
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(
            "-" + (int)(BuildingsManager.getNuclearReactor_Bonus(CFG.game.getProvince(this.iValue).getLevelOfNuclearReactor()) * 100.0F) + "%",
