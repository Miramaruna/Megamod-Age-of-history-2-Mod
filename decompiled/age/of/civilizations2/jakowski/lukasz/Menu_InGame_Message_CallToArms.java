...
public class Menu_InGame_Message_CallToArms extends SliderMenu {
   ...
   public Menu_InGame_Message_CallToArms(int onCivID, int iMessageID, int iValue) {
      ...
      int tY = 0;
      menuElements.add(
         new Button_Diplomacy_Message_JoinAWar(CFG.langManager.get("JoinAWarAgainst") + ": ", this.iOnCivID, iValue, 2, tY, CFG.BUTTON_WIDTH * 2) {
            @Override
            public int getWidth() {
      ...
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      int var9;
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Deny"), -1, 2 + CFG.PADDING, var9 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getCiv(Menu_InGame_Message_CallToArms.this.warAgainstCivID).getCivName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                  )
               );
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
         ...
         new SliderMenuTitle(CFG.langManager.get("CallToArms"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.diplo_message)
                  .draw(
                     oSB,
                     Menu_InGame_Message_CallToArms.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Message_CallToArms.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
