...
public class Event_Conditions_MilitaryAccess extends Event_Conditions {
   public int iCivID = -1;
   public int iCivID2 = -1;

   Event_Conditions_MilitaryAccess() {
   }
   ...
   public boolean outCondition() {
      try {
         return CFG.game.getMilitaryAccess(this.getCivID(), this.getCivID2()) > 0;
