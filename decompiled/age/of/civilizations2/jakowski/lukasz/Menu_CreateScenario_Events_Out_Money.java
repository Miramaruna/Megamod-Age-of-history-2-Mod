...
public class Menu_CreateScenario_Events_Out_Money extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(2).setText(CFG.langManager.get("Treasury") + ": ");
      this.getTitle().setText(CFG.langManager.get("UpdateMoney"));
   }
