...
public class Text_Economy_Value extends Text {
   public String sText2;
   public boolean row = false;
   public Color textColor;

   public Text_Economy_Value(String sText, String sText2, int iPosX, int iPosY, int iWidth, int iHeight) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.getText(),
         this.getPosX() + this.getWidth() - CFG.PADDING - CFG.PADDING / 2 - (int)(this.getTextWidth() * 0.75F) + iTranslateX,
         this.getPosY() + (int)((this.getHeight() - this.iTextHeight * 0.75F) / 2.0F) + iTranslateY,
         this.textColor
      );
