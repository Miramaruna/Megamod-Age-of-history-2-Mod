...
class Menu_InGame_Destroy_Shaft extends SliderMenu {
   private int iProvinceID = -1;

   protected Menu_InGame_Destroy_Shaft(int var1) {
      ...
      var2.add(
         new Button_Build_Building_Destroy(
            this,
            var4,
            CFG.langManager.get("Destroy") + ": " + CFG.langManager.get(Shaft.getShaft_Name(CFG.game.getProvince(this.iProvinceID).getLevelOfShaft())),
            Images.b_shaft,
            0,
            0,
            CFG.BUTTON_WIDTH * 2,
            ...
            final Menu_InGame_Destroy_Shaft this$0;
            ...
            protected void buildElementHover() {
               ...
               var2x.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager.get(Shaft.getShaft_Name(CFG.game.getProvince(this.this$0.iProvinceID).getLevelOfShaft())) + ": ",
      ...
      SliderMenuTitle var13 = new SliderMenuTitle(
         this, CFG.langManager.get(Shaft.getShaft_Name(CFG.game.getProvince(this.iProvinceID).getLevelOfShaft())), CFG.BUTTON_HEIGHT * 3 / 5, true, true
      ) {
         final Menu_InGame_Destroy_Shaft this$0;
      ...
      this.initMenu(var13, var5 - var7, var6, var3, var1, var2, true, true);
      this.updateLanguage();
   ...
   protected final void actionElement(int var1) {
      if (var1 == this.getMenuElementsSize() - 1) {
         if (Shaft.destroyShaft(this.iProvinceID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())) {
   ...
   protected void draw(SpriteBatch var1, int var2, int var3, boolean var4) {
      if (Menu_InGame_OfferAlliance.lTime + 200L >= System.currentTimeMillis()) {
         ...
         var14.draw2(var1, var7 + 2 + var6 - var11 + var2, var10 - var9 + var3, var8, CFG.PADDING + var12, true, true);
         ...
         var15.draw2(var1, var18 - 2 + var2, var30 - var21 + var3, var27 - var24 + 4, CFG.PADDING + var33, false, true);
         ...
         var30 = this.getHeight();
         var15.draw2(var1, var18 + 2 + var27 - var33 + var2, var21 - var24 + var3, var35, CFG.PADDING + var30, true, true);
         var1.setColor(new Color(0.0F, 0.0F, 0.0F, 0.45F));
         ImageManager.getImage(Images.gradient)
            .draw(
               var1,
