...
public class Menu_RandomGame_Civilizations_Select_Alphabet extends SliderMenu {
   ...
   public Menu_RandomGame_Civilizations_Select_Alphabet() {
      ...
      menuElements.add(new Button_Menu_Classic_Search("", CFG.PADDING * 2, 0, CFG.PADDING, CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT, true) {
         ...
         public String getTextToDraw() {
            return Menu_RandomGame_Civilizations_Select_Alphabet.this.nSearch + ": " + super.getTextToDraw();
         }
      });
      ...
      for (int var16 = 0; var16 < iSize; var16++) {
         if (!CFG.randomGameManager.isTagTaken(tagsSPLITED_ED[var16])) {
            boolean addChar = true;
