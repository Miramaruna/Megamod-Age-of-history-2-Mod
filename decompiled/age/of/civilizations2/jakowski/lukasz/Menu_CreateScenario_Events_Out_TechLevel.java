...
public class Menu_CreateScenario_Events_Out_TechLevel extends SliderMenu {
      ...
      menuElements.add(
         new Slider_BG(
            ...
            public String getDrawText() {
               return (this.getCurrent() > 0 ? "+" : "") + this.getCurrent() / 100.0F;
            }
         }
      );
   ...
   public void updateLanguage() {
      ...
      this.getTitle().setText(CFG.langManager.get("UpdateTechnologyLevel"));
   }
