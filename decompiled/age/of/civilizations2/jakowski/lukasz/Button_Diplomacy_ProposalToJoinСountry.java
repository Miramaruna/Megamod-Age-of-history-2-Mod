...
public class Button_Diplomacy_ProposalToJoinСountry extends Button {
   public Image lFlag = null;
   public boolean row = false;
   public String sCivTag;
   public int iImage;
   public String sTextCostGold;
   public String sTextCostDiplomacy;
   public int iTextCostGoldWidth;
   public int iTextCostDiplomacyWidth;

   public Button_Diplomacy_ProposalToJoinСountry(String text, int iPosX, int iPosY, int iWidth, int image, boolean isClickable, boolean nCheckbox) {
      super.init(
         CFG.langManager.get(text),
         0,
         iPosX,
         iPosY,
         iWidth,
      ...
      return this.checkbox
         ? new Button.Checkbox() {
            ...
            public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
               if (Button_Diplomacy_ProposalToJoinСountry.this.getCheckboxState()) {
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Button_Diplomacy_ProposalToJoinСountry.this.getPosX() + iTranslateX,
                     Button_Diplomacy_ProposalToJoinСountry.this.getPosY() - ImageManager.getImage(Images.slider_gradient).getHeight() + 1 + iTranslateY,
                     Button_Diplomacy_ProposalToJoinСountry.this.getWidth() / 6,
                     Button_Diplomacy_ProposalToJoinСountry.this.getHeight() - 2,
                     false,
                     false
                  );
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     Button_Diplomacy_ProposalToJoinСountry.this.getPosX() + iTranslateX,
                     Button_Diplomacy_ProposalToJoinСountry.this.getPosY() - ImageManager.getImage(Images.slider_gradient).getHeight() + 1 + iTranslateY,
                     Button_Diplomacy_ProposalToJoinСountry.this.getWidth() / 10,
                     Button_Diplomacy_ProposalToJoinСountry.this.getHeight() - 2,
                     false,
                     false
                  );
               ...
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Button_Diplomacy_ProposalToJoinСountry.this.getPosX() + iTranslateX,
                     Button_Diplomacy_ProposalToJoinСountry.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() + 1 + iTranslateY,
                     Button_Diplomacy_ProposalToJoinСountry.this.getWidth(),
                     CFG.PADDING,
                     false,
                     false
                  );
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Button_Diplomacy_ProposalToJoinСountry.this.getPosX() + iTranslateX,
                     Button_Diplomacy_ProposalToJoinСountry.this.getPosY()
                        - ImageManager.getImage(Images.gradient).getHeight()
                        + Button_Diplomacy_ProposalToJoinСountry.this.getHeight()
                        - 1
                        + iTranslateY
                        - CFG.PADDING,
                     Button_Diplomacy_ProposalToJoinСountry.this.getWidth(),
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ImageManager.getImage(this.iImage)
         .draw(
            oSB,
            this.getPosX() + (Button_Diplomacy.iDiploWidth - ImageManager.getImage(this.iImage).getWidth()) / 2 + iTranslateX,
            this.getPosY() + this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2 - ImageManager.getImage(this.iImage).getHeight() + iTranslateY,
            ImageManager.getImage(this.iImage).getWidth(),
            ImageManager.getImage(this.iImage).getHeight()
         );
      ...
      CFG.drawText(
         ...
         this.getPosX()
            ...
            + iTranslateX,
         this.getPosY() + CFG.PADDING / 2 + this.getHeight() / 2 - this.getHeight() / 4 - (int)(CFG.TEXT_HEIGHT * 0.6F / 2.0F) + iTranslateY,
      ...
      Rectangle clipBounds = new Rectangle(
         ...
         this.getWidth() - this.getRightWidth() - Button_Diplomacy.iDiploWidth,
         -this.getHeight()
      );
      oSB.flush();
   ...
   public final int getRightWidth() {
      return Math.max(
         this.iTextCostGoldWidth + CFG.PADDING * 3 + (int)(ImageManager.getImage(Images.top_gold).getWidth() * this.getImageScale(Images.top_gold)),
         this.iTextCostDiplomacyWidth
            + CFG.PADDING * 3
            + (int)(ImageManager.getImage(Images.top_gold).getWidth() * this.getImageScale(Images.top_diplomacy_points))
      );
   }
