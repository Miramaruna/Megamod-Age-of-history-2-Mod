...
public class Button_NS_Diseases extends Button {
   ...
   public Button_NS_Diseases(int iPosX, int iPosY, int iWidth) {
      super.init(CFG.langManager.get("Diseases"), 0, iPosX, iPosY, iWidth, CFG.BUTTON_HEIGHT * 4 / 5, true, true, false, false);
      int tempDeaths = 0;

      for (int i = 0; i < CFG.game.getProvincesSize(); i++) {
         tempDeaths += CFG.game.getProvince(i).saveProvinceData.iPlaguesDeaths;
      }

      this.sDeaths = CFG.getNumberWithSpaces("" + tempDeaths);
      ...
      this.relationColor = tempDeaths > 0 ? CFG.COLOR_TEXT_MODIFIER_NEGATIVE2 : CFG.COLOR_TEXT_MODIFIER_NEUTRAL2;
   }
            ...
            public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
               if (Button_NS_Diseases.this.getCheckboxState()) {
                  ...
                  ImageManager.getImage(Images.patt_square)
                     .draw2(
                        oSB,
                        Button_NS_Diseases.this.getPosX() + iTranslateX,
                        Button_NS_Diseases.this.getPosY() - ImageManager.getImage(Images.patt_square).getHeight() + 1 + iTranslateY,
                        Button_Diplomacy.iDiploWidth,
                        Button_NS_Diseases.this.getHeight() - 2,
                        true,
                        false
                     );
                  ...
                  ImageManager.getImage(Images.gradient)
                     .draw(
                        oSB,
                        Button_NS_Diseases.this.getPosX() + iTranslateX,
                        Button_NS_Diseases.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() + 1 + iTranslateY,
                        Button_Diplomacy.iDiploWidth,
                        Button_NS_Diseases.this.getHeight() / 4,
                        false,
                        false
                     );
                  ImageManager.getImage(Images.gradient)
                     .draw(
                        oSB,
                        Button_NS_Diseases.this.getPosX() + iTranslateX,
                        Button_NS_Diseases.this.getPosY()
                           - ImageManager.getImage(Images.gradient).getHeight()
                           + Button_NS_Diseases.this.getHeight()
                           - 1
                           + iTranslateY
                           - Button_NS_Diseases.this.getHeight() / 4,
                        Button_Diplomacy.iDiploWidth,
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.disease)
         .draw(
            oSB,
            this.getPosX() + Button_Diplomacy.iDiploWidth / 2 - ImageManager.getImage(Images.disease).getWidth() / 2 + iTranslateX,
            this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.disease).getHeight() / 2 + iTranslateY
         );
      oSB.setColor(Color.WHITE);
      ImageManager.getImage(Images.population)
         .draw(
            ...
            this.getPosY()
               ...
               - (int)(ImageManager.getImage(Images.population).getHeight() * this.getImageScale(Images.population, 0.65F)) / 2
               - ImageManager.getImage(Images.population).getHeight()
               + iTranslateY,
            (int)(ImageManager.getImage(Images.population).getWidth() * this.getImageScale(Images.population, 0.65F)),
            (int)(ImageManager.getImage(Images.population).getHeight() * this.getImageScale(Images.population, 0.65F))
         );
   ...
   public void buildElementHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Diseases"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(this.sDeaths, this.relationColor));
