...
public class Text_Outliner_WarPreparations extends Text {
   public static final float FONT_SCALE = 0.7F;
   public boolean row = false;
   public int iCivID;
   public Color colorText;

   public Text_Outliner_WarPreparations(int nWarAgainst, int numOfTurns, int iPosX, int iPosY, int iWidth) {
