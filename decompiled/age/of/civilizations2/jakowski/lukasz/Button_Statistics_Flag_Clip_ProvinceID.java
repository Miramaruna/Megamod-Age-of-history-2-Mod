...
public class Button_Statistics_Flag_Clip_ProvinceID extends Button_Statistics_Flag {
   public int iProvinceID;

   public Button_Statistics_Flag_Clip_ProvinceID(int iProvinceID, String sText, int iTextPosX, int iPosX, int iPosY, int iWidth, int iHeight) {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      try {
         oSB.setColor(
            new Color(
               CFG.game.getCiv(CFG.game.getProvince(this.iProvinceID).getCivID()).getR() / 255.0F,
               CFG.game.getCiv(CFG.game.getProvince(this.iProvinceID).getCivID()).getG() / 255.0F,
               CFG.game.getCiv(CFG.game.getProvince(this.iProvinceID).getCivID()).getB() / 255.0F,
               0.85F
            )
         );
