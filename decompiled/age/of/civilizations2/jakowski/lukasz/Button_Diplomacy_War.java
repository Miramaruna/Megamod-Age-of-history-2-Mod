...
public class Button_Diplomacy_War extends Button_Statistics {
   ...
   public Button_Diplomacy_War(int nAggressor, int nDefender, int iPosX, int iPosY, int iWidth) {
      super(CFG.game.getCiv(nAggressor).getCivName(), 0, iPosX, iPosY, iWidth, Math.max(CFG.TEXT_HEIGHT + CFG.PADDING * 4, (int)(CFG.BUTTON_HEIGHT * 0.6F)));
