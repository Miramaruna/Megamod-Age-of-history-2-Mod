...
public class HistoryLog_NewColony extends HistoryLog {
   public String sMess;
   ...
   public void updateLanguage() {
      this.sMess = CFG.langManager.get("CityHasBeenFounded", CFG.game.getProvince(this.iCivB).getName());
   ...
   public void draw(SpriteBatch oSB, int nTurnID, int iPosX, int iPosY, int iWidth, int iHeight, boolean isActive) {
      this.drawLeftIcon(oSB, Images.editor_city, iPosX, iPosY, iWidth, iHeight, isActive);
