...
public class Menu_Calendar extends SliderMenu {
      ...
      menuElements.add(
         new Button_ArrowLeft(0, CFG.PADDING, CFG.BUTTON_HEIGHT, CFG.BUTTON_HEIGHT * 2 / 3) {
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(Game_Calendar.getMonthName(Game_Calendar.currentMonth - 1), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE)
               );
