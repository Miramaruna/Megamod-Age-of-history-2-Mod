...
public class Message_Vassalization_Rejected extends Message {
   public Message_Vassalization_Rejected(int fromCivID) {
      super(fromCivID, 0);
      this.messageType = Message_Type.VASSALIZATION_REJECTED;
   ...
   public void onAccept(int iCivID) {
      if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID() == iCivID) {
         ...
         lMess.add(CFG.game.getCiv(this.iFromCivID).getCivName() + ": " + CFG.langManager.get("ProposalWasRejected"));
