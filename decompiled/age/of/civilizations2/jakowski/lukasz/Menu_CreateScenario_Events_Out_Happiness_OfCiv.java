...
public class Menu_CreateScenario_Events_Out_Happiness_OfCiv extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(2).setText(CFG.langManager.get("Happiness") + ": ");
      this.getTitle().setText(CFG.langManager.get("UpdateHappinessOfCivilization"));
   }
