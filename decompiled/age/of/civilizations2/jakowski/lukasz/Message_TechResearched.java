...
public class Message_TechResearched extends Message {
   ...
   public void onAction(int iMessageID) {
      CFG.toast
         .setInView(
            CFG.langManager.get("TechnologyLevelResearched") + ": " + (int)(CFG.game.getCiv(this.iFromCivID).getTechnologyLevel() * 100.0F) / 100.0F,
   ...
   public MenuElement_Hover_v2 getHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text("" + (int)(CFG.game.getCiv(this.iFromCivID).getTechnologyLevel() * 100.0F) / 100.0F));
