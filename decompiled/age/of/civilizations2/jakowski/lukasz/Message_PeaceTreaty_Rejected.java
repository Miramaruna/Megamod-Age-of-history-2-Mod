...
class Message_PeaceTreaty_Rejected extends Message {
   protected Message_PeaceTreaty_Rejected(int fromCivID) {
      super(fromCivID, 0);
      this.messageType = Message_Type.PEACE_TREATY_REJECTED;
   ...
   public void onAccept(int iCivID) {
      if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID() == iCivID) {
         ...
         lMess.add(CFG.langManager.get("ProposalWasRejected"));
