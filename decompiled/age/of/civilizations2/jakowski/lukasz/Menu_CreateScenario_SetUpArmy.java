...
public class Menu_CreateScenario_SetUpArmy extends SliderMenu {
   public static final int DESELECT_ALL_ID = 4;
   public String sSetUpArmy;
   ...
   public Menu_CreateScenario_SetUpArmy() {
      ...
      menuElements.add(
         new Slide(
            ...
            CFG.BUTTON_HEIGHT * 2 + CFG.PADDING * 5 + ImageManager.getImage(Images.slide_bg).getHeight() / 2,
            false
         )
      );
