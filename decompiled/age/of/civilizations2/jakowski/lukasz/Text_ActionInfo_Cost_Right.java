...
public class Text_ActionInfo_Cost_Right extends Text_ActionInfo {
   public Text_ActionInfo_Cost_Right(String sText, int iPosX, int iPosY) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      ImageManager.getImage(Images.top_gold)
         .draw(
            oSB,
            this.getPosX() + CFG.PADDING * 3 + (int)(this.iTextWidth * 0.8F) + var6,
            this.getPosY()
               + (int)(
                     this.getHeight()
