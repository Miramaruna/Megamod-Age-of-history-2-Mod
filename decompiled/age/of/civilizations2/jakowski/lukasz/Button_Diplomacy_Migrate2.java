...
public class Button_Diplomacy_Migrate2 extends Button {
   ...
   public Button_Diplomacy_Migrate2(int fromProvinceID, int toProvinceID, int iCivID, int iPosX, int iPosY, int iWidth, boolean isClickable) {
      ...
      this.sTextCostGold = "" + CFG.ideologiesManager.getIdeology(CFG.game.getCiv(iCivID).getIdeologyID()).COST_OF_MOVE / 10.0F;
      ...
      ImageManager.getImage(Images.top_movement_points)
         .draw(
            ...
            this.getPosY()
               ...
               + this.getHeight() / 2
               - this.getHeight() / 4
               - (int)(ImageManager.getImage(Images.top_movement_points).getHeight() * this.getImageScale(Images.top_movement_points) / 2.0F)
      ...
      ImageManager.getImage(Images.research)
         .draw(
            ...
            this.getPosX()
               + this.getWidth()
               - CFG.PADDING * 2
               - (int)(ImageManager.getImage(Images.research).getWidth() * this.getImageScale(Images.research))
               + iTranslateX,
            this.getPosY()
               - CFG.PADDING / 2
               + this.getHeight() / 2
               + this.getHeight() / 4
               - (int)(ImageManager.getImage(Images.research).getHeight() * this.getImageScale(Images.research) / 2.0F)
               - ImageManager.getImage(Images.research).getHeight()
               + iTranslateY,
            (int)(ImageManager.getImage(Images.research).getWidth() * this.getImageScale(Images.research)),
            (int)(ImageManager.getImage(Images.research).getHeight() * this.getImageScale(Images.research))
         );
   ...
   public final int getRightWidth() {
      return Math.max(
         ...
         this.iTextCostDiplomacyWidth
            + CFG.PADDING * 3
            + (int)(ImageManager.getImage(Images.top_movement_points).getWidth() * this.getImageScale(Images.research))
      );
   }
