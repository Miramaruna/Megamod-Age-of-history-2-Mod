...
public class Menu_CreateScenario_Events_Out_UpdatePopulation_OfCiv extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(2).setText(CFG.langManager.get("Percentage") + ": ");
      this.getTitle().setText(CFG.langManager.get("UpdatePopulationOfCiv"));
   }
