...
public class Game_Render {
   ...
   public static Game_Render.Renderer oRenderer;
   public static Game_Render.DrawMoveUnits oDrawMoveUnits;
   public static float DISABLE_INNER_BORDERS = 0.4F;
   public static float DISABLE_SEA_ARMIES = 0.65F;
   public static float CIV_NAMES_START_DRAWING_NAMES_MAP_SCALE = 1.0F;
   public static float CIVILIZATION_NAMES_ALPHA = 1.0F;
   public static long CIVILIZATIONS_NAMES_TIME = 0L;
   public static Game_Render.Renderer_CivRegionNames oRenderer_CivRegionNames;
   public static List<Integer> lRegions_Civs = new ArrayList<>();
   public static List<List<Integer>> lRegions_Civs_RegionsID = new ArrayList<>();
   ...
   public static final void updateRegionsInView() {
      if (CIVILIZATIONS_NAMES_TIME == 0L) {
         ...
         CIVILIZATION_NAMES_ALPHA = 0.1F
            + 0.9F * (float)(System.currentTimeMillis() - CIVILIZATIONS_NAMES_TIME) / CFG.settingsManager.CIVILIZATIONS_NAMES_INTERVAL;
   ...
   public static final void drawWithoutScale(SpriteBatch oSB) {
         ...
         if (CFG.gameAction.getActiveTurnState() == Game_Action.TurnStates.TURN_ACTIONS) {
            ...
            try {
               if (CFG.viewsManager.getActiveViewID() == -1 || CFG.viewsManager.getActiveViewID() >= 0 && CFG.viewsManager.getActiveView().canMoveArmy) {
                  oDrawMoveUnits = CFG.SPECTATOR_MODE ? new Game_Render.DrawMoveUnits() {
                     @Override
                     public void drawMoveUnits(SpriteBatch oSB) {
   ...
   public static final void updateRenderer_CivNames() {
      oRenderer_CivRegionNames = (
         ...
         ? new Game_Render.Renderer_CivRegionNames() {
            @Override
   ...
   public static final void updateRenderer() {
      ...
      oRenderer = CFG.menuManager.getInGameView()
            || CFG.menuManager.getInGame_PeaceTreaty()
            || CFG.menuManager.getInGame_PeaceTreaty_Response()
            || SaveManager.gameCanBeContinued
               && (CFG.menuManager.getInSettingsProvince() || CFG.menuManager.getInGame_ScreenShot() || CFG.menuManager.getInSettings())
         ? (
            (!CFG.menuManager.getInGame_PeaceTreaty() || !Menu_PeaceTreaty_Response.DRAW_TREATY_PROVINCES)
                  && (!CFG.menuManager.getInGame_PeaceTreaty_Response() || !Menu_PeaceTreaty_Response.DRAW_TREATY_PROVINCES)
               ? (
                  CFG.gameAction.getActiveTurnState() == Game_Action.TurnStates.LOAD_AI_RTO && CFG.gameAction.showNextPlayerTurnView()
                     ...
                     : (
                        CFG.viewsManager.getActiveViewID() >= 0
                           ? CFG.viewsManager.getActiveView().oRenderer
                           : (
                              !CFG.isDesktop() && CFG.menuManager.getVisible_InGame_FlagAction() && !CFG.menuManager.getVisible_InGame_FlagAction_Console()
                                 ? new Game_Render.Renderer() {
                                    @Override
                                    public void draw(SpriteBatch oSB) {
                                 ...
                                 : (CFG.FOG_OF_WAR == 2 ? new Game_Render.Renderer() {
                                    ...
                                    public void draw(SpriteBatch oSB) {
                                       Game_Render.drawInGame(oSB);
                                       if (CFG.map.getMapScale().getCurrentScale() < 1.0F
                                          && CFG.map.getMapScale().getCurrentScale() > Game_Render.DISABLE_INNER_BORDERS) {
         ...
         : (
            CFG.menuManager.getInGame_CreateAVassal()
               ? (CFG.viewsManager.getActiveViewID() >= 0 ? CFG.viewsManager.getActiveView().oRenderer : (CFG.FOG_OF_WAR == 2 ? new Game_Render.Renderer() {
                  @Override
                  public void draw(SpriteBatch oSB) {
                     Game_Render_Province.drawProvincesInGame(oSB);
                  ...
                  CFG.menuManager.getInVictory()
                     ...
                     : (
                        !CFG.menuManager.getInGame_Timeline() && !CFG.menuManager.getInVictory()
                           ? (
                              !CFG.menuManager.getInGame_ScreenShot() && !CFG.menuManager.getInVictory()
                                 ? (
                                       ...
                                       ? (CFG.FOG_OF_WAR == 2 ? new Game_Render.Renderer() {
                                          ...
                                          public void drawWithoutScale(SpriteBatch oSB) {
                                             if (Game_Render.drawInGame_WithoutScale_MapDetails()) {
                                                ...
                                                CFG.game
                                                   .drawAllCivilizations_Flag_InCapitals_WithCrown_FogOfWarDiscovery(
                                                      oSB, CFG.map.getMapScale().getCurrentScale()
                                                   );
                                             } else if (CFG.map.getMapScale().getCurrentScale() < 1.0F && !Game_Render.DISABLE_CITIES) {
                                                CFG.game.drawCities_OnlyCapitals_Images_FogOfWarDiscovery(oSB, CFG.map.getMapScale().getCurrentScale());
                                             }
                                          ...
                                          CFG.menuManager.getInGame_ShowProvinces()
                                             ...
                                             : (
                                                CFG.menuManager.getInGame_TradeSelectCiv()
                                                   ? (CFG.FOG_OF_WAR == 2 ? new Game_Render.Renderer() {
                                                      ...
                                                      public void drawWithoutScale(SpriteBatch oSB) {
                                                         if (Game_Render.drawInGame_WithoutScale_MapDetails()) {
                                                            ...
                                                            CFG.game
                                                               .drawCities_OnlyCapitals_Images_FogOfWarDiscovery(oSB, CFG.map.getMapScale().getCurrentScale());
                                                         }
                                                      }
                                                      ...
                                                      public void drawWithoutScale(SpriteBatch oSB) {
                                                         if (Game_Render.drawInGame_WithoutScale_MapDetails()) {
                                                            CFG.game.drawCities(oSB, CFG.map.getMapScale().getCurrentScale());
                                                            CFG.game
                                                               .drawAllCivilizations_Flag_InCapitals_WithCrown(oSB, CFG.map.getMapScale().getCurrentScale());
                                                         } else if (CFG.map.getMapScale().getCurrentScale() < 1.0F && !Game_Render.DISABLE_CITIES) {
                                                            CFG.game.drawCities_OnlyCapitals_Images(oSB, CFG.map.getMapScale().getCurrentScale());
                                                         }
                                                      }
                                                   ...
                                                   : (
                                                      !CFG.menuManager.getInStartGameMenu() && !CFG.menuManager.getInEndGameMenu()
                                                         ? (
                                                               ...
                                                               ? (CFG.FOG_OF_WAR == 2 ? new Game_Render.Renderer() {
                                                                  ...
                                                                  public void drawWithoutScale(SpriteBatch oSB) {
                                                                     if (Game_Render.drawInGame_WithoutScale_MapDetails()) {
                                                                        try {
                                                                           if (CFG.game
                                                                                 .getProvince(CFG.formableCivs_GameData.getCapitalProvinceID())
                                                                                 .getWasteland()
                                                                              < 0) {
                                                                              CFG.game
                                                                                 .drawCities_OnlyFormableCivCapital(
                                                                                    oSB, CFG.map.getMapScale().getCurrentScale()
                                                                                 );
                                                                           }
                                                                        } catch (IndexOutOfBoundsException var3) {
                                                                              ...
                                                                              CFG.viewsManager.getActiveViewID() >= 0
                                                                                 ...
                                                                                 : new Game_Render.Renderer() {
                                                                                    ...
                                                                                    public void draw(SpriteBatch oSB) {
                                                                                       Game_Render_Province.drawProvinces(oSB);
                                                                                       CFG.game.drawActiveProvince(oSB);
                                                                                       if (CFG.map.getMapScale().getCurrentScale()
                                                                                          >= Game_Render.DISABLE_INNER_BORDERS) {
                                                                                          Game_Render_Province.drawProvincesBorder(oSB);
                                                                                       } else {
                                                                                          Game_Render_Province.drawProvincesBorder_Only_CivilizationBorder_InGame(
                                                                                             oSB
                                                                                          );
                                                                                       }
                                                                                       ...
                                                                                       if (CFG.map.getMapScale().getCurrentScale() < 1.0F
                                                                                          ...
                                                                                          if (Game_Render.drawCivNamesInCreateNewGame) {
                                                                                             CFG.game
                                                                                                .drawAllCivilizations_Name_Flag_InCapitals_Vassals(oSB, 1.0F);
                                                                                          } else {
                                                                                             CFG.game.drawAllCivilizations_Flag_InCapitals_WithCrown(oSB, 1.0F);
                                                                                          }
                                                                                       }
                                                                                    ...
                                                                                    public void drawWithoutScale(SpriteBatch oSB) {
                                                                                       if (Game_Render.drawInGame_WithoutScale_MapDetails()) {
                                                                                          CFG.game.drawCities(oSB, CFG.map.getMapScale().getCurrentScale());
                                                                                          CFG.game
                                                                                             .drawCities_ActiveProvince(
                                                                                                oSB, CFG.map.getMapScale().getCurrentScale()
                                                                                             );
                                                                                          if (Game_Render.drawCivNamesInCreateNewGame) {
                                                                                             CFG.game
                                                                                                .drawAllCivilizations_Name_Flag_InCapitals_Vassals(
                                                                                                   oSB, CFG.map.getMapScale().getCurrentScale()
                                                                                                );
                                                                                          } else {
                                                                                             CFG.game
                                                                                                .drawAllCivilizations_Flag_InCapitals_WithCrown(
                                                                                                   oSB, CFG.map.getMapScale().getCurrentScale()
                                                                                                );
                                                                                          }
                                                                                       }
                                                                              ...
                                                                              !CFG.menuManager.getInRandomGame()
                                                                                 ...
                                                                                 ? (
                                                                                    CFG.menuManager.getInManageDiplomacy()
                                                                                       ...
                                                                                       ? new Game_Render.Renderer() {
                                                                                          ...
                                                                                          public void draw(SpriteBatch oSB) {
                                                                                             ...
                                                                                             if (CFG.map.getMapScale().getCurrentScale() <= 1.0F) {
                                                                                                ...
                                                                                                CFG.game
                                                                                                   .drawAllCivilizations_Flag_InCapitals_WithCrown(oSB, 1.0F);
                                                                                                if (CFG.game.getActiveProvinceID() >= 0
                                                                                                   ...
                                                                                                   && !CFG.game
                                                                                                      ...
                                                                                                      .getIsCapital()) {
                                                                                                   CFG.game
                                                                                                      .drawCivilization_Name_Flag(
                                                                                                         oSB, CFG.game.getActiveProvinceID(), 1.0F
                                                                                                      );
                                                                                                }
                                                                                             }
                                                                                          }
                                                                                       ...
                                                                                       : (
                                                                                          CFG.menuManager.getInNewGamePlayers()
                                                                                             ? new Game_Render.Renderer() {
                                                                                                @Override
                                                                                                public void draw(SpriteBatch oSB) {
                                                                                                   Game_Render_Province.drawProvinces(oSB);
                                                                                                   ...
                                                                                                   if (CFG.map.getMapScale().getCurrentScale() <= 0.25F) {
                                                                                                      CFG.game
                                                                                                         .drawAllCivilizations_Name_Flag_InCapitals(oSB, 1.0F);
                                                                                                   }
                                                                                                }
                                                                                                ...
                                                                                                public void drawWithoutScale(SpriteBatch oSB) {
                                                                                                   if (CFG.map.getMapScale().getCurrentScale() > 0.25F) {
                                                                                                      CFG.game
                                                                                                         .drawAllCivilizations_Name_Flag_InCapitals(
                                                                                                            oSB, CFG.map.getMapScale().getCurrentScale()
                                                                                                         );
                                                                                                   }
                                                                                                }
                                                                                                ...
                                                                                                CFG.menuManager.getInSelectCiv()
                                                                                                   ...
                                                                                                   : (
                                                                                                      CFG.menuManager.getInCreateScenario_Civilizations()
                                                                                                            || CFG.menuManager
                                                                                                               .getInCreateScenario_Civilizations_Select()
                                                                                                         ? new Game_Render.Renderer() {
                                                                                                            @Override
                                                                                                            public void draw(SpriteBatch oSB) {
                                                                                                               Game_Render_Province.drawProvinces(oSB);
                                                                                                               ...
                                                                                                               if (CFG.map.getMapScale().getCurrentScale()
                                                                                                                  ...
                                                                                                                  CFG.game.drawCities_All(oSB, 1.0F);
                                                                                                                  CFG.game
                                                                                                                     .drawAllCivilizations_Name_Flag_InCapitals_Crowns(
                                                                                                                        oSB, 1.0F
                                                                                                                     );
                                                                                                               }
                                                                                                            }
                                                                                                            ...
                                                                                                            CFG.menuManager.getInCreateScenario_Assign()
                                                                                                               ? new Game_Render.Renderer() {
                                                                                                                  ...
                                                                                                                  public void draw(SpriteBatch oSB) {
                                                                                                                     Game_Render_Province.drawProvinces(oSB);
                                                                                                                     CFG.game.drawActiveProvince(oSB);
                                                                                                                     Game_Render_Province.drawProvincesBorder(
                                                                                                                        oSB
                                                                                                                     );
                                                                                                                     CFG.game.drawActiveProvinceBorder(oSB);
                                                                                                                     if (CFG.map
                                                                                                                        ...
                                                                                                                        if (!CFG.VIEW_SHOW_VALUES) {
                                                                                                                           CFG.game
                                                                                                                              .drawAllProvinces_Name_Flag(
                                                                                                                                 oSB, 1.0F
                                                                                                                              );
                                                                                                                        } else {
                                                                                                                           CFG.game
                                                                                                                              .drawAllCivilizations_Flag_InCapitals(
                                                                                                                                 oSB, 1.0F
                                                                                                                              );
                                                                                                                        }
                                                                                                                     }
                                                                                                               ...
                                                                                                               : (
                                                                                                                  CFG.menuManager
                                                                                                                        .getInCreateScenario_Assign_Select()
                                                                                                                     ? new Game_Render.Renderer() {
                                                                                                                        @Override
                                                                                                                        public void draw(SpriteBatch oSB) {
                                                                                                                           Game_Render_Province.drawProvinces(
                                                                                                                              oSB
                                                                                                                           );
                                                                                                                           CFG.game.drawActiveProvince(oSB);
                                                                                                                           Game_Render_Province.drawProvincesBorder(
                                                                                                                           ...
                                                                                                                           CFG.game
                                                                                                                              .drawActiveProvinceBorder(oSB);
                                                                                                                        }

                                                                                                                        @Override
                                                                                                                        public void drawWithoutScale(
                                                                                                                           SpriteBatch oSB
                                                                                                                        ) {
                                                                                                                        }

                                                                                                                        @Override
                                                                                                                        public void drawMapDetails(
                                                                                                                           SpriteBatch oSB
                                                                                                                        ) {
                                                                                                                        }
                                                                                                                     }
                                                                                                                     : (
                                                                                                                        CFG.menuManager
                                                                                                                              .getInCreateScenario_WastelandMap()
                                                                                                                           ? new Game_Render.Renderer() {
                                                                                                                              @Override
                                                                                                                              public void draw(SpriteBatch oSB) {
                                                                                                                                 Game_Render_Province.drawProvinces(
                                                                                                                                 ...
                                                                                                                                 if (CFG.map
                                                                                                                                  ...
                                                                                                                                  {
                                                                                                                                    Game_Render_Province.drawLandProvincesBorder(
                                                                                                                                       oSB
                                                                                                                                    );
                                                                                                                                 }
                                                                                                                              }
                                                                                                                           ...
                                                                                                                           : (
                                                                                                                              CFG.menuManager
                                                                                                                                    .getInCreateScenario_SetUpArmy()
                                                                                                                                 ? new Game_Render.Renderer() {
                                                                                                                                    @Override
                                                                                                                                    public void draw(
                                                                                                                                       SpriteBatch oSB
                                                                                                                                    ) {
                                                                                                                                       Game_Render_Province.drawProvincesInGame(
                                                                                                                                          oSB
                                                                                                                                       );
                                                                                                                                       CFG.game
                                                                                                                                          ...
                                                                                                                                          CFG.menuManager
                                                                                                                                             ...
                                                                                                                                             : (
                                                                                                                                                CFG.menuManager
                                                                                                                                                      ...
                                                                                                                                                      || CFG.menuManager
                                                                                                                                                         .getInMapEditor_FormableCivs_SelectFormable()
                                                                                                                                                      || CFG.menuManager
                                                                                                                                                         .getInMapEditor_FormableCivs_SelectClaimant()
                                                                                                                                                   ? new Game_Render.Renderer() {
                                                                                                                                                      @Override
                                                                                                                                                      public void draw(
                                                                                                                                                         SpriteBatch oSB
                                                                                                                                                         ...
                                                                                                                                                         if (CFG.VIEW_SHOW_VALUES
                                                                                                                                                          ...
                                                                                                                                                          {
                                                                                                                                                            Game_Render_Province.drawProvincesBorder_DrawJustInnerBorder(
                                                                                                                                                               oSB
                                                                                                                                                            );
                                                                                                                                                         }
                                                                                                                                                   ...
                                                                                                                                                   : (
                                                                                                                                                      CFG.menuManager
                                                                                                                                                         ...
                                                                                                                                                         : (
                                                                                                                                                            CFG.menuManager
                                                                                                                                                                  .getInCreateScenario_Available_Provinces()
                                                                                                                                                               ? new Game_Render.Renderer() {
                                                                                                                                                                  @Override
                                                                                                                                                                  public void draw(
                                                                                                                                                                     SpriteBatch oSB
                                                                                                                                                               ...
                                                                                                                                                               : (
                                                                                                                                                                  CFG.menuManager
                                                                                                                                                                        .getInSelectAvailableCivilizations()
                                                                                                                                                                     ? new Game_Render.Renderer() {
                                                                                                                                                                        @Override
                                                                                                                                                                        public void draw(
                                                                                                                                                                           SpriteBatch oSB
                                                                                                                                                                        ) {
                                                                                                                                                                           Game_Render_Province.drawProvincesInCreateNewGameSelectAvailableCivs(
                                                                                                                                                                              oSB
                                                                                                                                                                           );
                                                                                                                                                                           CFG.game
                                                                                                                                                                              .drawActiveProvince(
                                                                                                                                                                              ...
                                                                                                                                                                              CFG.menuManager
                                                                                                                                                                                    ...
                                                                                                                                                                                    public void draw(
                                                                                                                                                                                       ...
                                                                                                                                                                                       if (CFG.map
                                                                                                                                                                                          ...
                                                                                                                                                                                          )
                                                                                                                                                                                        {
                                                                                                                                                                                          ...
                                                                                                                                                                                          CFG.game
                                                                                                                                                                                             .drawAllCivilizations_Name_Flag_InCapitals_AvailableCivs(
                                                                                                                                                                                                oSB,
                                                                                                                                                                                                1.0F
                                                                                                                                                                                             );
                                                                                                                                                                                       }
                                                                                                                                                                                 ...
                                                                                                                                                                                 : (
                                                                                                                                                                                    CFG.menuManager
                                                                                                                                                                                       ...
                                                                                                                                                                                       : (
                                                                                                                                                                                          CFG.menuManager
                                                                                                                                                                                                   .getInMapEditor_Create_NewContinent()
                                                                                                                                                                                                || CFG.menuManager
                                                                                                                                                                                                   .getInMapEditor_Create_NewRegion()
                                                                                                                                                                                                || CFG.menuManager
                                                                                                                                                                                                   .getInGameEditor_Create_DiplomacyPackage()
                                                                                                                                                                                                || CFG.menuManager
                                                                                                                                                                                                   .getInGameEditor_ReligionAdd()
                                                                                                                                                                                                || CFG.menuManager
                                                                                                                                                                                                   .getInGameEditor_TerrainAdd()
                                                                                                                                                                                                || CFG.menuManager
                                                                                                                                                                                                   .getInEditor_GameCivs()
                                                                                                                                                                                                || CFG.menuManager
                                                                                                                                                                                                   .getInCreateCivilization()
                                                                                                                                                                                             ? new Game_Render.Renderer() {
                                                                                                                                                                                                @Override
                                                                                                                                                                                                public void draw(
                                                                                                                                                                                                   SpriteBatch oSB
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      CFG.menuManager
                                                                                                                                                                                                         ...
                                                                                                                                                                                                         ? new Game_Render.Renderer() {
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            public void draw(
                                                                                                                                                                                                               ...
                                                                                                                                                                                                               CFG.game
                                                                                                                                                                                                                  .drawActiveProvince_HoverJust_WithoutDrawingActiveProvince(
                                                                                                                                                                                                                     oSB
                                                                                                                                                                                                                  );
                                                                                                                                                                                                               Game_Render_Province.drawProvincesBorder(
                                                                                                                                                                                                                  oSB
                                                                                                                                                                                                         ...
                                                                                                                                                                                                         : (
                                                                                                                                                                                                            CFG.menuManager
                                                                                                                                                                                                                  .getInCreateScenario_TechnologyLevels()
                                                                                                                                                                                                               ? new Game_Render.Renderer() {
                                                                                                                                                                                                                  @Override
                                                                                                                                                                                                                  public void draw(
                                                                                                                                                                                                                     SpriteBatch oSB
                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                     if (Game_Render.drawInGame_WithoutScale_MapDetails()
                                                                                                                                                                                                                        )
                                                                                                                                                                                                                      {
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        if (CFG.VIEW_SHOW_VALUES
                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                         {
                                                                                                                                                                                                                           CFG.game
                                                                                                                                                                                                                              .drawProvinces_TechnologyLevels(
                                                                                                                                                                                                                                 oSB,
                                                                                                                                                                                                                                 CFG.map
                                                                                                                                                                                                                                    .getMapScale()
                                                                                                                                                                                                                                    .getCurrentScale()
                                                                                                                                                                                                               ...
                                                                                                                                                                                                               : (
                                                                                                                                                                                                                  CFG.menuManager
                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                     : (
                                                                                                                                                                                                                        CFG.menuManager
                                                                                                                                                                                                                              .getInCreateScenario_StartingMoney()
                                                                                                                                                                                                                           ? new Game_Render.Renderer() {
                                                                                                                                                                                                                              @Override
                                                                                                                                                                                                                              public void draw(
                                                                                                                                                                                                                                 SpriteBatch oSB
                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                              CFG.menuManager
                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                 : (
                                                                                                                                                                                                                                    CFG.menuManager
                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                       : (
                                                                                                                                                                                                                                          CFG.menuManager
                                                                                                                                                                                                                                                .getInMapEditor_ProvinceBackground()
                                                                                                                                                                                                                                             ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                @Override
                                                                                                                                                                                                                                                public void draw(
                                                                                                                                                                                                                                                   SpriteBatch oSB
                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                             : (
                                                                                                                                                                                                                                                CFG.menuManager
                                                                                                                                                                                                                                                      .getInMapEditor_LoadPreDefinedBorders()
                                                                                                                                                                                                                                                   ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                      @Override
                                                                                                                                                                                                                                                      public void draw(
                                                                                                                                                                                                                                                         SpriteBatch oSB
                                                                                                                                                                                                                                                      ) {
                                                                                                                                                                                                                                                         Game_Render_Province.drawProvinces_InLoad_PreDefinedBorders(
                                                                                                                                                                                                                                                            oSB
                                                                                                                                                                                                                                                         );
                                                                                                                                                                                                                                                      }
                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                   : (
                                                                                                                                                                                                                                                      CFG.menuManager
                                                                                                                                                                                                                                                            .getInMapEditor_LoadSuggestedOwners()
                                                                                                                                                                                                                                                         ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                            @Override
                                                                                                                                                                                                                                                            public void draw(
                                                                                                                                                                                                                                                               SpriteBatch oSB
                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                         : (
                                                                                                                                                                                                                                                            CFG.menuManager
                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                               : (
                                                                                                                                                                                                                                                                  CFG.menuManager
                                                                                                                                                                                                                                                                        .getInMapEditor_WastelandMaps_Edit()
                                                                                                                                                                                                                                                                     ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                        @Override
                                                                                                                                                                                                                                                                        public void draw(
                                                                                                                                                                                                                                                                           SpriteBatch oSB
                                                                                                                                                                                                                                                                        ) {
                                                                                                                                                                                                                                                                           Game_Render_Province.drawProvincesIn_MapEditor_WastelandMaps(
                                                                                                                                                                                                                                                                              oSB
                                                                                                                                                                                                                                                                           );
                                                                                                                                                                                                                                                                           CFG.game
                                                                                                                                                                                                                                                                              .drawActiveProvince(
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        CFG.menuManager
                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                           ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                              public void draw(
                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                 Game_Render_Province.drawProvincesInGameEditorRegions(
                                                                                                                                                                                                                                                                                    oSB
                                                                                                                                                                                                                                                                                 );
                                                                                                                                                                                                                                                                                 CFG.game
                                                                                                                                                                                                                                                                                    .drawActiveProvince(
                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                 if (CFG.map
                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                  {
                                                                                                                                                                                                                                                                                    CFG.game
                                                                                                                                                                                                                                                                                       .drawProvinces_OptimizationRegions(
                                                                                                                                                                                                                                                                                          oSB,
                                                                                                                                                                                                                                                                                          1.0F
                                                                                                                                                                                                                                                                                       );
                                                                                                                                                                                                                                                                                 }
                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                           : (
                                                                                                                                                                                                                                                                              CFG.menuManager
                                                                                                                                                                                                                                                                                    .getInMapEditor_SeaProvinces()
                                                                                                                                                                                                                                                                                 ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                                    @Override
                                                                                                                                                                                                                                                                                    public void draw(
                                                                                                                                                                                                                                                                                       SpriteBatch oSB
                                                                                                                                                                                                                                                                                    ) {
                                                                                                                                                                                                                                                                                       Game_Render_Province.drawProvincesInMapEditor_SeaProvinces(
                                                                                                                                                                                                                                                                                          oSB
                                                                                                                                                                                                                                                                                       );
                                                                                                                                                                                                                                                                                       CFG.game
                                                                                                                                                                                                                                                                                          .drawActiveProvince(
                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                       if (CFG.map
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                          CFG.game
                                                                                                                                                                                                                                                                                             .drawProvinces_SeaProvincesLevels(
                                                                                                                                                                                                                                                                                                oSB,
                                                                                                                                                                                                                                                                                                1.0F
                                                                                                                                                                                                                                                                                             );
                                                                                                                                                                                                                                                                                       }
                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                 : (
                                                                                                                                                                                                                                                                                    CFG.menuManager
                                                                                                                                                                                                                                                                                          .getInMapEditor_ArmySeaBoxes()
                                                                                                                                                                                                                                                                                       ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                                          @Override
                                                                                                                                                                                                                                                                                          public void draw(
                                                                                                                                                                                                                                                                                             SpriteBatch oSB
                                                                                                                                                                                                                                                                                          ) {
                                                                                                                                                                                                                                                                                             Game_Render_Province.drawProvincesInMapEditor_ArmySeaBoxes(
                                                                                                                                                                                                                                                                                                oSB
                                                                                                                                                                                                                                                                                             );
                                                                                                                                                                                                                                                                                             CFG.game
                                                                                                                                                                                                                                                                                                .drawActiveProvince(
                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                       : (
                                                                                                                                                                                                                                                                                          CFG.menuManager
                                                                                                                                                                                                                                                                                                .getInMapEditor_Connections()
                                                                                                                                                                                                                                                                                             ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                                                @Override
                                                                                                                                                                                                                                                                                                public void draw(
                                                                                                                                                                                                                                                                                                   SpriteBatch oSB
                                                                                                                                                                                                                                                                                                ) {
                                                                                                                                                                                                                                                                                                   Game_Render_Province.drawProvincesInMapEditor_Connections(
                                                                                                                                                                                                                                                                                                      oSB
                                                                                                                                                                                                                                                                                                   );
                                                                                                                                                                                                                                                                                                   CFG.game
                                                                                                                                                                                                                                                                                                      .drawActiveProvince(
                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                   if (CFG.map
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      )
                                                                                                                                                                                                                                                                                                    {
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      if (CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV2
                                                                                                                                                                                                                                                                                                            >= 0
                                                                                                                                                                                                                                                                                                         && CFG.game
                                                                                                                                                                                                                                                                                                            .getProvince(
                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                             : (
                                                                                                                                                                                                                                                                                                !CFG.menuManager
                                                                                                                                                                                                                                                                                                         .getInSettingsProvince()
                                                                                                                                                                                                                                                                                                      && !CFG.menuManager
                                                                                                                                                                                                                                                                                                         .getInGame_ScreenShot()
                                                                                                                                                                                                                                                                                                   ? (
                                                                                                                                                                                                                                                                                                      CFG.menuManager
                                                                                                                                                                                                                                                                                                            .getInMapEditor_ArmySeaBoxes_Edit()
                                                                                                                                                                                                                                                                                                         ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                                                            @Override
                                                                                                                                                                                                                                                                                                            public void draw(
                                                                                                                                                                                                                                                                                                               SpriteBatch oSB
                                                                                                                                                                                                                                                                                                            ) {
                                                                                                                                                                                                                                                                                                               Game_Render_Province.drawProvincesInMapEditor_ArmySeaBoxes_Edit(
                                                                                                                                                                                                                                                                                                                  oSB
                                                                                                                                                                                                                                                                                                               );
                                                                                                                                                                                                                                                                                                               CFG.game
                                                                                                                                                                                                                                                                                                                  .drawActiveProvince(
                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                               if (CFG.map
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                                                  CFG.game
                                                                                                                                                                                                                                                                                                                     .drawProvinces_SeaArmyBoxes_Edit(
                                                                                                                                                                                                                                                                                                                        oSB,
                                                                                                                                                                                                                                                                                                                        1.0F
                                                                                                                                                                                                                                                                                                                     );
                                                                                                                                                                                                                                                                                                               }
                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                         : (
                                                                                                                                                                                                                                                                                                            CFG.menuManager
                                                                                                                                                                                                                                                                                                                  .getInMapEditor_ArmySeaBoxes_Add()
                                                                                                                                                                                                                                                                                                               ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                                                                  @Override
                                                                                                                                                                                                                                                                                                                  public void draw(
                                                                                                                                                                                                                                                                                                                     SpriteBatch oSB
                                                                                                                                                                                                                                                                                                                  ) {
                                                                                                                                                                                                                                                                                                                     Game_Render_Province.drawProvincesInMapEditor_ArmySeaBoxes_Add(
                                                                                                                                                                                                                                                                                                                        oSB
                                                                                                                                                                                                                                                                                                                     );
                                                                                                                                                                                                                                                                                                                     CFG.game
                                                                                                                                                                                                                                                                                                                        .drawActiveProvince(
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        CFG.FOG_OF_WAR
                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                           ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                              public void draw(
                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                 Game_Render_Province.drawProvinces_NextPlayer_Turn(
                                                                                                                                                                                                                                                                                                                                    oSB
                                                                                                                                                                                                                                                                                                                                 );
                                                                                                                                                                                                                                                                                                                                 Game_Render_Province.drawProvincesBorder_NextPlayer(
                                                                                                                                                                                                                                                                                                                                    oSB
                                                                                                                                                                                                                                                                                                                                 );
                                                                                                                                                                                                                                                                                                                                 if (CFG.map
                                                                                                                                                                                                                                                                                                                                          .getMapScale()
                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                  {
                                                                                                                                                                                                                                                                                                                                    CFG.game
                                                                                                                                                                                                                                                                                                                                       .drawCities_OnlyCapitals_FogOfWarDiscovery(
                                                                                                                                                                                                                                                                                                                                          oSB,
                                                                                                                                                                                                                                                                                                                                          1.0F
                                                                                                                                                                                                                                                                                                                                       );
                                                                                                                                                                                                                                                                                                                                 }
                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                              CFG.FOG_OF_WAR
                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                 ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                    public void draw(
                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                       Game_Render_Province.drawProvinces_CivilizationView_FogOfWar(
                                                                                                                                                                                                                                                                                                                                          oSB
                                                                                                                                                                                                                                                                                                                                       );
                                                                                                                                                                                                                                                                                                                                       Game_Render_Province.drawProvincesBorder_CivilizationView(
                                                                                                                                                                                                                                                                                                                                          oSB
                                                                                                                                                                                                                                                                                                                                       );
                                                                                                                                                                                                                                                                                                                                       if (CFG.map
                                                                                                                                                                                                                                                                                                                                                .getMapScale()
                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                 : new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                    public void draw(
                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                       Game_Render_Province.drawProvinces_CivilizationView(
                                                                                                                                                                                                                                                                                                                                          oSB
                                                                                                                                                                                                                                                                                                                                       );
                                                                                                                                                                                                                                                                                                                                       Game_Render_Province.drawProvincesBorder_CivilizationView(
                                                                                                                                                                                                                                                                                                                                          oSB
                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                    CFG.menuManager
                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                       ? new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                          public void draw(
                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                             Game_Render_Province.drawProvinces_PrintAMap(
                                                                                                                                                                                                                                                                                                                                                oSB
                                                                                                                                                                                                                                                                                                                                             );
                                                                                                                                                                                                                                                                                                                                             Game_Render_Province.drawProvincesBorder_PrintAMap(
                                                                                                                                                                                                                                                                                                                                                oSB
                                                                                                                                                                                                                                                                                                                                             );
                                                                                                                                                                                                                                                                                                                                          }
                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                   : new Game_Render.Renderer() {
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      public void draw(
                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                         if (CFG.FOG_OF_WAR
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          {
                                                                                                                                                                                                                                                                                                            Game_Render_Province.drawOccupiedProvinces_FogOfWar(
                                                                                                                                                                                                                                                                                                               oSB
                                                                                                                                                                                                                                                                                                            );
                                                                                                                                                                                                                                                                                                         } else {
                                                                                                                                                                                                                                                                                                            Game_Render_Province.drawOccupiedProvinces(
                                                                                                                                                                                                                                                                                                               oSB
                                                                                                                                                                                                                                                                                                            );
                                                                                                                                                                                                                                                                                                         }
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      public void drawWithoutScale(
                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                         if (Game_Render.drawInGame_WithoutScale_MapDetails()
                                                                                                                                                                                                                                                                                                            )
                                                                                                                                                                                                                                                                                                          {
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            CFG.game
                                                                                                                                                                                                                                                                                                               .drawProvinces_ArmyPosition_Capitals(
                                                                                                                                                                                                                                                                                                                  oSB,
                                                                                                                                                                                                                                                                                                                  CFG.map
                                                                                                                                                                                                                                                                                                                     .getMapScale()
                                                                                                                                                                                                                                                                                                                     .getCurrentScale()
                                                                                          ...
                                                                                          for (int i = 0; i < CFG.randomGameManager.getPlayersSize(); i++) {
                                                                                             if (CFG.randomGameManager.getPlayer(i).getCapitalProvinceID() >= 0
                                                                                                )
                                                                                              {
                                                                                                CFG.game
                                                                                                   .getProvince(
                                                                                                      CFG.randomGameManager.getPlayer(i).getCapitalProvinceID()
                                                                                                   )
                                                                                                   .drawProvinceFlag_CreateRandomGame(oSB, i);
                                                                                             }
                                                                                          }
                                                                                       } catch (NullPointerException var3) {
                                                                                       } catch (IndexOutOfBoundsException var4) {
                                                         ...
                                                         : (CFG.FOG_OF_WAR == 2 ? new Game_Render.Renderer() {
                                                            ...
                                                            public void drawWithoutScale(SpriteBatch oSB) {
                                                               if (CFG.map.getMapScale().getCurrentScale() > 1.0F) {
                                                                  CFG.game
                                                                     .drawCities_OnlyCapitals_StartTheGame_FogOfWarDiscovery(
                                                                        oSB, CFG.map.getMapScale().getCurrentScale()
                                                                     );
                                                               }
                                                            }
                                 ...
                                 : (CFG.FOG_OF_WAR == 2 ? new Game_Render.Renderer() {
                                    ...
                                    public void draw(SpriteBatch oSB) {
                                       ...
                                       if (CFG.map.getMapScale().getCurrentScale() >= Game_Render.DISABLE_INNER_BORDERS) {
                                          ...
                                          Game_Render_Province.drawProvincesBorder_Only_CivilizationBorder(oSB);
                                       }
