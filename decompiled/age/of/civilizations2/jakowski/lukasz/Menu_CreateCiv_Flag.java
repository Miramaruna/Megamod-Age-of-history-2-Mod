...
public class Menu_CreateCiv_Flag extends SliderMenu {
   public Menu_CreateCiv_Flag() {
      ...
      menuElements.add(
         new Button_NewGameStyle(
            null, -1, CFG.PADDING, var7 = tPosY + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING, tempW - CFG.PADDING * 2, true
         )
      );
      menuElements.add(
         new Button_NewGameStyle_Middle(
            ...
            tempW - CFG.PADDING * 2 - CFG.BUTTON_HEIGHT * 2,
            Math.max(ImageManager.getImage(Images.top_flag_frame).getHeight() + CFG.PADDING * 2, (int)(CFG.BUTTON_HEIGHT * 0.6F)),
            true
         ) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               oSB.setColor(
                  new Color(
                     CFG.flagManager.flagEdit.lDivisionColors.get(0).getR(),
                     CFG.flagManager.flagEdit.lDivisionColors.get(0).getG(),
                     CFG.flagManager.flagEdit.lDivisionColors.get(0).getB(),
                     1.0F
                  )
               );
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     this.getPosX() + this.getWidth() / 2 - ImageManager.getImage(Images.top_flag_frame).getWidth() / 2 - CFG.PADDING - 1 + iTranslateX,
                     this.getPosY() + CFG.PADDING - ImageManager.getImage(Images.gradient).getHeight() + iTranslateY,
                     1,
                     (this.getHeight() - CFG.PADDING * 2) / 2,
                     false,
                     true
                  );
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     this.getPosX() + this.getWidth() / 2 - ImageManager.getImage(Images.top_flag_frame).getWidth() / 2 - CFG.PADDING - 1 + iTranslateX,
                     this.getPosY() + CFG.PADDING - ImageManager.getImage(Images.gradient).getHeight() + (this.getHeight() - CFG.PADDING * 2) / 2 + iTranslateY,
                     1,
                     (this.getHeight() - CFG.PADDING * 2) / 2
                  );
               oSB.setColor(Color.WHITE);
               CFG.flagManager
                  .drawDivision_FlagFrameSize(
                     oSB,
                     this.getPosX() + this.getWidth() / 2 - ImageManager.getImage(Images.top_flag_frame).getWidth() / 2 + iTranslateX,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.top_flag_frame).getHeight() / 2 + iTranslateY
                  );
            }
         }
      );
      ...
      menuElements.add(
         new Button_NewGameStyle_Right(
            ">>",
            -1,
            tempW - CFG.PADDING - CFG.BUTTON_HEIGHT,
            tPosY,
            CFG.BUTTON_HEIGHT,
            Math.max(ImageManager.getImage(Images.top_flag_frame).getHeight() + CFG.PADDING * 2, (int)(CFG.BUTTON_HEIGHT * 0.6F)),
            true
      ...
      for (int i = 1; i < CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers; i++) {
         menuElements.add(
            new Button_NewGameStyle(
               "",
               -1,
               ...
               public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                  oSB.setColor(
                     new Color(
                        CFG.flagManager.flagEdit.lDivisionColors.get(this.iCurrent).getR(),
                        CFG.flagManager.flagEdit.lDivisionColors.get(this.iCurrent).getG(),
                        CFG.flagManager.flagEdit.lDivisionColors.get(this.iCurrent).getB(),
                        1.0F
                     )
                  );
                  ImageManager.getImage(Images.gradient)
      ...
      for (int var6 = 0; var6 < CFG.flagManager.flagEdit.lOverlays.size(); var6++) {
         menuElements.add(
            new Button_NewGameStyle_Left(
               "",
               0,
               ...
               public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
                  ...
                  ImageManager.getImage(Images.pickeIcon)
                     .draw(
                        ...
                        this.getPosY()
                           + this.getHeight() / 2
                           - ImageManager.getImage(Images.pickeIcon).getHeight()
         ...
         menuElements.add(
            new Button_NewGameStyle_Middle(
               ...
               CFG.PADDING + CFG.BUTTON_HEIGHT,
               tPosY,
               tempW - CFG.PADDING * 2 - CFG.BUTTON_HEIGHT * 3,
               Math.max(ImageManager.getImage(Images.top_flag_frame).getHeight() + CFG.PADDING * 2, (int)(CFG.BUTTON_HEIGHT * 0.6F)),
               true
            ) {
               public int iCurrent;
         ...
         menuElements.get(menuElements.size() - 1).setCurrent(var6);
         menuElements.add(
            new Button_NewGameStyle_Middle(
               "",
               0,
               tempW - CFG.PADDING - CFG.BUTTON_HEIGHT * 2,
               tPosY,
               CFG.BUTTON_HEIGHT,
               Math.max(ImageManager.getImage(Images.top_flag_frame).getHeight() + CFG.PADDING * 2, (int)(CFG.BUTTON_HEIGHT * 0.6F)),
               true
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(1).setText(CFG.langManager.get("AddNewOverlay"));
   }
   ...
   public final void actionElement(int iID) {
      if (iID > 4 && iID <= 4 + CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers - 1) {
         if (CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID == iID - 5 + 1 && CFG.menuManager.getColorPicker().getVisible()) {
            ...
            CFG.menuManager
               .getColorPicker()
               .setActiveRGBColor(
                  CFG.flagManager.flagEdit.lDivisionColors.get(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID).getR(),
                  CFG.flagManager.flagEdit.lDivisionColors.get(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID).getG(),
                  CFG.flagManager.flagEdit.lDivisionColors.get(CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID).getB()
               );
            CFG.menuManager.getColorPicker().setVisible(true, ColorPicker_AoC.PickerAction.EDITOR_CIV_FLAG_DIVISION_COLOR);
         }
      } else if (iID > 4 + CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers - 1) {
         if ((iID - 5 - CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers + 1) % 4 == 0) {
            if (CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID == (iID - 5 - CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers + 1) / 4
               && CFG.menuManager.getColorPicker().getVisible()) {
               CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID = -1;
               CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID = -1;
               CFG.menuManager.getColorPicker().setVisible(false, null);
            } else {
               CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID = (iID - 5 - CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers + 1) / 4;
               CFG.menuManager
                  .getColorPicker()
                  .setActiveRGBColor(
                     CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).oColor.getR(),
                     CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).oColor.getG(),
                     CFG.flagManager.flagEdit.lOverlays.get(CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID).oColor.getB()
                  );
               CFG.menuManager.getColorPicker().setVisible(true, ColorPicker_AoC.PickerAction.EDITOR_CIV_FLAG_OVERLAY_COLOR);
            }
         } else if ((iID - 5 - CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers + 1) % 4 == 1) {
            CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID = (iID - 5 - CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers + 1) / 4;
            CFG.menuManager.getColorPicker().setVisible(false, null);
            CFG.menuManager.setVisibleCreateCiv_Overlay(true);
            CFG.menuManager.setVisibleCreateCiv_Flag(false);
         } else if ((iID - 5 - CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers + 1) % 4 == 2) {
            CFG.flagManager.moveOverlayUp((iID - 5 - CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers + 1) / 4);
            CFG.menuManager.rebuildCreateCiv_Flag();
            CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID = -1;
            CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID = -1;
            CFG.menuManager.getColorPicker().setVisible(false, null);
         } else if ((iID - 5 - CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers + 1) % 4 == 3) {
            CFG.flagManager.removeOverlay((iID - 5 - CFG.flagManager.lDivisions.get(CFG.flagManager.flagEdit.iDivisionID).iLayers + 1) / 4);
            CFG.menuManager.rebuildCreateCiv_Flag();
            CFG.EDIT_ALLIANCE_NAMES_BUNDLE_ID = -1;
            CFG.MANAGE_DIPLOMACY_CUSTOMIZE_RELATIONS_CIV_ID = -1;
            CFG.menuManager.getColorPicker().setVisible(false, null);
      ...
      switch (iID) {
         ...
         case 2:
            ...
            CFG.toast
               .setInView(
                  "ID: [" + CFG.flagManager.flagEdit.iDivisionID + "/" + (CFG.flagManager.lDivisions.size() - 1) + "]", CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
               );
            return;
         case 3:
