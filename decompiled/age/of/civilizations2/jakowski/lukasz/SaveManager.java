...
public class SaveManager {
   ...
   public static boolean gameCanBeContinued = false;
   public static int iTurnsSinceLastSave = 0;
   public static boolean gameSaved = false;
   public static boolean forceShowNextPlayerTurnView = false;
      ...
      try {
         ...
         try {
            FileHandle file = CFG.readLocalFiles()
               ? Gdx.files.local("saves/games/" + CFG.map.getFile_ActiveMap_Path() + "Age_of_Civilizations")
               : Gdx.files.internal("saves/games/" + CFG.map.getFile_ActiveMap_Path() + "Age_of_Civilizations");
         ...
         try {
            if (CFG.isDesktop()) {
               ...
               if ((fileReadData2 = Gdx.files.local("saves/games/" + CFG.map.getFile_ActiveMap_Path() + saveTag + "/" + saveTag + ".json")).exists()) {
         ...
         try {
            ...
            fileReadData3 = CFG.readLocalFiles()
               ? Gdx.files.local("saves/games/" + CFG.map.getFile_ActiveMap_Path() + saveTag + "/TS/TURN/Age_of_Civilizations")
               : Gdx.files.internal("saves/games/" + CFG.map.getFile_ActiveMap_Path() + saveTag + "/TS/TURN/Age_of_Civilizations");
            String tRead = fileReadData3.readString();
            turnSavesID = Integer.parseInt(tRead) + 1;
            FileHandle fileSave = Gdx.files.local("saves/games/" + CFG.map.getFile_ActiveMap_Path() + saveTag + "/TS/TURN/Age_of_Civilizations");
            fileSave.writeString("" + turnSavesID, false);
         } catch (GdxRuntimeException var1158) {
            FileHandle fileSavex = Gdx.files.local("saves/games/" + CFG.map.getFile_ActiveMap_Path() + saveTag + "/TS/TURN/Age_of_Civilizations");
            fileSavex.writeString("" + turnSavesID, false);
         }
         ...
         try {
            FileHandle file4 = Gdx.files.local("saves/games/" + CFG.map.getFile_ActiveMap_Path() + saveTag + "/TS/TURN/" + saveTag + "_C_" + turnSavesID);
   ...
   public static final void saveGame_OLD() {
      try {
         Gdx.app.log("AoC", "saveGame: BEGIN");
         CFG.toast.setInView(CFG.langManager.get("Saving") + ".", CFG.COLOR_TEXT_NUM_OF_PROVINCES);
         CFG.toast.setTimeInView(6000);
         ...
         try {
            ...
            FileHandle fileSave = Gdx.files.local("saves/games/" + CFG.map.getFile_ActiveMap_Path() + saveTag + "/TS/TURN/Age_of_Civilizations");
            fileSave.writeString("" + turnSavesID, false);
         } catch (GdxRuntimeException var186) {
            FileHandle fileSavex = Gdx.files.local("saves/games/" + CFG.map.getFile_ActiveMap_Path() + saveTag + "/TS/TURN/Age_of_Civilizations");
            fileSavex.writeString("" + turnSavesID, false);
         }
   ...
   public static final void deleteSavedGame(int i) {
      ...
      if (i < tSplted.length) {
         ...
         try {
            FileHandle fileReadData3 = null;
            fileReadData3 = CFG.readLocalFiles()
               ? Gdx.files.local("saves/games/" + CFG.map.getFile_ActiveMap_Path() + tSplted[i] + "/TS/TURN/Age_of_Civilizations")
               : Gdx.files.internal("saves/games/" + CFG.map.getFile_ActiveMap_Path() + tSplted[i] + "/TS/TURN/Age_of_Civilizations");
            String tRead = fileReadData3.readString();
            turnSavesID = Integer.parseInt(tRead) + 1;

            for (int j = 0; j < turnSavesID; j++) {
               try {
                  Gdx.files.local("saves/games/" + CFG.map.getFile_ActiveMap_Path() + tSplted[i] + "/TS/TURN/" + tSplted[i] + "_C_" + j).delete();
