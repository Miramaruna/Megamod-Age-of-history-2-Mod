...
public class Text_Economy_Balance extends Text {
   ...
   public Text_Economy_Balance(String sText, String sText2, int iPosX, int iPosY, int iWidth, int iHeight) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      ImageManager.getImage(Images.top_gold)
         .draw(
            ...
            this.getPosX()
               ...
               - CFG.PADDING
               - CFG.PADDING / 2
               - (int)(this.getTextWidth() * 0.85F)
               - CFG.PADDING
               - (int)(ImageManager.getImage(Images.top_gold).getWidth() * this.getImageScale())
               + iTranslateX,
            this.getPosY()
               - ImageManager.getImage(Images.top_gold).getHeight()
               + (this.getHeight() - (int)(ImageManager.getImage(Images.top_gold).getHeight() * this.getImageScale())) / 2
               + iTranslateY,
            (int)(ImageManager.getImage(Images.top_gold).getWidth() * this.getImageScale()),
            (int)(ImageManager.getImage(Images.top_gold).getHeight() * this.getImageScale())
         );
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosY() + (int)((this.getHeight() - this.iTextHeight * 0.75F) / 2.0F) + iTranslateY,
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.getText(),
         this.getPosX() + this.getWidth() - CFG.PADDING - CFG.PADDING / 2 - (int)(this.getTextWidth() * 0.85F) + iTranslateX,
         this.getPosY() + (int)((this.getHeight() - this.iTextHeight * 0.9F) / 2.0F) + iTranslateY,
         this.textColor
      );
   ...
   public final float getImageScale() {
      return this.iTextHeight * 0.85F / ImageManager.getImage(Images.top_gold).getHeight();
   }
