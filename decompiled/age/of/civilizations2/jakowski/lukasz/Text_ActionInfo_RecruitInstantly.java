...
public class Text_ActionInfo_RecruitInstantly extends Text_ActionInfo {
   public Text_ActionInfo_RecruitInstantly(String sText, int iPosX, int iPosY) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      ImageManager.getImage(Images.civ_name_bg)
         .draw2(
            ...
            (int)(this.getWidth() * 0.8F) + CFG.PADDING * 3,
      ...
      ImageManager.getImage(Images.diplo_army)
         .draw(
            oSB,
            this.getPosX() + CFG.PADDING + var6,
            this.getPosY()
               + (int)((this.getHeight() - ImageManager.getImage(Images.diplo_army).getHeight() * this.getImageScale()) / 2.0F)
               - ImageManager.getImage(Images.flag_rect).getHeight()
               + iTranslateY,
            (int)(ImageManager.getImage(Images.diplo_army).getWidth() * this.getImageScale()),
            (int)(ImageManager.getImage(Images.diplo_army).getHeight() * this.getImageScale())
         );
      CFG.fontMain.getData().setScale(0.8F);
      CFG.drawTextWithShadow(
         oSB,
         this.sText,
         this.getPosX() + (int)(ImageManager.getImage(Images.diplo_army).getWidth() * this.getImageScale()) + CFG.PADDING * 2 + var6,
   ...
   public final float getImageScale() {
      return (float)CFG.TEXT_HEIGHT / ImageManager.getImage(Images.diplo_army).getHeight();
   }

   @Override
   public int getWidth() {
      return super.getWidth() + (int)(ImageManager.getImage(Images.diplo_army).getWidth() * this.getImageScale()) + CFG.PADDING * 2;
   }
