...
public class Button_VictoryStats extends Button {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.getText(),
         this.getPosX() + CFG.PADDING * 3 + CFG.CIV_FLAG_WIDTH + (int)(this.iPopulationWidth * 0.8F) + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(this.getTextHeight() * 0.8F / 2.0F) + iTranslateY,
         this.colorRight
      );
         ...
         ImageManager.getImage(this.iImageID)
            .draw(
               ...
               this.getPosX()
                  ...
                  + (int)(this.iPopulationWidth * 0.8F)
                  + CFG.PADDING
                  + iTranslateX,
   ...
   public int getWidth() {
      return Math.max(
            super.getWidth(), CFG.PADDING * 3 + CFG.CIV_FLAG_WIDTH + (int)(this.getTextWidth() * 0.8F + this.iPopulationWidth * 0.8F) + CFG.PADDING * 2
         )
