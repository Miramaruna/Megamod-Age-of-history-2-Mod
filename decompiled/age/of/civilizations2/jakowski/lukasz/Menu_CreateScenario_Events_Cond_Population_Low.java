...
public class Menu_CreateScenario_Events_Cond_Population_Low extends SliderMenu {
      ...
      menuElements.add(
         new Slider_BG(
            ...
            public String getDrawText() {
               return this.getText() + this.getCurrent() * 1000;
            }
         }
      );
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("Population") + " < ");
      this.getTitle().setText(CFG.langManager.get("Population"));
   }
      ...
      switch (iID) {
         ...
         case 5:
            CFG.eventsManager
               ...
               .lConditions
               .get(CFG.eventsManager.iCreateEvent_EditConditionID)
               .setValue(this.getMenuElement(iID).getCurrent() * 1000);
      }
   }
