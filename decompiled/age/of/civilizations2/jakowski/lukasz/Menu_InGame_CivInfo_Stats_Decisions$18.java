...
class Menu_InGame_CivInfo_Stats_Decisions$18 extends Button_Diplomacy_Action {
   final Menu_InGame_CivInfo_Stats_Decisions this$0;

   Menu_InGame_CivInfo_Stats_Decisions$18(
   ...
   protected void actionElement(int var1) {
      CFG.menuManager.rebuildInGame_DeclarationOfIndependence7(CFG.getActiveCivInfo());
   }
