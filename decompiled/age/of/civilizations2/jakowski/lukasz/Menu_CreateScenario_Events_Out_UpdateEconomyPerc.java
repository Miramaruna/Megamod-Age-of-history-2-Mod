...
public class Menu_CreateScenario_Events_Out_UpdateEconomyPerc extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(3).setText(CFG.langManager.get("Economy") + ": ");
      this.getTitle().setText(CFG.langManager.get("UpdateEconomyPercentage"));
   }
