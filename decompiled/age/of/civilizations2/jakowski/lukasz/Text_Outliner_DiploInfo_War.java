...
public class Text_Outliner_DiploInfo_War extends Text {
   ...
   public Text_Outliner_DiploInfo_War(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
         ...
         ImageManager.getImage(Images.randomCivilizationFlag)
            .draw(
               ...
               this.getPosX()
                  ...
                  - CFG.CIV_FLAG_WIDTH * 3 / 4
                  + iTranslateX,
               this.getPosY() - ImageManager.getImage(Images.randomCivilizationFlag).getHeight() + this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2 + iTranslateY,
               CFG.CIV_FLAG_WIDTH,
               CFG.CIV_FLAG_HEIGHT
            );
      }
   ...
   public void buildElementHover() {
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Color(
            this.iCivLeft >= 0
               ? new Color(
                  CFG.game.getCiv(this.iCivLeft).getR() / 255.0F,
                  CFG.game.getCiv(this.iCivLeft).getG() / 255.0F,
                  CFG.game.getCiv(this.iCivLeft).getB() / 255.0F,
                  1.0F
               )
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Color(
            this.iCivRight >= 0
               ? new Color(
                  CFG.game.getCiv(this.iCivRight).getR() / 255.0F,
                  CFG.game.getCiv(this.iCivRight).getG() / 255.0F,
                  CFG.game.getCiv(this.iCivRight).getB() / 255.0F,
                  1.0F
               )
               : new Color(0.0F, 0.0F, 0.0F, 1.0F),
            0,
      ...
      nData.clear();
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("War"), CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
   ...
   @Override
   public int getSFX() {
      return SoundsManager.SOUND_WAR;
   }
   ...
   public void actionElement(int iID) {
      ...
      int tWarID = CFG.game.getWarID(Math.abs(this.iCivLeft), Math.abs(this.iCivRight));
      if (tWarID >= 0) {
         if (tWarID == Menu_InGame_WarDetails.WAR_ID && CFG.menuManager.getVisibleInGame_WarDetails()) {
