...
public class Button extends MenuElement {
   public Button.TypeOfButton typeOfButton;
   public Button.Checkbox oCheckbox;
   public String sText = null;
   public int iTextWidth = -1;
   public int iTextHeight;
   public int iTextPositionX;
   public Button.TextPosition textPosition;
   ...
   public final void init(
      ...
      this.textPosition = nTextPositionX < 0 ? new Button.TextPosition() {
         @Override
         public int getTextPosition() {
            return Button.this.getWidth() / 2 - Button.this.getTextWidth() / 2;
         }
      } : new Button.TextPosition() {
         @Override
         public int getTextPosition() {
