...
public class Button_Diplomacy_Demands extends Button_Statistics {
   ...
   public Button_Diplomacy_Demands(String sText, int nCiv, int iPosX, int iPosY, int iWidth) {
      super(sText, 0, iPosX, iPosY, iWidth, CFG.TEXT_HEIGHT + CFG.PADDING * 4, false);
      this.iCivA = nCiv;
      this.row = !this.row;
      this.sCivName = CFG.game.getCiv(nCiv).getCivName() + ": ";
      CFG.glyphLayout.setText(CFG.fontMain, this.sCivName);
      this.iCivNameWidth = (int)(CFG.glyphLayout.width * 0.7F);
   }
