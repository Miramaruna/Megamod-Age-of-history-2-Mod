...
public class Text_ActionInfo_Turns extends Text_ActionInfo {
   public Text_ActionInfo_Turns(String sText, int iPosX, int iPosY) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      ImageManager.getImage(Images.time)
         .draw(
            ...
            this.getPosY()
               + (int)((this.getHeight() - ImageManager.getImage(Images.time).getHeight() * this.getImageScale()) / 2.0F)
               - ImageManager.getImage(Images.flag_rect).getHeight()
               + iTranslateY,
            (int)(ImageManager.getImage(Images.time).getWidth() * this.getImageScale()),
            (int)(ImageManager.getImage(Images.time).getHeight() * this.getImageScale())
         );
      CFG.fontMain.getData().setScale(0.8F);
      CFG.drawTextWithShadow(
         oSB,
         this.sText,
         this.getPosX() + (int)(ImageManager.getImage(Images.time).getWidth() * this.getImageScale()) + CFG.PADDING * 2 + var6,
   ...
   public final float getImageScale() {
      return (float)CFG.TEXT_HEIGHT / ImageManager.getImage(Images.time).getHeight();
   }

   @Override
   public int getWidth() {
      return super.getWidth() + (int)(ImageManager.getImage(Images.time).getWidth() * this.getImageScale()) + CFG.PADDING * 2;
   }
