...
public class Menu_CreateScenario_Events_Cond_DecisionTaken extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("Decision") + ": " + tName);
      this.getTitle().setText(CFG.langManager.get("DecisionTaken"));
   }
   ...
   public final void actionElement(int iID) {
      switch (iID) {
         ...
         case 5:
            ...
            CFG.menuManager.setViewID(Menu.eCREATE_SCENARIO_EVENTS_SELECTDECISION);
      }
   }
