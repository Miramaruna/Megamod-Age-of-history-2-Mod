...
public class Menu_CreateScenario_Events_Cond_ControlsProvinces extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(6).setText(CFG.langManager.get("PercentageOfProvinces") + ": ");
      this.getTitle().setText(CFG.langManager.get("ControlsProvinces"));
   }
