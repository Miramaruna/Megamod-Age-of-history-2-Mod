...
public class Slider_FlagAction_Investments extends Slider_FlagAction {
   public Slider_FlagAction_Investments(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
