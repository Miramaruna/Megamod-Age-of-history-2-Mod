...
public class Button_Diplomacy_Civilize extends Button {
   ...
   public Button_Diplomacy_Civilize(int iCivID, int iPosX, int iPosY, int iWidth, boolean isClickable, boolean nCheckbox) {
      super.init(
         CFG.langManager.get("Civilize"),
         0,
         iPosX,
         iPosY,
         iWidth,
      ...
      this.iCivID = iCivID;
      this.sTextCostGold = "" + (int)(CFG.ideologiesManager.getIdeology(CFG.game.getCiv(iCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL * 100.0F) / 100.0F;
         ...
         ? new Button.Checkbox() {
            ...
            public void drawCheckBox(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean scrollableY) {
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Button_Diplomacy_Civilize.this.getPosX() + iTranslateX,
                     Button_Diplomacy_Civilize.this.getPosY() - ImageManager.getImage(Images.slider_gradient).getHeight() + 1 + iTranslateY,
                     Button_Diplomacy_Civilize.this.getWidth() / 6,
                     Button_Diplomacy_Civilize.this.getHeight() - 2,
                     false,
                     false
                  );
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     Button_Diplomacy_Civilize.this.getPosX() + iTranslateX,
                     Button_Diplomacy_Civilize.this.getPosY() - ImageManager.getImage(Images.slider_gradient).getHeight() + 1 + iTranslateY,
                     Button_Diplomacy_Civilize.this.getWidth() / 10,
                     Button_Diplomacy_Civilize.this.getHeight() - 2,
                     false,
                     false
                  );
               ...
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Button_Diplomacy_Civilize.this.getPosX() + iTranslateX,
                     Button_Diplomacy_Civilize.this.getPosY() - ImageManager.getImage(Images.gradient).getHeight() + 1 + iTranslateY,
                     Button_Diplomacy_Civilize.this.getWidth(),
                     CFG.PADDING,
                     false,
                     false
                  );
               ImageManager.getImage(Images.gradient)
                  .draw(
                     oSB,
                     Button_Diplomacy_Civilize.this.getPosX() + iTranslateX,
                     Button_Diplomacy_Civilize.this.getPosY()
                        - ImageManager.getImage(Images.gradient).getHeight()
                        + Button_Diplomacy_Civilize.this.getHeight()
                        - 1
                        + iTranslateY
                        - CFG.PADDING,
                     Button_Diplomacy_Civilize.this.getWidth(),
      ...
      ImageManager.getImage(Images.top_diplomacy_points)
         .draw(
            ...
            this.getPosY()
               ...
               + this.getHeight() / 2
               + this.getHeight() / 4
               - (int)(ImageManager.getImage(Images.top_diplomacy_points).getHeight() * this.getImageScale(Images.top_diplomacy_points) / 2.0F)
   ...
   public final int getRightWidth() {
      return Math.max(
         this.iTextCostGoldWidth + CFG.PADDING * 3 + (int)(ImageManager.getImage(Images.technology).getWidth() * this.getImageScale(Images.technology)),
         this.iTextCostDiplomacyWidth
            + CFG.PADDING * 3
            + (int)(ImageManager.getImage(Images.technology).getWidth() * this.getImageScale(Images.top_diplomacy_points))
      );
   }
   ...
   public void buildElementHover() {
      try {
         ...
         nData.add(
            new MenuElement_Hover_v2_Element_Type_Text(
               "" + (int)(CFG.ideologiesManager.getIdeology(CFG.game.getCiv(this.iCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL * 100.0F) / 100.0F,
         ...
         nData.add(
            new MenuElement_Hover_v2_Element_Type_Text(
               "" + (int)(CFG.game.getCiv(this.iCivID).getTechnologyLevel() * 100.0F) / 100.0F,
               CFG.game.getCiv(this.iCivID).getTechnologyLevel()
                     >= CFG.ideologiesManager.getIdeology(CFG.game.getCiv(this.iCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL
                  ? CFG.COLOR_TEXT_MODIFIER_POSITIVE
                  : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2
