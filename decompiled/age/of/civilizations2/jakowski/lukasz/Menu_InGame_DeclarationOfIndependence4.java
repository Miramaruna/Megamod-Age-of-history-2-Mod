...
class Menu_InGame_DeclarationOfIndependence4 extends SliderMenu {
   private int iOnCivID = -1;

   protected Menu_InGame_DeclarationOfIndependence4(int var1) {
      ...
      var2.add(
         new Button_NS_Opinion(
            this, var1, CFG.game.getCiv(CFG.getActiveCivInfo()).getPuppetOfCivID(), Images.diplo_popstability, 0, 0, 0, 0, CFG.BUTTON_WIDTH * 0
         ) {
            final Menu_InGame_DeclarationOfIndependence4 this$0;
               ...
               ImageManager.getImage(Images.diplo_popstability)
                  .draw(
                     ...
                     this.getPosX()
                        ...
                        + var2x,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.diplo_popstability).getHeight() / 2 + var3x
                  );
      ...
      String var6;
      if (CFG.game.getCiv(var1).isAssimilateProvincesPlayer <= 0) {
         var5 = CFG.langManager;
         var6 = "StartAssimilation";
      } else {
         var5 = CFG.langManager;
         var6 = "assimilatNo";
      }
   ...
   protected final void actionElement(int var1) {
      if (var1 == this.getMenuElementsSize() - 1) {
         var1 = CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID();
         if (CFG.game.getCiv(var1).isAssimilateProvincesPlayer <= 0) {
            CFG.oAI.getAI_Style(CFG.game.getCiv(var1).getAI_Style()).assimilateProvincesPlayer(var1);
            CFG.game.getCiv(var1).isAssimilateProvincesPlayer = 1;
            CFG.menuManager.updateInGame_TOP_All(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID());
         } else {
            CFG.game.getCiv(var1).isAssimilateProvincesPlayer = 0;
         }
   ...
   protected void draw(SpriteBatch var1, int var2, int var3, boolean var4) {
      if (Menu_InGame_OfferAlliance.lTime + 200L >= System.currentTimeMillis()) {
         ...
         var9 = ImageManager.getImage(Images.new_game_top_edge).getWidth();
         var8 = this.getHeight();
         var14.draw2(var1, var6 + 2 + var7 - var12 + var2, var10 - var11 + var3, var9, CFG.PADDING + var8, true, true);
         ...
         int var27 = ImageManager.getImage(Images.new_game_top_edge).getHeight();
         int var21 = this.getWidth();
         int var30 = ImageManager.getImage(Images.new_game_top_edge).getWidth();
         int var24 = this.getHeight();
         var15.draw2(var1, var33 - 2 + var2, var18 - var27 + var3, var21 - var30 + 4, CFG.PADDING + var24, false, true);
         var15 = ImageManager.getImage(Images.new_game_top_edge);
         var24 = this.getPosX();
         var21 = this.getWidth();
         var30 = ImageManager.getImage(Images.new_game_top_edge).getWidth();
         var33 = this.getPosY();
         ...
         var15.draw2(var1, var24 + 2 + var21 - var30 + var2, var33 - var27 + var3, var18, CFG.PADDING + var35, true, true);
         var1.setColor(new Color(0.0F, 0.0F, 0.0F, 0.45F));
         ImageManager.getImage(Images.gradient)
            .draw(
               var1,
