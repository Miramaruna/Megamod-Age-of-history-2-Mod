...
public class Text_Outliner_DiploInfo_SignedDefensivePact extends Text {
   ...
   public Text_Outliner_DiploInfo_SignedDefensivePact(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
