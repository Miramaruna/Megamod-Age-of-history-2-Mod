...
class Button_PeaceTreaty_Demands_Vassalize extends Button {
   ...
   protected Button_PeaceTreaty_Demands_Vassalize(int nCivID, int toPayCivID, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
      super.init(CFG.langManager.get("DemandVassalization"), 0, iPosX, iPosY, iWidth, iHeight, isClickable, true, false, false);
      this.iCivID = nCivID;
   ...
   public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      oSB.setColor(
         new Color(
            CFG.game.getCiv(this.toPayCivID).getR() / 255.0F,
            CFG.game.getCiv(this.toPayCivID).getG() / 255.0F,
            CFG.game.getCiv(this.toPayCivID).getB() / 255.0F,
            0.125F
         )
      );
   ...
   public void buildElementHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Flag(this.toPayCivID, CFG.PADDING, 0));
   ...
   public void actionElement(int iID) {
      this.iCivID = CFG.peaceTreatyData.takeVassalize(this.toPayCivID, CFG.peaceTreatyData.iBrushCivID, this.iCivID);
      if (CFG.menuManager.getInGame_PeaceTreaty()) {
         CFG.menuManager.rebuildInGame_PeaceTreaty_Scores();
      }

      CFG.toast.setInView(CFG.langManager.get("DemandVassalization"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
