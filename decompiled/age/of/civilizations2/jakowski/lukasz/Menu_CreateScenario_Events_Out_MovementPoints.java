...
public class Menu_CreateScenario_Events_Out_MovementPoints extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(2).setText(CFG.langManager.get("MovementPoints") + ": ");
      this.getTitle().setText(CFG.langManager.get("UpdateMovementPoints"));
   }
