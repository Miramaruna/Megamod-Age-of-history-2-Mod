...
public class Menu_CreateScenario_Events_Cond_Happiness_Low extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("Happiness") + " < ");
      this.getTitle().setText(CFG.langManager.get("Happiness"));
   }
