...
public class Button_FlagActionSliderStyle extends Button {
   ...
   public Button_FlagActionSliderStyle(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
      super.init(sText, iTextPositionX, iPosX, iPosY, iWidth, (int)(CFG.BUTTON_HEIGHT * 0.6F), isClickable, true, false, false);
   }

   public Button_FlagActionSliderStyle(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
