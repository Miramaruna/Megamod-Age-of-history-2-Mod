...
public class Button_Diplomacy_FormCivilization extends Button {
   ...
   public Button_Diplomacy_FormCivilization(String nTag, int iPosX, int iPosY, int iWidth, boolean isClickable, boolean nCheckbox) {
      super.init(
      ...
      this.sCivTag = nTag;
      this.sTextCostGold = Integer.toString(CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getSanboxMovePoints());
      ...
      ImageManager.getImage(Images.top_gold)
         .draw(
            ...
            this.getPosY()
               ...
               + this.getHeight() / 2
               - this.getHeight() / 4
               - (int)(ImageManager.getImage(Images.top_gold).getHeight() * this.getImageScale(Images.top_gold) / 2.0F)
