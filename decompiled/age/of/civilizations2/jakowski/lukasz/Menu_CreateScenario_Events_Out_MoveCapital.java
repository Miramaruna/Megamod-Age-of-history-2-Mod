...
public class Menu_CreateScenario_Events_Out_MoveCapital extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getTitle().setText(CFG.langManager.get("MoveCapital"));
   }
