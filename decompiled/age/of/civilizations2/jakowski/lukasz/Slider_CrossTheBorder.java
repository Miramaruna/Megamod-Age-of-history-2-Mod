...
public class Slider_CrossTheBorder extends Slider {
      ...
      ImageManager.getImage(Images.diplo_army)
         .draw(
            ...
            this.getPosX()
               + this.getWidth()
               - CFG.PADDING
               - (int)(ImageManager.getImage(Images.diplo_army).getWidth() * this.getImageScale(this.FONT_SCALE, Images.diplo_army))
               + iTranslateX,
            this.getPosY()
               + this.getHeight()
               - CFG.PADDING * 2
               - this.getSliderHeight()
               - (int)(ImageManager.getImage(Images.diplo_army).getHeight() * this.getImageScale(this.FONT_SCALE, Images.diplo_army))
