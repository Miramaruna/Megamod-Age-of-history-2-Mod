...
public class Menu_CreateScenario_Events_Cond_NumOfAllies_Low extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("NumberOfAllies") + " < ");
      this.getTitle().setText(CFG.langManager.get("NumberOfAllies"));
   }
