...
public class HistoryLog_Disease extends HistoryLog {
   public String sMess;
   ...
   public HistoryLog_Disease(int iProvinceID) {
      ...
      this.iCivA = CFG.game.getProvince(iProvinceID).getCivID();
      this.iCivB = iProvinceID;

      try {
         this.sAllianceName = CFG.plagueManager
            .getPlague_InGame(CFG.game.getProvince(iProvinceID).saveProvinceData.provincePlague.iPlagueID_InGame)
            .getPlagueName();
   ...
   public void updateLanguage() {
      this.sMess = CFG.langManager.get("Disease") + ":";
