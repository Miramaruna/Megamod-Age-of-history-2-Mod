...
public class Message_PrepareForWar_Accepted extends Message {
   ...
   public MenuElement_Hover_v2 getHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("AcceptedToJoinWarPreparationsAgainst") + ":", CFG.COLOR_TEXT_MODIFIER_POSITIVE));
