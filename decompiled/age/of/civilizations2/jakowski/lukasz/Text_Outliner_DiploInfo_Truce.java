...
public class Text_Outliner_DiploInfo_Truce extends Text {
   ...
   public Text_Outliner_DiploInfo_Truce(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
         ...
         CFG.game
            ...
            .draw(
               ...
               this.getPosX()
                  + this.getWidth()
                  - CFG.CIV_FLAG_WIDTH
                  - ImageManager.getImage(Images.diplo_truce).getWidth() / 2
                  - CFG.PADDING
      ...
      if (this.iCivLeft >= 0) {
         CFG.game
            ...
            .draw(
               oSB,
               this.getPosX() + this.getWidth() - CFG.CIV_FLAG_WIDTH - ImageManager.getImage(Images.diplo_truce).getWidth() / 2 - CFG.PADDING + iTranslateX,
   ...
   public void buildElementHover() {
      ...
      nData.clear();
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Truce"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
