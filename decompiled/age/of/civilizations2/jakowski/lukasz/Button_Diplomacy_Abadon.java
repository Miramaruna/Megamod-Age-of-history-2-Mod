...
public class Button_Diplomacy_Abadon extends Button_Statistics {
   ...
   public Button_Diplomacy_Abadon(String sText, String nDiploCost, int nAggressor, int nProvinceID, int iPosX, int iPosY, int iWidth) {
      ...
      this.sCurrentRelation = ""
         + (CFG.game.getProvince(nProvinceID).getName().length() > 0 ? CFG.game.getProvince(nProvinceID).getName() : CFG.langManager.get("Province"));
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.provinces)
         .draw(
            oSB,
            this.getPosX() + Button_Diplomacy.iDiploWidth / 2 - ImageManager.getImage(Images.provinces).getWidth() / 2 + iTranslateX,
            this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.provinces).getHeight() / 2 + iTranslateY
         );
      ...
      CFG.game
         ...
         .draw(
            oSB,
            this.getPosX() + Button_Diplomacy.iDiploWidth + CFG.PADDING * 2 + 2 + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               - (int)(ImageManager.getImage(Images.flag_rect).getHeight() * this.getImageScale(Images.flag_rect)) / 2
