...
public class Button_Build_Level extends Button_Build {
   public static final float FONT_SIZE_LEVEL = 0.65F;
   public String sLevelID;
   public String sLevel;
   public int iLevelWidth = 0;

   public Button_Build_Level(
      String sText,
      int nImageID,
      String nLevelID,
      int nCost,
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosY() + this.getHeight() / 2 - (int)(this.getTextHeight() * 0.7F + this.getTextHeight() * 0.65F + CFG.PADDING) / 2 + iTranslateY,
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosY()
            + this.getHeight() / 2
            - (int)(this.getTextHeight() * 0.7F + this.getTextHeight() * 0.65F + CFG.PADDING) / 2
            + CFG.PADDING
            + (int)(this.getTextHeight() * 0.7F)
            + iTranslateY,
