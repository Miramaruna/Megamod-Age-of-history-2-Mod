...
public class Menu_RandomGame_Settings extends SliderMenu {
   ...
   public Menu_RandomGame_Settings() {
      ...
      int tempWidth = (int)(CFG.GAME_WIDTH * 0.8F);
      int tempHeight = CFG.BUTTON_HEIGHT + CFG.PADDING * 6 + CFG.BUTTON_HEIGHT * 3 / 4 * 4;
      menuElements.add(
         new Button_FlagActionSliderStyle("-", -1, CFG.PADDING, CFG.PADDING, CFG.BUTTON_WIDTH, CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5, true)
      );
      menuElements.add(
         new Slider_FlagAction_Clear(
            CFG.langManager.get("Civilizations"),
            CFG.PADDING * 3 + CFG.BUTTON_WIDTH,
            CFG.PADDING,
            tempWidth - CFG.PADDING * 4 - CFG.BUTTON_WIDTH * 2 - CFG.PADDING * 2,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5,
            0,
            getCivMax(),
            CFG.randomGameManager.getCivilizationsSize()
         ) {
            @Override
            public int getWidth() {
      ...
      menuElements.add(
         new Button_FlagActionSliderStyle(
            "+", -1, tempWidth - CFG.PADDING - CFG.BUTTON_WIDTH, CFG.PADDING, CFG.BUTTON_WIDTH, CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5, true
         ) {
            @Override
            public int getPosX() {
      ...
      menuElements.add(
         new Slider_FlagAction_Clear(
            CFG.langManager.get("StartingPopulation"),
            CFG.PADDING * 2,
            CFG.PADDING * 2 + CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5,
            ...
            public Color getColorLEFT() {
               return new Color(
                  CFG.COLOR_POPULATION[CFG.COLOR_POPULATION.length - 1].r,
                  CFG.COLOR_POPULATION[CFG.COLOR_POPULATION.length - 1].g,
                  CFG.COLOR_POPULATION[CFG.COLOR_POPULATION.length - 1].b,
                  0.65F
               );
            }
      ...
      menuElements.add(
         new Slider_FlagAction_Clear(
            CFG.langManager.get("StartingEconomy"),
            CFG.PADDING * 2,
            CFG.PADDING * 3 + (CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5) * 2,
            tempWidth - CFG.PADDING * 4,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5,
            1,
            1000,
            ...
            public Color getColorLEFT() {
               return new Color(
                  CFG.COLOR_ECONOMY[CFG.COLOR_ECONOMY.length - 1].r,
                  CFG.COLOR_ECONOMY[CFG.COLOR_ECONOMY.length - 1].g,
                  CFG.COLOR_ECONOMY[CFG.COLOR_ECONOMY.length - 1].b,
                  0.65F
               );
            }
      ...
      menuElements.add(
         new Slider_FlagAction_Clear(
            CFG.langManager.get("StartingArmyInCapitals"),
            CFG.PADDING * 2,
            CFG.PADDING * 4 + (CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5) * 3,
            tempWidth - CFG.PADDING * 4,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5,
            0,
            200,
      ...
      menuElements.add(
         new Slider_FlagAction_Clear(
            CFG.langManager.get("NeutralArmy"),
            CFG.PADDING * 2,
            CFG.PADDING * 5 + (CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5) * 4,
            tempWidth - CFG.PADDING * 4,
            CFG.TEXT_HEIGHT + CFG.PADDING * 2 + CFG.PADDING * 5,
            0,
            200,
            CFG.randomGameManager.getNeutralArmy() / 25
         ) {
            @Override
            public String getDrawText() {
               return "" + this.getCurrent() * 25;
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Settings"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            @Override
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.dialog_title)
                  .draw2(
                     oSB,
                     nPosX + iTranslateX,
                     nPosY - ImageManager.getImage(Images.dialog_title).getHeight() - this.getHeight(),
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(oSB, nPosX + 2 + iTranslateX, nPosY - ImageManager.getImage(Images.line_32_off1).getHeight() * 2, nWidth - 4, 1);
         ...
         (CFG.GAME_WIDTH - (int)(CFG.GAME_WIDTH * 0.8F)) / 2,
         (CFG.GAME_HEIGHT * 4 / 5 - tempHeight - CFG.BUTTON_HEIGHT * 3 / 5) / 2 > 0
            ? (CFG.GAME_HEIGHT * 4 / 5 - tempHeight - CFG.BUTTON_HEIGHT * 3 / 5) / 2
            : CFG.PADDING,
         tempWidth,
         tempHeight,
         menuElements,
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      if (lTime + 175L >= System.currentTimeMillis()) {
         Rectangle clipBounds = new Rectangle(
            ...
            this.getWidth(),
            -((int)(this.getHeight() * ((float)(System.currentTimeMillis() - lTime) / 175.0F)))
         );
         oSB.flush();
