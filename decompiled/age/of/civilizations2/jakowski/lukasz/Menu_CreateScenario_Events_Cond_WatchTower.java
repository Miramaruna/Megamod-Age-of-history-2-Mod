...
public class Menu_CreateScenario_Events_Cond_WatchTower extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("Built"));
      this.getTitle().setText(CFG.langManager.get("WatchTower"));
   }
