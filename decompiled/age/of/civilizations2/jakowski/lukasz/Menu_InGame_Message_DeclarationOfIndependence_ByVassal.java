...
public class Menu_InGame_Message_DeclarationOfIndependence_ByVassal extends SliderMenu {
   ...
   public Menu_InGame_Message_DeclarationOfIndependence_ByVassal() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("DeclarationOfIndependence"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Message_DeclarationOfIndependence_ByVassal(int onCivID, int iMessageID, int iValue) {
      ...
      int var9;
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Fine") + "!", -1, 2 + CFG.PADDING, var9 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getWidth() {
               return Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager.get("WeWillSignATruceUntilX", Game_Calendar.getDate_ByTurnID(Game_Calendar.TURN_ID + 30))
                  )
               );
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(" [" + CFG.langManager.get("TurnsX", 30) + "]", CFG.COLOR_TEXT_MODIFIER_NEUTRAL));
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.iOnCivID, 0, 0));
      ...
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("DeclareWar"), -1, 2, var9, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.iOnCivID, 0, CFG.PADDING));
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(CFG.game.getCiv(Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.iOnCivID).getCivName())
               );
         ...
         new SliderMenuTitle(CFG.langManager.get("DeclarationOfIndependence"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.diplo_message)
                  .draw(
                     oSB,
                     Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Message_DeclarationOfIndependence_ByVassal.this.getPosY()
                        - this.getHeight() / 2
                        - ImageManager.getImage(Images.diplo_message).getHeight() / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
