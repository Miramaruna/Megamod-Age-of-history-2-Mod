...
public class Button_Diplomacy_Wiki_Civ extends Button {
   public int iCivID = 0;
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      Rectangle clipBounds = new Rectangle(
         ...
         this.getWidth() - CFG.PADDING * 4 - ImageManager.getImage(Images.wikipedia).getWidth(),
         -this.getHeight()
      );
      oSB.flush();
      ...
      CFG.drawText(
         oSB,
         " [" + this.sLink + "]",
         this.getPosX() + CFG.CIV_FLAG_WIDTH + CFG.PADDING * 2 + (int)(this.getTextWidth() * 0.6F) + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(this.getTextHeight() * 0.6F / 2.0F) + iTranslateY,
