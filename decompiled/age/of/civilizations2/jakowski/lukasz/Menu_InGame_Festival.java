...
public class Menu_InGame_Festival extends SliderMenu {
   ...
   public Menu_InGame_Festival() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Festival"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Festival(int nProvinceID) {
      ...
      menuElements.add(
         new Button_Build_Festival(
            ...
            Game_Calendar.getCurrentDate() + " - " + Game_Calendar.getDate_ByTurnID(Game_Calendar.TURN_ID + 7),
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "+" + (int)(DiplomacyManager.festivalHappinessPerTurn(Menu_InGame_Festival.this.iProvinceID) * 10000.0F) / 100.0F,
      ...
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Confirm"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getProvince(Menu_InGame_Festival.this.iProvinceID).getName().length() > 0
                        ? CFG.game.getProvince(Menu_InGame_Festival.this.iProvinceID).getName()
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text("" + DiplomacyManager.festivalCost(Menu_InGame_Festival.this.iProvinceID), CFG.COLOR_INGAME_GOLD)
               );
         ...
         new SliderMenuTitle(CFG.langManager.get("Festival"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_Festival.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Festival.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_Festival.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Festival.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
