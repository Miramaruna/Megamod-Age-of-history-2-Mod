...
public class Button_PeaceTreaty_VicPoints extends Button {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.victoryPoints)
         .draw(
            oSB,
            this.getPosX() + CFG.CIV_FLAG_WIDTH + CFG.PADDING * 2 + this.iVicPointsWidth + (int)(this.getTextWidth() * 0.6F) + CFG.PADDING + iTranslateX,
            this.getPosY()
               + 1
               + this.getHeight() / 2
      ...
      try {
         ...
         nData.add(
            new MenuElement_Hover_v2_Element_Type_Text(
               "" + (int)(CFG.game.getCivRelation_OfCivB(CFG.getActiveCivInfo(), CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()) * 10.0F) / 10.0F,
