...
public class Menu_InGame_Message_Union extends SliderMenu {
   ...
   public Menu_InGame_Message_Union() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Union"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Message_Union(int onCivID, int iMessageID, int iValue) {
      ...
      menuElements.add(
         new Button_Diplomacy_MessageAlliance(
            Images.diplo_union,
            CFG.langManager.get("FormUnionWithCivA", CFG.game.getCiv(this.iOnCivID).getCivName()),
            this.iOnCivID,
            2,
            tY,
            CFG.BUTTON_WIDTH * 2
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Refuse"), -1, 2 + CFG.PADDING, var9 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Message_Union.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
         ...
         public void buildElementHover() {
            ...
            nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("RefuseAUnionProposal"), CFG.COLOR_TEXT_MODIFIER_NEGATIVE2));
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Accept"), -1, 2, var9, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getPosX() {
            return Menu_InGame_Message_Union.this.getElementW() + CFG.PADDING / 2;
         }
         ...
         public void buildElementHover() {
            ...
            nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.diplo_union, CFG.PADDING, 0));
            nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_Message_Union.this.iOnCivID, CFG.PADDING, 0));
            nElements.add(new MenuElement_Hover_v2_Element2(nData));
            nData.clear();
            this.menuElementHover = new MenuElement_Hover_v2(nElements);
         }
         ...
         new SliderMenuTitle(CFG.langManager.get("Union"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.diplo_message)
                  .draw(
                     oSB,
                     Menu_InGame_Message_Union.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Message_Union.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2
                  );
