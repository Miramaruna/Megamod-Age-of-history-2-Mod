...
public class TutorialManager {
   ...
   public TutorialManager.TutStep tutStep;
   public List<MenuElement_Hover> textBox = new ArrayList<>();
   public int iDrawPosX = 0;
   public int iDrawPosY = 0;
   public List<List<TutorialBox>> tutBoxes = new ArrayList<>();
   ...
   public final void updateDrawTutorial(boolean enable) {
      ...
      if (enable) {
         if (this.STEP_ID == 0) {
            ...
            this.tutStep = new TutorialManager.TutStep() {
                  ...
                  if (CFG.menuManager.getInGameView()) {
                     ...
                     try {
                        ...
                        TutorialManager.this.drawLine(
                           oSB,
                           CFG.menuManager.getInGame_ProvinceInfo().getPosX() + CFG.menuManager.getInGame_ProvinceInfo().getMenuElement(0).getPosX(),
                           -CFG.PADDING / 2
               ...
               public boolean action(Tutorial_ActionType actionType) {
                  if (actionType == Tutorial_ActionType.NEXT_TURN && CFG.gameAction.getActiveTurnState() == Game_Action.TurnStates.INPUT_ORDERS) {
                     TutorialManager this$0 = TutorialManager.this;
                     this$0.STEP_ID++;
                  ...
                  public int getPosY() {
                     return CFG.game
                           .getDrawProvinceArmy_EndPosY(
                              CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getCapitalProvinceID(), CFG.map.getMapScale().getCurrentScale()
                           )
            ...
            tempBoxes2.add(new TutorialBox(CFG.langManager.get("1")) {
               @Override
               public int getPosX() {
            ...
            tempBoxes2.add(new TutorialBox(CFG.langManager.get("2")) {
               @Override
               public int getPosX() {
            ...
            tempBoxes3.add(new TutorialBox("4. " + CFG.langManager.get("chPr")) {
               @Override
               public int getPosX() {
                  return CFG.PADDING;
               }
            ...
            for (int j = 0; j < tempText.size(); j++) {
               nData2.add(new MenuElement_Hover_v2_Element_Type_Text(tempText.get(j), COLOR_TITLE));
               if (j == tempText.size() - 1) {
            ...
            for (int j = 0; j < tempText.size(); j++) {
               nData2.add(new MenuElement_Hover_v2_Element_Type_Text(tempText.get(j), COLOR_TEXT));
               if (j == tempText.size() - 1) {
            ...
            List<TutorialBox> tempBoxes4 = new ArrayList<>();
            tempBoxes4.add(
               new TutorialBox(CFG.langManager.get("1")) {
                  @Override
                  public int getPosX() {
            ...
            this.tutBoxes.add(tempBoxes4);
            List<TutorialBox> tempBoxes5 = new ArrayList<>();
            tempBoxes5.add(new TutorialBox("2. " + CFG.langManager.get("chPr")) {
               @Override
               public int getPosX() {
                  return CFG.PADDING;
               }
            ...
            this.tutBoxes.add(tempBoxes5);
            List<TutorialBox> tempBoxes6 = new ArrayList<>();
            tempBoxes6.add(
               new TutorialBox("2") {
                  @Override
                  public int getPosX() {
                  ...
                  if (CFG.menuManager.getInGameView()) {
                     try {
                        ...
                        if (CFG.menuManager.getInGame_ProvinceRecruit().getVisible()) {
                           ...
                           TutorialManager.this.drawLine(
                              oSB,
                              CFG.menuManager.getInGame_ProvinceAction().getPosX() + CFG.menuManager.getInGame_ProvinceAction().getMenuElement(1).getPosX(),
                              -CFG.PADDING / 2
                                 + CFG.menuManager.getInGame_ProvinceAction().getPosY()
                                 + CFG.menuManager.getInGame_ProvinceAction().getMenuElement(1).getPosY(),
                              CFG.menuManager.getInGame_ProvinceAction().getMenuElement(1).getWidth()
                           );
                        } else {
                           TutorialManager.this.INNER_STEP = 1;
                           TutorialManager.this.textBox
            ...
            List<TutorialBox> tempBoxes7 = new ArrayList<>();
            tempBoxes7.add(
               new TutorialBox(CFG.langManager.get("1")) {
                  @Override
                  public int getPosX() {
            ...
            this.tutBoxes.add(tempBoxes7);
            List<TutorialBox> tempBoxes8 = new ArrayList<>();
            tempBoxes8.add(new TutorialBox("2. " + CFG.langManager.get("chPr")) {
               @Override
               public int getPosX() {
                  return CFG.PADDING;
               }
            ...
            this.tutBoxes.add(tempBoxes8);
            List<TutorialBox> tempBoxes9 = new ArrayList<>();
            tempBoxes9.add(
               new TutorialBox("2") {
                  @Override
                  public int getPosX() {
                  ...
                  if (CFG.menuManager.getInGameView()) {
                     try {
                        ...
                        if (CFG.menuManager.getInGame_ProvinceMoveUnits().getVisible()) {
                           ...
                           TutorialManager.this.drawLine(
                              oSB,
                              CFG.menuManager.getInGame_ProvinceAction().getPosX() + CFG.menuManager.getInGame_ProvinceAction().getMenuElement(0).getPosX(),
                              -CFG.PADDING / 2
                                 + CFG.menuManager.getInGame_ProvinceAction().getPosY()
                                 + CFG.menuManager.getInGame_ProvinceAction().getMenuElement(0).getPosY(),
                              CFG.menuManager.getInGame_ProvinceAction().getMenuElement(0).getWidth()
                           );
                        }
               ...
               public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY) {
                  if (CFG.menuManager.getInGameView()) {
                     try {
                        ...
                        TutorialManager.this.drawLine(
                           oSB,
                           CFG.menuManager.getInGame_ProvinceAction().getPosX() + CFG.menuManager.getInGame_ProvinceAction().getMenuElement(2).getPosX(),
                           -CFG.PADDING / 2
                              + CFG.menuManager.getInGame_ProvinceAction().getPosY()
                              + CFG.menuManager.getInGame_ProvinceAction().getMenuElement(2).getPosY(),
                           CFG.menuManager.getInGame_ProvinceAction().getMenuElement(2).getWidth()
                        );
            ...
            nData.clear();
            this.textBox.add(new MenuElement_Hover_v2(nElements));
            List<MenuElement_Hover_v2_Element2> nElements4 = new ArrayList<>();
            List<MenuElement_Hover_v2_Element_Type> nData4 = new ArrayList<>();
            List<String> tempText2 = this.getTextSplited(CFG.langManager.get("in1"));
            nData4.add(new MenuElement_Hover_v2_Element_Type_Text("1. ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));

            for (int j = 0; j < tempText2.size(); j++) {
               nData4.add(new MenuElement_Hover_v2_Element_Type_Text(tempText2.get(j), COLOR_TITLE));
               nElements4.add(new MenuElement_Hover_v2_Element2(nData4));
               nData4.clear();
            }

            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("in2"));
            nData4.add(new MenuElement_Hover_v2_Element_Type_Text("2. ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
            ...
            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("hAdm0"));
            nData4.add(new MenuElement_Hover_v2_Element_Type_Text("3. ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
            ...
            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("hAdministrationCost"));
            nData4.add(new MenuElement_Hover_v2_Element_Type_Text(" - ", COLOR_TITLE));

            for (int j = 0; j < tempText2.size(); j++) {
               nData4.add(new MenuElement_Hover_v2_Element_Type_Text(tempText2.get(j), COLOR_TEXT));
               nElements4.add(new MenuElement_Hover_v2_Element2(nData4));
               nData4.clear();
            }

            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("tx"));
            nData4.add(new MenuElement_Hover_v2_Element_Type_Text("4. ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
            ...
            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("txa"));
            nData4.add(new MenuElement_Hover_v2_Element_Type_Text(" - ", COLOR_TITLE));
            ...
            this.textBox.add(new MenuElement_Hover_v2(nElements4));
            List<TutorialBox> tempBoxes4 = new ArrayList<>();
            tempBoxes4.add(
                  ...
                  if (CFG.menuManager.getInGameView()) {
                     try {
                        if (!CFG.menuManager.getInGame_Budget().getVisible()) {
                           ...
                           for (int j = 0; j < TutorialManager.this.tutBoxes.get(TutorialManager.this.INNER_STEP).size(); j++) {
                              TutorialManager.this.tutBoxes.get(TutorialManager.this.INNER_STEP).get(j).draw(oSB);
                           }
                        }
                     } catch (IndexOutOfBoundsException var6) {
                     } catch (NullPointerException var7) {
            ...
            List<MenuElement_Hover_v2_Element2> nElements4 = new ArrayList<>();
            List<MenuElement_Hover_v2_Element_Type> nData4 = new ArrayList<>();
            List<String> tempText2 = this.getTextSplited(CFG.langManager.get("hGoods"));
            nData4.add(new MenuElement_Hover_v2_Element_Type_Text("1. ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
            ...
            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("hGoods2"));
            ...
            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("hGoods4"));
            ...
            List<MenuElement_Hover_v2_Element2> nElements4 = new ArrayList<>();
            List<MenuElement_Hover_v2_Element_Type> nData4 = new ArrayList<>();
            List<String> tempText2 = this.getTextSplited(CFG.langManager.get("Tech1"));
            nData4.add(new MenuElement_Hover_v2_Element_Type_Text("1. ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
            ...
            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("Tech2"));
            ...
            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("Tech3"));
            ...
            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("Tech4"));
            ...
            List<MenuElement_Hover_v2_Element2> nElements4 = new ArrayList<>();
            List<MenuElement_Hover_v2_Element_Type> nData4 = new ArrayList<>();
            List<String> tempText2 = this.getTextSplited(CFG.langManager.get("BuildYourEconomicPowerBySpendingGoldOnInvestments"));
            nData4.add(new MenuElement_Hover_v2_Element_Type_Text("1. ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
            ...
            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("DevelopmentLevelAndEconomyWillBeIncreased"));
            ...
            tempText2.clear();
            tempText2 = this.getTextSplited(CFG.langManager.get("Tech5"));
            ...
            tempBoxes.add(new TutorialBox(CFG.langManager.get("3")) {
               @Override
               public int getPosX() {
                  return CFG.menuManager.getInGame_Civ_Info_Diplomacy().getPosX() + CFG.menuManager.getInGame_Civ_Info_Diplomacy().getWidth() - this.getWidth();
               }
