...
public class Button_TodayPartOf_Population extends Button {
   public boolean row = true;
   public String sPerc;
   public int iPercWidth = 0;
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sPopulation,
         this.getPosX() + CFG.PADDING * 3 + CFG.CIV_FLAG_WIDTH + (int)(this.getTextWidth() * 0.8F) + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(this.getTextHeight() * 0.8F / 2.0F) + iTranslateY,
      ...
      CFG.drawTextWithShadow(
         oSB,
         "[" + this.sPerc + "]",
         this.getPosX() + CFG.PADDING * 3 + CFG.CIV_FLAG_WIDTH + (int)(this.getTextWidth() * 0.8F + this.iPopulationWidth * 0.8F) + iTranslateX,
   ...
   public int getWidth() {
      return Math.max(
         super.getWidth(),
         CFG.PADDING * 3 + CFG.CIV_FLAG_WIDTH + (int)(this.getTextWidth() * 0.8F + this.iPopulationWidth * 0.8F + this.iPercWidth * 0.7F) + CFG.PADDING * 2
      );
   }
}
