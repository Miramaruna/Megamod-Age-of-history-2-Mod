   ...
   public Menu_InGame_Build() {
      ...
      if (BuildingsManager.iBuildInProvinceID >= 0) {
         ...
         for (int i = 0; i < CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getWonderSize(); i++) {
            menuElements.add(
               new Button_NS_Wonder(new Color(0.09411765F, 0.3137255F, 0.43137255F, 1.0F), BuildingsManager.iBuildInProvinceID, i, 0, tPosY, tempW) {}
            );
         ...
         menuElements.add(
            new Button_Build(
               ...
               0,
               tPosY,
               canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
               true,
               false,
               0,
               0.0F
               ...
               public void actionElement(int iID) {
                  CFG.menuManager.rebuildInGame_BuildAll(BuildingsManager.iBuildInProvinceID);
               }
            }
         );
         menuElements.get(menuElements.size() - 1).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
         menuElements.get(menuElements.size() - 1).setCurrent(tRow);
         menuElements.add(new Button_Build_Destroy(tempW - Button_Build_Destroy.getButtonWidth(), tPosY, Button_Build_Destroy.getButtonWidth(), true) {
            @Override
            public void actionElement(int iID) {
               CFG.menuManager.rebuildInGame_DestroyAll(BuildingsManager.iBuildInProvinceID);
            }
         });
         menuElements.get(menuElements.size() - 1).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
         menuElements.get(menuElements.size() - 1).setCurrent(tRow);
         ...
         menuElements.add(
            new Button_Build_Level(
               BuildingsManager.getFort_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() + 1),
               Images.b_fort,
               "" + CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort(),
               BuildingsManager.getFort_BuildCost(
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() + 1, BuildingsManager.iBuildInProvinceID
               ),
               BuildingsManager.getFort_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() + 1),
               0,
               tPosY,
               canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
               true,
               CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() == BuildingsManager.getFort_MaxLevel(),
               CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.FORT),
               BuildingsManager.getFort_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() + 1)
            ) {
               @Override
               public void actionElement(int iID) {
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() == BuildingsManager.getFort_MaxLevel()) {
                     CFG.toast.setInView(CFG.langManager.get("Built"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                        ...
                        .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.FORT)
                     > 0) {
               ...
               public void buildElementHover() {
                  ...
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() == BuildingsManager.getFort_MaxLevel()) {
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "+" + BuildingsManager.getFort_DefenseBonus(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort()) + "%",
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager.get(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() == 0 ? "Castle" : "Fortress") + ": ",
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                                 .get(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() == 0 ? "BuildCastleIn" : "BuildFortressIn")
                              + ": ",
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "+" + BuildingsManager.getFort_DefenseBonus(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() + 1) + "%",
                           CFG.COLOR_TEXT_MODIFIER_POSITIVE
                        )
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                        ...
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                              .get(
                                 ...
                                 BuildingsManager.getFort_Construction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() + 1)
                              )
                        )
                     );
                     nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.time, CFG.PADDING, 0));
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           ""
                              + (int)(
                                    BuildingsManager.getFort_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() + 1) * 100.0F
                                 )
                                 / 100.0F,
         ...
         if (canDestroy) {
            menuElements.add(
               new Button_Build_Destroy(
                  tempW - Button_Build_Destroy.getButtonWidth(),
                  tPosY,
                  Button_Build_Destroy.getButtonWidth(),
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFort() > 0
               ) {
                  @Override
                  public void actionElement(int iID) {
         ...
         menuElements.add(
            new Button_Build(
               BuildingsManager.getTower_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower() + 1),
               Images.b_tower,
               BuildingsManager.getTower_BuildCost(
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower() + 1, BuildingsManager.iBuildInProvinceID
               ),
               BuildingsManager.getTower_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower() + 1),
               0,
               var11 = tPosY + menuElements.get(menuElements.size() - 1).getHeight(),
               canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
               true,
               CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower() == BuildingsManager.getTower_MaxLevel(),
               CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.TOWER),
               BuildingsManager.getTower_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower() + 1)
            ) {
               @Override
               public void actionElement(int iID) {
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower() == BuildingsManager.getTower_MaxLevel()) {
                     CFG.toast.setInView(CFG.langManager.get("Built"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                        ...
                        .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                        .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.TOWER)
                     > 0) {
                     CFG.toast.setInView(CFG.langManager.get("InConstruction"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                  } else {
               ...
               public void buildElementHover() {
                  ...
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower() == BuildingsManager.getTower_MaxLevel()) {
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "+" + BuildingsManager.getTower_DefenseBonus(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower()) + "%",
                           CFG.COLOR_TEXT_MODIFIER_POSITIVE
                        )
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "+"
                              + BuildingsManager.getTower_DefenseBonus(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower() + 1)
                              + "%",
                           CFG.COLOR_TEXT_MODIFIER_POSITIVE
                        )
                     );
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                              .get(
                                 "ConstructionWillTakeXurns",
                                 BuildingsManager.getTower_Construction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower() + 1)
                              )
                        )
                     );
                     nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.time, CFG.PADDING, 0));
         ...
         if (canDestroy) {
            menuElements.add(
               new Button_Build_Destroy(
                  ...
                  var11,
                  Button_Build_Destroy.getButtonWidth(),
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWatchTower() > 0
               ) {
                  @Override
                  public void actionElement(int iID) {
         ...
         if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() >= 0) {
            ...
            menuElements.add(
               new Button_Build(
                  BuildingsManager.getPort_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() + 1),
                  Images.b_port,
                  BuildingsManager.getPort_BuildCost(
                     CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() + 1, BuildingsManager.iBuildInProvinceID
                  ),
                  BuildingsManager.getPort_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() + 1),
                  0,
                  tPosY,
                  canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
                  true,
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() == BuildingsManager.getPort_MaxLevel(),
                  CFG.game
                     .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                     .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.PORT),
                  BuildingsManager.getPort_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() + 1)
               ) {
                  @Override
                  public void actionElement(int iID) {
                  ...
                  public void buildElementHover() {
                     ...
                     if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() == BuildingsManager.getPort_MaxLevel()) {
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getCivID(), CFG.PADDING, 0)
                        );
                        nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.icon_check_true, CFG.PADDING, 0));
                        nElements.add(new MenuElement_Hover_v2_Element2(nData));
                        nData.clear();
                        nData.add(new MenuElement_Hover_v2_Element_Type_Text(" - "));
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("AllowsYourArmyGoToTheSea"), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE)
                        );
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              "+"
                                 + (int)(
                                    BuildingsManager.getPort_IncomeProduction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort())
                                       * 100.0F
                                 )
                                 + "%",
                              CFG.COLOR_TEXT_MODIFIER_POSITIVE
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              "+"
                                 + (int)(
                                    BuildingsManager.getPort_IncomeProduction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() + 1)
                                       * 100.0F
                                 )
                                 + "%",
                              CFG.COLOR_TEXT_MODIFIER_POSITIVE
                           ...
                           new MenuElement_Hover_v2_Element_Type_Text(
                              ""
                                 + BuildingsManager.getPort_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() + 1)
                                    / 10.0F,
                              CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                                    >= BuildingsManager.getPort_BuildMovementCost(
                                       CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() + 1
                                    )
                                 ? CFG.COLOR_INGAME_MOVEMENT
                                 : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2
                           )
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              CFG.langManager
                                 .get(
                                    "ConstructionWillTakeXurns",
                                    BuildingsManager.getPort_Construction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() + 1)
                                 )
                           )
                        );
                        nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.time, CFG.PADDING, 0));
            ...
            if (canDestroy) {
               menuElements.add(
                  new Button_Build_Destroy(
                     ...
                     tPosY,
                     Button_Build_Destroy.getButtonWidth(),
                     CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfPort() > 0
                  ) {
                     @Override
                     public void actionElement(int iID) {
         ...
         if (CFG.terrainTypesManager.getPopulationGrowth(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getTerrainTypeID()) >= 0.0F) {
            menuElements.add(
               new Button_Build_Level(
                  BuildingsManager.getFarm_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() + 1),
                  Images.b_farm,
                  "" + CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm(),
                  BuildingsManager.getFarm_BuildCost(
                     CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() + 1, BuildingsManager.iBuildInProvinceID
                  ),
                  BuildingsManager.getFarm_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() + 1),
                  0,
                  tPosY,
                  canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
                  true,
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() == BuildingsManager.getFarm_MaxLevel(),
                  CFG.game
                     .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                     .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.FARM),
                  BuildingsManager.getFarm_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() + 1)
               ) {
                  @Override
                  public void actionElement(int iID) {
                     ...
                     if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() == BuildingsManager.getFarm_MaxLevel()) {
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              "+"
                                 + (int)(
                                    BuildingsManager.getFarm_GrowthRateBonus(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm())
                                       * 100.0F
                                 )
                                 + "%",
                              CFG.COLOR_TEXT_MODIFIER_POSITIVE
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              "+"
                                 + (int)(
                                    BuildingsManager.getFarm_GrowthRateBonus(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() + 1)
                                       * 100.0F
                                 )
                                 + "%",
                              CFG.COLOR_TEXT_MODIFIER_POSITIVE
                           ...
                           new MenuElement_Hover_v2_Element_Type_Text(
                              ""
                                 + BuildingsManager.getFarm_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() + 1)
                                    / 10.0F,
                              CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                                    >= BuildingsManager.getFarm_BuildMovementCost(
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              CFG.langManager
                                 .get(
                                    "ConstructionWillTakeXurns",
                                    BuildingsManager.getFarm_Construction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() + 1)
                                 )
                           )
                        );
                        nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.time, CFG.PADDING, 0));
            ...
            if (canDestroy) {
               menuElements.add(
                  new Button_Build_Destroy(
                     ...
                     tPosY,
                     Button_Build_Destroy.getButtonWidth(),
                     CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfFarm() > 0
                  ) {
                     @Override
                     public void actionElement(int iID) {
         ...
         menuElements.add(
            new Button_Build_Level(
               BuildingsManager.getWorkshop_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop() + 1),
               Images.b_workshop,
               "" + CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop(),
               BuildingsManager.getWorkshop_BuildCost(
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop() + 1, BuildingsManager.iBuildInProvinceID
               ),
               BuildingsManager.getWorkshop_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop() + 1),
               0,
               tPosY,
               canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
               true,
               CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop() == BuildingsManager.getWorkshop_MaxLevel(),
               CFG.game
                  .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                  .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.WORKSHOP),
               BuildingsManager.getWorkshop_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop() + 1)
            ) {
               @Override
               public void actionElement(int iID) {
               ...
               public void buildElementHover() {
                  ...
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop() == BuildingsManager.getWorkshop_MaxLevel()) {
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                                 .get(BuildingsManager.getWorkshop_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop()))
                              + ": ",
                           CFG.COLOR_TEXT_NUM_OF_PROVINCES
                        )
                     );
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "+"
                              + (int)(
                                 BuildingsManager.getWorkshop_IncomeProduction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop())
                                    * 100.0F
                              )
                              + "%",
                           CFG.COLOR_TEXT_MODIFIER_POSITIVE
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                                 .get(BuildingsManager.getWorkshop_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop() + 1))
                              + ": ",
                           CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           ""
                              + BuildingsManager.getWorkshop_BuildMovementCost(
                                    CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop() + 1
                                 )
                                 / 10.0F,
                           CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                              .get(
                                 "ConstructionWillTakeXurns",
                                 BuildingsManager.getWorkshop_Construction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop() + 1)
                              )
                        )
                     );
                     nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.time, CFG.PADDING, 0));
         ...
         if (canDestroy) {
            menuElements.add(
               new Button_Build_Destroy(
                  ...
                  tPosY,
                  Button_Build_Destroy.getButtonWidth(),
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfWorkshop() > 0
               ) {
                  @Override
                  public void actionElement(int iID) {
         ...
         tRow = (tRow + 1) % 2;
         tPosY += menuElements.get(menuElements.size() - 1).getHeight();
         canDestroy = CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() > 0;
         menuElements.add(
            new Button_Build_Level(
               BuildingsManager.getNuclearReactor_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() + 1),
               Images.b_radiation,
               "" + CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor(),
               BuildingsManager.getNuclearReactor_BuildCost(
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() + 1, BuildingsManager.iBuildInProvinceID
               ),
               BuildingsManager.getNuclearReactor_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() + 1),
               0,
               tPosY,
               canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
               true,
               CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() == BuildingsManager.getNuclearReactor_MaxLevel(),
               CFG.game
                  .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                  .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.NUCLEAR_REACTOR),
               BuildingsManager.getNuclearReactor_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() + 1)
            ) {
               @Override
               public void actionElement(int iID) {
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() == BuildingsManager.getNuclearReactor_MaxLevel()) {
                     CFG.toast.setInView(CFG.langManager.get("Built"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                  } else if (CFG.game
                        .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                        .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.NUCLEAR_REACTOR)
                     ...
                     CFG.menuManager.rebuildInGame_BuildNuclearReactor(BuildingsManager.iBuildInProvinceID);
                  }
               }
                  ...
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() == BuildingsManager.getNuclearReactor_MaxLevel()) {
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                                 .get(
                                    BuildingsManager.getNuclearReactor_Name(
                                       CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor()
                                    )
                                 )
                              + ": ",
                     ...
                     nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("BuildNuclearReactorIn") + ": ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getName().length() > 0
                              ? CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getName()
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           ...
                           CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney()
                                 >= BuildingsManager.getNuclearReactor_BuildCost(
                                    CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() + 1,
                                    BuildingsManager.iBuildInProvinceID
                                 )
                              ? CFG.COLOR_INGAME_GOLD
                              : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2
                        )
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           ""
                              + BuildingsManager.getNuclearReactor_BuildMovementCost(
                                    CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() + 1
                                 )
                                 / 10.0F,
                           CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                              .get(
                                 "ConstructionWillTakeXurns",
                                 BuildingsManager.getNuclearReactor_Construction(
                                    CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() + 1
                                 )
                              )
                        )
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           ""
                              + (int)(
                                    BuildingsManager.getNuclearReactor_TechLevel(
                                          CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() + 1
                                       )
                                       * 100.0F
                                 )
         ...
         if (canDestroy) {
            menuElements.add(
               new Button_Build_Destroy(
                  ...
                  tPosY,
                  Button_Build_Destroy.getButtonWidth(),
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfNuclearReactor() > 0
               ) {
                  @Override
                  public void actionElement(int iID) {
                     CFG.menuManager.rebuildInGame_DestroyNuclearReactor(BuildingsManager.iBuildInProvinceID);
                  }
               }
            );
            menuElements.get(menuElements.size() - 1).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
         ...
         tRow = (tRow + 1) % 2;
         tPosY += menuElements.get(menuElements.size() - 1).getHeight();
         canDestroy = CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() > 0;
         menuElements.add(
            new Button_Build_Level(
               BuildingsManager.getShelter_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() + 1),
               Images.b_shelter,
               "" + CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter(),
               BuildingsManager.getShelter_BuildCost(
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() + 1, BuildingsManager.iBuildInProvinceID
               ),
               BuildingsManager.getShelter_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() + 1),
               0,
               tPosY,
               canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
               true,
               CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() == BuildingsManager.getShelter_MaxLevel(),
               CFG.game
                  .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                  .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.SHELTER),
               BuildingsManager.getShelter_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() + 1)
            ) {
               @Override
               public void actionElement(int iID) {
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() == BuildingsManager.getShelter_MaxLevel()) {
                     CFG.toast.setInView(CFG.langManager.get("Built"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                  } else if (CFG.game
                        .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                        .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.SHELTER)
                     ...
                     CFG.menuManager.rebuildInGame_BuildShelter(BuildingsManager.iBuildInProvinceID);
                  }
               }
               ...
               public void buildElementHover() {
                  ...
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() == BuildingsManager.getShelter_MaxLevel()) {
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager.get(BuildingsManager.getShelter_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter()))
                              + ": ",
                           CFG.COLOR_TEXT_NUM_OF_PROVINCES
                        )
                     );
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                                 .get(BuildingsManager.getShelter_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() + 1))
                              + ": ",
                           CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
                     ...
                     nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("BuildShelterIn") + ": ", CFG.COLOR_TEXT_NUM_OF_PROVINCES));
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getName().length() > 0
                              ? CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getName()
                        ...
                        new MenuElement_Hover_v2_Element_Type_Text(
                           ""
                              + BuildingsManager.getShelter_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() + 1)
                                 / 10.0F,
                           CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                                 >= BuildingsManager.getShelter_BuildMovementCost(
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                              .get(
                                 "ConstructionWillTakeXurns",
                                 BuildingsManager.getShelter_Construction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() + 1)
                              )
                        )
                     );
                     nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.time, CFG.PADDING, 0));
         ...
         if (canDestroy) {
            menuElements.add(
               new Button_Build_Destroy(
                  ...
                  tPosY,
                  Button_Build_Destroy.getButtonWidth(),
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfShelter() > 0
               ) {
                  @Override
                  public void actionElement(int iID) {
                     CFG.menuManager.rebuildInGame_DestroyShelter(BuildingsManager.iBuildInProvinceID);
                  }
               }
            );
            menuElements.get(menuElements.size() - 1).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
         ...
         menuElements.add(
            new Button_Build_Level(
               BuildingsManager.getLibrary_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary() + 1),
               Images.b_library,
               "" + CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary(),
               BuildingsManager.getLibrary_BuildCost(
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary() + 1, BuildingsManager.iBuildInProvinceID
               ),
               BuildingsManager.getLibrary_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary() + 1),
               0,
               var15 = tPosY + menuElements.get(menuElements.size() - 1).getHeight(),
               canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
               true,
               CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary() == BuildingsManager.getLibrary_MaxLevel(),
               CFG.game
                  .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                  .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.LIBRARY),
               BuildingsManager.getLibrary_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary() + 1)
            ) {
               @Override
               public void actionElement(int iID) {
               ...
               public void buildElementHover() {
                  ...
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary() == BuildingsManager.getLibrary_MaxLevel()) {
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager.get(BuildingsManager.getLibrary_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary()))
                              + ": ",
                           CFG.COLOR_TEXT_NUM_OF_PROVINCES
                        )
                     );
                        ...
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                              .get(
                                 ...
                                 BuildingsManager.getLibrary_ResearchPerPopulation(
                                    CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary()
                                 )
                              ),
                           CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                                 .get(BuildingsManager.getLibrary_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary() + 1))
                              + ": ",
                           CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                                 .get(
                                    CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary() == 0
                                       ? "BuildLibraryIn"
                                       : (
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                              .get(
                                 "ConstructionWillTakeXurns",
                                 BuildingsManager.getLibrary_Construction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfLibrary() + 1)
                              )
                        )
                     );
                     nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.time, CFG.PADDING, 0));
         ...
         menuElements.add(
            new Button_Build(
               BuildingsManager.getArmoury_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1),
               Images.b_armoury,
               BuildingsManager.getArmoury_BuildCost(
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1, BuildingsManager.iBuildInProvinceID
               ),
               BuildingsManager.getArmoury_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1),
               0,
               tPosY = var15 + menuElements.get(menuElements.size() - 1).getHeight(),
               canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
               true,
               CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() == BuildingsManager.getArmoury_MaxLevel(),
               CFG.game
                  .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                  .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.ARMOURY),
               BuildingsManager.getArmoury_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1)
            ) {
               @Override
               public void actionElement(int iID) {
               ...
               public void buildElementHover() {
                  ...
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() == BuildingsManager.getArmoury_MaxLevel()) {
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager.get(BuildingsManager.getArmoury_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury()))
                              + ": ",
                           CFG.COLOR_TEXT_NUM_OF_PROVINCES
                        )
                     );
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                                 .get(BuildingsManager.getArmoury_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1))
                              + ": ",
                           CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
                        ...
                        new MenuElement_Hover_v2_Element_Type_Text(
                           ""
                              + BuildingsManager.getArmoury_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1)
                                 / 10.0F,
                           CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                                 >= BuildingsManager.getArmoury_BuildMovementCost(
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                              .get(
                                 "ConstructionWillTakeXurns",
                                 BuildingsManager.getArmoury_Construction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() + 1)
                              )
                        )
                     );
                     nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.time, CFG.PADDING, 0));
         ...
         if (canDestroy) {
            menuElements.add(
               new Button_Build_Destroy(
                  ...
                  tPosY,
                  Button_Build_Destroy.getButtonWidth(),
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfArmoury() > 0
               ) {
                  @Override
                  public void actionElement(int iID) {
         ...
         menuElements.add(
            new Button_Build(
               BuildingsManager.getSupply_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() + 1),
               Images.b_supply,
               BuildingsManager.getSupply_BuildCost(
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() + 1, BuildingsManager.iBuildInProvinceID
               ),
               BuildingsManager.getSupply_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() + 1),
               0,
               var17 = tPosY + menuElements.get(menuElements.size() - 1).getHeight(),
               canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
               true,
               CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() == BuildingsManager.getSupply_MaxLevel(),
               CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.SUPPLY),
               BuildingsManager.getSupply_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() + 1)
            ) {
               @Override
               public void actionElement(int iID) {
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() == BuildingsManager.getSupply_MaxLevel()) {
                     CFG.toast.setInView(CFG.langManager.get("Built"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                        ...
                        .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                        .isInConstruction(BuildingsManager.iBuildInProvinceID, ConstructionType.SUPPLY)
                     > 0) {
                     CFG.toast.setInView(CFG.langManager.get("InConstruction"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                  } else {
               ...
               public void buildElementHover() {
                  ...
                  if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() == BuildingsManager.getSupply_MaxLevel()) {
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager.get(BuildingsManager.getSupply_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply()))
                              + ": ",
                           CFG.COLOR_TEXT_NUM_OF_PROVINCES
                        )
                     );
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "-"
                              + (int)(BuildingsManager.getSupply_Bonus(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply()) * 100.0F)
                              + "%",
                           CFG.COLOR_TEXT_MODIFIER_POSITIVE
                        )
                     );
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                                 .get(BuildingsManager.getSupply_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() + 1))
                              + ": ",
                           CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "-"
                              + (int)(
                                 BuildingsManager.getSupply_Bonus(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() + 1) * 100.0F
                              )
                              + "%",
                           CFG.COLOR_TEXT_MODIFIER_POSITIVE
                        )
                        ...
                        new MenuElement_Hover_v2_Element_Type_Text(
                           ""
                              + BuildingsManager.getSupply_BuildMovementCost(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() + 1)
                                 / 10.0F,
                           CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                                 >= BuildingsManager.getSupply_BuildMovementCost(
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.langManager
                              .get(
                                 "ConstructionWillTakeXurns",
                                 BuildingsManager.getSupply_Construction(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() + 1)
                              )
                        )
                     );
                     nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.time, CFG.PADDING, 0));
         ...
         if (canDestroy) {
            menuElements.add(
               new Button_Build_Destroy(
                  ...
                  var17,
                  Button_Build_Destroy.getButtonWidth(),
                  CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfSupply() > 0
               ) {
                  @Override
                  public void actionElement(int iID) {
         ...
         if (CustomBuildingsManager.getCustomBuildingsAmount() > 0) {
            menuElements.add(new Text_BuildTitle(CFG.langManager.get("CustomBuildings"), -1, 0, tPosY, tempW, CFG.TEXT_HEIGHT + CFG.PADDING * 4) {});
            tRow = (tRow + 1) % 2;
            tPosY += menuElements.get(menuElements.size() - 1).getHeight();
            int n = 0;
            ...
            while (true) {
               CFG.game.getGame_CustomBuildingsManager();
               if (n >= CustomBuildingsManager.getCustomBuildingsAmount()) {
                  break;
               }

               canDestroy = CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(n) > 0;
               final int localn = n;
               menuElements.add(
                  new Button_Build_Level(
                     CustomBuildingsManager.getBuilding_Name(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(n) + 1, n),
                     CustomBuildingsManager.getBuildings_Image(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(n), localn),
                     "" + CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(n),
                     CustomBuildingsManager.getBuilding_BuildCost(
                        CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(n) + 1, BuildingsManager.iBuildInProvinceID, n
                     ),
                     CustomBuildingsManager.getBuilding_BuildMovementCost(
                        CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(n) + 1, n
                     ),
                     0,
                     tPosY,
                     canDestroy ? tempW - Button_Build_Destroy.getButtonWidth() : tempW,
                     true,
                     CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(n) == CustomBuildingsManager.getBuilding_MaxLevel(n),
                     CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isInConstructionBuilding(BuildingsManager.iBuildInProvinceID, localn),
                     CustomBuildingsManager.getBuilding_TechLevel(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(n) + 1, n)
                  ) {
                     @Override
                     public void actionElement(int iID) {
                        if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(localn)
                           == CustomBuildingsManager.getBuilding_MaxLevel(localn)) {
                           CFG.toast.setInView(CFG.langManager.get("Built"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                        } else if (CFG.game
                              .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                              .isInConstructionBuilding(BuildingsManager.iBuildInProvinceID, localn)
                           > 0) {
                           CFG.toast.setInView(CFG.langManager.get("InConstruction"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
                        } else {
                           CFG.menuManager.rebuildInGame_BuildBuilding(BuildingsManager.iBuildInProvinceID, localn);
                        }
                     }
                     ...
                     public void buildElementHover() {
                        ...
                        if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(localn)
                           ...
                           nData.add(
                              new MenuElement_Hover_v2_Element_Type_Text(
                                 "+"
                                    + CustomBuildingsManager.getBuilding_DefenseBonus(
                                       CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(localn), localn
                                    )
                                    + "%",
                                 CFG.COLOR_TEXT_MODIFIER_POSITIVE
                              )
                           ...
                           nData.add(
                              new MenuElement_Hover_v2_Element_Type_Text(
                                 CFG.langManager
                                       .get(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(localn) == 0 ? "Castle" : "Fortress")
                                    + ": ",
                                 CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                              )
                           );
                           ...
                           nData.add(
                              new MenuElement_Hover_v2_Element_Type_Text(
                                 CFG.langManager
                                       .get(
                                          CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(localn) == 0
                                             ? "BuildCastleIn"
                                             : "BuildFortressIn"
                                       )
                                    + ": ",
                           ...
                           nData.add(
                              new MenuElement_Hover_v2_Element_Type_Text(
                                 "+"
                                    + CustomBuildingsManager.getBuilding_DefenseBonus(
                                       CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(localn) + 1, localn
                                    )
                                    + "%",
                                 CFG.COLOR_TEXT_MODIFIER_POSITIVE
                              )
                           ...
                           nData.add(
                              new MenuElement_Hover_v2_Element_Type_Text(
                                 ""
                                    + CustomBuildingsManager.getBuilding_BuildCost(
                                       CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(localn) + 1,
                                       BuildingsManager.iBuildInProvinceID,
                                       localn
                                    ),
                                 CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney()
                           ...
                           nData.add(
                              new MenuElement_Hover_v2_Element_Type_Text(
                                 CFG.langManager
                                    .get(
                                       "ConstructionWillTakeXurns",
                                       CustomBuildingsManager.getBuilding_Construction(
                                          CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(localn) + 1, localn
                                       )
                                    )
                              )
                           ...
                           nData.add(
                              new MenuElement_Hover_v2_Element_Type_Text(
                                 ""
                                    + (int)(
                                          CustomBuildingsManager.getBuilding_TechLevel(
                                                CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(localn) + 1, localn
                                             )
                                             * 100.0F
                                       )
                        ...
                        CustomBuildingsManager.getBuilding_Action(CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(localn), localn)
                           .buildMenuHoverElement(nElements);
                        this.menuElementHover = new MenuElement_Hover_v2(nElements);
                     }
                  }
               );
               ...
               if (canDestroy) {
                  menuElements.add(
                     new Button_Build_Destroy(
                        ...
                        tPosY,
                        Button_Build_Destroy.getButtonWidth(),
                        CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getLevelOfBuilding(n) > 0
                     ) {
                        @Override
                        public void actionElement(int iID) {
                           CFG.menuManager.rebuildInGame_DestroyBuilding(BuildingsManager.iBuildInProvinceID, localn);
                        }
                     }
                  );
                  menuElements.get(menuElements.size() - 1).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
      ...
      menuElements.add(
         new Button_Build(
            CFG.langManager.get("Festival"),
            Images.diplo_festival,
            DiplomacyManager.festivalCost(BuildingsManager.iBuildInProvinceID),
            8,
            0,
            var18 = tPosY + menuElements.get(menuElements.size() - 1).getHeight(),
            tempW,
            true,
            false,
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "+" + (int)(DiplomacyManager.festivalHappinessPerTurn(BuildingsManager.iBuildInProvinceID) * 10000.0F) / 100.0F,
                     CFG.COLOR_TEXT_MODIFIER_POSITIVE
                  )
               );
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Cost") + ": "));
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text("" + DiplomacyManager.festivalCost(BuildingsManager.iBuildInProvinceID), CFG.COLOR_INGAME_GOLD)
               );
               nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.top_gold, CFG.PADDING, 0));
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
      ...
      menuElements.get(menuElements.size() - 1).setHeight(CFG.BUTTON_HEIGHT * 3 / 5);
      menuElements.add(
         new Button_Build_DiplomacyCost(
            ...
            6,
            0,
            tPosY = var18 + menuElements.get(menuElements.size() - 1).getHeight(),
            tempW,
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "" + DiplomacyManager.assimilateCost(BuildingsManager.iBuildInProvinceID, 1), CFG.COLOR_INGAME_GOLD
                  )
               );
               nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.top_gold, CFG.PADDING, 0));
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
      ...
      menuElements.add(
         new Button_Build(
            CFG.langManager.get("Invest"),
            Images.economy,
            0,
            12,
            0,
            var20 = tPosY + menuElements.get(menuElements.size() - 1).getHeight(),
            tempW,
            true,
            false,
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.getNumberWithSpaces("" + CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getEconomy()), CFG.COLOR_TEXT_ECONOMY
                  )
               );
               nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.economy, CFG.PADDING, 0));
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
      ...
      menuElements.add(
         new Button_Build(
            ...
            8,
            0,
            tPosY = var20 + menuElements.get(menuElements.size() - 1).getHeight(),
            tempW,
            true,
            false,
            ...
            public void actionElement(int iID) {
               if (CFG.game
                     .getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())
                     .isInvestOrganized_TurnsLeft_Development(BuildingsManager.iBuildInProvinceID)
                  > 0) {
                  CFG.toast.setInView(CFG.langManager.get("InConstruction"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
               } else {
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "" + String.format("%.2f", CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getDevelopmentLevel()).replace(',', '.'),
               ...
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
               if (CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getTechnologyLevel() - 0.01F
                  <= CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getDevelopmentLevel()) {
                  nData.add(new MenuElement_Hover_v2_Element_Type_Space());
                  nElements.add(new MenuElement_Hover_v2_Element2(nData));
                  nData.clear();
      ...
      if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).isOccupied()) {
         menuElements.add(
            new Button_Build_DiplomacyCost(CFG.langManager.get("TransferControl"), Images.transfer_control, 0, 4, 0, tPosY, tempW, true, false, 0, 0.0F) {
               @Override
               public void actionElement(int iID) {
               ...
               public void buildElementHover() {
                  ...
                  ArrayList<MenuElement_Hover_v2_Element_Type> nData = new ArrayList<>();
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("TransferControlOverProvince") + ": ", CFG.COLOR_TEXT_NUM_OF_PROVINCES)
                  );
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Text(
                        CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getName().length() > 0
      ...
      menuElements.add(
         new Button_Build(
            ...
            0,
            0,
            var23 = tPosY + menuElements.get(menuElements.size() - 1).getHeight(),
            tempW,
            true,
            false,
            0,
            ...
            public void actionElement(int iID) {
               if (BuildingsManager.iBuildInProvinceID >= 0
                  && CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getTrueOwnerOfProvince() == CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()) {
                  ...
                  if (CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                     ...
                     < CFG.getCostOfRecruitArmyMoney_Instantly(BuildingsManager.iBuildInProvinceID)) {
            ...
            public boolean getClickable() {
               try {
                  return BuildingsManager.iBuildInProvinceID >= 0
                     ? CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getTrueOwnerOfProvince() == CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()
                     : super.getClickable();
               } catch (IndexOutOfBoundsException var2) {
      ...
      menuElements.add(
         new Button_Build(
            CFG.langManager.get("DisbandArmy"),
            Images.diplo_army,
            0,
            0,
            0,
            tPosY = var23 + menuElements.get(menuElements.size() - 1).getHeight(),
            tempW,
            true,
            false,
            0,
            ...
            public void buildElementHover() {
               ...
               if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getArmyCivID(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()) > 0) {
                  ...
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Text(
                        "" + CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).getArmyCivID(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()),
                        CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                     )
                  );
                  nData.add(new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), CFG.PADDING, 0));
      ...
      menuElements.add(
         new Button_Build(
            CFG.langManager.get("Plunder"),
            Images.diplo_plunder,
            0,
            0,
            0,
            var25 = tPosY + menuElements.get(menuElements.size() - 1).getHeight(),
            tempW,
            true,
            false,
            CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isPlundred(BuildingsManager.iBuildInProvinceID) ? 1 : 0,
            0.0F
         ) {
            @Override
            public void actionElement(int iID) {
            ...
            public void buildElementHover() {
               ...
               if (CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).isOccupied()) {
                  ...
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Image(
                        CFG.game.getProvince(BuildingsManager.iBuildInProvinceID).isOccupied() ? Images.icon_check_true : Images.icon_check_false,
                        CFG.PADDING,
                        0
                     )
                  );
                  ...
                  nData.add(
                     new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("OnlyOccupiedProvinceCanBePlundered"), CFG.COLOR_TEXT_MODIFIER_NEGATIVE2)
                  );
                  nElements.add(new MenuElement_Hover_v2_Element2(nData));
                  nData.clear();
               }
      ...
      menuElements.add(
         new Text_BuildTitle(
            ...
            -1,
            0,
            tPosY = var25 + menuElements.get(menuElements.size() - 1).getHeight(),
            tempW,
         ...
         new SliderMenuTitle(null, CFG.BUTTON_HEIGHT * 3 / 5, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_InGame_Build.this.getPosX() + iTranslateX,
                     Menu_InGame_Build.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(),
                     Menu_InGame_Build.this.getWidth() + 2,
                     this.getHeight(),
                     true,
                     false
                  );
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_InGame_Build.this.getPosX() + iTranslateX,
                     Menu_InGame_Build.this.getPosY()
                        - ImageManager.getImage(Images.pix255_255_255).getHeight()
                        - ImageManager.getImage(Images.line_32_off1).getHeight(),
                     Menu_InGame_Build.this.getWidth(),
                     1
                  );
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     Menu_InGame_Build.this.getWidth() / 4,
                     1
                  );
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Menu_InGame_Build.this.getPosX() + Menu_InGame_Build.this.getWidth() - Menu_InGame_Build.this.getWidth() / 4 + iTranslateX,
                     Menu_InGame_Build.this.getPosY()
                        - ImageManager.getImage(Images.pix255_255_255).getHeight()
                        - ImageManager.getImage(Images.slider_gradient).getHeight(),
                     Menu_InGame_Build.this.getWidth() / 4,
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_Build.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_Build.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
