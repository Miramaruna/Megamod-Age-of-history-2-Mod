...
public class CivArmyMission_RegroupAfterRecruitment_War_Double extends CivArmyMission {
   ...
   public CivArmyMission_RegroupAfterRecruitment_War_Double(int nCivID, int fromProvinceID, int toProvinceID, int iArmy) {
      this.iArmy = iArmy;
   ...
   public boolean action(int nCivID) {
      RegroupArmy_Data_ToTheFront_Double tryRegroupArmy;
      if (this.iProvinceID == this.toProvinceID
         || (tryRegroupArmy = new RegroupArmy_Data_ToTheFront_Double(nCivID, this.iProvinceID, this.toProvinceID)).getRouteSize() <= 0) {
         return true;
