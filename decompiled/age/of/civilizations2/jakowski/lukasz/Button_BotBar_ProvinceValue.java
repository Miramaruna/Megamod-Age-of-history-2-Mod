...
public class Button_BotBar_ProvinceValue extends Button_BotBar {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ImageManager.getImage(Images.victoryPoints)
         .draw(
            ...
            this.getPosY() + (this.getHeight() - ImageManager.getImage(Images.victoryPoints).getHeight()) / 2 + iTranslateY
         );
      CFG.fontMain.getData().setScale(this.FONT_SCALE);
      CFG.drawTextWithShadow(
         oSB,
         this.getTextToDraw(),
         this.getPosX() + this.getTextPos() + CFG.PADDING + ImageManager.getImage(Images.victoryPoints).getWidth() + iTranslateX,
   ...
   public int getWidth() {
      return this.iTextWidth
         + CFG.PADDING * 2
         + 2
         + ImageManager.getImage(Images.victoryPoints).getWidth()
         + CFG.PADDING * 2
