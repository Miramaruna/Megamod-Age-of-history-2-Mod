...
public class Button_Diplomacy_Message_Gift extends Button_Statistics {
   ...
   public Button_Diplomacy_Message_Gift(String sText, int nAggressor, String sRight, int iPosX, int iPosY, int iWidth) {
      ...
      this.sRight = sRight;
      CFG.glyphLayout.setText(CFG.fontMain, sRight);
      this.iRightWidth = (int)(CFG.glyphLayout.width * 0.7F);
   }
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.diplo_gift)
         .draw(
            oSB,
            this.getPosX() + Button_Diplomacy.iDiploWidth / 2 - ImageManager.getImage(Images.diplo_gift).getWidth() / 2 + iTranslateX,
