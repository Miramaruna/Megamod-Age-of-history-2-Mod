...
public class Button_Diplomacy_OfferAlliance extends Button_Statistics {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      ImageManager.getImage(Images.diplo_alliance)
         .draw(
            ...
            this.getPosY()
               + this.getHeight() / 2
               - (int)(ImageManager.getImage(Images.diplo_alliance).getHeight() * this.getImageScale(Images.diplo_alliance)) / 2
               - ImageManager.getImage(Images.diplo_alliance).getHeight()
               + iTranslateY,
            (int)(ImageManager.getImage(Images.diplo_alliance).getWidth() * this.getImageScale(Images.diplo_alliance)),
            (int)(ImageManager.getImage(Images.diplo_alliance).getHeight() * this.getImageScale(Images.diplo_alliance))
         );
