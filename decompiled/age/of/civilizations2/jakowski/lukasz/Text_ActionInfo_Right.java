...
public class Text_ActionInfo_Right extends Text {
   public Text_ActionInfo_Right(String sText, int iPosX, int iPosY) {
      super(sText, CFG.PADDING, iPosX, iPosY, CFG.TEXT_HEIGHT + CFG.PADDING * 2);
      this.setWidth((int)(this.getWidth() * 0.8F) + CFG.PADDING * 3);
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sText,
         this.getPosX() + this.getWidth() - (int)(this.getTextWidth() * 0.8F) - CFG.PADDING + var6,
