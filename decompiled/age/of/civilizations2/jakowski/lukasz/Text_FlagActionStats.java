...
public class Text_FlagActionStats extends Text {
   public static final float TEXT_SCALE = 0.7F;
   public String s2;
   public int iS2Width = 0;
   public Color oColor2;

   public Text_FlagActionStats(String sText, int iPosX, int iPosY) {
   ...
   public Text_FlagActionStats(String sText, String s2, Color oColor2, int iPosX, int iPosY) {
      this.typeOfElement = MenuElement.TypeOfElement.TEXT;
      this.setPosX(iPosX);
      this.setPosY(iPosY);
      this.setHeight(CFG.TEXT_HEIGHT + CFG.PADDING * 4 - 1);
