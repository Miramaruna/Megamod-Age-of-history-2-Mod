...
public class Event_Conditions_IsAVassalOfCiv extends Event_Conditions {
   public int iCivID = -1;
   public int iCivID2 = -1;

   Event_Conditions_IsAVassalOfCiv() {
   }
   ...
   public boolean outCondition() {
      try {
         return CFG.game.getCiv(this.getCivID2()).getPuppetOfCivID() == this.getCivID();
   ...
   public String getConditionText() {
      try {
         return CFG.langManager.get("IsAVassalOfCiv")
            + ": "
            + CFG.langManager.get("Lord")
            + ": "
