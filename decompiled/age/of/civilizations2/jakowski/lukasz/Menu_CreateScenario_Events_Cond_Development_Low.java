...
public class Menu_CreateScenario_Events_Cond_Development_Low extends SliderMenu {
      ...
      menuElements.add(
         new Slider_BG(
            ...
            public String getDrawText() {
               return this.getText() + this.getCurrent() / 100.0F;
            }
         }
      );
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("DevelopmentLevel") + " < ");
      this.getTitle().setText(CFG.langManager.get("DevelopmentLevel"));
   }
