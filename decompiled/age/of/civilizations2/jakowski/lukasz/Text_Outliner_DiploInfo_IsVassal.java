...
public class Text_Outliner_DiploInfo_IsVassal extends Text {
   ...
   public Text_Outliner_DiploInfo_IsVassal(int iCivLeft, int iCivRight, int iTurnID, int iPosX, int iPosY, int nWidth) {
   ...
   public void buildElementHover() {
      ...
      nData.add(new MenuElement_Hover_v2_Element_Type_Text(" " + CFG.langManager.get("CivBIsNowAPuppetStateOfCivA") + " ", CFG.COLOR_TEXT_MODIFIER_POSITIVE));
      nData.add(
      ...
      CFG.toast
         .setInView(
            (this.iCivLeft >= 0 ? CFG.game.getCiv(this.iCivLeft).getCivName() : CFG.langManager.get("Undiscovered"))
               + " "
               + CFG.langManager.get("CivBIsNowAPuppetStateOfCivA")
               + " "
