...
public class Button_Likelihood extends Button {
   public static final float FONT_SIZE = 0.55F;
   public long lTime;
   public static final int ANIMATION_TIME = 375;
   public float fPerc = 1.0F;
   public String sLikelihood;
   public int iLikelihoodwidth;
   public String sRes;
   public int iResWidth;

   public Button_Likelihood(float fPerc, int iPosX, int iPosY, int iWidth) {
      super.init("", 0, iPosX, iPosY, iWidth, (int)(CFG.TEXT_HEIGHT * 0.95F + CFG.PADDING * 2), true, true, false, false, null);
      this.fPerc = fPerc;
   ...
   public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.drawText(
         ...
         this.getPosY() + (int)((this.getHeight() - CFG.TEXT_HEIGHT * 0.55F) / 2.0F) + iTranslateY,
   ...
   public void buildElementHover() {
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(
            this.getCurrent() / 100.0F >= 0.5F ? CFG.langManager.get("High") : CFG.langManager.get("Low"), CFG.COLOR_TEXT_NUM_OF_PROVINCES
         )
      );
