...
public class Slider_FlagAction_Clear_Tech extends Slider {
   ...
   public Slider_FlagAction_Clear_Tech(float fModifier, String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
