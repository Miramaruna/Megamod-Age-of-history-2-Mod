...
public class Menu_CreateScenario_Events_Cond_Relation_Low extends SliderMenu {
   public Menu_CreateScenario_Events_Cond_Relation_Low() {
      ...
      menuElements.add(
         new Slider_BG(
            0,
            var5 = tY + menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING * 2,
            CFG.GAME_WIDTH,
            ...
            public String getDrawText() {
               return this.getText() + (this.getCurrent() > 0 ? "+" : "") + this.getCurrent();
            }
         }
      );
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(6).setText(CFG.langManager.get("Relation") + " < ");
      this.getTitle().setText(CFG.langManager.get("Relation"));
   }
