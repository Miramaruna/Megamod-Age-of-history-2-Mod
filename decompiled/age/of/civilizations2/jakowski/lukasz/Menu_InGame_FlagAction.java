...
public class Menu_InGame_FlagAction extends SliderMenu {
   public Menu_InGame_FlagAction() {
      ...
      menuElements.add(
         new Button_Chatbox(
            CFG.langManager.get("TypeMessage") + "..",
            1,
            "",
            CFG.PADDING,
            menuElements.get(0).getPosX() + menuElements.get(0).getWidth() + CFG.PADDING,
            CFG.PADDING * 2,
            CFG.GAME_WIDTH
               - CFG.PADDING * 4
               - menuElements.get(0).getWidth()
               - menuElements.get(0).getPosX() * 2
               - CFG.PADDING * 3
               - CFG.BUTTON_WIDTH * 3
               - CFG.PADDING,
      ...
      menuElements.add(
         new Button_New_Game_Players(
            "",
            -1,
            CFG.GAME_WIDTH - CFG.PADDING * 4 - CFG.PADDING * 2 - CFG.BUTTON_WIDTH,
            menuElements.get(0).getPosY(),
            CFG.BUTTON_WIDTH,
            menuElements.get(0).getHeight(),
            true
         ) {
            ...
            public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ...
               ImageManager.getImage(Images.editor_game)
                  .draw(
                     oSB,
                     this.getPosX() + this.getWidth() / 2 - ImageManager.getImage(Images.editor_game).getWidth() / 2 + iTranslateX,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.editor_game).getHeight() / 2 + iTranslateY
                  );
               oSB.setColor(Color.WHITE);
            }
      ...
      menuElements.add(
         new Button_New_Game_Players(
            "",
            -1,
            CFG.GAME_WIDTH - CFG.PADDING * 4 - CFG.PADDING * 2 - CFG.BUTTON_WIDTH - CFG.BUTTON_WIDTH - CFG.PADDING,
            menuElements.get(0).getPosY(),
            CFG.BUTTON_WIDTH,
            menuElements.get(0).getHeight(),
            true
            ...
            public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ...
               ImageManager.getImage(Images.icon_save)
                  .draw(
                     oSB,
                     this.getPosX() + this.getWidth() / 2 - ImageManager.getImage(Images.icon_save).getWidth() / 2 + iTranslateX,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.icon_save).getHeight() / 2 + iTranslateY
                  );
               oSB.setColor(Color.WHITE);
            }
      ...
      menuElements.add(
         new Button_New_Game_Players(
            "",
            -1,
            CFG.GAME_WIDTH - CFG.PADDING * 4 - CFG.PADDING * 2 - CFG.BUTTON_WIDTH - CFG.BUTTON_WIDTH * 2 - CFG.PADDING * 2,
            menuElements.get(0).getPosY(),
            CFG.BUTTON_WIDTH,
            menuElements.get(0).getHeight(),
            true
            ...
            public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ...
               ImageManager.getImage(Images.stats)
                  .draw(
                     oSB,
                     this.getPosX() + this.getWidth() / 2 - ImageManager.getImage(Images.stats).getWidth() / 2 + iTranslateX,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.stats).getHeight() / 2 + iTranslateY
                  );
               oSB.setColor(Color.WHITE);
            }
      ...
      this.initMenu(
         ...
         CFG.PADDING * 4 + ImageManager.getImage(Images.top_flag_frame).getHeight(),
         menuElements,
         false,
         false
      );
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      ImageManager.getImage(Images.new_game_top_edge_title)
         .draw2(
            ...
            this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() + iTranslateY,
            this.getWidth() - ImageManager.getImage(Images.new_game_top_edge_title).getWidth(),
            ImageManager.getImage(Images.top_flag_frame).getHeight() + CFG.PADDING * 4
         );
      ImageManager.getImage(Images.new_game_top_edge_title)
         .draw2(
            oSB,
            this.getPosX() + this.getWidth() - ImageManager.getImage(Images.new_game_top_edge_title).getWidth() + iTranslateX,
            this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() + iTranslateY,
      ...
      CFG.game
         ...
         .draw(
            ...
            this.getPosY() - CFG.game.getPlayer(CFG.PLAYER_TURNID).getFlag().getHeight() + this.getMenuElement(0).getPosY() + iTranslateY,
      ...
      ImageManager.getImage(Images.pix255_255_255)
         .draw(
            ...
            this.getPosY() + ImageManager.getImage(Images.top_flag_frame).getHeight() + CFG.PADDING * 4 - 1 + iTranslateY,
            this.getWidth() - 4
         );
      ...
      if (CFG.FLIP_Y_CIV_FLAG_COUNTER == 3) {
         ...
         ImageManager.getImage(Images.line_32_off1)
            .draw(
               oSB,
               this.getPosX() + this.getMenuElement(0).getPosX() + iTranslateX,
               this.getPosY() - ImageManager.getImage(Images.line_32_off1).getHeight() + this.getMenuElement(0).getPosY() + iTranslateY,
