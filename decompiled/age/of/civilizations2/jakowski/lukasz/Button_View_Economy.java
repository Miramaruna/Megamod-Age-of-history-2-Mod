...
public class Button_View_Economy extends Button {
   ...
   public Button_View_Economy(int iRow, String sText, int nProvinceID, int totalPop, int iPosX, int iPosY, int iWidth, boolean isFestivalOrganized) {
      ...
      this.sPopulationPerc = "" + (int)((float)CFG.game.getProvince(this.iProvinceID).getEconomy() / totalPop * 10000.0F) / 100.0F + "%";
         ...
         ImageManager.getImage(Images.economy)
            .draw(
               ...
               this.getPosX()
                  ...
                  - (int)(ImageManager.getImage(Images.b_workshop).getWidth() * this.getImageScale2(ImageManager.getImage(Images.b_workshop).getHeight()))
                  - this.iPopulationPercWidth
                  - (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale2(ImageManager.getImage(Images.economy).getHeight()))
                  + iTranslateX,
               this.getPosY()
                  + this.getHeight() / 2
                  - (int)(ImageManager.getImage(Images.economy).getHeight() * this.getImageScale2(ImageManager.getImage(Images.economy).getHeight())) / 2
                  + iTranslateY
                  - ImageManager.getImage(Images.economy).getHeight(),
               (int)(ImageManager.getImage(Images.economy).getWidth() * this.getImageScale2(ImageManager.getImage(Images.economy).getHeight())),
               (int)(ImageManager.getImage(Images.economy).getHeight() * this.getImageScale2(ImageManager.getImage(Images.economy).getHeight()))
            );
   ...
   public void buildElementHover() {
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(
            "" + (int)(CFG.game.getProvince(this.iProvinceID).getDevelopmentLevel() * 100.0F) / 100.0F, CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
         )
      );
