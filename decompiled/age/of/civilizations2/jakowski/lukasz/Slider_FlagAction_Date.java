...
public class Slider_FlagAction_Date extends Slider {
   public static final Color bgColor = new Color(0.0F, 0.0F, 0.0F, 0.3F);
   public float FONT_SCALE = 0.8F;
   public float FONT_SCALE22 = 0.65F;
   public String sDate = "";
   public int iDateWidth;
   public String sTruns = "";
   public int iTurnsWidth;

   public Slider_FlagAction_Date(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
      this.initSlider(sText, iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
   }

   public Slider_FlagAction_Date(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent, float FONT_SCALE) {
      this.initSlider(sText, iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      oSB.setColor(new Color(new Color(CFG.COLOR_GRADIENT_TITLE_BLUE.r, CFG.COLOR_GRADIENT_TITLE_BLUE.g, CFG.COLOR_GRADIENT_TITLE_BLUE.b, 0.275F)));
      ...
      oSB.setColor(new Color(new Color(CFG.COLOR_GRADIENT_TITLE_BLUE.r, CFG.COLOR_GRADIENT_TITLE_BLUE.g, CFG.COLOR_GRADIENT_TITLE_BLUE.b, 0.175F)));
      ImageManager.getImage(Images.line_32_off1)
         .draw(
            oSB,
      ...
      CFG.drawTextWithShadow(
         ...
         this.getPosY() + this.getHeight() - CFG.PADDING * 2 - this.getSliderHeight() - (int)(CFG.TEXT_HEIGHT * this.FONT_SCALE22) + iTranslateY,
