...
public class Menu_CreateScenario_Events_AddNewOutcome extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(20).setText(CFG.langManager.get("ChangeIdeology"));
      this.getMenuElement(21).setText(CFG.langManager.get("AddArmy"));
      this.getMenuElement(22).setText(CFG.langManager.get("UpdatePopulation"));
      this.getMenuElement(23).setText(CFG.langManager.get("UpdatePopulationPercentage"));
      this.getMenuElement(24).setText(CFG.langManager.get("UpdatePopulationOfCiv"));
      this.getMenuElement(25).setText(CFG.langManager.get("UpdateEconomy"));
      this.getMenuElement(26).setText(CFG.langManager.get("UpdateEconomyPercentage"));
      this.getMenuElement(27).setText(CFG.langManager.get("UpdateEconomyOfCiv"));
      this.getMenuElement(28).setText(CFG.langManager.get("UpdateTechnologyLevel"));
      this.getMenuElement(29).setText(CFG.langManager.get("UpdateDevelopmentLevel"));
      this.getMenuElement(30).setText(CFG.langManager.get("UpdateHappiness"));
      this.getMenuElement(31).setText(CFG.langManager.get("UpdateHappinessOfCivilization"));
      this.getMenuElement(32).setText(CFG.langManager.get("UpdateMoney"));
      this.getMenuElement(33).setText(CFG.langManager.get("UpdateMovementPoints"));
      this.getMenuElement(34).setText(CFG.langManager.get("UpdateDiplomacyPoints"));
      this.getMenuElement(35).setText(CFG.langManager.get("UpdateWastelandProvinces"));
      ...
      switch (iID) {
         ...
         case 1:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_TriggerAnotherEvent());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
                  .lOutcomes
                  .size()
               - 1;
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 8:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_IncreaseRelation());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 9:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_CreateVassal());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 10:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_LiberateVassal());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 11:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_JoinAlliance());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 12:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_LeaveAlliance());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 14:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_FormCivilization());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 15:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_NonAggression());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 16:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_DefensivePact());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 17:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_Independence());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 18:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_MilitaryAccess());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 20:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_ChangeIdeology());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 22:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_UpdatePopulation());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 23:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_UpdatePopulationPerc());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 24:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_UpdatePopulationOfCiv());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 25:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_UpdateEconomy());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 26:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_UpdateEconomyPerc());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 27:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_UpdateEconomyOfCiv());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 30:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_UpdateHappiness());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 31:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_UpdateHappinessOfCiv());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 33:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_MovementPoints());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
         ...
         case 34:
            CFG.eventsManager.lCreateScenario_Event.lDecisions.get(CFG.eventsManager.iCreateEvent_EditTriggerID)
               .lOutcomes
               .add(new Event_Outcome_DiplomacyPoints());
            CFG.eventsManager.iCreateEvent_EditConditionID = CFG.eventsManager
                     .lCreateScenario_Event
                     .lDecisions
                     .get(CFG.eventsManager.iCreateEvent_EditTriggerID)
