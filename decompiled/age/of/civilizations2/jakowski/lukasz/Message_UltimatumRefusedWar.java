...
public class Message_UltimatumRefusedWar extends Message {
   ...
   public void onAccept(int iCivID) {
      if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID() == iCivID) {
         ...
         lMess.add(CFG.game.getCiv(this.iFromCivID).getCivName() + ": " + CFG.langManager.get("RefusedToAcceptOurUltimatum"));
