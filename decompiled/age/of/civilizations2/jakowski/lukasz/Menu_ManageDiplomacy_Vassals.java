...
public class Menu_ManageDiplomacy_Vassals extends SliderMenu {
            ...
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ...
               if (CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1 > 0) {
                  CFG.ideologiesManager
                     .getIdeology(CFG.game.getCiv(CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1).getIdeologyID())
                     .getiCrownImage()
                     .draw(
                        oSB,
                        this.getPosX()
                  ...
                  CFG.ideologiesManager
                     ...
                     .draw(
                        oSB,
                        this.getPosX() + this.getWidth() / 2 - CFG.ideologiesManager.getIdeology(0).getiCrownImage().getWidth() / 2 + iTranslateX,
                        this.getPosY() + this.getHeight() / 2 - CFG.ideologiesManager.getIdeology(0).getiCrownImage().getHeight() / 2 + iTranslateY
                     );
               }
            }
         ...
         new Button_Add(
            ...
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ...
               if (CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV2 > 0) {
                  CFG.ideologiesManager
                     .getIdeology(CFG.game.getCiv(CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV2).getIdeologyID())
                  ...
                  CFG.ideologiesManager
                     ...
                     .draw(
                        oSB,
                        this.getPosX() + this.getWidth() / 2 - CFG.ideologiesManager.getIdeology(0).getiCrownVassalImage().getWidth() / 2 + iTranslateX,
                        this.getPosY() + this.getHeight() / 2 - CFG.ideologiesManager.getIdeology(0).getiCrownVassalImage().getHeight() / 2 + iTranslateY
                     );
               }
            }
      ...
      switch (iID) {
         case 2:
            if (CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1 > 0 && CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV2 > 0) {
               ...
               ArrayList<Color> tempMessColors = new ArrayList<>();
