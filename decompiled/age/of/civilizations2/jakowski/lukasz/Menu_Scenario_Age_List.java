...
public class Menu_Scenario_Age_List extends SliderMenu {
   ...
   public final void actionElement(int iID) {
      if (CFG.CREATE_SCENARIO_AGE != iID / 2) {
         ...
         Game_Calendar.currentYear = Math.max(
               Math.abs(CFG.gameAges.getAge(CFG.CREATE_SCENARIO_AGE).getBeginningYear()), Math.abs(CFG.gameAges.getAge(CFG.CREATE_SCENARIO_AGE).getEndYear())
            )
            - Math.min(
               Math.abs(CFG.gameAges.getAge(CFG.CREATE_SCENARIO_AGE).getBeginningYear()), Math.abs(CFG.gameAges.getAge(CFG.CREATE_SCENARIO_AGE).getEndYear())
            );
         ...
         tMess.add(
            CFG.gameAges.getYear(CFG.gameAges.getAge(CFG.CREATE_SCENARIO_AGE).getBeginningYear())
               + " - "
               + CFG.gameAges.getYear(CFG.gameAges.getAge(CFG.CREATE_SCENARIO_AGE).getEndYear())
         );
