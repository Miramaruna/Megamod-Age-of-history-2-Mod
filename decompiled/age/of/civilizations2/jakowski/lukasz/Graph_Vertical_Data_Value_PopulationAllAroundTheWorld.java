...
public class Graph_Vertical_Data_Value_PopulationAllAroundTheWorld extends Graph_Vertical_Data_Value {
   ...
   public final Color getColor(float fAlpha) {
      try {
         return new Color(
            CFG.game.getCiv(this.iColorDataID).getR() / 255.0F,
            CFG.game.getCiv(this.iColorDataID).getG() / 255.0F,
            CFG.game.getCiv(this.iColorDataID).getB() / 255.0F,
            fAlpha
         );
