...
public class Button_Menu_LR_MainMenu_TextScale_Active extends Button_Menu_LR_MainMenu {
   public Button_Menu_LR_MainMenu_TextScale_Active(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
      super(sText, iTextPositionX, iPosX, iPosY, iWidth, iHeight, isClickable);
   }

   public Button_Menu_LR_MainMenu_TextScale_Active(
