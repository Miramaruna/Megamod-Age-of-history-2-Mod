...
public class Button_FormCivTitle extends Button {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sText,
         this.getPosX() + (int)((this.getWidth() - this.getTextWidth() * 0.85F) / 2.0F) + iTranslateX,
         this.getPosY() + (int)((this.getHeight() - this.iTextHeight * 0.85F) / 2.0F) + iTranslateY,
