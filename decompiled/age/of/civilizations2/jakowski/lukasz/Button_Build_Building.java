...
public class Button_Build_Building extends Button_Build {
   ...
   public Button_Build_Building(String sText, String sProvinceID, int nImageID, int nCost, int nMovementCost, int iPosX, int iPosY, int iWidth) {
   ...
   public void setMin(int iMin) {
      this.sEconomy = "" + iMin / 100.0F;
      this.oColor = iMin / 100.0F <= CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getTechnologyLevel()
