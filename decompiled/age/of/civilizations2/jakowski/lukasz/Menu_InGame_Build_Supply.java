...
public class Menu_InGame_Build_Supply extends SliderMenu {
   public int iProvinceID = -1;

   public Menu_InGame_Build_Supply() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("SupplyCamp"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Build_Supply(int nProvinceID) {
      ArrayList<MenuElement> menuElements = new ArrayList<>();
      ...
      menuElements.add(
         new Button_Build_Building(
            CFG.langManager.get("BuildSupplyCampIn") + ": ",
            ...
            Images.b_supply,
            BuildingsManager.getSupply_BuildCost(CFG.game.getProvince(this.iProvinceID).getLevelOfSupply() + 1, this.iProvinceID),
            BuildingsManager.getSupply_BuildMovementCost(CFG.game.getProvince(this.iProvinceID).getLevelOfSupply() + 1),
            0,
            tY,
            CFG.BUTTON_WIDTH * 2
         ) {
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     "-"
                        + (int)(
                           BuildingsManager.getSupply_Bonus(CFG.game.getProvince(Menu_InGame_Build_Supply.this.iProvinceID).getLevelOfSupply() + 1) * 100.0F
                        )
                        + "%",
      ...
      menuElements.get(menuElements.size() - 1)
         .setMin((int)(BuildingsManager.getSupply_TechLevel(CFG.game.getProvince(this.iProvinceID).getLevelOfSupply() + 1) * 100.0F));
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      int var7;
      ...
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Construct"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getProvince(Menu_InGame_Build_Supply.this.iProvinceID).getName().length() > 0
                        ? CFG.game.getProvince(Menu_InGame_Build_Supply.this.iProvinceID).getName()
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + BuildingsManager.getSupply_BuildCost(
                           CFG.game.getProvince(Menu_InGame_Build_Supply.this.iProvinceID).getLevelOfSupply() + 1, Menu_InGame_Build_Supply.this.iProvinceID
                        ),
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + BuildingsManager.getSupply_BuildMovementCost(CFG.game.getProvince(Menu_InGame_Build_Supply.this.iProvinceID).getLevelOfSupply() + 1)
                           / 10.0F,
                     CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                           >= BuildingsManager.getSupply_BuildMovementCost(
                              CFG.game.getProvince(Menu_InGame_Build_Supply.this.iProvinceID).getLevelOfSupply() + 1
                           )
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager
                        .get(
                           ...
                           BuildingsManager.getSupply_Construction(CFG.game.getProvince(Menu_InGame_Build_Supply.this.iProvinceID).getLevelOfSupply() + 1)
                        )
                  )
               );
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + (int)(
                              BuildingsManager.getSupply_TechLevel(CFG.game.getProvince(Menu_InGame_Build_Supply.this.iProvinceID).getLevelOfSupply() + 1)
                                 * 100.0F
                           )
                           / 100.0F,
         ...
         new SliderMenuTitle(CFG.langManager.get("SupplyCamp"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_Build_Supply.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Supply.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_Build_Supply.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Supply.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
