...
class Menu_InGame_Technology$23 extends Button_FlagActionSliderStyle {
   Menu_InGame_Technology$23(
   ...
   protected void actionElement(int iID) {
      SkillsManager.add_Research(this.this$0.iCivID);
      ...
      this.this$0.getMenuElement(iID - 1).setCurrent(CFG.game.getCiv(this.this$0.iCivID).civGameData.skills.POINTS_RESEARCH);
