...
public class Button_New_Game_Players_Anim extends Button_New_Game_Players {
   public static long lTimeAnimation = 0L;
   public static int animationState = 0;
   public static final int ANIMATION_T = 750;

   public Button_New_Game_Players_Anim(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
      super(sText, iTextPositionX, iPosX, iPosY, iWidth, isClickable);
   }

   public Button_New_Game_Players_Anim(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
