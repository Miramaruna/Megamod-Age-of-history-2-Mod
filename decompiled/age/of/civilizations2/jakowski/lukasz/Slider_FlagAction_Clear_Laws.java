...
public class Slider_FlagAction_Clear_Laws extends Slider {
   public static final Color bgColor = new Color(0.0F, 0.0F, 0.0F, 0.3F);
   public float FONT_SCALE = 0.7F;
   public float FONT_SCALE2 = 0.8F;
   public float fModifier = 1.0F;
   public String sPoints;
   public int iPointsWidth;
   public int iTextWidth;

   public Slider_FlagAction_Clear_Laws(float fModifier, String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.getDrawText(),
         this.getPosX() + this.getWidth() - CFG.PADDING * 2 - (int)(this.getTextWidth() * this.FONT_SCALE2) - this.iPointsWidth + iTranslateX,
         this.getPosY() + this.getHeight() - CFG.PADDING * 2 - this.getSliderHeight() - (int)(CFG.TEXT_HEIGHT * this.FONT_SCALE) + iTranslateY,
