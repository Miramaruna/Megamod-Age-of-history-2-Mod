...
public class Menu_CreateScenario_Events_Cond_NumOfVassals_Low extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(5).setText(CFG.langManager.get("NumberOfVassals") + " < ");
      this.getTitle().setText(CFG.langManager.get("NumberOfVassals"));
   }
