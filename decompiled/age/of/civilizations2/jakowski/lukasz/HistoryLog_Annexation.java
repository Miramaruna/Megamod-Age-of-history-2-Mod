...
public class HistoryLog_Annexation extends HistoryLog {
   public String sMess;
   ...
   public void updateLanguage() {
      this.sMess = CFG.langManager.get("Annexation") + ": ";
   ...
   public void draw(SpriteBatch oSB, int nTurnID, int iPosX, int iPosY, int iWidth, int iHeight, boolean isActive) {
      this.drawLeftIcon(oSB, Images.diplo_rivals, iPosX, iPosY, iWidth, iHeight, isActive);
