...
public class Button_BotBar_Disease extends Button_BotBar {
   ...
   public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      oSB.setColor(CFG.COLOR_TEXT_MODIFIER_NEGATIVE);
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ImageManager.getImage(Images.disease)
         .draw(
            ...
            this.getPosY() + (this.getHeight() - ImageManager.getImage(Images.disease).getHeight()) / 2 + iTranslateY
         );
      CFG.fontMain.getData().setScale(this.FONT_SCALE);
      CFG.drawTextWithShadow(
         oSB,
         this.getTextToDraw(),
         this.getPosX() + this.getTextPos() + CFG.PADDING + ImageManager.getImage(Images.disease).getWidth() + iTranslateX,
   ...
   public int getWidth() {
      return this.iTextWidth
         + CFG.PADDING * 2
         + 2
         + ImageManager.getImage(Images.disease).getWidth()
         + CFG.PADDING * 2
