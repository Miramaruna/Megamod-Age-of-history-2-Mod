...
public class Message_Gift_Accepted extends Message {
   public Message_Gift_Accepted(int fromCivID, int iValue) {
   ...
   public void onAccept(int iCivID) {
      if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID() == iCivID) {
         ...
         lMess.add(CFG.langManager.get("Gift") + " - " + CFG.langManager.get("Accepted"));
