...
public class Menu_InGame_Message_Ultimatum extends SliderMenu {
   public static final int ANIMATION_TIME = 200;
   public long lTime = 0L;
   public int iOnCivID = -1;
   public int iMessageID = 0;
   public Ultimatum_GameData oUltimatum;
   ...
   public Menu_InGame_Message_Ultimatum(final int onCivID, int iMessageID, int iValue, Ultimatum_GameData nUltimatum) {
      ...
      if (this.oUltimatum.demandLiberation.size() > 0) {
         for (int i = 0; i < this.oUltimatum.demandLiberation.size(); i++) {
            menuElements.add(
               new Button_Diplomacy_Demands(
                  CFG.langManager.get("DemandLiberationOfVassal") + ": " + CFG.game.getCiv(this.oUltimatum.demandLiberation.get(i)).getCivName(),
                  onCivID,
                  2,
                  tY,
                  CFG.BUTTON_WIDTH * 2
      ...
      if (this.oUltimatum.demandProvinces.size() > 0) {
         menuElements.add(
            new Button_Diplomacy_Demands(CFG.langManager.get("DemandsOurProvinces"), onCivID, 2, tY, CFG.BUTTON_WIDTH * 2) {
               @Override
               public int getWidth() {
                  return Menu_InGame_Message_Ultimatum.this.getElementW() * 2;
               }
               ...
               public void buildElementHover() {
                  ...
                  for (int i = 0; i < Menu_InGame_Message_Ultimatum.this.oUltimatum.demandProvinces.size(); i++) {
                     nData.add(new MenuElement_Hover_v2_Element_Type_Text(" - ", CFG.COLOR_TEXT_MODIFIER_NEUTRAL));
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.game.getProvince(Menu_InGame_Message_Ultimatum.this.oUltimatum.demandProvinces.get(i)).getName()
                        )
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     nData.clear();
               ...
               public void actionElement(int iID) {
                  ...
                  for (int i = 0; i < Menu_InGame_Message_Ultimatum.this.oUltimatum.demandProvinces.size(); i++) {
                     CFG.game.getSelectedProvinces().addProvince(Menu_InGame_Message_Ultimatum.this.oUltimatum.demandProvinces.get(i));
                  }
      ...
      menuElements.add(
         new Button_Diplomacy_Demands(CFG.langManager.get("XUnitsAreReadyToAttackIfWeRefuseTheirOffer", iValue), onCivID, 2, tY, CFG.BUTTON_WIDTH * 2) {
            @Override
            public int getWidth() {
               return Menu_InGame_Message_Ultimatum.this.getElementW() * 2;
            }
      ...
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      int var11;
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Refuse"), -1, CFG.PADDING, var11 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
      ...
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("War"), -1, 2, var11, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
            ...
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ImageManager.getImage(Images.diplo_war)
                  .draw(
                     ...
                     this.getPosX()
                        + this.getWidth() / 2
                        - (int)((this.getTextWidth() * 0.8F + ImageManager.getImage(Images.diplo_war).getWidth() + CFG.PADDING) / 2.0F)
                        + iTranslateX,
      ...
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Accept"), -1, 2, var11, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager.get("WeWillSignATruceUntilX", Game_Calendar.getDate_ByTurnID(Game_Calendar.TURN_ID + 30)), CFG.COLOR_TEXT_MODIFIER_NEUTRAL
                  )
               );
               ...
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
               if (Menu_InGame_Message_Ultimatum.this.oUltimatum.demandAnexation) {
                  nData.add(new MenuElement_Hover_v2_Element_Type_Flag(onCivID));
               ...
               if (Menu_InGame_Message_Ultimatum.this.oUltimatum.demandVasalization) {
                  nData.add(new MenuElement_Hover_v2_Element_Type_Flag(onCivID));
               ...
               if (Menu_InGame_Message_Ultimatum.this.oUltimatum.demandMilitaryAccess) {
                  nData.add(new MenuElement_Hover_v2_Element_Type_Flag(onCivID));
               ...
               if (Menu_InGame_Message_Ultimatum.this.oUltimatum.demandLiberation.size() > 0) {
                  for (int i = 0; i < Menu_InGame_Message_Ultimatum.this.oUltimatum.demandLiberation.size(); i++) {
                     nData.add(new MenuElement_Hover_v2_Element_Type_Flag(onCivID));
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("DemandLiberationOfVassal") + ": ", CFG.COLOR_TEXT_NUM_OF_PROVINCES)
                     );
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.game.getCiv(Menu_InGame_Message_Ultimatum.this.oUltimatum.demandLiberation.get(i)).getCivName()
                        )
                     );
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_Message_Ultimatum.this.oUltimatum.demandLiberation.get(i), CFG.PADDING, 0)
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     nData.clear();
                  }
               ...
               if (Menu_InGame_Message_Ultimatum.this.oUltimatum.demandProvinces.size() > 0) {
                  nData.add(new MenuElement_Hover_v2_Element_Type_Flag(onCivID));
                  nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("DemandsOurProvinces"), CFG.COLOR_TEXT_NUM_OF_PROVINCES));
                  nElements.add(new MenuElement_Hover_v2_Element2(nData));
                  nData.clear();
         ...
         new SliderMenuTitle(CFG.langManager.get("Ultimatum"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.diplo_message)
                  .draw(
                     oSB,
                     Menu_InGame_Message_Ultimatum.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Message_Ultimatum.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         ...
         CFG.game
            .getCiv(this.iOnCivID)
            .getCivilization_Diplomacy_GameData()
            .messageBox
            .addMessage(new Message_War(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.iOnCivID));
         CFG.game
            .getCiv(this.iOnCivID)
            .getCivilization_Diplomacy_GameData()
            .messageBox
            .addMessage(new Message_UltimatumRefusedWar(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()));
         CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getCivilization_Diplomacy_GameData().messageBox.removeMessage(this.iMessageID);
         CFG.menuManager.rebuildInGame_Messages();
