...
public class Text_TitleStyle extends Text {
   public Text_TitleStyle(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sText,
         this.getPosX() + this.getWidth() / 2 - (int)(this.getTextWidth() * 0.85F / 2.0F) + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(this.getTextHeight() * 0.85F / 2.0F) + iTranslateY,
