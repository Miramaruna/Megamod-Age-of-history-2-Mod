...
public class Button_Game extends Button {
   ...
   public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      if (isActive) {
         ...
         ImageManager.getImage(Images.btnh_clear)
            .draw(oSB, this.getPosX() + this.getWidth() - ImageManager.getImage(Images.btnh_clear).getWidth() + iTranslateX, this.getPosY() + iTranslateY, true);
      } else {
