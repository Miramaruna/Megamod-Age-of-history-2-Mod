...
public class Menu_InGame_CityFounded extends SliderMenu {
   ...
   public Menu_InGame_CityFounded(int nProvinceID, int nCivID) {
      ...
      this.sWar = CFG.game.getProvince(nProvinceID).getCitiesSize() > 0
         ? CFG.langManager.get("CityHasBeenFounded", CFG.game.getProvince(nProvinceID).getCity(0).getCityName())
         : CFG.langManager.get("CityHasBeenFounded", CFG.game.getProvince(nProvinceID).getName());
