...
public class Menu_InGame_View_Technology extends SliderMenu {
   ...
   public Menu_InGame_View_Technology(boolean allCivs) {
      ...
      for (int i = 1; i < CFG.game.getCivsSize(); i++) {
         if (CFG.game.getCiv(i).getNumOfProvinces() > 0 && (allCivs || CFG.FOG_OF_WAR != 2 || CFG.game.getPlayer(CFG.PLAYER_TURNID).getMetCivilization(i))) {
            tempCivs.add(i);
         }
      }
      ...
      while (tempCivs.size() > 0) {
         ...
         for (int i2 = 1; i2 < tempCivs.size(); i2++) {
            if (CFG.game.getCiv(tempCivs.get(i2)).getTechnologyLevel() > CFG.game.getCiv(tempCivs.get(tBest)).getTechnologyLevel()) {
               tBest = i2;
            }
         }
      ...
      if (tSorted.size() > 0) {
         for (int var10 = 0; var10 < tSorted.size(); var10++) {
            menuElements.add(
               new Button_View_Technology(
                  var10,
                  CFG.FOG_OF_WAR == 2 && !CFG.game.getPlayer(CFG.PLAYER_TURNID).getMetCivilization((Integer)tSorted.get(var10))
                     ? -(Integer)tSorted.get(var10)
                     : (Integer)tSorted.get(var10),
                  0,
                  tY,
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Technology"), CFG.BUTTON_HEIGHT * 3 / 5, false, false) {
            @Override
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_InGame_View_Technology.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Technology.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(),
                     Menu_InGame_View_Technology.this.getWidth() + 2,
                     this.getHeight(),
                     true,
                     false
                  );
               ...
               ImageManager.getImage(Images.pix255_255_255)
                  .draw(
                     oSB,
                     Menu_InGame_View_Technology.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Technology.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(),
                     Menu_InGame_View_Technology.this.getWidth()
                  );
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_InGame_View_Technology.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Technology.this.getPosY()
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     Menu_InGame_View_Technology.this.getWidth() / 4,
                     1
                  );
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Menu_InGame_View_Technology.this.getPosX()
                        + Menu_InGame_View_Technology.this.getWidth()
                        - Menu_InGame_View_Technology.this.getWidth() / 4
                        + iTranslateX,
                     Menu_InGame_View_Technology.this.getPosY()
               ...
               ImageManager.getImage(Images.technology)
                  .draw(
                     ...
                     Menu_InGame_View_Technology.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.technology).getHeight() / 2
                  );
