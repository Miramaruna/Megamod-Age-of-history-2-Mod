...
public class Menu_Settings extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getTitle().setText(CFG.langManager.get("Settings"));
   }
   ...
   public final void onBackPressed() {
      CFG.menuManager.setViewID(CFG.goToMenu2);
      CFG.menuManager.setBackAnimation(true);
      if (CFG.goToMenu2 == Menu.eINGAME) {
