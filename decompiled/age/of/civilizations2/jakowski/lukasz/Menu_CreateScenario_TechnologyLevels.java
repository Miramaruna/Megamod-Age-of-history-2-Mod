...
public class Menu_CreateScenario_TechnologyLevels extends Menu_CreateScenario {
      ...
      menuElements.add(
         new Slider(
            ...
            public String getDrawText() {
               return CFG.game.getCiv(CFG.iCreateScenario_AssignProvinces_Civ).getCivName() + this.getText() + this.getCurrent() / 100.0F;
            }
   ...
   public void updateLanguage() {
      this.sTopText = CFG.langManager.get("TechnologyLevels");
   ...
   public final void actionElement(int iID) {
      switch (iID) {
         ...
         case 3:
            ...
            if (CFG.iCreateScenario_AssignProvinces_Civ > 0) {
               CFG.game.getCiv(CFG.iCreateScenario_AssignProvinces_Civ).setTechnologyLevel(this.getMenuElement(iID + 1).getCurrent() / 100.0F);
               CFG.game
                  .getProvince(CFG.game.getCiv(CFG.iCreateScenario_AssignProvinces_Civ).getCapitalProvinceID())
                  .getArmy_Obj(0)
                  .updateArmyWidth(CFG.game.getCiv(CFG.iCreateScenario_AssignProvinces_Civ).getTechnologyLevel());
            }

            return;
         case 4:
            if (CFG.iCreateScenario_AssignProvinces_Civ > 0) {
               CFG.game.getCiv(CFG.iCreateScenario_AssignProvinces_Civ).setTechnologyLevel(this.getMenuElement(iID).getCurrent() / 100.0F);
               CFG.game
                  .getProvince(CFG.game.getCiv(CFG.iCreateScenario_AssignProvinces_Civ).getCapitalProvinceID())
                  .getArmy_Obj(0)
                  .updateArmyWidth(CFG.game.getCiv(CFG.iCreateScenario_AssignProvinces_Civ).getTechnologyLevel());
