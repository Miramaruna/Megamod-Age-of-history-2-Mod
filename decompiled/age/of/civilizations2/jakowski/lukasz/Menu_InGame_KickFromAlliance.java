...
public class Menu_InGame_KickFromAlliance extends SliderMenu {
   public int iOnCivID = 0;
   ...
   public Menu_InGame_KickFromAlliance(int onCivID) {
      ...
      menuElements.add(
         new Button_Diplomacy_CallToArms(Images.diplo_alliance, CFG.langManager.get("KickFromAlliance") + ": ", this.iOnCivID, 2, tY, CFG.BUTTON_WIDTH * 2, 2) {
            @Override
            public int getWidth() {
            ...
            public void actionElement(int iID) {
               CFG.menuManager.rebuildInGame_Alliance(CFG.game.getCiv(Menu_InGame_KickFromAlliance.this.iOnCivID).getAllianceID());
            }
         }
      );
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_KickFromAlliance.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Confirm"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_KickFromAlliance.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("KickFromAlliance") + ": ", CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
               nData.add(new MenuElement_Hover_v2_Element_Type_Flag(Menu_InGame_KickFromAlliance.this.iOnCivID, CFG.PADDING, CFG.PADDING));
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getCiv(Menu_InGame_KickFromAlliance.this.iOnCivID).getCivName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                  )
               );
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("KickFromAlliance"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            @Override
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         DiplomacyManager.kickFromAlliance(this.iOnCivID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID());
