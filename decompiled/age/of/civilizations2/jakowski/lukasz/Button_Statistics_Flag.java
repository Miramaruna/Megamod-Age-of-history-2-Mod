...
public class Button_Statistics_Flag extends Button_Statistics {
   public int iCivID;

   public Button_Statistics_Flag(int iCivID, String sText, int iTextPosX, int iPosX, int iPosY, int iWidth, int iHeight) {
