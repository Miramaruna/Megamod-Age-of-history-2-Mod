...
public class Button_New_Game_Players_Player extends Button_New_Game_Players {
   public long lTime = 0L;
   public float fAlphaMod = 0.0F;
   public boolean backAnimation = false;
   public long lTimeAnimation = 0L;
   public int animationState = 0;
   public static final int ANIMATION_T = 1000;

   public Button_New_Game_Players_Player(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      try {
         ...
         Rectangle clipBounds = new Rectangle(
            ...
            this.getWidth() - (CFG.CIV_FLAG_WIDTH + CFG.PADDING * 4),
            -this.getHeight()
         );
         oSB.flush();
