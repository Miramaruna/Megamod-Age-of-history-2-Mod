...
public class Button_Diplomacy_Message_JoinAWar extends Button_Statistics {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      try {
         oSB.setColor(
            new Color(
               CFG.game.getCiv(this.warAgainstCivID).getR() / 255.0F,
               CFG.game.getCiv(this.warAgainstCivID).getG() / 255.0F,
               CFG.game.getCiv(this.warAgainstCivID).getB() / 255.0F,
               1.0F
            )
         );
