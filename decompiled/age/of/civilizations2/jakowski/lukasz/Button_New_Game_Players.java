...
public class Button_New_Game_Players extends Button {
   public static final float BUTTON_PERC_HEIGHT = 0.6F;

   public Button_New_Game_Players(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
      super.init(sText, iTextPositionX, iPosX, iPosY, iWidth, (int)(CFG.BUTTON_HEIGHT * 0.6F), isClickable, true, false, false);
   }

   public Button_New_Game_Players(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
