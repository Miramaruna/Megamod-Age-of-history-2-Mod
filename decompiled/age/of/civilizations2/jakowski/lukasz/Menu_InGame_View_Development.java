...
public class Menu_InGame_View_Development extends SliderMenu {
   ...
   public Menu_InGame_View_Development() {
      ...
      while (tempProvs.size() > 0) {
         ...
         for (int i2 = 1; i2 < tempProvs.size(); i2++) {
            if (CFG.game.getProvince(tempProvs.get(tBest)).getDevelopmentLevel() < CFG.game.getProvince(tempProvs.get(i2)).getDevelopmentLevel()) {
               tBest = i2;
            }
         }
      ...
      if (tempProvincesSorted.size() > 0) {
         menuElements.add(
            new Button_NS_Population(
               ...
               "" + CFG.game.countAvarageDevelopmentLevel(this.iCivID),
               Images.development,
            ...
            menuElements.add(
               new Button_View_Development(
                  ...
                  (CFG.SPECTATOR_MODE || CFG.game.isAlly(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.iCivID))
                     && CFG.game.getCiv(this.iCivID).isInvestOrganized_Development((Integer)tempProvincesSorted.get(var9))
               ) {
                  @Override
                  public void actionElement(int iID) {
                     if (CFG.gameAction.getActiveTurnState() != Game_Action.TurnStates.INPUT_ORDERS
                        ...
                        || CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isInvestOrganized_Development(this.getCurrent())) {
                        ...
                        CFG.menuManager.rebuildInGame_InvestDevelopment(this.getCurrent());
                     }
                  }
               }
            );
         ...
         new SliderMenuTitle(CFG.game.getCiv(this.iCivID).getCivName(), CFG.BUTTON_HEIGHT * 3 / 5, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_InGame_View_Development.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Development.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(),
                     Menu_InGame_View_Development.this.getWidth() + 2,
                     this.getHeight(),
                     true,
                     false
                  );
               oSB.setColor(
                  new Color(
                     CFG.game.getCiv(Menu_InGame_View_Development.this.iCivID).getR() / 255.0F,
                     CFG.game.getCiv(Menu_InGame_View_Development.this.iCivID).getG() / 255.0F,
                     CFG.game.getCiv(Menu_InGame_View_Development.this.iCivID).getB() / 255.0F,
                     0.165F
                  )
               );
               ...
               ImageManager.getImage(Images.pix255_255_255)
                  .draw(
                     oSB,
                     Menu_InGame_View_Development.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Development.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(),
                     Menu_InGame_View_Development.this.getWidth()
                  );
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_InGame_View_Development.this.getPosX() + iTranslateX,
                     Menu_InGame_View_Development.this.getPosY()
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     Menu_InGame_View_Development.this.getWidth() / 4,
                     1
                  );
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Menu_InGame_View_Development.this.getPosX()
                        + Menu_InGame_View_Development.this.getWidth()
                        - Menu_InGame_View_Development.this.getWidth() / 4
                        + iTranslateX,
                     Menu_InGame_View_Development.this.getPosY()
               ...
               ImageManager.getImage(Images.development)
                  .draw(
                     ...
                     Menu_InGame_View_Development.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.development).getHeight() / 2
                  );
