...
public class Menu_InGame_LeaveAlliance extends SliderMenu {
   public Menu_InGame_LeaveAlliance(int onCivID) {
      ...
      menuElements.add(
         new Button_Diplomacy_CallToArms(
            Images.diplo_alliance, CFG.langManager.get("LeaveAlliance"), CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), 2, tY, CFG.BUTTON_WIDTH * 2, 2
         ) {
            @Override
            public int getWidth() {
            ...
            public void actionElement(int iID) {
               CFG.menuManager.rebuildInGame_Alliance(CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getAllianceID());
            }
         }
      );
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_LeaveAlliance.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Confirm"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_LeaveAlliance.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("LeaveAlliance"), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE));
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("LeaveAlliance"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            @Override
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         DiplomacyManager.leaveAlliance(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID());
