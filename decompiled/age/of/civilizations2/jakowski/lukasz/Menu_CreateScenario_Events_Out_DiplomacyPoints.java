...
public class Menu_CreateScenario_Events_Out_DiplomacyPoints extends SliderMenu {
      ...
      menuElements.add(
         new Slider_BG(
            ...
            public String getDrawText() {
               return this.getText() + (this.getCurrent() > 0 ? "+" : "") + this.getCurrent() / 100.0F;
            }
         }
      );
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(2).setText(CFG.langManager.get("DiplomacyPoints") + ": ");
      this.getTitle().setText(CFG.langManager.get("UpdateDiplomacyPoints"));
   }
