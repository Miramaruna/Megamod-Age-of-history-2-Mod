...
public class Button_Diplomacy_InGame extends Button_Diplomacy {
   public Button_Diplomacy_InGame(int iDiploImageID, List<Integer> nCivs, int iPosX, int iPosY, int iWidth) {
