...
public class Button_Options_NS_MapModes extends Button_Options_NS {
   public static final float FONT_SCALE = 0.7F;
   public int iCurrent = 0;

   public Button_Options_NS_MapModes(int iCurrent, String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
      super(sText, iTextPositionX, iPosX, iPosY, iWidth, iHeight, isClickable);
      this.iCurrent = iCurrent;
   }

   public Button_Options_NS_MapModes(
      ...
      if (this.getTextPos() < 0) {
         if (isActive) {
            CFG.drawText(
               oSB,
               this.getTextToDraw(),
               this.getPosX() + this.getWidth() / 2 - (int)(this.getTextWidth() * 0.7F / 2.0F) + iTranslateX,
               this.getPosY() + CFG.PADDING / 2 + (this.getHeight() - CFG.PADDING) / 2 - (int)(this.getTextHeight() * 0.7F / 2.0F) + iTranslateY,
