...
public class Button_Game_Ideology extends Button_Game {
   ...
   public int iIdeologyTextWidth = 0;
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      if (isActive) {
         CFG.drawText(
            oSB,
            this.getTextToDraw(),
            this.getPosX() + (this.getWidth() - (CFG.PADDING + CFG.CIV_FLAG_WIDTH + super.getTextWidth())) / 2 + CFG.PADDING + CFG.CIV_FLAG_WIDTH + iTranslateX,
