...
public class Menu_MapEditor_GrowthRate extends SliderMenu {
   ...
   public final void actionElement(int iID) {
      switch (iID) {
         ...
         case 4:
            ...
            Editor_GrowthRate.currentGrowthRate = this.getMenuElement(iID + 1).getCurrent() / 100.0F;
            break;
         case 5:
            Editor_GrowthRate.currentGrowthRate = this.getMenuElement(iID).getCurrent() / 100.0F;
            break;
         case 6:
            this.getMenuElement(iID - 1).setCurrent(this.getMenuElement(iID - 1).getCurrent() + 1);
            Editor_GrowthRate.currentGrowthRate = this.getMenuElement(iID - 1).getCurrent() / 100.0F;
