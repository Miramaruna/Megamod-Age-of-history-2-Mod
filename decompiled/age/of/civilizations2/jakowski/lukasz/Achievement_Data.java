...
class Achievement_Data {
   ...
   public String sTextNum;
   public int iTextNumWidth = -1;
   public int iCivID;
   public int iSROverID = 0;
   ...
   public final void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY) {
      ...
      CFG.drawTextWithShadow(
         ...
         new Color(
            CFG.COLOR_TEXT_MODIFIER_NEUTRAL.r, CFG.COLOR_TEXT_MODIFIER_NEUTRAL.g, CFG.COLOR_TEXT_MODIFIER_NEUTRAL.b, CFG.COLOR_TEXT_MODIFIER_NEUTRAL.a * tAlpha
         )
      );
      CFG.drawTextWithShadow(
         oSB,
         ...
         this.getPosY() + CFG.SERVICE_RIBBON_HEIGHT + CFG.PADDING * 4 + iTranslateY,
         new Color(
            CFG.COLOR_TEXT_NUM_OF_PROVINCES.r, CFG.COLOR_TEXT_NUM_OF_PROVINCES.g, CFG.COLOR_TEXT_NUM_OF_PROVINCES.b, CFG.COLOR_TEXT_NUM_OF_PROVINCES.a * tAlpha
         )
      );
   ...
   public final boolean canBeDisposed() {
      return System.currentTimeMillis() > this.lTime + this.TIME_IN_VIEW;
   }
}
