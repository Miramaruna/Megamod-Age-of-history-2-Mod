...
public class Button_Build_Building_Library extends Button_Build_Building {
   public int iProvinceNameWidth;
   public String sResearch;
   public int iResearchWidth;
   public String sPerTurn;

   public Button_Build_Building_Library(
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sResearch,
         this.getPosX() + CFG.PADDING + Button_Diplomacy.iDiploWidth + this.iProvinceNameWidth + CFG.PADDING + (int)(this.getTextWidth() * 0.7F) + iTranslateX,
         this.getPosY() + this.getHeight() / 2 - (int)(this.getTextHeight() * 0.7F) - CFG.PADDING / 2 + iTranslateY,
      ...
      ImageManager.getImage(Images.research)
         .draw(
            ...
            this.getPosY()
               ...
               - (int)(ImageManager.getImage(Images.research).getHeight() * this.getImageScale(Images.research, 0.7F)) / 2
               - ImageManager.getImage(Images.research).getHeight()
               - CFG.PADDING / 2
               + iTranslateY,
            (int)(ImageManager.getImage(Images.research).getWidth() * this.getImageScale(Images.research, 0.7F)),
            (int)(ImageManager.getImage(Images.research).getHeight() * this.getImageScale(Images.research, 0.7F))
         );
      CFG.drawTextWithShadow(
         oSB,
         this.sPerTurn,
