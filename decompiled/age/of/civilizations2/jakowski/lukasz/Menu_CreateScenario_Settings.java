...
public class Menu_CreateScenario_Settings extends SliderMenu {
   ...
   public String sWiki;
   public int iWikiWidth = 0;
   public static Image previewImage = null;

   public Menu_CreateScenario_Settings() {
      ArrayList<MenuElement> menuElements = new ArrayList<>();
      menuElements.add(
         new Button_Menu("", CFG.PADDING * 2, 0, CFG.PADDING * 3, CFG.GAME_WIDTH, CFG.BUTTON_HEIGHT, true) {
            @Override
      ...
      menuElements.add(
         new Button_Menu("", CFG.PADDING * 2, 0, CFG.BUTTON_HEIGHT + CFG.PADDING * 4, CFG.GAME_WIDTH, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, true) {
            @Override
            public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               if (isActive) {
                  oSB.setColor(0.981F, 0.981F, 0.981F, 0.65F);
      ...
      menuElements.add(
         new Button_Menu("", CFG.PADDING * 2, 0, CFG.BUTTON_HEIGHT * 2 + CFG.PADDING * 3, CFG.GAME_WIDTH, CFG.BUTTON_HEIGHT - CFG.PADDING * 2, true) {
            @Override
            public String getTextToDraw() {
      ...
      menuElements.add(
         new Slider(
            null,
            CFG.BUTTON_WIDTH,
            CFG.BUTTON_HEIGHT * 5 + CFG.PADDING * 7,
            CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2,
            CFG.BUTTON_HEIGHT - CFG.PADDING * 2,
            0,
            1000,
            CFG.game.getGameScenarios().getScenario_StartingArmyInCapitals() / 25
         ) {
            @Override
      ...
      menuElements.add(
         new Button_Menu_ReflectedBG(
            "+", -1, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 5 + CFG.PADDING * 6, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true
         )
      );
      ...
      menuElements.add(
         new Slider(
            null,
            CFG.BUTTON_WIDTH,
            CFG.BUTTON_HEIGHT * 6 + CFG.PADDING * 8,
            CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2,
            CFG.BUTTON_HEIGHT - CFG.PADDING * 2,
            1,
            30000,
            CFG.game.getGameScenarios().getScenario_StartingPopulation() / 100
         ) {
            @Override
            public String getDrawText() {
      ...
      menuElements.add(
         new Button_Menu_ReflectedBG(
            "+", -1, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 6 + CFG.PADDING * 7, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true
         )
      );
      ...
      menuElements.add(
         new Slider(
            null,
            CFG.BUTTON_WIDTH,
            CFG.BUTTON_HEIGHT * 7 + CFG.PADDING * 9,
            CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2,
            CFG.BUTTON_HEIGHT - CFG.PADDING * 2,
            1,
            30000,
            CFG.game.getGameScenarios().getScenario_StartingEconomy() / 100
         ) {
            @Override
            public String getDrawText() {
               return super.getText() + this.getCurrent() * 100;
      ...
      menuElements.add(
         new Button_Menu_ReflectedBG(
            "+", -1, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 7 + CFG.PADDING * 8, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true
         )
      );
      menuElements.add(
         new Button_Menu_Descripted(
            CFG.langManager.get("ChangeDiplomaticRelationsBetweenCivilizations"),
            null,
            (int)(50.0F * CFG.GUI_SCALE),
            0,
            CFG.BUTTON_HEIGHT * 4 + CFG.PADDING * 5,
            CFG.GAME_WIDTH,
            CFG.BUTTON_HEIGHT,
            true
         ) {
            ...
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ImageManager.getImage(Images.top_diplomacy_points)
                  .draw(
                     oSB,
                     this.getPosX() + this.getTextPos() / 2 - ImageManager.getImage(Images.top_diplomacy_points).getWidth() / 2 + iTranslateX,
      ...
      menuElements.add(
         new Button_Menu(null, (int)(50.0F * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 3 + CFG.PADDING * 4, CFG.GAME_WIDTH, CFG.BUTTON_HEIGHT, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ImageManager.getImage(Images.technology)
                  .draw(
                     oSB,
                     this.getPosX() + this.getTextPos() / 2 - ImageManager.getImage(Images.technology).getWidth() / 2 + iTranslateX,
      ...
      menuElements.add(
         new Button_Menu(null, -1, 0, CFG.BUTTON_HEIGHT * 17 + CFG.PADDING * 18, CFG.GAME_WIDTH, CFG.BUTTON_HEIGHT, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               if (CFG.palletManager.getActivePalletID() == 0) {
                  CFG.palletManager
                     .drawSampleColors_Standard(
                        oSB,
                        this.getPosX() + this.getWidth() / 2 - CFG.BUTTON_WIDTH - CFG.BUTTON_WIDTH / 2 + iTranslateX,
                        this.getPosY() + this.getHeight() / 2 - this.getHeight() / 4 + Menu_CreateScenario_Settings.this.getMenuPosY(),
                        CFG.BUTTON_WIDTH * 3,
                        this.getHeight() / 2,
                        CFG.palletManager.getActivePalletID(),
                        isActive
                     );
               } else {
                  CFG.palletManager
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager.get("DefaultSetOfCivilizationsColorsInAScenario") + ".", CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                  )
               );
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
      ...
      menuElements.add(
         new Slider(
            null,
            CFG.BUTTON_WIDTH,
            CFG.BUTTON_HEIGHT * 8 + CFG.PADDING * 10,
            CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2,
            CFG.BUTTON_HEIGHT - CFG.PADDING * 2,
            -200,
            1500,
            CFG.game.getGameScenarios().getScenario_StartingMoney() / 50
         ) {
            @Override
            public String getDrawText() {
      ...
      menuElements.add(
         new Button_Menu_ReflectedBG(
            "+", -1, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 8 + CFG.PADDING * 9, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true
         )
      );
      menuElements.add(
         new Button_Menu(null, (int)(50.0F * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 14 + CFG.PADDING * 15, CFG.GAME_WIDTH, CFG.BUTTON_HEIGHT, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ImageManager.getImage(Images.top_gold)
                  .draw(
                     oSB,
                     this.getPosX() + this.getTextPos() / 2 - ImageManager.getImage(Images.top_gold).getWidth() / 2 + iTranslateX,
      ...
      menuElements.add(
         new Button_Menu(null, (int)(50.0F * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 15 + CFG.PADDING * 16, CFG.GAME_WIDTH, CFG.BUTTON_HEIGHT, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ImageManager.getImage(Images.happiness)
                  .draw(
                     oSB,
                     this.getPosX() + this.getTextPos() / 2 - ImageManager.getImage(Images.happiness).getWidth() / 2 + iTranslateX,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.happiness).getHeight() / 2 + iTranslateY
                  );
               super.drawText(oSB, iTranslateX, iTranslateY, isActive);
            }
         }
            ...
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ImageManager.getImage(Images.hre_flag)
                  .draw(
                     ...
                     this.getPosY() - ImageManager.getImage(Images.hre_flag).getHeight() + this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2 + iTranslateY,
                     CFG.CIV_FLAG_WIDTH,
                     CFG.CIV_FLAG_HEIGHT
                  );
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     this.getPosX() + this.getTextPos() / 2 - ImageManager.getImage(Images.flag_rect).getWidth() / 2 + iTranslateX,
      ...
      menuElements.add(
         new Button_Menu(null, (int)(50.0F * CFG.GUI_SCALE), 0, CFG.BUTTON_HEIGHT * 16 + CFG.PADDING * 17, CFG.GAME_WIDTH, CFG.BUTTON_HEIGHT, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ImageManager.getImage(Images.wikipedia)
                  .draw(
                     oSB,
                     this.getPosX() + this.getTextPos() / 2 - ImageManager.getImage(Images.wikipedia).getWidth() / 2 + iTranslateX,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.wikipedia).getHeight() / 2 + iTranslateY
                  );
               CFG.drawText(
                  oSB,
                  Menu_CreateScenario_Settings.this.sWiki,
      ...
      menuElements.add(
         new Slider(
            null,
            CFG.BUTTON_WIDTH,
            CFG.BUTTON_HEIGHT * 18 + CFG.PADDING * 20,
            CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2,
            CFG.BUTTON_HEIGHT - CFG.PADDING * 2,
            -500,
            5100,
            100 + (int)(CFG.game.getGameScenarios().getScenario_PopulationGrowthRate_Modifier() * 100.0F)
         ) {
            @Override
            public String getDrawText() {
            ...
            @Override
            public void setCurrent(int nCurrent) {
               CFG.game.getGameScenarios().setScenario_PopulationGrowthRate_Modifier((nCurrent - 100) / 100.0F);
               super.setCurrent(nCurrent);
            }
         }
      );
      menuElements.add(
         new Button_Menu_ReflectedBG(
            "+", -1, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 18 + CFG.PADDING * 19, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true
         )
      );
      ...
      menuElements.add(
         new Slider(
            null,
            CFG.BUTTON_WIDTH,
            CFG.BUTTON_HEIGHT * 19 + CFG.PADDING * 21,
            CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2,
            CFG.BUTTON_HEIGHT - CFG.PADDING * 2,
            -500,
            5100,
            100 + (int)(CFG.game.getGameScenarios().getScenario_EconomyGrowthRate_Modifier() * 100.0F)
         ) {
            @Override
            public String getDrawText() {
               return super.getText() + (this.getCurrent() - 100 >= 0 ? "+" : "") + (this.getCurrent() - 100) + "%";
            ...
            @Override
            public void setCurrent(int nCurrent) {
               CFG.game.getGameScenarios().setScenario_EconomyGrowthRate_Modifier((nCurrent - 100) / 100.0F);
               super.setCurrent(nCurrent);
            }
         }
      );
      menuElements.add(
         new Button_Menu_ReflectedBG(
            "+", -1, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 19 + CFG.PADDING * 20, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true
         )
      );
      ...
      menuElements.add(
         new Slider(
            null,
            CFG.BUTTON_WIDTH,
            CFG.BUTTON_HEIGHT * 20 + CFG.PADDING * 22,
            CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2,
            CFG.BUTTON_HEIGHT - CFG.PADDING * 2,
            -100,
            500,
            100 + (int)(CFG.game.getGameScenarios().getScenario_DiseasesDeathRate_Modifier() * 100.0F)
         ) {
            @Override
            public String getDrawText() {
               return super.getText() + (this.getCurrent() - 100 >= 0 ? "+" : "") + (this.getCurrent() - 100) + "%";
            ...
            @Override
            public void setCurrent(int nCurrent) {
               CFG.game.getGameScenarios().setScenario_DiseasesDeathRate_Modifier((nCurrent - 100) / 100.0F);
               super.setCurrent(nCurrent);
            }
         }
      );
      menuElements.add(
         new Button_Menu_ReflectedBG(
            "+", -1, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT * 20 + CFG.PADDING * 21, CFG.BUTTON_WIDTH, CFG.BUTTON_HEIGHT, true
         )
      );
      this.initMenu(null, 0, CFG.BUTTON_HEIGHT + CFG.PADDING * 2, CFG.GAME_WIDTH, CFG.GAME_HEIGHT - (CFG.BUTTON_HEIGHT + CFG.PADDING * 2), menuElements);
      this.updateLanguage();
   }
   ...
   public void updateLanguage() {
      ...
      this.getMenuElement(1)
         .setText(
            CFG.gameAges.getAge(CFG.CREATE_SCENARIO_AGE).getName()
               + " ["
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      ImageManager.getImage(Images.pix255_255_255)
         .draw2(
            ...
            -CFG.PADDING
               + this.getMenuPosY()
               + (this.getMenuElement(0).getPosY() - CFG.PADDING)
      ...
      ImageManager.getImage(Images.patt2)
         .draw2(
            ...
            -CFG.PADDING
               + this.getMenuPosY()
               + (this.getMenuElement(0).getPosY() - CFG.PADDING)
               - ImageManager.getImage(Images.patt2).getHeight()
               + iTranslateY,
            this.getWidth(),
            CFG.BUTTON_HEIGHT * 3 + CFG.PADDING * 2
         );
      ...
      try {
         ...
         ImageManager.getImage(Images.pix255_255_255)
            .draw(
               ...
               this.getMenuPosY() + this.getMenuElement(0).getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight() + iTranslateY,
         ...
         previewImage.draw(
            oSB,
            this.getPosX() + CFG.PADDING * 2 + iTranslateX,
            this.getMenuPosY() + this.getMenuElement(0).getPosY() - previewImage.getHeight() + iTranslateY,
         ...
         CFG.map
            ...
            .draw2(
               oSB,
               this.getPosX() + CFG.PADDING * 2 + iTranslateX,
               this.getMenuPosY() + this.getMenuElement(0).getPosY() - CFG.map.getMapBG().getMinimap().getHeight() + iTranslateY,
         ...
         CFG.map
            ...
            .draw2(
               oSB,
               this.getPosX() + CFG.PADDING * 2 + (int)(previewImage.getWidth() * CFG.GUI_SCALE) - CFG.map.getMapBG().getMinimap().getWidth() + iTranslateX,
               this.getMenuPosY() + this.getMenuElement(0).getPosY() - CFG.map.getMapBG().getMinimap().getHeight() + iTranslateY,
         ...
         CFG.drawRect(
            oSB,
            this.getPosX() + CFG.PADDING * 2 + iTranslateX,
            this.getMenuPosY() + this.getMenuElement(0).getPosY() - 1 + iTranslateY,
            (int)(previewImage.getWidth() * CFG.GUI_SCALE),
            (int)(previewImage.getHeight() * CFG.GUI_SCALE)
         );
         ...
         CFG.drawRect(
            oSB,
            this.getPosX() + 1 + CFG.PADDING * 2 + iTranslateX,
            this.getMenuPosY() + this.getMenuElement(0).getPosY() + iTranslateY,
         ...
         oSB.setColor(Color.BLACK);
         ImageManager.getImage(Images.pix255_255_255)
            .draw(oSB, 0, -ImageManager.getImage(Images.pix255_255_255).getHeight(), previewImage.getWidth(), previewImage.getHeight());
         oSB.setColor(Color.WHITE);
         this.getMenuElement(0).setPosX(CFG.PADDING * 2 + (int)(previewImage.getWidth() * CFG.GUI_SCALE) + 1);
         this.getMenuElement(0).setWidth(CFG.GAME_WIDTH - this.getMenuElement(0).getPosX());
         this.getMenuElement(1).setPosX(CFG.PADDING * 2 + (int)(previewImage.getWidth() * CFG.GUI_SCALE) + 1);
         this.getMenuElement(1).setWidth(CFG.GAME_WIDTH - this.getMenuElement(1).getPosX());
         this.getMenuElement(2).setPosX(CFG.PADDING * 2 + (int)(previewImage.getWidth() * CFG.GUI_SCALE) + 1);
         this.getMenuElement(2).setWidth(CFG.GAME_WIDTH - this.getMenuElement(2).getPosX());
   ...
   public final void updateStartingArmyInCapitals(int nArmyBefore) {
      for (int i = 1; i < CFG.game.getCivsSize(); i++) {
         if (CFG.game.getCiv(i).getCapitalProvinceID() >= 0
            && CFG.game.getProvince(CFG.game.getCiv(i).getCapitalProvinceID()).getCivID() == i
            && CFG.game.getProvince(CFG.game.getCiv(i).getCapitalProvinceID()).getArmy(0) == nArmyBefore) {
      ...
      switch (iID) {
         ...
         case 13:
            ...
            for (int ixx = 0; ixx < CFG.game.getProvincesSize(); ixx++) {
               if (CFG.game.getProvince(ixx).getIsCapital()) {
                  CFG.game.getProvince(ixx).getArmy_Obj(0).updateArmyWidth(CFG.game.getCiv(CFG.game.getProvince(ixx).getCivID()).getTechnologyLevel());
               }
            }
         ...
         case 20:
            ...
            for (int ix = 0; ix < CFG.game.getProvincesSize(); ix++) {
               if (CFG.game.getProvince(ix).getIsCapital()) {
                  CFG.game
                     .getProvince(ix)
                     .getArmy_Obj(0)
                     .updateArmyWidth(
                        (int)(
                           CFG.game.getCiv(CFG.game.getProvince(ix).getCivID()).getMoney() == -999999L
                              ? CFG.game.getGameScenarios().getScenario_StartingMoney()
                              : CFG.game.getCiv(CFG.game.getProvince(ix).getCivID()).getMoney()
                        )
                     );
               }
            }
         ...
         case 27:
            ...
            return;
         case 28:
            CFG.game.getGameScenarios().setScenario_PopulationGrowthRate_Modifier((this.getMenuElement(iID).getCurrent() - 100) / 100.0F);
            return;
         case 29:
            this.getMenuElement(iID - 1).setCurrent(this.getMenuElement(iID - 1).getCurrent() + 1);
            return;
         case 30:
            ...
            return;
         case 31:
            CFG.game.getGameScenarios().setScenario_EconomyGrowthRate_Modifier((this.getMenuElement(iID).getCurrent() - 100) / 100.0F);
            return;
         case 32:
            this.getMenuElement(iID - 1).setCurrent(this.getMenuElement(iID - 1).getCurrent() + 1);
            return;
         case 33:
            ...
            return;
         case 34:
            CFG.game.getGameScenarios().setScenario_DiseasesDeathRate_Modifier((this.getMenuElement(iID).getCurrent() - 100) / 100.0F);
            return;
         case 35:
            this.getMenuElement(iID - 1).setCurrent(this.getMenuElement(iID - 1).getCurrent() + 1);
            return;
