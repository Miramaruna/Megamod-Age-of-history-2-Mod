...
class Button_PeaceTreaty_Demands_TakeAll extends Button {
   ...
   protected static final int getElemHeight() {
      return CFG.isAndroid()
         ? (int)Math.max(CFG.BUTTON_HEIGHT * 0.6F, (float)Math.max(CFG.CIV_FLAG_HEIGHT + CFG.PADDING * 4, CFG.TEXT_HEIGHT + CFG.PADDING * 4))
   ...
   public void actionElement(int iID) {
      ...
      if (!rebuildMenu) {
         for (int var4 = 0; var4 < CFG.peaceTreatyData.peaceTreatyGameData.lCivsData_Defenders.size(); var4++) {
            if (CFG.peaceTreatyData.peaceTreatyGameData.lCivsData_Defenders.get(var4).iCivID == this.getCurrent()) {
               CFG.peaceTreatyData.peaceTreatyGameData.lCivsData_Defenders.get(var4).showProvinces = !CFG.peaceTreatyData
                     .peaceTreatyGameData
                     .lCivsData_Defenders
                     .get(var4)
                  .showProvinces;
