...
public class Menu_CreateScenario_Civilizations extends Menu_CreateScenario {
   ...
   public int iStepWidth = 0;
   public String selectAProvince2;
   public int iStepWidth2 = 0;
   public String sCivilizations;
   public int iCivilizationsWidth;
   public int iLastKnownNumOfCivs = -1;
   ...
   public Menu_CreateScenario_Civilizations() {
      ...
      menuElements.add(
         new Button_Game(null, -1, CFG.PADDING * 2 + CFG.BUTTON_WIDTH + CFG.PADDING, CFG.GAME_HEIGHT - CFG.BUTTON_HEIGHT - CFG.PADDING, false, true) {
            @Override
            ...
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
               ...
               CFG.game
                  .getCiv(CFG.game.getActiveProvinceID() >= 0 ? CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID() : 0)
                  .getFlag()
                  .draw(
                     oSB,
      ...
      menuElements.add(
         new Button_Game(null, -1, CFG.PADDING * 3 + CFG.BUTTON_WIDTH * 2 + CFG.PADDING, CFG.GAME_HEIGHT - CFG.BUTTON_HEIGHT - CFG.PADDING, false, true) {
            @Override
            public int getTextWidth() {
               return super.getTextWidth() + CFG.PADDING + CFG.CIV_FLAG_WIDTH;
            }
                     ...
                     )
                   {
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.game.getProvince(CFG.game.getActiveProvinceID()).getName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     nData.clear();
      ...
      menuElements.add(
         new Button_Game("", -1, CFG.PADDING * 4 + CFG.BUTTON_WIDTH * 3 + CFG.PADDING, CFG.GAME_HEIGHT - CFG.BUTTON_HEIGHT - CFG.PADDING, false, true) {
            @Override
            public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
            ...
            public void buildElementHover() {
               try {
                  if (this.getClickable() && CFG.game.getActiveProvinceID() >= 0 && CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID() > 0) {
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           CFG.game.getCiv(CFG.game.getProvince(CFG.game.getActiveProvinceID()).getCivID()).getCivName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                        )
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     nData.clear();
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      if (this.getMenuElement(3).getVisible()) {
         CFG.drawEditorButtons_Bot_Edge_R(
            oSB,
            iTranslateX,
            this.getMenuElement(3).getPosY() - CFG.PADDING + iTranslateY,
      ...
      ImageManager.getImage(Images.civ_name_bg)
         .draw2(
            oSB,
            CFG.GAME_WIDTH - (CFG.PADDING * 2 + CFG.CIV_NAME_BG_EXTRA_WIDTH + (int)(this.iCivilizationsWidth * 0.9F)) + iTranslateX,
            CFG.GAME_HEIGHT
               ...
               + iTranslateY,
            CFG.PADDING * 2 + CFG.CIV_NAME_BG_EXTRA_WIDTH + (int)(this.iCivilizationsWidth * 0.9F),
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sCivilizations + ": " + (CFG.game.getCivsSize() - 1),
         CFG.GAME_WIDTH - (int)(this.iCivilizationsWidth * 0.9F) - CFG.PADDING + iTranslateX,
