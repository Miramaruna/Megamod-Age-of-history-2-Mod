...
public class Button_PeaceTreaty_Demands_ChangeGoverment extends Button {
   ...
   public Button_PeaceTreaty_Demands_ChangeGoverment(int nCivID, int toPayCivID, int iPosX, int iPosY, int iWidth, int iHeight, boolean isClickable) {
      super.init(CFG.langManager.get("ChangeGovernment"), 0, iPosX, iPosY, iWidth, iHeight, isClickable, true, false, false);
      this.iCivID = nCivID;
         ...
         if (this.iCivID > 0) {
            ...
            ImageManager.getImage(Images.top_gold)
               .draw(
                  ...
                  this.getPosX()
                     + MAX_WDITH_LEFT / 2
                     - (int)(ImageManager.getImage(Images.top_gold).getWidth() * this.getImageScale(ImageManager.getImage(Images.top_gold).getHeight())) / 2
                     + iTranslateX,
                  this.getPosY()
                     + 1
                     + this.getHeight() / 2
                     - (int)(ImageManager.getImage(Images.top_gold).getHeight() * this.getImageScale(ImageManager.getImage(Images.top_gold).getHeight())) / 2
   ...
   public void buildElementHover() {
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(
            CFG.langManager.get("ChangeGovernmentTo")
               + ": "
               + CFG.ideologiesManager.getIdeology(CFG.game.getCiv(this.iCivID).getIdeologyID()).getName()
               + ", "
               + CFG.game.getCiv(this.iCivID).getCivName(),
            CFG.ideologiesManager.getIdeology(CFG.game.getCiv(this.iCivID).getIdeologyID()).getColor()
         )
      );
   ...
   public void actionElement(int iID) {
      ...
      CFG.toast.setInView(CFG.langManager.get("ChangeGovernment"), CFG.COLOR_TEXT_NUM_OF_PROVINCES);
