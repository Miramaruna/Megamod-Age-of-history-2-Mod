...
public class Button_View_ProvinceStability extends Button {
   ...
   public Button_View_ProvinceStability(int iRow, String sText, int nProvinceID, int iPosX, int iPosY, int iWidth, boolean isAssimiliate) {
      ...
      this.sPopulationPerc = "" + (int)(CFG.game.getProvince(this.iProvinceID).getProvinceStability() * 10000.0F) / 100.0F + "%";
