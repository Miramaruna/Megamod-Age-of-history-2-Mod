...
public class Menu_InGame_Message_Independence_Ask extends SliderMenu {
   ...
   public Menu_InGame_Message_Independence_Ask() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("GuaranteeIndependence"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Message_Independence_Ask(int onCivID, int iMessageID, int iValue) {
      ...
      menuElements.add(
         new Button_Diplomacy_Message_Pact(
            Images.diplo_guarantee_gives,
            CFG.langManager.get("CivAWantsToGuaranteeOurIndependence", CFG.game.getCiv(this.iOnCivID).getCivName()),
            this.iOnCivID,
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Refuse"), -1, 2 + CFG.PADDING, var9 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Message_Independence_Ask.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      ...
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Accept"), -1, 2, var9, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getPosX() {
            return Menu_InGame_Message_Independence_Ask.this.getElementW() + CFG.PADDING / 2;
         }
         ...
         new SliderMenuTitle(CFG.langManager.get("GuaranteeIndependence"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               ImageManager.getImage(Images.diplo_message)
                  .draw(
                     oSB,
                     Menu_InGame_Message_Independence_Ask.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Message_Independence_Ask.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.diplo_message).getHeight() / 2
                  );
