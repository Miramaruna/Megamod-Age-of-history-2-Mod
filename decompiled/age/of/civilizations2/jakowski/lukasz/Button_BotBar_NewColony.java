...
public class Button_BotBar_NewColony extends Button_BotBar {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ImageManager.getImage(Images.city)
         .draw(
            ...
            this.getPosY() + (this.getHeight() - ImageManager.getImage(Images.city).getHeight()) / 2 + iTranslateY
         );
      CFG.fontMain.getData().setScale(this.FONT_SCALE);
      CFG.drawTextWithShadow(
         oSB,
         this.getTextToDraw(),
         this.getPosX() + this.getTextPos() + CFG.PADDING + ImageManager.getImage(Images.city).getWidth() + iTranslateX,
