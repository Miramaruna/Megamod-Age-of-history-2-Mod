...
public class Menu_MapEditor_OptimizationRegions extends SliderMenu {
   ...
   public Menu_MapEditor_OptimizationRegions() {
      ...
      menuElements.add(
         new Button_Game_Checkbox(null, -1, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 4 - CFG.PADDING * 2, CFG.PADDING, CFG.BUTTON_WIDTH * 2, true, true) {
            @Override
      ...
      menuElements.add(
         new Slider(
            ...
            CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 4 - CFG.PADDING * 6,
            CFG.BUTTON_HEIGHT,
            0,
            CFG.game.getRegions().size(),
            0
         ) {
            @Override
      ...
      menuElements.add(
         new Button_Game(
            null, -1, CFG.GAME_WIDTH - CFG.BUTTON_WIDTH * 2 - CFG.PADDING, CFG.GAME_HEIGHT - CFG.PADDING * 3 - CFG.BUTTON_HEIGHT * 2, CFG.BUTTON_WIDTH * 2
         )
      );
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ...
      CFG.drawEditorButtons_Top_Edge_R_Reflected(
         ...
         iTranslateY,
         CFG.BUTTON_WIDTH * 5 + CFG.PADDING * 4,
         CFG.BUTTON_HEIGHT + CFG.PADDING * 2
      );
      CFG.drawEditorButtons_Bot_Edge_R_Reflected(
         oSB,
         this.getMenuElement(9).getPosX() - CFG.PADDING + iTranslateX,
         this.getMenuElement(9).getPosY() - CFG.PADDING + iTranslateY,
         this.getMenuElement(9).getWidth() + CFG.PADDING * 2,
         this.getMenuElement(9).getHeight() + CFG.PADDING * 2
      );
   ...
   public final void centerToActiveRegionID() {
      for (int i = 0; i < CFG.game.getProvincesSize(); i++) {
