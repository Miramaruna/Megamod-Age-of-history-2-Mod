...
public class ViewsManager {
   public List<View_Type> lViews = new ArrayList<>();
   public int iActiveViewID = -1;
   public static int VIEW_POPULATION_MODE = -1;
   public static int VIEW_POPULATION2_MODE = -1;
   public static int VIEW_POPULATION_OF_CIV_MODE = -1;
   public static int VIEW_ECONOMY_MODE = -1;
   public static int VIEW_RADIATION_MODE = -1;
   ...
   public static int VIEW_DEFENSIVE_POSITION_MODE = -1;
   ...
   public static float RADIATION_MAX = 1.0F;
   ...
   public ViewsManager() {
            ...
            public MenuElement_Hover getProvinceInformations() {
               try {
                  ...
                  if (!CFG.getMetProvince(CFG.menuManager.getHoveredProvinceID())) {
                     ...
                     nData.clear();
                     int nActiveCivID = 0;
                     nActiveCivID = CFG.game.getActiveProvinceID() < 0
                  ...
                  for (int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; i++) {
                     if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID() > 0) {
                        if (!CFG.getMetProvince(CFG.game.getProvinceInViewID(i))) {
                           ...
                           int tempRelation = 0;
                           tempRelation = CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID() == nActiveCivID
                              ? (int)CFG.game.getCivRelation_OfCivB(CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID(), nActiveCivID)
                              : (int)CFG.game.getCivRelation_OfCivB(nActiveCivID, CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCivID());
      ...
      VIEW_RADIATION_MODE = this.addViewToTheGame(
         new View_Type() {
            @Override
            public MenuElement_Hover getProvinceInformations() {
               try {
               ...
               public void draw(SpriteBatch oSB) {
                  if (Game_Render_Province.PROVINCE_COLOR_ANIMATION_TIMER + 250L <= System.currentTimeMillis()) {
                     ...
                     for (int ix = 0; ix < CFG.NUM_OF_PROVINCES_IN_VIEW; ix++) {
                        if (CFG.getMetProvince(CFG.game.getProvinceInViewID(ix))) {
                           oSB.setColor(
                              CFG.getColorStep_WithAlpha(
                                 CFG.game
                                    .getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(ix)).getCivID())
                                    .getRGB(CFG.settingsManager.PROVINCE_ALPHA / 255.0F),
                                 CFG.getPopulationColor(
                                    (int)(
                                       (float)CFG.game.getProvince(CFG.game.getProvinceInViewID(ix)).getPopulationData().getPopulation()
                                          / ViewsManager.POPULATION_MAX
                                          * 100.0F
                                    ),
                                    0.6F
            ...
            public MenuElement_Hover getProvinceInformations() {
               try {
                  ...
                  if (!CFG.getMetProvince(CFG.menuManager.getHoveredProvinceID())) {
                     ...
                     for (int var5 = 0; var5 < CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCore().getCivsSize(); var5++) {
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCore().getCivID(var5))
                        );
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              CFG.langManager
                                 .get(
                                    ...
                                    Game_Calendar.getDate_ByTurnID(CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCore().getSinceTurnID(var5))
                                 )
                           )
                        );
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              " ["
                                 ...
                                 + ": "
                                 + CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCore().getSinceTurnID(var5)
                                 + "]",
                     ...
                     for (int var6 = 0; var6 < CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCore().getOwnership_CivsSize(); var6++) {
                        if (!CFG.game
                           .getProvince(CFG.menuManager.getHoveredProvinceID())
                           .getCore()
                           .getHaveACore(CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCore().getOwnership_CivID(var6))) {
                           nData.add(
                              new MenuElement_Hover_v2_Element_Type_Flag(
                                 CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCore().getOwnership_CivID(var6)
                              )
                           );
                           ...
                           nData.add(
                              new MenuElement_Hover_v2_Element_Type_Text(
                                 ""
                                    + Math.min(
                                       (int)(
                                          (float)CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCore().getOwnership_NumOfTurns(var6)
                                             / CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCore().getNumOfTurnsOwnershipToGetACore()
                                             * 100.0F
                                       ),
                                       99
                                    )
                  ...
                  for (int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; i++) {
                     if (CFG.getMetProvince(CFG.game.getProvinceInViewID(i))) {
                        if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCore().getHaveACore(nActiveCivID)) {
                           oSB.setColor(
                              new Color(
                                 CFG.game.getCiv(nActiveCivID).getR() / 255.0F,
                                 CFG.game.getCiv(nActiveCivID).getG() / 255.0F,
                                 CFG.game.getCiv(nActiveCivID).getB() / 255.0F,
                                 ...
                                 CFG.settingsManager.PROVINCE_ALPHA
                                    ...
                                    * Math.min(
                                       (float)CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCore().getNumOfOwnership(nActiveCivID)
                                          / CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getCore().getNumOfTurnsOwnershipToGetACore(),
                                       1.0F
                                    )
                              )
                           );
            ...
            public MenuElement_Hover getProvinceInformations() {
               try {
                  ...
                  if (!CFG.getMetProvince(CFG.menuManager.getHoveredProvinceID())) {
                     ...
                     nData.clear();
                     return new MenuElement_Hover_v2(nElements);
                  } else if (CFG.game.getCiv(CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCivID()).getAllianceID() <= 0) {
                     return null;
                  } else {
                     nData.add(
         ...
         new View_Type() {
            ...
            public MenuElement_Hover getProvinceInformations() {
               try {
                  ...
                  } else if (CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCivsSize() > 1
                  ...
                  if (!CFG.getMetProvince(CFG.menuManager.getHoveredProvinceID())) {
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           ...
                           tTotal > 0 ? CFG.COLOR_TEXT_MODIFIER_POSITIVE : (tTotal == 0 ? CFG.COLOR_TEXT_MODIFIER_NEUTRAL2 : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2)
                        )
                     );
            ...
            public MenuElement_Hover getProvinceInformations() {
               try {
                  ...
                  if (!CFG.getMetProvince(CFG.menuManager.getHoveredProvinceID())) {
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "" + (int)(CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getHappiness() * 100.0F) + "%", CFG.COLOR_TEXT_HAPPINESS_MAX
                        )
                     );
                     nData.add(
         ...
         CFG.FOG_OF_WAR == 2
            ? new Game_Render_Province.DrawProvinces() {
               ...
               public void draw(SpriteBatch oSB) {
                  ...
                  for (int var3 = 0; var3 < CFG.NUM_OF_PROVINCES_IN_VIEW; var3++) {
                     if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getMetProvince(CFG.game.getProvinceInViewID(var3))
                        && CFG.game.getProvince(CFG.game.getProvinceInViewID(var3)).viewBool) {
            ...
            : new Game_Render_Province.DrawProvinces() {
               ...
               public void draw(SpriteBatch oSB) {
                  ...
                  for (int var3 = 0; var3 < CFG.NUM_OF_PROVINCES_IN_VIEW; var3++) {
                     if (CFG.game.getProvince(CFG.game.getProvinceInViewID(var3)).viewBool) {
                        CFG.game.getProvince(CFG.game.getProvinceInViewID(var3)).drawOccupiedProvince(oSB);
                     }
                  }
            ...
            public MenuElement_Hover getProvinceInformations() {
               try {
                  ...
                  if (!CFG.getMetProvince(CFG.menuManager.getHoveredProvinceID())) {
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "" + CFG.getNumberWithSpaces("" + CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getEconomy()), CFG.COLOR_TEXT_ECONOMY
                        )
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     nData.clear();
                  ...
                  if (Game_Render_Province.PROVINCE_COLOR_ANIMATION_TIMER + 250L <= System.currentTimeMillis()) {
                     for (int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; i++) {
                        if (CFG.getMetProvince(CFG.game.getProvinceInViewID(i))) {
                           oSB.setColor(
                              CFG.getEconomyColor(
                                 (int)((float)CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getEconomy() / ViewsManager.ECONOMY_MAX * 100.0F), 0.6F
                              )
                           );
                           CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawLandProvince(oSB);
                        } else {
                           ...
                           oSB.setColor(
                              CFG.getColorStep_WithAlpha(
                                 CFG.game
                                    ...
                                    .getRGB(CFG.settingsManager.PROVINCE_ALPHA / 255.0F),
                                 CFG.getEconomyColor(
                                    (int)((float)CFG.game.getProvince(CFG.game.getProvinceInViewID(ix)).getEconomy() / ViewsManager.ECONOMY_MAX * 100.0F), 0.6F
                                 ),
                                 tempStepID,
                                 250
                              )
      ...
      VIEW_RADIATION_MODE = this.addViewToTheGame(
         new View_Type() {
            ...
            public MenuElement_Hover getProvinceInformations() {
               try {
                  ...
                  if (!CFG.getMetProvince(CFG.menuManager.getHoveredProvinceID())) {
                     ...
                     nData.add(new MenuElement_Hover_v2_Element_Type_Text(CFG.langManager.get("Radiation") + ": "));
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "" + CFG.getNumberWithSpaces("" + CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getZiverts()), CFG.COLOR_TEXT_ECONOMY
                        )
                     );
                     nElements.add(new MenuElement_Hover_v2_Element2(nData));
                     nData.clear();
            ...
            public void enableViewAction() {
               ...
               Game_Render_Province.PROVINCE_COLOR_ANIMATION_TIMER = System.currentTimeMillis();
               if (CFG.menuManager.getInGameView()) {
                  CFG.menuManager.setVisible_InGame_ViewRadiation(true);
               }
            }
            ...
            public void disableViewAction() {
               if (CFG.menuManager.getInGameView()) {
                  CFG.menuManager.setVisible_InGame_ViewRadiation(false);
               }
            }
                  ...
                  if (Game_Render_Province.PROVINCE_COLOR_ANIMATION_TIMER + 250L <= System.currentTimeMillis()) {
                     for (int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; i++) {
                        if (CFG.getMetProvince(CFG.game.getProvinceInViewID(i))) {
                           oSB.setColor(
                              CFG.getEconomyColor(
                                 (int)(CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getZiverts() / ViewsManager.RADIATION_MAX * 100.0F), 0.6F
                              )
                           );
                           CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawLandProvince(oSB);
                        } else {
                           ...
                           oSB.setColor(
                              CFG.getColorStep_WithAlpha(
                                 CFG.game
                                    ...
                                    .getRGB(CFG.settingsManager.PROVINCE_ALPHA / 255.0F),
                                 CFG.getEconomyColor(
                                    (int)(CFG.game.getProvince(CFG.game.getProvinceInViewID(ix)).getZiverts() / ViewsManager.RADIATION_MAX * 100.0F), 0.6F
                                 ),
                                 tempStepID,
                                 250
                              )
            ...
            ? new Game_Render_Province.DrawProvinces() {
               ...
               public void draw(SpriteBatch oSB) {
                  if (Game_Render_Province.PROVINCE_COLOR_ANIMATION_TIMER + 250L <= System.currentTimeMillis()) {
                           ...
                           if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getMetProvince(CFG.game.getProvinceInViewID(i))) {
                              oSB.setColor(
                                 new Color(
                                    ...
                                    0.15F
                                       + 0.7F
                                          * CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getPopulationData().getPopulation()
                                          / ViewsManager.POPULATION_MAX
                                 )
                              );
                           } else {
                     ...
                     for (int ix = 0; ix < CFG.NUM_OF_PROVINCES_IN_VIEW; ix++) {
                        if (CFG.game.getProvince(CFG.game.getProvinceInViewID(ix)).getCivID() == ViewsManager.POPULATION_OF_CIVID) {
                           if (CFG.game.getPlayer(CFG.PLAYER_TURNID).getMetProvince(CFG.game.getProvinceInViewID(ix))) {
                              oSB.setColor(
                                 new Color(
                                    CFG.game.getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(ix)).getCivID()).getR() / 255.0F,
                                    CFG.game.getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(ix)).getCivID()).getG() / 255.0F,
                                    CFG.game.getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(ix)).getCivID()).getB() / 255.0F,
                                    (
                                          0.15F
                                             + 0.7F
                                                * CFG.game.getProvince(CFG.game.getProvinceInViewID(ix)).getPopulationData().getPopulation()
                                                / ViewsManager.POPULATION_MAX
                                       )
                                       * tempStepID
                                       / 250.0F
                  ...
                  if (!CFG.getMetProvince(CFG.menuManager.getHoveredProvinceID())) {
                     ...
                     if (CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getIsCapital()) {
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              ""
                                 + (int)(CFG.game.getCiv(CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getCivID()).getTechnologyLevel() * 100.0F)
                                    / 100.0F,
                              CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                           )
                        );
                     ...
                     nData.add(
                        new MenuElement_Hover_v2_Element_Type_Text(
                           "" + (int)(CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getDevelopmentLevel() * 100.0F) / 100.0F,
                           CFG.COLOR_TEXT_POPULATION
                        )
                     );
                        ...
                        if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getIsPartOfHolyRomanEmpire()) {
                           ...
                           oSB.setColor(
                              new Color(
                                 ...
                                 CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEUTRAL.getG(),
                                 CFG.diplomacyColors_GameData.COLOR_DIPLOMACY_NEUTRAL.getB(),
                                 CFG.settingsManager.PROVINCE_ALPHA * 2.0F / 5.0F / 255.0F
                              )
                           );
                        }
                     } else {
               ...
               for (int i = 0; i < CFG.game.getProvincesSize(); i++) {
                  if (CFG.game.getProvince(i).getIsCapital()) {
                     CFG.game
                        .getProvince(i)
                        .getArmy_Obj(0)
                        .updateArmyWidth((int)(CFG.game.getCiv(CFG.game.getProvince(i).getCivID()).getTechnologyLevel() * 100.0F) / 100.0F);
                  }
               }
               ...
               try {
                  if (!CFG.getMetProvince(CFG.menuManager.getHoveredProvinceID())) {
                     ...
                     if (CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getLevelOfPort() > 0) {
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              CFG.langManager.get(BuildingsManager.getPort_Name(CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getLevelOfPort()))
                           )
                        );
                     ...
                     if (CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getLevelOfFarm() > 0) {
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              CFG.langManager.get(BuildingsManager.getFarm_Name(CFG.game.getProvince(CFG.menuManager.getHoveredProvinceID()).getLevelOfFarm()))
                           )
                        );
                        nData.add(new MenuElement_Hover_v2_Element_Type_Image(Images.b_farm, CFG.PADDING, 0));
                        nElements.add(new MenuElement_Hover_v2_Element2(nData));
               ...
               for (int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; i++) {
                  oSB.setColor(
                     CFG.getColorStep(
                        ...
                        (int)((float)CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getPotential() / ViewsManager.ECONOMY_MAX * 100.0F),
                        100,
                        0.6F
                     )
                  );
               ...
               for (int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; i++) {
                  oSB.setColor(
                     CFG.getColorStep(
                        ...
                        (int)((float)CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getDangerLevel() / ViewsManager.ECONOMY_MAX * 100.0F),
                        100,
                        0.6F
                     )
                  );
            ...
            public void draw(SpriteBatch oSB) {
               for (int i = 0; i < CFG.NUM_OF_PROVINCES_IN_VIEW; i++) {
                  if (CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getTrueOwnerOfProvince() != 0) {
                     oSB.setColor(
                        CFG.game.getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getTrueOwnerOfProvince()).getR() / 255.0F,
                        CFG.game.getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getTrueOwnerOfProvince()).getG() / 255.0F,
                        CFG.game.getCiv(CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).getTrueOwnerOfProvince()).getB() / 255.0F,
                        CFG.settingsManager.PROVINCE_ALPHA / 255.0F
                     );
                     CFG.game.getProvince(CFG.game.getProvinceInViewID(i)).drawLandProvince(oSB);
                  }
   ...
   public final int addViewToTheGame(View_Type nView, Game_Render.Renderer nRenderer, Game_Render_Province.DrawProvinces nDrawProvinces) {
   ...
   public final void setActiveViewID(int iID, boolean viewConfig) {
      this.viewConfig = viewConfig;
      this.setActiveViewID(iID);
   }

   public final void setActiveViewID(int iID) {
      try {
   ...
   public static final void updateMaxIncome() {
      POPULATION_MAX = 0;
   ...
   public static final void updateMaxDistance() {
      ...
      for (int i = 0; i < CFG.game.getProvincesSize(); i++) {
         if (!CFG.game.getProvince(i).getSeaProvince()
            ...
            && CFG.game_NextTurnUpdate.getDistanceFromCapital(CFG.game.getCiv(CFG.game.getProvince(i).getCivID()).getCapitalProvinceID(), i) > POPULATION_MAX) {
   ...
   public static final void updateMaxRadiation() {
      RADIATION_MAX = 0.0F;

      for (int i = 0; i < CFG.game.getProvincesSize(); i++) {
         if (!CFG.game.getProvince(i).getSeaProvince() && !(CFG.game.getProvince(i).getZiverts() <= RADIATION_MAX)) {
            RADIATION_MAX = CFG.game.getProvince(i).getZiverts();
         }
      }
