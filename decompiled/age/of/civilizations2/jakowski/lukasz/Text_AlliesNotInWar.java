...
public class Text_AlliesNotInWar extends Text {
   public Text_AlliesNotInWar(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, int iHeight) {
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sText,
         this.getPosX() + (int)((this.getWidth() - this.getTextWidth() * 0.6F) / 2.0F) + iTranslateX,
         this.getPosY() + (int)((this.getHeight() - this.iTextHeight * 0.6F) / 2.0F) + iTranslateY,
