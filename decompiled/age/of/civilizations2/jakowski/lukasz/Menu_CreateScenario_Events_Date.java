            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.gameAges.getAge(CFG.eventsManager.iCreateEvent_Age).getName(), CFG.COLOR_BUTTON_GAME_TEXT_ACTIVE
                  )
               );
      ...
      menuElements.add(
         new Slider_Age(
            ...
            public void buildElementHover() {
               ...
               nData.clear();
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(CFG.gameAges.getYear(CFG.gameAges.getAge(CFG.eventsManager.iCreateEvent_Age).getBeginningYear()))
               );
