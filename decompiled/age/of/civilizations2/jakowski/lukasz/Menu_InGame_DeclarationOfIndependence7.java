...
class Menu_InGame_DeclarationOfIndependence7 extends SliderMenu {
   private int iOnCivID = -1;

   protected Menu_InGame_DeclarationOfIndependence7(int var1) {
      ...
      var2.add(new Button_NS_Opinion(this, var1, CFG.game.getCiv(CFG.getActiveCivInfo()).getPuppetOfCivID(), Images.skull, 0, 0, 0, 0, CFG.BUTTON_WIDTH * 0) {
         final Menu_InGame_DeclarationOfIndependence7 this$0;
               ...
               ImageManager.getImage(Images.skull)
                  .draw(
                     ...
                     this.getPosX()
                        ...
                        + var2x,
                     this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.skull).getHeight() / 2 + var3x
                  );
      ...
      String var6;
      if (CFG.game.getCiv(var1).isRegroupArmyForPlayer <= 0) {
   ...
   protected final void actionElement(int var1) {
      if (var1 == this.getMenuElementsSize() - 1) {
         var1 = CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID();
         if (CFG.game.getCiv(var1).isRegroupArmyForPlayer <= 0) {
            CFG.oAI.getAI_Style(CFG.game.getCiv(var1).getAI_Style()).regroupArmy_AtPeace(var1);
            CFG.game.getCiv(var1).isRegroupArmyForPlayer = 1;
            CFG.menuManager.updateInGame_TOP_All(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID());
         } else {
            CFG.game.getCiv(var1).isRegroupArmyForPlayer = 0;
         }
   ...
   protected void draw(SpriteBatch var1, int var2, int var3, boolean var4) {
      if (Menu_InGame_OfferAlliance.lTime + 200L >= System.currentTimeMillis()) {
         ...
         var14.draw2(var1, var11 + 2 + var8 - var10 + var2, var6 - var9 + var3, var7, CFG.PADDING + var12, true, true);
         ...
         var15.draw2(var1, var27 - 2 + var2, var21 - var33 + var3, var30 - var24 + 4, CFG.PADDING + var18, false, true);
         ...
         var15.draw2(var1, var33 + 2 + var30 - var35 + var2, var27 - var24 + var3, var21, CFG.PADDING + var18, true, true);
         var1.setColor(new Color(0.0F, 0.0F, 0.0F, 0.45F));
         ImageManager.getImage(Images.gradient)
            .draw(
               var1,
