...
public class Button_PrepareForWar extends Button_Build {
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      CFG.game
         ...
         .draw(
            ...
            this.getPosX()
               + this.getWidth()
               - CFG.PADDING * 2
               - (int)(ImageManager.getImage(Images.flag_rect).getWidth() * this.getImageScale(Images.flag_rect, 1.0F))
               + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               - CFG.game.getCiv(this.iFromCivID).getFlag().getHeight()
               - (int)(ImageManager.getImage(Images.flag_rect).getHeight() * this.getImageScale(Images.flag_rect, 1.0F)) / 2
               + iTranslateY,
            (int)(ImageManager.getImage(Images.flag_rect).getWidth() * this.getImageScale(Images.flag_rect, 1.0F)),
            (int)(ImageManager.getImage(Images.flag_rect).getHeight() * this.getImageScale(Images.flag_rect, 1.0F))
         );
      ...
      CFG.game
         ...
         .draw(
            oSB,
            this.getPosX() + CFG.PADDING * 2 + this.iProvinceNameWidth + Button_Diplomacy.iDiploWidth + (int)(this.getTextWidth() * 0.7F) + iTranslateX,
            this.getPosY()
               + this.getHeight() / 2
               - (int)(this.getTextHeight() * 0.7F) / 2
               - CFG.PADDING / 2
               - CFG.game.getCiv(this.warAgainstCivID).getFlag().getHeight()
               - (int)(ImageManager.getImage(Images.flag_rect).getHeight() * this.getImageScale(Images.flag_rect, 0.7F)) / 2
               + iTranslateY,
            (int)(ImageManager.getImage(Images.flag_rect).getWidth() * this.getImageScale(Images.flag_rect, 0.7F)),
            (int)(ImageManager.getImage(Images.flag_rect).getHeight() * this.getImageScale(Images.flag_rect, 0.7F))
         );
      ImageManager.getImage(Images.flag_rect)
         .draw(
            oSB,
