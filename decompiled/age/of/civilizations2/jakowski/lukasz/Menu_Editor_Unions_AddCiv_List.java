...
public class Menu_Editor_Unions_AddCiv_List extends SliderMenu {
                     ...
                     try {
                        ...
                        nData.add(
                           new MenuElement_Hover_v2_Element_Type_Text(
                              CFG.getWikiInormationsLink_Clear(Menu_Editor_Unions_AddCiv_List.this.lCivsTags.get(this.getTextPos())),
   ...
   public final void actionElement(int iID) {
      if (CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1 == -2) {
         ...
         CFG.unionsManager.createUnion_Data.lCivsTags.add(CFG.ideologiesManager.getRealTag(this.lCivsTags.get(iID / 2)));
      } else {
         if (iID % 2 != 0) {
            CFG.EDITOR_ACTIVE_GAMEDATA_TAG = this.lCivsTags.get(iID / 2);
            CFG.setDialogType(Dialog.GO_TO_WIKI);
         ...
         try {
            CFG.unionsManager
               .createUnion_Data
               .lCivsTags
               .set(CFG.MANAGE_DIPLOMACY_ADD_NEW_PACT_CIV1, CFG.ideologiesManager.getRealTag(this.lCivsTags.get(iID / 2)));
         } catch (IndexOutOfBoundsException var3) {
         }
      }
