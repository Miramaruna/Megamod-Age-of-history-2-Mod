...
public class Slider_FlagAction_Gold extends Slider {
   public static final Color bgColor = new Color(0.0F, 0.0F, 0.0F, 0.3F);
   public float FONT_SCALE = 0.8F;
   public int IMAGE;

   public Slider_FlagAction_Gold(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent) {
      this.initSlider(sText, iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
   }

   public Slider_FlagAction_Gold(String sText, int iPosX, int iPosY, int iWidth, int iHeight, int iMin, int iMax, int iCurrent, float FONT_SCALE, int nImageID) {
      this.initSlider(sText, iPosX, iPosY, iWidth, iHeight, iMin, iMax, iCurrent);
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive, boolean scrollableY) {
      ...
      ImageManager.getImage(this.IMAGE)
         .draw(
            ...
            this.getPosX()
               ...
               - (int)(ImageManager.getImage(this.IMAGE).getWidth() * this.getImageScale(this.FONT_SCALE, this.IMAGE))
               + iTranslateX,
            this.getPosY()
               + this.getHeight()
               - CFG.PADDING * 2
               - this.getSliderHeight()
               - (int)(ImageManager.getImage(this.IMAGE).getHeight() * this.getImageScale(this.FONT_SCALE, this.IMAGE))
               - ImageManager.getImage(this.IMAGE).getHeight()
               + iTranslateY,
            (int)(ImageManager.getImage(this.IMAGE).getWidth() * this.getImageScale(this.FONT_SCALE, this.IMAGE)),
            (int)(ImageManager.getImage(this.IMAGE).getHeight() * this.getImageScale(this.FONT_SCALE, this.IMAGE))
         );
      ...
      CFG.drawTextWithShadow(
         ...
         this.getText(),
         this.getPosX() + CFG.PADDING + iTranslateX,
         this.getPosY() + this.getHeight() - CFG.PADDING * 2 - this.getSliderHeight() - (int)(CFG.TEXT_HEIGHT * this.FONT_SCALE) + iTranslateY,
         this.getColor(isActive)
      );
      CFG.drawTextWithShadow(
         oSB,
         this.getDrawText(),
         this.getPosX() + this.getWidth() - CFG.PADDING - (int)(this.getTextWidth() * this.FONT_SCALE) + iTranslateX,
         this.getPosY() + this.getHeight() - CFG.PADDING * 2 - this.getSliderHeight() - (int)(CFG.TEXT_HEIGHT * this.FONT_SCALE) + iTranslateY,
         this.getCurrent() == 0 ? CFG.COLOR_TEXT_MODIFIER_NEUTRAL : CFG.COLOR_INGAME_GOLD
      );
