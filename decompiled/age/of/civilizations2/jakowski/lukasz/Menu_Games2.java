...
public class Menu_Games2 extends SliderMenu {
   public Menu_Games2() {
      ArrayList<MenuElement> menuElements = new ArrayList<>();
      int tempH = CFG.GAME_HEIGHT / 2 - (CFG.BUTTON_HEIGHT * 10 + CFG.PADDING * 11) / 2;
      menuElements.add(
         new Button_Menu_LR_MainMenu(
            null, (int)(50.0F * CFG.GUI_SCALE), CFG.GAME_WIDTH / 10, tempH, CFG.GAME_WIDTH - CFG.GAME_WIDTH / 5, CFG.BUTTON_HEIGHT, false
         )
      );
      menuElements.add(
         new Button_Menu_LR_MainMenu(
            ...
            CFG.GAME_WIDTH / 10,
            tempH + CFG.BUTTON_HEIGHT + CFG.PADDING,
            CFG.GAME_WIDTH - CFG.GAME_WIDTH / 5,
            CFG.BUTTON_HEIGHT,
            false
         )
      );
      menuElements.add(
         new Button_Menu_LR_MainMenu(
            ...
            (int)(50.0F * CFG.GUI_SCALE),
            CFG.GAME_WIDTH / 10,
            tempH + CFG.BUTTON_HEIGHT * 2 + CFG.PADDING * 2,
            CFG.GAME_WIDTH - CFG.GAME_WIDTH / 5,
            CFG.BUTTON_HEIGHT,
            true
         )
      ...
      menuElements.add(
         new Button_Menu_LR_MainMenu(
            ...
            (int)(50.0F * CFG.GUI_SCALE),
            CFG.GAME_WIDTH / 10,
            tempH + CFG.BUTTON_HEIGHT * 3 + CFG.PADDING * 3,
            CFG.GAME_WIDTH - CFG.GAME_WIDTH / 5,
            CFG.BUTTON_HEIGHT,
            true
         )
      ...
      menuElements.add(
         new Button_Menu_LR_MainMenu(
            ...
            (int)(50.0F * CFG.GUI_SCALE),
            CFG.GAME_WIDTH / 10,
            tempH + CFG.BUTTON_HEIGHT * 4 + CFG.PADDING * 4,
            CFG.GAME_WIDTH - CFG.GAME_WIDTH / 5,
            CFG.BUTTON_HEIGHT,
            true
         )
      ...
      menuElements.add(
         new Button_Menu_LR_MainMenu(
            ...
            (int)(50.0F * CFG.GUI_SCALE),
            CFG.GAME_WIDTH / 10,
            tempH + CFG.BUTTON_HEIGHT * 5 + CFG.PADDING * 5,
            CFG.GAME_WIDTH - CFG.GAME_WIDTH / 5,
            CFG.BUTTON_HEIGHT,
            true
         )
      ...
      menuElements.add(
         new Button_Menu_LR_MainMenu(
            ...
            (int)(50.0F * CFG.GUI_SCALE),
            CFG.GAME_WIDTH / 10,
            tempH + CFG.BUTTON_HEIGHT * 6 + CFG.PADDING * 6,
            CFG.GAME_WIDTH - CFG.GAME_WIDTH / 5,
            CFG.BUTTON_HEIGHT,
            false
         )
      ...
      menuElements.add(
         new Button_Menu_LR_MainMenu(
            ...
            (int)(50.0F * CFG.GUI_SCALE),
            CFG.GAME_WIDTH / 10,
            tempH + CFG.BUTTON_HEIGHT * 7 + CFG.PADDING * 7,
            CFG.GAME_WIDTH - CFG.GAME_WIDTH / 5,
            CFG.BUTTON_HEIGHT,
            false
         )
      ...
      menuElements.add(
         new Button_Menu_LR_MainMenu(
            ...
            (int)(50.0F * CFG.GUI_SCALE),
            CFG.GAME_WIDTH / 10,
            tempH + CFG.BUTTON_HEIGHT * 8 + CFG.PADDING * 8,
            CFG.GAME_WIDTH - CFG.GAME_WIDTH / 5,
            CFG.BUTTON_HEIGHT,
            true
         )
      ...
      menuElements.add(
         new Button_Menu_LR_MainMenu(
            null, -1, CFG.GAME_WIDTH / 10, tempH + CFG.BUTTON_HEIGHT * 9 + CFG.PADDING * 9, CFG.GAME_WIDTH - CFG.GAME_WIDTH / 5, CFG.BUTTON_HEIGHT, true
         )
      );
   ...
   public void draw(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean sliderMenuIsActive) {
      ImageManager.getImage(Images.main_menu_edge)
         .draw2(
            oSB,
            this.getPosX() - 2 + this.getMenuElement(0).getPosX() + iTranslateX,
            this.getMenuPosY() - ImageManager.getImage(Images.main_menu_edge).getHeight() * 2 - CFG.PADDING + this.getMenuElement(0).getPosY() + iTranslateY,
            this.getMenuElement(0).getWidth() + 4 - ImageManager.getImage(Images.main_menu_edge).getWidth(),
            this.getMenuElement(this.getMenuElementsSize() - 1).getPosY()
               + this.getMenuElement(this.getMenuElementsSize() - 1).getHeight()
               - this.getMenuElement(0).getPosY()
               + (ImageManager.getImage(Images.main_menu_edge).getHeight() + CFG.PADDING) * 2
      ...
      ImageManager.getImage(Images.main_menu_edge)
         .draw2(
            ...
            this.getMenuPosY()
               ...
               + (ImageManager.getImage(Images.main_menu_edge).getHeight() + CFG.PADDING) * 2
               - ImageManager.getImage(Images.main_menu_edge).getHeight()
               - ImageManager.getImage(Images.main_menu_edge).getHeight() * 2
               - CFG.PADDING
               + this.getMenuElement(0).getPosY()
               + iTranslateY,
            this.getMenuElement(0).getWidth() + 4 - ImageManager.getImage(Images.main_menu_edge).getWidth(),
