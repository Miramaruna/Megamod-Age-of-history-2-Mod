...
public class Menu_CreateScenario_Events_Out_FormCiv extends SliderMenu {
   ...
   public void updateLanguage() {
      ...
      this.getTitle().setText(CFG.langManager.get("FormCivilization"));
   }
