...
public class Button_NewGameStyle extends Button {
   public static final float BUTTON_PERC_HEIGHT = 0.65F;
   public static final float BUTTON_TEXT_SCALE = 0.8F;

   public Button_NewGameStyle(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable) {
      super.init(sText, iTextPositionX, iPosX, iPosY, iWidth, (int)(CFG.BUTTON_HEIGHT * 0.65F), isClickable, true, false, false);
   }
   ...
   public Button_NewGameStyle(String sText, int iTextPositionX, int iPosX, int iPosY, int iWidth, boolean isClickable, boolean checkBox) {
      super.init(sText, iTextPositionX, iPosX, iPosY, iWidth, (int)(CFG.BUTTON_HEIGHT * 0.65F), isClickable, true, true, checkBox);
   }
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      if (isActive) {
         ...
         CFG.drawText(
            oSB,
            this.getTextToDraw(),
            this.getPosX() + (this.getTextPos() < 0 ? (int)(this.getWidth() - this.getTextWidth() * 0.8F) / 2 : this.getTextPos()) + iTranslateX,
