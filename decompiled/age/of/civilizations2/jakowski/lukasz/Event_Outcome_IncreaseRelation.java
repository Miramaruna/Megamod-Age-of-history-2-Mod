...
public class Event_Outcome_IncreaseRelation extends Event_Outcome {
   public int iCivID = -1;
   ...
   public void outcomeAction() {
      if (this.canMakeAction()) {
         CFG.game.setCivRelation_OfCivB(this.getCivID(), this.getCivID2(), CFG.game.getCivRelation_OfCivB(this.getCivID(), this.getCivID2()) + this.getValue());
         CFG.game.setCivRelation_OfCivB(this.getCivID2(), this.getCivID(), CFG.game.getCivRelation_OfCivB(this.getCivID2(), this.getCivID()) + this.getValue());
      }
   }
