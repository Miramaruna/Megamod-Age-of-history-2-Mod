...
public class Menu_InGame_ChangeGovernment extends SliderMenu {
   ...
   public Menu_InGame_ChangeGovernment() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Government"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
         ...
         new SliderMenuTitle(CFG.langManager.get("Government"), CFG.BUTTON_HEIGHT * 3 / 5, true, true) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_ChangeGovernment.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_ChangeGovernment.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_ChangeGovernment.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_ChangeGovernment.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
