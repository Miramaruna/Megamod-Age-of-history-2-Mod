...
public class Menu_InGame_View_GrowthRate extends SliderMenu {
   ...
   public Menu_InGame_View_GrowthRate() {
      ...
      while (tempProvs.size() > 0) {
         ...
         for (int i2 = 1; i2 < tempProvs.size(); i2++) {
            if (CFG.game.getProvince(tempProvs.get(tBest)).getGrowthRate_Population_WithFarm_WithTerrain()
               < CFG.game.getProvince(tempProvs.get(i2)).getGrowthRate_Population_WithFarm_WithTerrain()) {
               tBest = i2;
            }
         }
      ...
      if (tempProvincesSorted.size() > 0) {
         menuElements.add(
            new Button_NS_Population(
               ...
               this.iCivID,
               CFG.langManager.get("AverageGrowthRate") + ": ",
               CFG.game.countAvarageGrowthRate(this.iCivID) + "%",
         ...
         for (int var9 = 0; var9 < tempProvincesSorted.size(); var9++) {
            menuElements.add(
               new Button_View_GrowthRate(
                  var9,
                  (
                  ...
                  (CFG.SPECTATOR_MODE || CFG.game.isAlly(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID(), this.iCivID))
                     && CFG.game.getCiv(this.iCivID).isInConstruction((Integer)tempProvincesSorted.get(var9), ConstructionType.FARM) > 0
               ) {
                  @Override
                  public void actionElement(int iID) {
                     if (CFG.gameAction.getActiveTurnState() != Game_Action.TurnStates.INPUT_ORDERS
                        ...
                        || !BuildingsManager.canBuildFarm_Terrain(this.getCurrent())
                        || CFG.game.getProvince(this.getCurrent()).getCivID() != CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()
                        || CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isInConstruction(this.getCurrent(), ConstructionType.FARM) > 0) {
                        ...
                        CFG.menuManager.rebuildInGame_BuildFarm(this.getCurrent());
                     }
                  }
               }
            );
         ...
         new SliderMenuTitle(CFG.game.getCiv(this.iCivID).getCivName(), CFG.BUTTON_HEIGHT * 3 / 5, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_InGame_View_GrowthRate.this.getPosX() + iTranslateX,
                     Menu_InGame_View_GrowthRate.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(),
                     Menu_InGame_View_GrowthRate.this.getWidth() + 2,
                     this.getHeight(),
                     true,
                     false
                  );
               oSB.setColor(
                  new Color(
                     CFG.game.getCiv(Menu_InGame_View_GrowthRate.this.iCivID).getR() / 255.0F,
                     CFG.game.getCiv(Menu_InGame_View_GrowthRate.this.iCivID).getG() / 255.0F,
                     CFG.game.getCiv(Menu_InGame_View_GrowthRate.this.iCivID).getB() / 255.0F,
                     0.165F
                  )
               );
               ...
               ImageManager.getImage(Images.pix255_255_255)
                  .draw(
                     oSB,
                     Menu_InGame_View_GrowthRate.this.getPosX() + iTranslateX,
                     Menu_InGame_View_GrowthRate.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(),
                     Menu_InGame_View_GrowthRate.this.getWidth()
                  );
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_InGame_View_GrowthRate.this.getPosX() + iTranslateX,
                     Menu_InGame_View_GrowthRate.this.getPosY()
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     Menu_InGame_View_GrowthRate.this.getWidth() / 4,
                     1
                  );
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Menu_InGame_View_GrowthRate.this.getPosX()
                        + Menu_InGame_View_GrowthRate.this.getWidth()
                        - Menu_InGame_View_GrowthRate.this.getWidth() / 4
                        + iTranslateX,
                     Menu_InGame_View_GrowthRate.this.getPosY()
               ...
               ImageManager.getImage(Images.population_growth)
                  .draw(
                     ...
                     Menu_InGame_View_GrowthRate.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.population_growth).getHeight() / 2
                  );
