...
public class Button_Build_Assimilate extends Button_Build {
   public static final float FONT_SIZE_SCALE = 0.6F;
   ...
   public Button_Build_Assimilate(
      int nProvinceID, String sText, String sProvinceID, String sDate, int nImageID, int nCost, int nMovementCost, int iPosX, int iPosY, int iWidth
   ) {
      ...
      this.cColorAssimilate = CFG.getColorStep(
         CFG.COLOR_TEXT_PROVINCE_STABILITY_MIN,
         CFG.COLOR_TEXT_PROVINCE_STABILITY_MAX,
         (int)(CFG.game.getProvince(nProvinceID).getProvinceStability() * 100.0F),
         100,
         1.0F
      );
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
            ...
            ImageManager.getImage(Images.top_diplomacy_points)
               .draw(
                  ...
                  this.getPosX()
                     + this.getWidth()
                     - CFG.PADDING * 2
                     - (int)(ImageManager.getImage(Images.top_diplomacy_points).getWidth() * this.getImageScale(Images.top_diplomacy_points, 0.6F))
                     + iTranslateX,
                  this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.top_diplomacy_points).getHeight() + CFG.PADDING / 2 + iTranslateY,
                  (int)(ImageManager.getImage(Images.top_diplomacy_points).getWidth() * this.getImageScale(Images.top_diplomacy_points, 0.6F)),
                  (int)(ImageManager.getImage(Images.top_diplomacy_points).getHeight() * this.getImageScale(Images.top_diplomacy_points, 0.6F))
               );
            CFG.fontMain.getData().setScale(0.6F);
            CFG.drawTextWithShadow(
               oSB,
         ...
         ImageManager.getImage(Images.top_diplomacy_points)
            .draw(
               ...
               this.getPosY()
                  ...
                  - (int)(ImageManager.getImage(Images.top_diplomacy_points).getHeight() * this.getImageScale(Images.top_diplomacy_points, 0.6F)) / 2
                  + iTranslateY,
               (int)(ImageManager.getImage(Images.top_diplomacy_points).getWidth() * this.getImageScale(Images.top_diplomacy_points, 0.6F)),
               (int)(ImageManager.getImage(Images.top_diplomacy_points).getHeight() * this.getImageScale(Images.top_diplomacy_points, 0.6F))
            );
      ...
      CFG.drawTextWithShadow(
         oSB,
         this.sStability,
         this.getPosX() + CFG.PADDING + this.iDateWidth + Button_Diplomacy.iDiploWidth + iTranslateX,
         this.getPosY() + this.getHeight() / 2 + CFG.PADDING / 2 + iTranslateY,
         this.cColorAssimilate
      );
   ...
   public void setCurrent(int nCurrent) {
      this.canBuild_MoneyCost = CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney() >= nCurrent;
