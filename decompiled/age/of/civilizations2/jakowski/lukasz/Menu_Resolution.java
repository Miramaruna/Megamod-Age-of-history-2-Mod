...
public class Menu_Resolution extends SliderMenu {
   public List<Point_XY> lResolution = new ArrayList<>();
   ...
   public Menu_Resolution() {
      ...
      this.lResolution.add(new Point_XY(720, 1280));
      this.lResolution.add(new Point_XY(1080, 1920));
      this.lResolution.add(new Point_XY(1080, 1350));
      ...
      for (int i = 0; i < this.lResolution.size(); i++) {
         if (CFG.GAME_WIDTH == this.lResolution.get(i).getPosX() && CFG.GAME_HEIGHT == this.lResolution.get(i).getPosY()) {
            menuElements.add(
               new Button_Menu(
                  "" + this.lResolution.get(i).getPosX() + "x" + this.lResolution.get(i).getPosY(),
