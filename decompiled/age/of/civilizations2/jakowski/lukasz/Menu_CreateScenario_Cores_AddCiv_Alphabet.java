...
public class Menu_CreateScenario_Cores_AddCiv_Alphabet extends SliderMenu {
   ...
   public Menu_CreateScenario_Cores_AddCiv_Alphabet() {
      ...
      menuElements.add(new Button_Menu_Classic_Search("", CFG.PADDING * 2, 0, CFG.PADDING, CFG.BUTTON_WIDTH * 2, CFG.BUTTON_HEIGHT, true) {
         ...
         public String getTextToDraw() {
            return Menu_CreateScenario_Cores_AddCiv_Alphabet.this.nSearch + ": " + super.getTextToDraw();
         }
      });
