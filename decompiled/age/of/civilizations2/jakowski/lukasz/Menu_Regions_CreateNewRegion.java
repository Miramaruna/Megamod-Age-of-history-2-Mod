...
public class Menu_Regions_CreateNewRegion extends SliderMenu {
   public String sName;
   ...
   public Menu_Regions_CreateNewRegion() {
      ...
      menuElements.add(
         new Button_Game(null, -1, CFG.PADDING, CFG.BUTTON_HEIGHT + CFG.PADDING * 3, CFG.BUTTON_WIDTH * 2) {
            ...
            public Color getColor(boolean isActive) {
               return isActive
                  ? new Color(CFG.editor_Region_GameData.getR(), CFG.editor_Region_GameData.getG(), CFG.editor_Region_GameData.getB(), 1.0F)
