...
public class Menu_InGame_View_ProvinceValue extends SliderMenu {
   public static final int ANIMATION_TIME = 175;
   public static long lTime = 0L;
   public static boolean hideAnimation = true;
   public int iCivID = 0;

   public Menu_InGame_View_ProvinceValue(int init) {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("ProvinceValue"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_View_ProvinceValue() {
      ...
      for (int i = 0; i < CFG.game.getCiv(this.iCivID).getNumOfProvinces(); i++) {
         if (CFG.FOG_OF_WAR != 2 || CFG.game.getPlayer(CFG.PLAYER_TURNID).getMetProvince(CFG.game.getCiv(this.iCivID).getProvinceID(i))) {
            ...
            totalPopulation += CFG.game.getProvinceValue(CFG.game.getCiv(this.iCivID).getProvinceID(i));
         }
      }
      ...
      while (tempProvs.size() > 0) {
         ...
         for (int i2 = 1; i2 < tempProvs.size(); i2++) {
            if (CFG.game.getProvinceValue(tempProvs.get(tBest)) < CFG.game.getProvinceValue(tempProvs.get(i2))) {
               tBest = i2;
            }
         }
               ...
               new Button_View_ProvinceValue(
                  ...
                  public void actionElement(int iID) {
                     if (CFG.gameAction.getActiveTurnState() != Game_Action.TurnStates.INPUT_ORDERS
                        ...
                        || CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).isInvestOrganized(this.getCurrent())) {
                        ...
                        CFG.menuManager.rebuildInGame_Invest(this.getCurrent());
                     }
                  }
               }
            );
         ...
         new SliderMenuTitle(CFG.game.getCiv(this.iCivID).getCivName(), CFG.BUTTON_HEIGHT * 3 / 5, false, false) {
            ...
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ImageManager.getImage(Images.new_game_top_edge_title)
                  .draw2(
                     oSB,
                     Menu_InGame_View_ProvinceValue.this.getPosX() + iTranslateX,
                     Menu_InGame_View_ProvinceValue.this.getPosY() - ImageManager.getImage(Images.new_game_top_edge_title).getHeight() - this.getHeight(),
                     Menu_InGame_View_ProvinceValue.this.getWidth() + 2,
                     this.getHeight(),
                     true,
                     false
                  );
               oSB.setColor(new Color(CFG.COLOR_TEXT_PROVINCE_VALUE.r, CFG.COLOR_TEXT_PROVINCE_VALUE.g, CFG.COLOR_TEXT_PROVINCE_VALUE.b, 0.165F));
               ...
               oSB.setColor(new Color(CFG.COLOR_TEXT_PROVINCE_VALUE.r, CFG.COLOR_TEXT_PROVINCE_VALUE.g, CFG.COLOR_TEXT_PROVINCE_VALUE.b, 0.375F));
               ...
               ImageManager.getImage(Images.pix255_255_255)
                  .draw(
                     oSB,
                     Menu_InGame_View_ProvinceValue.this.getPosX() + iTranslateX,
                     Menu_InGame_View_ProvinceValue.this.getPosY() - ImageManager.getImage(Images.pix255_255_255).getHeight(),
                     Menu_InGame_View_ProvinceValue.this.getWidth()
                  );
               ...
               ImageManager.getImage(Images.line_32_off1)
                  .draw(
                     oSB,
                     Menu_InGame_View_ProvinceValue.this.getPosX() + iTranslateX,
                     Menu_InGame_View_ProvinceValue.this.getPosY()
               ...
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     ...
                     Menu_InGame_View_ProvinceValue.this.getWidth() / 4,
                     1
                  );
               ImageManager.getImage(Images.slider_gradient)
                  .draw(
                     oSB,
                     Menu_InGame_View_ProvinceValue.this.getPosX()
                        + Menu_InGame_View_ProvinceValue.this.getWidth()
                        - Menu_InGame_View_ProvinceValue.this.getWidth() / 4
                        + iTranslateX,
                     Menu_InGame_View_ProvinceValue.this.getPosY()
               ...
               ImageManager.getImage(Images.victoryPoints)
                  .draw(
                     ...
                     Menu_InGame_View_ProvinceValue.this.getPosY() - this.getHeight() / 2 - ImageManager.getImage(Images.victoryPoints).getHeight() / 2
                  );
