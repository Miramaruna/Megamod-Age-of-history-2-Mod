...
public class Button_Stats_Image extends Button_Stats {
   public int iImageID = 0;

   public Button_Stats_Image(
   ...
   public void setText(String sText) {
      ...
      try {
         ...
         if (super.getWidth() < this.iTextWidth + CFG.PADDING * 2 + (int)(ImageManager.getImage(this.iImageID).getWidth() * this.getImageScale())) {
            this.setWidth(this.iTextWidth + CFG.PADDING * 2 + (int)(ImageManager.getImage(this.iImageID).getWidth() * this.getImageScale()));
         }
