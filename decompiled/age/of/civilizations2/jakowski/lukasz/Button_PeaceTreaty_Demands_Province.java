...
class Button_PeaceTreaty_Demands_Province extends Button {
   ...
   public void drawButtonBG(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      ...
      oSB.setColor(
         new Color(
            CFG.game.getCiv(CFG.game.getProvince(this.iProvinceID).getTrueOwnerOfProvince()).getR() / 255.0F,
            CFG.game.getCiv(CFG.game.getProvince(this.iProvinceID).getTrueOwnerOfProvince()).getG() / 255.0F,
            CFG.game.getCiv(CFG.game.getProvince(this.iProvinceID).getTrueOwnerOfProvince()).getB() / 255.0F,
            0.125F
         )
      );
