...
public class Button_RTO extends Button_Menu {
   public int iCivID;
      ...
      try {
         ...
         ImageManager.getImage(Images.randomCivilizationFlag)
            .draw(
               oSB,
               this.getTextPos() + this.getPosX() + iTranslateX,
               this.getPosY() + this.getHeight() / 2 - ImageManager.getImage(Images.randomCivilizationFlag).getHeight() - CFG.CIV_FLAG_HEIGHT / 2 + iTranslateY,
               CFG.CIV_FLAG_WIDTH,
               CFG.CIV_FLAG_HEIGHT
            );
      }
