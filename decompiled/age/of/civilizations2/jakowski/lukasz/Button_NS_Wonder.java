...
public class Button_NS_Wonder extends Button {
   ...
   public Button_NS_Wonder(Color nColor, int nProvinceID, int nWonderID, int iPosX, int iPosY, int iWidth) {
      super.init(
         ...
         iPosY,
         iWidth,
         (int)(CFG.BUTTON_HEIGHT * 3.5F / 5.0F),
         true,
         true,
         false,
         false
   ...
   public void drawText(SpriteBatch oSB, int iTranslateX, int iTranslateY, boolean isActive) {
      try {
         CFG.game
            ...
            .draw(
               ...
               this.getPosX()
                  ...
                  - (int)(CFG.game.getProvince(this.iProvinceID).getWonder(this.iWonderID).nImage.getWidth() / 2 * CFG.GUI_SCALE)
                  + iTranslateX,
               this.getPosY()
                  + this.getHeight() / 2
                  - (int)(CFG.game.getProvince(this.iProvinceID).getWonder(this.iWonderID).nImage.getHeight() * CFG.GUI_SCALE / 2.0F)
                  - CFG.game.getProvince(this.iProvinceID).getWonder(this.iWonderID).nImage.getHeight()
                  + iTranslateY,
               (int)(CFG.game.getProvince(this.iProvinceID).getWonder(this.iWonderID).nImage.getWidth() * CFG.GUI_SCALE),
               (int)(CFG.game.getProvince(this.iProvinceID).getWonder(this.iWonderID).nImage.getHeight() * CFG.GUI_SCALE)
            );
         float fScale = CFG.TEXT_HEIGHT * 0.65F / ImageManager.getImage(Images.flag_rect).getHeight();
         ...
         CFG.drawTextWithShadow(
            oSB,
            this.sDeathsTEXT,
            this.getPosX() + CFG.PADDING * 2 + (int)(ImageManager.getImage(Images.flag_rect).getWidth() * fScale) + Button_Diplomacy.iDiploWidth + iTranslateX,
