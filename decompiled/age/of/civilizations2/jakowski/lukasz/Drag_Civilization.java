...
public class Drag_Civilization {
   ...
   public final void draw(SpriteBatch oSB, int iTranslateX) {
      if (this.visible) {
         int tFlagW = (int)(CFG.game.getCiv(this.iCivID).getCivNameHeight() * 100.0F / CFG.CIV_FLAG_HEIGHT * CFG.CIV_FLAG_WIDTH / 100.0F);
         int tFlagH = (int)(CFG.CIV_FLAG_HEIGHT * CFG.game.getCiv(this.iCivID).getCivNameHeight() * 100.0F / CFG.CIV_FLAG_HEIGHT / 100.0F);
