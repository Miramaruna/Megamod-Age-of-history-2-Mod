...
public class Message_Uncivilized extends Message {
   ...
   public MenuElement_Hover_v2 getHover() {
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(
            "" + (int)(CFG.ideologiesManager.getIdeology(CFG.game.getCiv(this.iFromCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL * 100.0F) / 100.0F,
      ...
      nData.add(
         new MenuElement_Hover_v2_Element_Type_Text(
            "" + (int)(CFG.game.getCiv(this.iFromCivID).getTechnologyLevel() * 100.0F) / 100.0F,
            CFG.game.getCiv(this.iFromCivID).getTechnologyLevel()
                  >= CFG.ideologiesManager.getIdeology(CFG.game.getCiv(this.iFromCivID).getIdeologyID()).CIVILIZE_TECH_LEVEL
               ? CFG.COLOR_TEXT_MODIFIER_POSITIVE
               : CFG.COLOR_TEXT_MODIFIER_NEGATIVE2
