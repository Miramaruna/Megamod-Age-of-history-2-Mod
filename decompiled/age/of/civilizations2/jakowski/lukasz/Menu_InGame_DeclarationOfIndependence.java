...
public class Menu_InGame_DeclarationOfIndependence extends SliderMenu {
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         DiplomacyManager.declarationOfIndependeceByVassal(
            CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getPuppetOfCivID(), CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()
         );
