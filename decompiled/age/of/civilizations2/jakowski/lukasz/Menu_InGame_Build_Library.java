...
public class Menu_InGame_Build_Library extends SliderMenu {
   public int iProvinceID = -1;

   public Menu_InGame_Build_Library() {
      ...
      this.initMenu(
         new SliderMenuTitle(CFG.langManager.get("Library"), CFG.BUTTON_HEIGHT * 3 / 5, true, true),
   ...
   public Menu_InGame_Build_Library(int nProvinceID) {
      ArrayList<MenuElement> menuElements = new ArrayList<>();
      this.iProvinceID = nProvinceID;
      int tempWidth = CFG.CIV_INFO_MENU_WIDTH * 2;
      int tY = 0;
      menuElements.add(
         new Button_Build_Building_Library(
            CFG.langManager
                  .get(
                     CFG.game.getProvince(this.iProvinceID).getLevelOfLibrary() == 0
                        ? "BuildLibraryIn"
                        : (CFG.game.getProvince(this.iProvinceID).getLevelOfLibrary() == 1 ? "BuildUniversityIn" : "BuildResearchLabIn")
                  )
               + ": ",
            ...
            Images.b_library,
            BuildingsManager.getLibrary_BuildCost(CFG.game.getProvince(this.iProvinceID).getLevelOfLibrary() + 1, this.iProvinceID),
            BuildingsManager.getLibrary_BuildMovementCost(CFG.game.getProvince(this.iProvinceID).getLevelOfLibrary() + 1),
            0,
            tY,
            CFG.BUTTON_WIDTH * 2,
            (int)(
               (float)CFG.game.getProvince(this.iProvinceID).getPopulationData().getPopulation()
                  / BuildingsManager.getLibrary_ResearchPerPopulation(CFG.game.getProvince(this.iProvinceID).getLevelOfLibrary() + 1)
            )
         ) {
            @Override
            public int getWidth() {
               return Menu_InGame_Build_Library.this.getElementW() * 2;
            }
                     ...
                     CFG.langManager
                        .get(
                           ...
                           BuildingsManager.getLibrary_ResearchPerPopulation(
                              CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getLevelOfLibrary() + 1
                           )
                        ),
      ...
      menuElements.get(menuElements.size() - 1)
         .setMin((int)(BuildingsManager.getLibrary_TechLevel(CFG.game.getProvince(this.iProvinceID).getLevelOfLibrary() + 1) * 100.0F));
      tY += menuElements.get(menuElements.size() - 1).getHeight();
      int var7;
      menuElements.add(new Button_FlagActionSliderStyle(CFG.langManager.get("Cancel"), -1, 2 + CFG.PADDING, var7 = tY + CFG.PADDING, CFG.BUTTON_WIDTH, true) {
         @Override
         public int getWidth() {
            return Menu_InGame_Build_Library.this.getElementW() - CFG.PADDING - CFG.PADDING / 2;
         }
      });
      menuElements.add(
         new Button_FlagActionSliderStyle(CFG.langManager.get("Construct"), -1, 2, var7, CFG.BUTTON_WIDTH, true) {
            @Override
            public int getPosX() {
               return Menu_InGame_Build_Library.this.getElementW() + CFG.PADDING / 2;
            }
            ...
            public void buildElementHover() {
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager
                           .get(
                              CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getLevelOfLibrary() == 0
                                 ? "BuildLibraryIn"
                                 : (
                                    CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getLevelOfLibrary() == 1
                                       ? "BuildUniversityIn"
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getName().length() > 0
                        ? CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getName()
                        : CFG.langManager.get("Province")
                  )
               );
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Flag(CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getCivID(), CFG.PADDING, 0)
               );
               nElements.add(new MenuElement_Hover_v2_Element2(nData));
               nData.clear();
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + BuildingsManager.getLibrary_BuildCost(
                           CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getLevelOfLibrary() + 1, Menu_InGame_Build_Library.this.iProvinceID
                        ),
                     CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney()
                           >= BuildingsManager.getLibrary_BuildCost(
                              CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getLevelOfLibrary() + 1,
                              Menu_InGame_Build_Library.this.iProvinceID
                           )
                  ...
                  new MenuElement_Hover_v2_Element_Type_Text(
                     CFG.langManager
                        .get(
                           ...
                           BuildingsManager.getLibrary_Construction(CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getLevelOfLibrary() + 1)
                        )
                  )
               );
               ...
               nData.add(
                  new MenuElement_Hover_v2_Element_Type_Text(
                     ""
                        + (int)(
                              BuildingsManager.getLibrary_TechLevel(CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getLevelOfLibrary() + 1)
                                 * 100.0F
                           )
                           / 100.0F,
            ...
            public boolean getClickable() {
               return CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMovePoints()
                     >= BuildingsManager.getLibrary_BuildMovementCost(CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getLevelOfLibrary() + 1)
                  && CFG.game.getCiv(CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID()).getMoney()
                     >= BuildingsManager.getLibrary_BuildCost(
                        CFG.game.getProvince(Menu_InGame_Build_Library.this.iProvinceID).getLevelOfLibrary() + 1, Menu_InGame_Build_Library.this.iProvinceID
                     )
      ...
      this.initMenu(
         new SliderMenuTitle(
            BuildingsManager.getLibrary_Name(CFG.game.getProvince(this.iProvinceID).getLevelOfLibrary() + 1), CFG.BUTTON_HEIGHT * 3 / 5, true, true
         ) {
            @Override
            public void draw(SpriteBatch oSB, int iTranslateX, int nPosX, int nPosY, int nWidth, boolean sliderMenuIsActive) {
               ...
               oSB.setColor(new Color(0.4F, 0.7058824F, 0.8352941F, 0.165F));
               ...
               oSB.setColor(new Color(0.4F, 0.7058824F, 0.8352941F, 0.375F));
               ...
               CFG.game
                  ...
                  .draw(
                     oSB,
                     Menu_InGame_Build_Library.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Library.this.getPosY()
                        - this.getHeight() / 2
               ...
               ImageManager.getImage(Images.flag_rect)
                  .draw(
                     oSB,
                     Menu_InGame_Build_Library.this.getPosX() + CFG.PADDING * 2 + iTranslateX,
                     Menu_InGame_Build_Library.this.getPosY() - this.getHeight() / 2 - CFG.CIV_FLAG_HEIGHT / 2
                  );
               CFG.fontMain.getData().setScale(0.8F);
               CFG.drawText(
                  oSB,
   ...
   public final void actionElement(int iID) {
      if (iID == this.getMenuElementsSize() - 1) {
         if (BuildingsManager.constructLibrary(this.iProvinceID, CFG.game.getPlayer(CFG.PLAYER_TURNID).getCivID())) {
