...
public class SteamMatchmaking extends SteamInterface {
   ...
   public boolean getFavoriteGame(int game, int[] appID, int[] ip, short[] connPort, short[] queryPort, int[] flags, int[] lastPlayedOnServer) {
      return getFavoriteGame(this.pointer, game, appID, ip, connPort, queryPort, flags, lastPlayedOnServer);
   }

   public int addFavoriteGame(int appID, int ip, short connPort, short queryPort, int flags, int lastPlayedOnServer) {
      return addFavoriteGame(this.pointer, appID, ip, connPort, queryPort, flags, lastPlayedOnServer);
   }

   public boolean removeFavoriteGame(int appID, int ip, short connPort, short queryPort, int flags) {
      return removeFavoriteGame(this.pointer, appID, ip, connPort, queryPort, flags);
   }
   ...
   public void addRequestLobbyListStringFilter(String keyToMatch, String valueToMatch, SteamMatchmaking.LobbyComparison comparisonType) {
      addRequestLobbyListStringFilter(this.pointer, keyToMatch, valueToMatch, comparisonType.value);
   }
   ...
   public void addRequestLobbyListNumericalFilter(String keyToMatch, int valueToMatch, SteamMatchmaking.LobbyComparison comparisonType) {
      addRequestLobbyListNumericalFilter(this.pointer, keyToMatch, valueToMatch, comparisonType.value);
   }

   public void addRequestLobbyListNearValueFilter(String keyToMatch, int valueToBeCloseTo) {
      addRequestLobbyListNearValueFilter(this.pointer, keyToMatch, valueToBeCloseTo);
   }

   public void addRequestLobbyListFilterSlotsAvailable(int slotsAvailable) {
      addRequestLobbyListFilterSlotsAvailable(this.pointer, slotsAvailable);
   }
   ...
   public void addRequestLobbyListResultCountFilter(int maxResults) {
      addRequestLobbyListResultCountFilter(this.pointer, maxResults);
   }

   public void addRequestLobbyListCompatibleMembersFilter(SteamID steamIDLobby) {
      addRequestLobbyListCompatibleMembersFilter(this.pointer, steamIDLobby.handle);
   }

   public SteamID getLobbyByIndex(int lobby) {
      return new SteamID(getLobbyByIndex(this.pointer, lobby));
   }

   public SteamAPICall createLobby(SteamMatchmaking.LobbyType lobbyType, int maxMembers) {
      return new SteamAPICall(createLobby(this.pointer, this.callback, lobbyType.ordinal(), maxMembers));
   }

   public SteamAPICall joinLobby(SteamID steamIDLobby) {
      return new SteamAPICall(joinLobby(this.pointer, this.callback, steamIDLobby.handle));
   }

   public void leaveLobby(SteamID steamIDLobby) {
      leaveLobby(this.pointer, steamIDLobby.handle);
   }

   public boolean inviteUserToLobby(SteamID steamIDLobby, SteamID steamIDInvitee) {
      return inviteUserToLobby(this.pointer, steamIDLobby.handle, steamIDInvitee.handle);
   }

   public int getNumLobbyMembers(SteamID steamIDLobby) {
      return getNumLobbyMembers(this.pointer, steamIDLobby.handle);
   }

   public SteamID getLobbyMemberByIndex(SteamID steamIDLobby, int memberIndex) {
      return new SteamID(getLobbyMemberByIndex(this.pointer, steamIDLobby.handle, memberIndex));
   }

   public String getLobbyData(SteamID steamIDLobby, String key) {
      return getLobbyData(this.pointer, steamIDLobby.handle, key);
   }

   public boolean setLobbyData(SteamID steamIDLobby, String key, String value) {
      return setLobbyData(this.pointer, steamIDLobby.handle, key, value);
   }

   public boolean setLobbyData(SteamID steamIDLobby, SteamMatchmakingKeyValuePair keyValuePair) {
      return setLobbyData(this.pointer, steamIDLobby.handle, keyValuePair.getKey(), keyValuePair.getValue());
   }

   public String getLobbyMemberData(SteamID steamIDLobby, SteamID steamIDUser, String key) {
      return getLobbyMemberData(this.pointer, steamIDLobby.handle, steamIDUser.handle, key);
   }

   public void setLobbyMemberData(SteamID steamIDLobby, String key, String value) {
      setLobbyMemberData(this.pointer, steamIDLobby.handle, key, value);
   }

   public void setLobbyMemberData(SteamID steamIDLobby, SteamMatchmakingKeyValuePair keyValuePair) {
      setLobbyMemberData(this.pointer, steamIDLobby.handle, keyValuePair.getKey(), keyValuePair.getValue());
   }

   public int getLobbyDataCount(SteamID steamIDLobby) {
      return getLobbyDataCount(this.pointer, steamIDLobby.handle);
   }

   public boolean getLobbyDataByIndex(SteamID steamIDLobby, int lobbyDataIndex, SteamMatchmakingKeyValuePair keyValuePair) {
      return getLobbyDataByIndex(this.pointer, steamIDLobby.handle, lobbyDataIndex, keyValuePair);
   }

   public boolean deleteLobbyData(SteamID steamIDLobby, String key) {
      return deleteLobbyData(this.pointer, steamIDLobby.handle, key);
   }
   ...
   public boolean sendLobbyChatMsg(SteamID steamIDLobby, ByteBuffer data) throws SteamException {
      if (!data.isDirect()) {
         ...
         return sendLobbyChatMsg(this.pointer, steamIDLobby.handle, data, data.position(), data.remaining());
      }
   }

   public boolean sendLobbyChatMsg(SteamID steamIDLobby, String data) {
      return sendLobbyChatMsg(this.pointer, steamIDLobby.handle, data);
   }

   public int getLobbyChatEntry(SteamID steamIDLobby, int chatID, SteamMatchmaking.ChatEntry chatEntry, ByteBuffer dest) throws SteamException {
      if (!dest.isDirect()) {
         throw new SteamException("Direct buffer required!");
      } else {
         return getLobbyChatEntry(this.pointer, steamIDLobby.handle, chatID, chatEntry, dest, dest.position(), dest.remaining());
      }
   }

   public boolean requestLobbyData(SteamID steamIDLobby) {
      return requestLobbyData(this.pointer, steamIDLobby.handle);
   }

   public void setLobbyGameServer(SteamID steamIDLobby, int gameServerIP, short gameServerPort, SteamID steamIDGameServer) {
      setLobbyGameServer(this.pointer, steamIDLobby.handle, gameServerIP, gameServerPort, steamIDGameServer.handle);
   }

   public boolean getLobbyGameServer(SteamID steamIDLobby, int[] gameServerIP, short[] gameServerPort, SteamID steamIDGameServer) {
      long[] id = new long[1];
      if (getLobbyGameServer(this.pointer, steamIDLobby.handle, gameServerIP, gameServerPort, id)) {
   ...
   public boolean setLobbyMemberLimit(SteamID steamIDLobby, int maxMembers) {
      return setLobbyMemberLimit(this.pointer, steamIDLobby.handle, maxMembers);
   }

   public int getLobbyMemberLimit(SteamID steamIDLobby) {
      return getLobbyMemberLimit(this.pointer, steamIDLobby.handle);
   }

   public boolean setLobbyType(SteamID steamIDLobby, SteamMatchmaking.LobbyType lobbyType) {
      return setLobbyType(this.pointer, steamIDLobby.handle, lobbyType.ordinal());
   }

   public boolean setLobbyJoinable(SteamID steamIDLobby, boolean joinable) {
      return setLobbyJoinable(this.pointer, steamIDLobby.handle, joinable);
   }

   public SteamID getLobbyOwner(SteamID steamIDLobby) {
      return new SteamID(getLobbyOwner(this.pointer, steamIDLobby.handle));
   }

   public boolean setLobbyOwner(SteamID steamIDLobby, SteamID steamIDNewOwner) {
      return setLobbyOwner(this.pointer, steamIDLobby.handle, steamIDNewOwner.handle);
   }

   public boolean setLinkedLobby(SteamID steamIDLobby, SteamID steamIDLobbyDependent) {
      return setLinkedLobby(this.pointer, steamIDLobby.handle, steamIDLobbyDependent.handle);
   }
   ...
   public static enum ChatEntryType {
      ...
      static SteamMatchmaking.ChatEntryType byCode(int code) {
         for (SteamMatchmaking.ChatEntryType value : values) {
            if (value.code == code) {
               return value;
            }
         }
   ...
   public static enum ChatMemberStateChange {
      ...
      static boolean isSet(SteamMatchmaking.ChatMemberStateChange value, int bitMask) {
   ...
   public static enum ChatRoomEnterResponse {
      ...
      static SteamMatchmaking.ChatRoomEnterResponse byCode(int code) {
         for (SteamMatchmaking.ChatRoomEnterResponse value : values) {
            if (value.code == code) {
               return value;
            }
         }
