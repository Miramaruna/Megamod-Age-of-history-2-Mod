...
class SteamMatchmakingCallbackAdapter extends SteamCallbackAdapter<SteamMatchmakingCallback> {
   ...
   void onLobbyEnter(long steamIDLobby, int chatPermissions, boolean blocked, int response) {
      this.callback.onLobbyEnter(new SteamID(steamIDLobby), chatPermissions, blocked, SteamMatchmaking.ChatRoomEnterResponse.byCode(response));
   }
   ...
   void onLobbyChatMessage(long steamIDLobby, long steamIDUser, int entryType, int chatID) {
      this.callback.onLobbyChatMessage(new SteamID(steamIDLobby), new SteamID(steamIDUser), SteamMatchmaking.ChatEntryType.byCode(entryType), chatID);
   }
