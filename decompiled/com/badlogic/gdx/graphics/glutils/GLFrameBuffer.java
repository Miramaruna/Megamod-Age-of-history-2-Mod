...
public abstract class GLFrameBuffer<T extends GLTexture> implements Disposable {
   ...
   protected void build() {
      ...
      gl.glBindTexture(this.colorTexture.glTarget, this.colorTexture.getTextureObjectHandle());
      if (this.hasDepth) {
      ...
      this.attachFrameBufferColorTexture();
      if (this.hasDepth) {
      ...
      gl.glBindTexture(this.colorTexture.glTarget, 0);
