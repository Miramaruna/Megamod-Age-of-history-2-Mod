...
public class RenderableShapeBuilder extends BaseShapeBuilder {
   ...
   private static final RenderableShapeBuilder.RenderablePool renderablesPool = new RenderableShapeBuilder.RenderablePool();
   ...
   public static void buildNormals(MeshPartBuilder builder, RenderableProvider renderableProvider, float vectorSize) {
      buildNormals(
         ...
         renderableProvider,
         vectorSize,
         tmpColor0.set(0.0F, 0.0F, 1.0F, 1.0F),
         tmpColor1.set(1.0F, 0.0F, 0.0F, 1.0F),
         tmpColor2.set(0.0F, 1.0F, 0.0F, 1.0F)
      );
   }

   public static void buildNormals(
      MeshPartBuilder builder, RenderableProvider renderableProvider, float vectorSize, Color normalColor, Color tangentColor, Color binormalColor
   ) {
