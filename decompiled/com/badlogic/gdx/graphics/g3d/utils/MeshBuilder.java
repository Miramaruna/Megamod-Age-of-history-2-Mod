...
public class MeshBuilder implements MeshPartBuilder {
   ...
   public void setColor(Color color) {
      this.color.set(!(this.hasColor = color != null) ? Color.WHITE : color);
   }
   ...
   public void setUVRange(TextureRegion region) {
      if (!(this.hasUVTransform = region != null)) {
         this.uOffset = this.vOffset = 0.0F;
         this.uScale = this.vScale = 1.0F;
      } else {
   ...
   public void setVertexTransform(Matrix4 transform) {
      if (this.vertexTransformationEnabled = transform != null) {
   ...
   private final void addVertex(float[] values, int offset) {
      ...
      if (this.hasColor) {
         if (this.colOffset >= 0) {
            ...
            this.vertices.items[o + this.cpOffset] = this.tempC1
               .set(NumberUtils.floatToIntColor(this.vertices.items[o + this.cpOffset]))
               .mul(this.color)
               .toFloatBits();
         }
      }
   ...
   public short vertex(MeshPartBuilder.VertexInfo info) {
      return this.vertex(
         info.hasPosition ? info.position : null, info.hasNormal ? info.normal : null, info.hasColor ? info.color : null, info.hasUV ? info.uv : null
      );
   }
   ...
   @Override
   public void rect(
      MeshPartBuilder.VertexInfo corner00, MeshPartBuilder.VertexInfo corner10, MeshPartBuilder.VertexInfo corner11, MeshPartBuilder.VertexInfo corner01
   ) {
   ...
   public void rect(Vector3 corner00, Vector3 corner10, Vector3 corner11, Vector3 corner01, Vector3 normal) {
      this.rect(
         this.vertTmp1.set(corner00, normal, null, null).setUV(0.0F, 1.0F),
         this.vertTmp2.set(corner10, normal, null, null).setUV(1.0F, 1.0F),
         this.vertTmp3.set(corner11, normal, null, null).setUV(1.0F, 0.0F),
         this.vertTmp4.set(corner01, normal, null, null).setUV(0.0F, 0.0F)
      );
   }
   ...
   public void rect(
      ...
      this.rect(
         this.vertTmp1.set(null, null, null, null).setPos(x00, y00, z00).setNor(normalX, normalY, normalZ).setUV(0.0F, 1.0F),
         this.vertTmp2.set(null, null, null, null).setPos(x10, y10, z10).setNor(normalX, normalY, normalZ).setUV(1.0F, 1.0F),
         this.vertTmp3.set(null, null, null, null).setPos(x11, y11, z11).setNor(normalX, normalY, normalZ).setUV(1.0F, 0.0F),
         this.vertTmp4.set(null, null, null, null).setPos(x01, y01, z01).setNor(normalX, normalY, normalZ).setUV(0.0F, 0.0F)
      );
   }
   ...
   public void addMesh(Mesh mesh, int indexOffset, int numIndices) {
      if (!this.attributes.equals(mesh.getVertexAttributes())) {
         ...
         this.addMesh(tmpVertices.items, tmpIndices.items, 0, numIndices);
      }
   }
   ...
   @Override
   public void box(
      Vector3 corner000, Vector3 corner010, Vector3 corner100, Vector3 corner110, Vector3 corner001, Vector3 corner011, Vector3 corner101, Vector3 corner111
   ) {
      BoxShapeBuilder.build(this, corner000, corner010, corner100, corner110, corner001, corner011, corner101, corner111);
   }
   ...
   public void circle(
      ...
      EllipseShapeBuilder.build(
         this, radius, divisions, centerX, centerY, centerZ, normalX, normalY, normalZ, tangentX, tangentY, tangentZ, binormalX, binormalY, binormalZ
      );
   }
   ...
   @Override
   public void circle(
      float radius, int divisions, float centerX, float centerY, float centerZ, float normalX, float normalY, float normalZ, float angleFrom, float angleTo
   ) {
   ...
   public void ellipse(
      ...
      EllipseShapeBuilder.build(
         this, width, height, divisions, centerX, centerY, centerZ, normalX, normalY, normalZ, tangentX, tangentY, tangentZ, binormalX, binormalY, binormalZ
      );
   }
   ...
   @Override
   public void ellipse(
      float width, float height, int divisions, Vector3 center, Vector3 normal, Vector3 tangent, Vector3 binormal, float angleFrom, float angleTo
   ) {
   ...
   public void ellipse(
      ...
      EllipseShapeBuilder.build(
         this, width, height, innerWidth, innerHeight, divisions, centerX, centerY, centerZ, normalX, normalY, normalZ, angleFrom, angleTo
      );
   }
   ...
   @Override
   public void sphere(
      float width, float height, float depth, int divisionsU, int divisionsV, float angleUFrom, float angleUTo, float angleVFrom, float angleVTo
   ) {
